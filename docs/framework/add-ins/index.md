...
### <a name="discovery-and-activation"></a>Обнаружение и активация  
 ...
 Подробнее об обновлении и повторной сборке банка данных см. в разделе [Обнаружение надстройки](http://msdn.microsoft.com/en-us/5d268dde-11df-4c4d-a022-f58d88bbc421). Информацию об активации надстроек см. в разделах [Активация надстройки](http://msdn.microsoft.com/en-us/bedcbcdf-5964-4215-b5f3-3299798b2b3f) и [Практическое руководство. Активация надстроек с другими параметрами изоляции и безопасности](http://msdn.microsoft.com/en-us/7afe7ec8-5158-4350-9119-5df0ecab8aa5).  
