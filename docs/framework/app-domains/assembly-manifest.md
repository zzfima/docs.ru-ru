---
title: "Манифест сборки | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "сборки [платформа .NET Framework], метаданные"
  - "манифест сборки"
  - "язык и региональные параметры, манифест сборки"
  - "динамические сборки, манифест сборки"
  - "метаданные, манифест сборки"
