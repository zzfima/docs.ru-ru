---
title: "Сборки в среде CLR | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "сборки [платформа .NET Framework], сведения"
  - "сборки [платформа .NET Framework], границы"
  - "границы сборок"
  - "динамические сборки"
  - "границы области видимости ссылок"
  - "безопасность [платформа .NET Framework], границы"
  - "границы типа"
  - "границы версии"
...
|[Emitting Dynamic Methods and Assemblies](../../../docs/framework/reflection-and-codedom/emitting-dynamic-methods-and-assemblies.md)|Описание способов создания динамических сборок.|  
