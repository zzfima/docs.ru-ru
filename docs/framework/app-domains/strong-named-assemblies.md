---
title: "Сборки со строгими именами | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "сборки со строгими именами, о сборках со строгими именами"
...
## Что такое сборка со строгим именем?  
 ...
 Задавать строгие имена для сборок можно с помощью Visual Studio или программы командной строки.  Дополнительные сведения см. в разделе [Практическое руководство. Подписание сборки строгим именем](../../../docs/framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md) или [Sn.exe \(Strong Name Tool\)](../../../docs/framework/tools/sn-exe-strong-name-tool.md).  
