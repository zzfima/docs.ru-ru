...
- Использование инструмента разработчика под названием [Средство глобального кэша сборок (Gacutil.exe)](../../../docs/framework/tools/gacutil-exe-gac-tool.md), предоставляемого в пакете средств разработки программного обеспечения (SDK) Windows.  
