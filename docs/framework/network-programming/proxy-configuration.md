---
title: "Конфигурация прокси-сервера | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "приспособительные учетные записи-посредники"
  - "Интернет, конфигурация прокси-сервера"
  - "Сетевые ресурсы"
  - "сеть, конфигурация прокси-сервера"
  - "Сеть"
  - "прокси-серверы"
  - "прокси-серверы, настройка"
  - "статические учетные записи-посредники"
