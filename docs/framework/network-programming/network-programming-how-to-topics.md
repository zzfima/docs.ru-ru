---
title: "Практические руководства по сетевому программированию | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "сетевые ресурсы"
  - "сети [платформа .NET Framework], руководства по программированию"
  - "руководства по организации сети [платформа .NET Framework]"
  - "сеть"
...
---
# Практические руководства по сетевому программированию
Ниже приведены ссылки на все разделы руководства основной документации по программированию сети.  
 ...
 **Подключаемый протокол и приложений.**  
  
-   [Практическое руководство. Регистрация пользовательского протокола с помощью WebRequest](../../../docs/framework/network-programming/how-to-register-a-custom-protocol-using-webrequest.md)  
...
-   [Практическое руководство. Скачивание файлов с использованием FTP](../../../docs/framework/network-programming/how-to-download-files-with-ftp.md)  
...
-   [Практическое руководство. Изменение файла конфигурации компьютера для включения поддержки IPv6](../../../docs/framework/network-programming/how-to-modify-the-computer-configuration-file-to-enable-ipv6-support.md)  
 ...
 **Использование учетных записей\-посредников.**  
...
-   [Практическое руководство. Определение доступности сети и изменений адреса](../../../docs/framework/network-programming/how-to-detect-network-availability-and-address-changes.md)  
  
-   [Практическое руководство. Получение информации об интерфейсах и протоколах](../../../docs/framework/network-programming/how-to-get-interface-and-protocol-information.md)  
...
## См. также  
 ...
 [Образцы сети .NET в MSDN code gallery](http://code.msdn.microsoft.com/Wiki/View.aspx?ProjectName=nclsamples)