...
Средство просмотра трассировки службы Windows Communication Foundation (WCF) позволяет анализировать диагностические трассировки, созданных [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]. Программа Service Trace Viewer предоставляет возможность простого слияния, просмотра и фильтрации сообщений трассировки в журнале, чтобы можно было диагностировать, исправлять и проверять неисправности служб [!INCLUDE[indigo2](../../../includes/indigo2-md.md)].  
...
1.  Запустите Service Trace Viewer, используя окно командной строки перейдите к [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] расположение установки (C:\Program Files\Microsoft SDKs\Windows\v6.0\Bin), а затем введите `SvcTraceViewer.exe`.  
...
#### <a name="event-tracing-and-crimson-tracing"></a>Трассировка событий и трассировка Crimson  
 Собственный формат средства просмотра - это формат трассировки действий [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]. Трассировки, создаваемые в различных форматах, должны конвертироваться перед их отображением в средстве просмотра. На данный момент кроме формата трассировки действий средство просмотра поддерживает трассировку событий и трассировку Crimson.  
...
-   С помощью встроенного фильтра средства просмотра можно выборочно фильтровать части трассировок инфраструктуры [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]. По умолчанию он настроен на пропускание всех трассировок инфраструктуры. Определенные параметры этот фильтр в **параметры фильтра** подменю в **представление** меню.  
