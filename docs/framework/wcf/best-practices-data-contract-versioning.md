---
title: "Рекомендации. Управление версиями контракта данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "рекомендации [WCF], управление версиями контракта данных"
  - "контракты данных"
  - "контракты служб"
...
В данном разделе приводятся рекомендации по созданию контрактов данных, которые можно легко развить со временем.  [!INCLUDE[crabout](../../../includes/crabout-md.md)] контрактах данных см. в разделе [Использование контрактов данных](../../../docs/framework/wcf/feature-details/using-data-contracts.md).  
...
## Управление версиями при необходимости в проверке схемы  
 ...
 [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] рекомендации [Управление версиями службы](../../../docs/framework/wcf/service-versioning.md).  
