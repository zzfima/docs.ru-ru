...
```  
 ...
 Сигнатура этой операции диктует вид базового обмена сообщениями. Если корреляции не существует, WCF не удается определить, для какой операции предназначается возвращаемое значение.  
