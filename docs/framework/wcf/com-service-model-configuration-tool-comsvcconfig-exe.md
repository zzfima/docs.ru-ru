...
> Для использования ComSvcConfig.exe на компьютере под управлением ОС Windows Vista требуются права администратора.  
 ...
 Дополнительные сведения о программе ComSvcConfig. exe см. [в разделе как Используйте средство](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md)настройки модели службы COM+.  
...
- [Практическое руководство. Использование средства настройки модели службы COM+](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md)
