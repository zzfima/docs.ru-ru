...
### <a name="wcf-syndication-service-library-template"></a>Шаблон библиотеки служб синдикации WCF.  
 Этот шаблон позволяет предоставлять веб-канал в формате RSS или ATOM как службу WCF. Дополнительные сведения см. в разделе [WCF синдикации](../../../docs/framework/wcf/feature-details/wcf-syndication.md).  
...
#### <a name="changing-the-address-of-the-feed"></a>Изменение адреса веб-канала  
 ...
 При изменении адреса веб-канала необходимо также изменить адрес на вкладке **Отладка** . Если этого не сделать, то Internet Explorer будет пытаться открыть веб-канал по адресу, используемому по умолчанию, и произойдет ошибка.  
