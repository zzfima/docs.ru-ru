...
Шаблоны Visual Studio Windows Communication Foundation (WCF) — это предопределенные шаблоны проектов и элементов в Visual Studio можно использовать для быстрого создания [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] службы и окружающих приложений.  
  
## <a name="using-the-wcf-templates"></a>Использование шаблонов WCF  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] Шаблоны Visual Studio предоставляют базовую структуру класса для разработки службы. В частности, эти шаблоны предоставляет основные определения для контракта службы, контракта данных, реализации службы и конфигурации. Эти шаблоны можно использовать для создания простой службы, которая потребует минимального программирования, и которая может служить как стандартный блок для более сложных служб.  
...
### <a name="wcf-service-item-template"></a>Шаблон элемента службы WCF  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] Шаблон элемента службы является пользовательский шаблон, который обеспечивает быстрый способ добавления [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] служб для существующих проектов Visual Studio.  
