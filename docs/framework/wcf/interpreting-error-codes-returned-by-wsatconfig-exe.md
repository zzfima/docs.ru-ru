...
|----------------|-----------------|------------------------------------|  
|0|Операция выполнена успешно.|Отсутствуют|  
...
|20|WinFX не установлен на удаленном компьютере или установлен неправильно.|Установите WinFX на компьютере.|  
...
|22|WinFX не установлен на удаленном компьютере или установлен неправильно.|Установите WinFX на компьютере.|  
...
|31|Недопустимый параметр командной строки `-traceLevel`.|Исправьте параметр командной строки `-traceLevel`, чтобы задать допустимое значение из списка ниже:<br /><br /> -Выкл.<br />-Ошибка<br />Критический<br />— Предупреждение<br />— Сведения<br />-Verbose<br />Все|  
...
|41|Либо не удалось найти установку WinFX, либо найденная версия не соответствует возможности, которую может настроить средство.|Убедитесь, что WinFX установлен правильно и используется только средство WsatConfig. exe, поставляемое с этой версией WinFX для настройки WS-AT.|  
...
|44|Отсутствует необходимое исправление, и не удается настроить WS-AT до установки этого исправления.|Инструкции по установке необходимого исправления см. в заметках о выпуске WinFX.|  
