...
|20|WinFX на удаленном компьютере не установлен или установлен неправильно.|Установите WinFX на компьютере.|  
...
|22|WinFX на удаленном компьютере не установлен или установлен неправильно.|Установите WinFX на компьютере.|  
...
|41|Найден без установки WinFX, либо найти ту из них соответствует содержимому средство может настраивать.|Убедитесь, что WinFX правильно установлен и использовать только средство WsatConfig.exe, поставляемый с этой версией WinFX, чтобы настроить WS-AT.|  
...
|44|Отсутствует необходимое исправление, и не удается настроить WS-AT до установки этого исправления.|См. заметки о выпуске для инструкции по установке необходимого исправления WinFX.|  
