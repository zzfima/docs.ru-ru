...
## <a name="in-this-section"></a>Содержание раздела  
 ...
 [Возможности для упрощения работы с WCF](../../../docs/framework/wcf/wcf-simplification-features.md)  
 ...
 [Перенос из .NET Remoting на платформу WCF](../../../docs/framework/wcf/migrating-from-net-remoting-to-wcf.md)  
 ...
 [Обратная связь и сообщество](../../../docs/framework/wcf/feedback-and-community.md)  
 Сведения о том, как оставлять отзывы и комментарии о библиотеке Windows Communication Foundation  
  
 [Сведения о конфиденциальности](../../../docs/framework/wcf/privacy-information.md)  
