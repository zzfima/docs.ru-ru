...
## <a name="in-this-section"></a>В данном разделе
 ...
 [Руководство](guide-to-the-documentation.md) по\ документации
 ...
 [Начало работы учебник](getting-started-tutorial.md)\
 ...
 [Сведения о компоненте WCF](./feature-details/index.md)\
 ...
 Рекомендации [и](guidelines-and-best-practices.md) рекомендации\
 Содержит рекомендации по созданию приложений Windows Communication Foundation (WCF).

 \ [администрирования и диагностики](./diagnostics/index.md)
 ...
 [Миграция с удаленного взаимодействия .NET на WCF](migrating-from-net-remoting-to-wcf.md)\
 ...
 [Windows Communication Foundation глоссарий](glossary.md)\
