...
-   **Метаданные службы**  
     ...
     [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] поддерживает публикацию метаданных службы с использованием форматов, указанных в отраслевых стандартах, таких как WSDL, схемы XML и WS-Policy. С помощью таких метаданных можно автоматически создавать и настраивать клиенты для доступа к службам [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] . Метаданные могут публиковаться через HTTP и HTTPS или с использованием стандарта обмена метаданными веб-служб. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Metadata](../../../docs/framework/wcf/feature-details/metadata.md).  
  
-   **Контракты данных**  
  
     Поскольку платформа [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] построена на основе [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)], в нее входят удобно используемые в коде методы передачи контрактов, которые нужно принудительно выполнять. Одним из универсальных типов контрактов является контракт данных. Если код службы создается на языке Visual C# или Visual Basic, то самым простым способом обработки данных фактически является создание классов, которые представляют сущность данных со свойствами, принадлежащими сущности данных. [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] включает сложную систему для работы с данными этим удобным способом. После создания классов, представляющих данные, служба автоматически создает метаданные, которые позволяют клиентам обеспечивать соответствие заданным типам данных. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Using Data Contracts](../../../docs/framework/wcf/feature-details/using-data-contracts.md)  
