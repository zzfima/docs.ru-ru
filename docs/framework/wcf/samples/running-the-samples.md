...
1.  Сборки решения (клиент и служба) с помощью **построения** меню или сочетание клавиш CTRL + SHIFT + B.  
...
2.  Служба размещается в службах IIS.  
    ...
    3.  Выберите **Показать процессы всех пользователей** флажок.  
...
4.  Щелкните правой кнопкой мыши элемент клиентского проекта и выберите **отладки**, **запустить новый экземпляр**.  
