---
title: "Передача формы | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
5.  Затем выдается предложение перейти к URI формы заказчика.  Откройте браузер и перейдите по заданному URI.  Введите имя и адрес для заказчика и нажмите кнопку **Отправить**.  
