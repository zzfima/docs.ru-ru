...
Этот раздел содержит образцы, демонстрирующие синдикации Windows Communication Foundation (WCF).  
  
## <a name="in-this-section"></a>В этом разделе  
 [Автономный веб-канал диагностики](../../../../docs/framework/wcf/samples/stand-alone-diagnostics-feed-sample.md)  
 Демонстрирует способ создания RSS/Atom для синдикации с помощью WCF.  
