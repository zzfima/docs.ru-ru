...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описываются действия, необходимые для настройки брандмауэра Windows для работы служб WCF.  
 ...
 Описаны шаги по построению образцов WCF.  
  
 [Выполнение примеров Windows Communication Foundation](../../../../docs/framework/wcf/samples/running-the-samples.md)  
 Описаны шаги по выполнению образцов WCF на том же компьютере или нескольких компьютерах.  
