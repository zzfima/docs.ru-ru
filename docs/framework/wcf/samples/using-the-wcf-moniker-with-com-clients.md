...
```  
 ...
 При запуске образца в окне сообщений сервера скриптов Windows отображается ответ операции. Это показывает, клиент COM осуществляет вызовы COM с использованием моникера с контрактом WSDL для связи со службой WCF.  
...
```  
 ...
 При запуске образца в окне сообщений сервера скриптов Windows отображается ответ операции. Это показывает, клиент COM осуществляет вызовы COM с использованием моникера с контрактом MEX для связи со службой WCF.  
