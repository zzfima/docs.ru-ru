...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Демонстрирует включение [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] режим совместимости в WCF.  
 ...
 Демонстрирует службы WCF, размещенной в управляемой службе Windows.  
