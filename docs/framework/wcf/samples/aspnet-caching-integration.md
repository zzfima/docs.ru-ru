...
-   **Служба**: проекта веб-приложения, в который включена служба WCF HTTP, размещенная в ASP.NET.  
  
-   **Клиент**: проект консольного приложения, который выполняет вызовы к службе.  
  
-   **Распространенные**: общая библиотека, содержащая тип Customer, используемые клиентом и службой.  
