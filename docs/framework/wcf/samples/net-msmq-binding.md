...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Обработка подозрительных сообщений в MSMQ 4.0](../../../../docs/framework/wcf/samples/poison-message-handling-in-msmq-4-0.md)  
 ...
 В этом примере показано, как создавать пакеты операций транзакционного чтения с помощью очереди сообщений (MSMQ).  
