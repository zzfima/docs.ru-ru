...
- [Создание безопасных приложений ASP.NET: проверка подлинности, авторизация и безопасное взаимодействие](https://docs.microsoft.com/previous-versions/msp-n-p/ff649248(v=pandp.10))  
  
- [Инструкции. Шифрование разделов конфигурации в ASP.NET 2,0 с помощью RSA](https://docs.microsoft.com/previous-versions/msp-n-p/ff650304(v=pandp.10))  
