...
## <a name="discussion"></a>Обсуждение  
 С помощью этих возможностей можно управлять безопасностью службы, используя их вместе либо по отдельности. Это не полное руководство по защите службы WCF.  
...
-   [Разработка безопасных приложений ASP.NET: Проверка подлинности, авторизации и безопасный обмен данными](https://go.microsoft.com/fwlink/?LinkId=95137)  
