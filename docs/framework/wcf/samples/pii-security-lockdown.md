...
## <a name="discussion"></a>Обсуждение  
 С помощью этих возможностей можно управлять безопасностью службы, используя их вместе либо по отдельности. Это не является полным руководством по обеспечению безопасности службы WCF.  
