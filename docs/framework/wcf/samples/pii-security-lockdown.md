...
1. Откройте командную строку с помощью команды Start-> выполнить.... Введите и нажмите кнопку **ОК.** `cmd`  
