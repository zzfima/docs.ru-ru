...
Этот раздел содержит образцы, которые демонстрируют пользовательскую синдикацию в Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Демонстрирует, как эффективно управлять веб-каналами синдикации, содержащими большое число элементов.
