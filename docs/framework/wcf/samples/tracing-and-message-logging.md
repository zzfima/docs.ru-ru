...
## <a name="message-logging"></a>Ведение журналов сообщений  
 Можно включить ведение журнала сообщений, как на стороне клиента и службы любого приложения WCF. Чтобы включить ведение журнала сообщений, необходимо добавить следующий код в клиент или службу.  
