...
> [!NOTE]
>  Необходимо иметь разрешения на запись **wwwroot** каталог для выполнения этого примера.  
...
4.  Книги, имеющиеся в книжном магазине можно просмотреть, щелкнув **Просмотр книг**.  
  
5.  Чтобы приобрести конкретную книгу, выберите книгу из списка и нажмите кнопку **купить книгу**. Приложение запустится и пройдет проверку подлинности с использованием проверки подлинности Windows со службой маркеров безопасности HomeRealm.  
