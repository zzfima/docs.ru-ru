...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Демонстрирует использование WCF, чтобы создать базовую службу ASP.NET асинхронных скриптов JavaScript и XML (AJAX).  
  
 [Служба AJAX с использованием HTTP POST](../../../../docs/framework/wcf/samples/ajax-service-using-http-post.md)  
 Демонстрируется использование WCF для создания [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] службы асинхронных скриптов JavaScript и XML (AJAX), которая использует HTTP POST.  
 ...
 Показано, как использовать WCF для создания службы ASP.NET асинхронных скриптов JavaScript и XML (AJAX), которая создает экземпляры сложных типов.  
  
 [Служба AJAX с JSON и XML](../../../../docs/framework/wcf/samples/ajax-service-with-json-and-xml-sample.md)  
 Показано, как использовать WCF для создания служб асинхронных сценариев JavaScript и XML (AJAX), возвращает JavaScript Object Notation (JSON) или XML-данные.
