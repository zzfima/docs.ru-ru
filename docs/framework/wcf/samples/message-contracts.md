---
title: "Контракты сообщений | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Контракты сообщений
Образцы в этом разделе демонстрируют контракты сообщений в [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
...
## В этом подразделе  
 ...
 [Нетипизированный запрос\/ответ](../../../../docs/framework/wcf/samples/untyped-request-reply.md)  
 ...
 [Образец XmlReader](../../../../docs/framework/wcf/samples/xmlreader-sample.md)  
