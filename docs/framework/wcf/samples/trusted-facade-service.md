---
title: "Доверенная фасадная служба | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### Путь обмена данными между клиентом и фасадной службой  
...
### Путь обмена данными между фасадной службой и серверной службой  
...
```  
 ...
 Элемент привязки [\<безопасность\>](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-custombinding.md) обеспечивает передачу и извлечение имени пользователя изначальной вызывающей стороны.[\<windowsStreamSecurity\>](../../../../docs/framework/configure-apps/file-schema/wcf/windowsstreamsecurity.md) и [\<tcpTransport\>](../../../../docs/framework/configure-apps/file-schema/wcf/tcptransport.md) обеспечивают проверку подлинности фасадной и серверной служб, а также защиту сообщений.  
...
>   
>  `<диск_установки>:\WF_WCF_Samples\WCF\Scenario\TrustedFacade`  
