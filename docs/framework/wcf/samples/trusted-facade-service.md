...
```  
 ...
 Элемент привязки [> безопасностиотвечаетзапередачуиизвлечениеименипользователявызывающегообъекта.\<](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-custombinding.md) Windowsstreamsecurity инициирует обновление > и [ tcpTransportплатформы>соблюдатьпроверкуподлинностифасаднойисерверныхслужбизащитусообщений\<](../../../../docs/framework/configure-apps/file-schema/wcf/tcptransport.md) . [ \<](../../../../docs/framework/configure-apps/file-schema/wcf/windowsstreamsecurity.md)  
