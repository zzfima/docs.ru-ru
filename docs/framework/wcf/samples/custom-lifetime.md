...
## <a name="extending-the-instancecontext"></a><span data-ttu-id="4da5e-119">Расширение InstanceContext</span><span class="sxs-lookup"><span data-stu-id="4da5e-119">Extending the InstanceContext</span></span>  
