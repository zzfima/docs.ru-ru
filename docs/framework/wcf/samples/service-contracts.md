...
В этом разделе содержатся образцы, которые демонстрируют контракты служб в Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Асинхронные](http://msdn.microsoft.com/library/833db946-f511-4f64-a26f-2759a11217c7)  
