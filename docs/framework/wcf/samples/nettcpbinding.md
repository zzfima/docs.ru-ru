...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Пример совместного использования портов Net.TCP](../../../../docs/framework/wcf/samples/net-tcp-port-sharing-sample.md)  
 Демонстрирует совместное использование в WCF TCP-порт.
