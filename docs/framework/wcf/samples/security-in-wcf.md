...
Этот раздел содержит образцы, связанные с безопасностью Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описание способов указания в стандартный или пользовательский алгоритм для шифрования, гибкой реализации клиента WFC и службы.
