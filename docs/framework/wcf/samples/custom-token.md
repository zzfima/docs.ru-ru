...
-   Как код службы WCF можно получить сведения о полученных маркерах безопасности включая пользовательский маркер безопасности.  
...
## <a name="custom-security-token-implementation"></a>Реализация пользовательского маркера безопасности  
 ...
 В следующем разделе описывается, что необходимо для того, чтобы включить пользовательский маркер, передаваемых по сети и используемый конечной точки WCF.  
...
2.  Если клиенту и службе не удается взаимодействовать, см. раздел [советы по устранению неполадок](http://msdn.microsoft.com/library/8787c877-5e96-42da-8214-fa737a38f10b).  
