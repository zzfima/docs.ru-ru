...
## <a name="accessing-wmi-information"></a>Доступ к сведениям WMI  
 Доступ к данным инструментария WMI может осуществляться несколькими различными способами. Microsoft предоставляет программные интерфейсы WMI для скриптов, приложений Visual Basic, C++ приложения и платформы .NET Framework (https://docs.microsoft.com/windows/desktop/wmisdk/using-wmi).  
