...
> [!NOTE]
> В этом примере демонстрируется использование очереди недоставленных сообщений приложения, которая доступна только в Windows Vista. Этот пример можно изменить, чтобы использовать системные очереди по умолчанию для MSMQ 3,0 на Windows Server 2003 и [!INCLUDE[wxp](../../../../includes/wxp-md.md)].
