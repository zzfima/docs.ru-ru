...
ms.locfileid: "33809996"
---
# <a name="routing-services"></a>Службы маршрутизации
Этот раздел содержит образцы, демонстрирующие способы использования этих маршрутизаторов Windows Communication Foundation (WCF).  
  
## <a name="in-this-section"></a>В этом разделе  
 [Приветствие средствами служб маршрутизации](../../../../docs/framework/wcf/samples/hello-world-with-the-routing-service.md)  
 Показано, как использовать маршрутизатор WCF.  
  
 [Использование моста и обработка ошибок](../../../../docs/framework/wcf/samples/bridging-and-error-handling.md)  
 Демонстрирует, как служба маршрутизации WCF используется для обеспечения связи между клиентом и службой, которые используют разные привязки.  
  
 [Дополнительные фильтры](../../../../docs/framework/wcf/samples/advanced-filters.md)  
 Показано, как адаптировать стандартный образец калькулятора WCF для взаимодействия с использованием службы маршрутизации.  
