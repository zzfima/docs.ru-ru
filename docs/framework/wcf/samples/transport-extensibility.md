...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Демонстрирует расширение [транспорт: UDP](../../../../docs/framework/wcf/samples/transport-udp.md) пример поддержки активацию с помощью службы активации процессов Windows (WAS).  
  
 [Транспорт: пользовательские транзакции по протоколу UDP](../../../../docs/framework/wcf/samples/transport-custom-transactions-over-udp-sample.md)  
