...
-   Как маркер SAML передается платформа клиента WCF.  
...
```  
 ...
 Ниже показано, как разработать пользовательский поставщик маркеров SAML и интегрировать его с WCF: инфраструктурой безопасности:  
