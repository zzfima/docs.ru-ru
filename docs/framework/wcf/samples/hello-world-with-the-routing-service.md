---
title: "Приветствие средствами служб маршрутизации. | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  Нажмите клавишу F5 или сочетание клавиш CTRL\+SHIFT\+B.  
    ...
    > 2.  Служба\-калькулятор \(.\/CalculatorService\/bin\/service.exe\)  
...
>   
>  `<диск_установки>:\WF_WCF_Samples\WCF\Basic\RoutingServices\HelloRoutingService`  
