...
2.  Разрешите запуск нескольких проектов.  
    ...
    3.  Переместить в начало списка, в проект службы с **действия** значение **запустить**.  
  
    4.  Переместить клиентский проект после обновления проекта, также с **действия** значение **запустить**.  
