...
#### <a name="to-use-this-sample"></a><span data-ttu-id="7b3c5-125">Использование этого образца</span><span class="sxs-lookup"><span data-stu-id="7b3c5-125">To use this sample</span></span>  
