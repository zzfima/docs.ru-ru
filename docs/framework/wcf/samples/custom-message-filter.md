---
title: "Пользовательский фильтр сообщений | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  Чтобы выполнить образец на одном компьютере, следуйте инструкциям раздела [Выполнение примеров Windows Communication Foundation](../../../../docs/framework/wcf/samples/running-the-samples.md).  
  
3.  Чтобы выполнить образец на нескольких компьютерах, выполните инструкции в разделе [Выполнение примеров Windows Communication Foundation](../../../../docs/framework/wcf/samples/running-the-samples.md) и измените следующую строку в файле Client.cs.  
