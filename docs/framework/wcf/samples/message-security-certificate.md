...
5.  На сервере, запустите **setup.bat service** в командную строку Visual Studio с правами администратора. Под управлением **setup.bat** с **службы** аргумент создается сертификат службы с полным доменным именем компьютера и экспортируется в файл с именем Service.cer.  
...
8.  На стороне клиента, выполните **setup.bat client** в командную строку Visual Studio с правами администратора. Под управлением **setup.bat** с **клиента** аргумент создается сертификат клиента с именем client.com и этот сертификат клиента экспортируется в файл с именем Client.cer.  
