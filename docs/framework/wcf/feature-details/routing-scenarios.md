...
### <a name="service-versioning"></a>Управление версиями службы  
 ...
 Действия по созданию конфигурации управления версиями службы см. в разделе [как Управление версиями](../../../../docs/framework/wcf/feature-details/how-to-service-versioning.md)службы.
...
### <a name="service-data-partitioning"></a>Секционирование данных служб  
 ...
 Шаги, используемые для создания конфигурации секционирования данных службы, см. в [разделе как Секционирование данных службы](../../../../docs/framework/wcf/feature-details/how-to-service-data-partitioning.md).  
...
### <a name="dynamic-routing"></a>Динамическая маршрутизация  
 ...
 Шаги, используемые для реализации динамической маршрутизации, см. [в разделе как Динамическое](../../../../docs/framework/wcf/feature-details/how-to-dynamic-update.md)обновление.
...
- При вычислении сообщения несколько фильтров должны возвращать **значение true** .  
...
### <a name="error-handling"></a>Обработка ошибок  
 ...
 Шаги, используемые для настройки обработки ошибок, см. [в разделе как Обработка](../../../../docs/framework/wcf/feature-details/how-to-error-handling.md)ошибок.
