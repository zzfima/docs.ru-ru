...
-   Список [children] содержит не личные сведения (PI) информационных единиц ( \<? xml... > объявление не считается информационной единицей)  
