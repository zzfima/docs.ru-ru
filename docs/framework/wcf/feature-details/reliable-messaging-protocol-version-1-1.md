...
- R2302: перед установкой последовательностей WS-ReliableMessaging необходимо установить сеанс защищенного диалога AWS.
...
- B2304: последовательность WS-ReliableMessaging или пара коррелированных обратных последовательностей всегда привязана к одному сеансу WS-SecureConversation.
