...
Правильный курс действий заключается в перехвате ожидаемых исключений в каждой операции или соответствующей точке расширения, принятии решения о возможности восстановления из и возврате правильной пользовательской ошибки в FaultException @ no__t-0T >.
