---
title: "Типы, поддерживаемые сериализатором контракта данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "сериализация [WCF], поддерживаемые типы"
