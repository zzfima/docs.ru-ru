...
Выданный маркер позволяет клиенту использовать Федеративный сценарий безопасности в Windows Communication Foundation (WCF).  
 ...
 Для получения дополнительных сведений о федеративном сценарии, см. в разделе [Федерация и выданные маркеры](../../../../docs/framework/wcf/feature-details/federation-and-issued-tokens.md).  
