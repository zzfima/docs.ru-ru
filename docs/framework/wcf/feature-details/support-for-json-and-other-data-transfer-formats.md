...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Практическое руководство. Сериализация и десериализация данных JSON](../../../../docs/framework/wcf/feature-details/how-to-serialize-and-deserialize-json-data.md)  
 ...
 [Сопоставление JSON и XML](../../../../docs/framework/wcf/feature-details/mapping-between-json-and-xml.md)  
 Описывает соответствие между кодировками JavaScript Object Notation (JSON) и набор сведений XML, который используется внутренне Windows Communication Foundation (WCF) для представления данных с кодированием JSON и документов.  
