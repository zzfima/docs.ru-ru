...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает соответствие между кодировками JavaScript Object Notation (JSON) и набором сведений XML, который используется внутренне Windows Communication Foundation (WCF) для представления данных из JSON и документов.  
