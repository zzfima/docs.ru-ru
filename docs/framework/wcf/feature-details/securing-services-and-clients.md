...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Сводка причин для использования безопасности уровня сообщений в [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
  
 [Безопасные сеансы](../../../../docs/framework/wcf/feature-details/secure-sessions.md)  
 Соображения, которые необходимо учитывать при обеспечении безопасности сеанса [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
