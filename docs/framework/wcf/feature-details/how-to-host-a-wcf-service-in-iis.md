...
11. Чтобы проверить правильность размещения службы, откройте экземпляр Internet Explorer и перейдите к URL-адрес службы: `http://localhost/IISHostedCalc/Service.svc`  
