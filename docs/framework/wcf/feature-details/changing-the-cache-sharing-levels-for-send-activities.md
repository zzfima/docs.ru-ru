...
-   **Уровень узла**: В уровне совместного использования узла кэш доступен только для экземпляров рабочих процессов, размещенным на узле службы рабочего процесса. Кэш может также совместно использоваться узлами служб рабочих процессов в кэше всего процесса.  
  
-   **Уровень экземпляра**: уровне совместного использования экземпляра кэш доступен определенному экземпляру рабочего процесса во время его существования, но кэш недоступен другим экземплярам рабочих процессов.  
