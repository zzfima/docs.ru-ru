...
- **Уровень узла**: На уровне общего доступа к узлу кэш доступен только для экземпляров рабочих процессов, размещенных на узле службы рабочего процесса. Кэш может также совместно использоваться узлами служб рабочих процессов в кэше всего процесса.  
