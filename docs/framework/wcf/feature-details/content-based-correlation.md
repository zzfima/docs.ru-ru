...
## Настройка запросов XPath с помощью конструктора рабочих процессов  
 ...
 ![Определение CorrelatesOn](../../../../docs/framework/wcf/feature-details/media/correlatesondialog.jpg "CorrelatesOnDialog")  
  
 В этом диалоговом окне можно указать дескриптор <xref:System.ServiceModel.Activities.CorrelationHandle> и выбрать элементы в списке **Запросы XPath**, чтобы создать запрос XPath.