...
```  
 ...
 Если домен указан, но с помощью возможности идентификации конечной точки задано недействительное имя участника-службы, то будет использоваться NTLM. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]Указанное удостоверение конечной точки, в статье [службы удостоверений и проверки подлинности](../../../../docs/framework/wcf/feature-details/service-identity-and-authentication.md).  
