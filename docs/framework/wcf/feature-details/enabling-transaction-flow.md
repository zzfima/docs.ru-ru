...
## <a name="enabling-transaction-flow-at-the-endpoint-level"></a>Включение потока транзакций на уровне конечной точки  
 ...
 Большинство существующих привязок WCF предоставляет содержат `transactionFlow` и `transactionProtocol` атрибуты, которые позволяют настроить прием входящих транзакций для конкретной привязки. Дополнительные сведения о настройке элементов конфигурации, см. в разделе [ \<привязки >](../../../../docs/framework/misc/binding.md).  
...
## <a name="security"></a>Безопасность  
 ...
 При создании клиентов WCF для неизвестных или ненадежных веб-служб посредством обмена метаданными, вызовы операций в этих веб-служб необходимо подавить текущей транзакции, если это возможно. В следующем примере показано, как это сделать.  
