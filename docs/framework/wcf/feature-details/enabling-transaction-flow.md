---
title: "Включение потока транзакций | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "транзакции [WCF], включение потока"
...
|----------------------------------|---------------------------------------|-----------------------------------------------|---------------------------|  
|Mandatory|true|WS\-AT|Транзакция должна передаваться в обеспечивающем возможность взаимодействия формате WS\-AT.|  
|Mandatory|true|OleTransactions|Транзакция должна передаваться в формате [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] OleTransactions.|  
|Mandatory|false|Неприменим|Неприменима, так как это недопустимая конфигурация.|  
...
|Транзакция не соответствует ожидаемому формату протокола|Mandatory|`MustUnderstand` равняется `false`.|Отклонена, так как требуется транзакция|  
...
|Транзакция отсутствует|Mandatory|Неприменимо|Отклонена, так как требуется транзакция|  
|Транзакция отсутствует|Allowed|Неприменимо|Процесс|  
|Транзакция отсутствует|NotAllowed|Неприменимо|Процесс|  
