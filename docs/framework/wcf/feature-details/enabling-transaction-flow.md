...
|Обязательный|true|OleTransactions|Транзакция должна передаваться в формате [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] OleTransactions.|  
|Обязательный|False|Неприменимо|Неприменима, так как это недопустимая конфигурация.|  
