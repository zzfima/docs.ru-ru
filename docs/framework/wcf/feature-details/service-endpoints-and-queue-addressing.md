...
## <a name="msmq-addressing"></a>Адресация к очереди сообщений MSMQ  
 ...
 Дополнительные сведения о пути MSMQ и именах форматов см. в статье [об очередях сообщений](https://go.microsoft.com/fwlink/?LinkId=94837).  
...
|NET. msmq://\<Machine-Name >/привате/АБК|False|SRMP|DIRECT =http://machine/msmq/private $/АБК|  
...
## <a name="msmqintegrationbinding-and-service-addressing"></a>MsmqIntegrationBinding и адресация к службе  
 ...
 Имя MSMQ-format-name указывается в формате MSMQ в статье [об очереди сообщений](https://go.microsoft.com/fwlink/?LinkId=94837).  
