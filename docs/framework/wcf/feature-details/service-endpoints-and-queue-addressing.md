...
- Укажите конечную точку для службы, реализующей все контракты. Рекомендуем использовать этот подход.  
...
|NET. msmq://\<Machine-Name >/привате/АБК|True|Собственный|PUBLIC=guid (идентификатор GUID очереди)|  
