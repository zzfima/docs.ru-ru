---
title: "Известные типы контрактов данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "контракты данных [WCF], известные типы"
...
Класс <xref:System.Runtime.Serialization.KnownTypeAttribute> позволяет заранее задавать типы, которые следует рассматривать при десериализации. Рабочий пример см. в разделе [Известные типы](../../../../docs/framework/wcf/samples/known-types.md).  
...
-   Контракт отправляемых данных унаследован из контракта ожидаемых данных.[!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] подраздел, посвященный наследованию, в разделе [Эквивалентность контрактов данных](../../../../docs/framework/wcf/feature-details/data-contract-equivalence.md)\). В этом случае контракт передаваемых данных отличается от контракта данных, ожидаемого принимающей конечной точкой;  
