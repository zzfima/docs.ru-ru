...
-   Фрагменты кода и сопутствующие сведения см. в разделе [Блог разработчиков одноранговых каналов](http://go.microsoft.com/fwlink/?LinkID=114531) (http://go.microsoft.com/fwlink/?LinkID=114531).  
...
-   Фрагменты кода и сопутствующие сведения см. в разделе [Блог разработчиков одноранговых каналов](http://go.microsoft.com/fwlink/?LinkID=114532) (http://go.microsoft.com/fwlink/?LinkID=114532).  
...
-   **Кто**  
    ...
    -   *Сложный набор узлов*: MessagePropagationFilter.  
  
-   **Как часто**  
  
    -   *Очень часто*: прямое подключение, PeerHopCount, MessagePropagationFilter.  
  
    -   *Случайные*: локальный фильтр.  
  
-   **Использование пропускной способности**  
  
    -   *Высокий уровень*: прямое подключение, менее предпочтительно использовать MessagePropagationFilter или локальный фильтр.  
  
    -   *Низкая*: все, прямое подключение скорее всего не требуется.  
