...
## <a name="supported-peer-resolvers"></a>Поддерживаемые одноранговые распознаватели  
 Одноранговый канал поддерживает распознаватели двух типов: Peer Name Resolution Protocol (PNRP) и пользовательские службы распознавателя.  
