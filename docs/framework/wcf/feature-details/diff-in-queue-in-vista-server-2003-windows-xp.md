...
-   MSMQ в [!INCLUDE[wv](../../../../includes/wv-md.md)] поддерживает свойство сообщения, подсчитывающее число попыток доставки сообщения. Это свойство подсчета прекращений недоступно в [!INCLUDE[ws2003](../../../../includes/ws2003-md.md)] и [!INCLUDE[wxp](../../../../includes/wxp-md.md)]. [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] поддерживает счет отмен в памяти, поэтому данное свойство может не содержать точного значения, если одно и то же сообщение считано более чем одной службой [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] в пределах веб-фермы.  
