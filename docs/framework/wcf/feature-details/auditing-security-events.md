...
|------------|---------------------|------------------|  
|[!INCLUDE[wxpsp2](../../../../includes/wxpsp2-md.md)] или более поздняя версия|Поддерживается|Не поддерживаются|  
|[!INCLUDE[ws2003sp1](../../../../includes/ws2003sp1-md.md)] и Windows Vista|Поддерживается|Контекст потока должен обладать привилегиями `SeAuditPrivilege`|  
