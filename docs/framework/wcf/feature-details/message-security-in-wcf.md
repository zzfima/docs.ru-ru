...
Безопасность сообщения использует спецификацию WS-Security для защиты сообщений. В спецификации WS-Security описываются дополнения к SOAP, обмена сообщениями для обеспечения конфиденциальности, целостности и проверки подлинности на уровне сообщений SOAP (вместо транспортного уровня).
...
- [Microsoft Patterns and Practices, Глава 3: Реализация безопасности транспорта и сообщений слой](https://go.microsoft.com/fwlink/?LinkId=88897)
