---
title: "Как проводить динамическое обновление | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
3.  Для оценки входящих сообщений с помощью фильтров, содержащихся в таблице фильтров, следует связать таблицу фильтров с конечными точками службы при помощи поведения маршрутизации.В следующем примере показано связывание «filterTable1» с конечной точкой службы:  
