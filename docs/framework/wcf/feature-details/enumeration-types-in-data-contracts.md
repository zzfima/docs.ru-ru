---
title: "Типы перечислений в контрактах данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "контракты данных [WCF], типы перечисления"
...
### Значения членов перечисления  
 Как правило, контракт данных содержит имена членов перечисления, а не числовые значения.  Однако при использовании модели контракта данных экспортируемая схема сохраняет числовые значения, если получающей стороной является клиент [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  Обратите внимание, что при использовании сериализатора [Использование класса XmlSerializer](../../../../docs/framework/wcf/feature-details/using-the-xmlserializer-class.md) ситуация несколько иная.  
