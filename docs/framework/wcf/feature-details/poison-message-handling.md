...
- <xref:System.ServiceModel.NetMsmqBinding>. .NET Framework привязка, подходящая для взаимодействия на основе очередей с другими конечными точками WCF.  
