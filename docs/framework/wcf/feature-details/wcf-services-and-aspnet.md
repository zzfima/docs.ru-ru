...
-   <xref:System.Web.HttpContext>: Можно получить доступ к WCF службы, работающие в режиме совместимости ASP.NET <xref:System.Web.HttpContext.Current%2A> и связанное состояние.  
