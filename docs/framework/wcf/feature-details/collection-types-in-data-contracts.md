...
```  
 ...
 Дополнительные сведения о коллекциях-словарях см. в разделе «Расширенные правила коллекции» далее в этом разделе.  
