...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает, как служба Windows Communication Foundation (WCF) размещается в службах IIS или [Windows Server AppFabric](https://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Описывает, как служба WCF размещается службой Windows.  
