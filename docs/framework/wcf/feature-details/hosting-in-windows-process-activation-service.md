...
[Windows Server AppFabric](https://go.microsoft.com/fwlink/?LinkId=196496) работает с IIS 7.0 и служба активации процессов Windows (WAS), чтобы предоставить среду для служб NET4 WCF и WF для размещения функционально насыщенных приложений. К ее преимуществам относятся управление жизненным циклом, перезапуск процессов, совместное размещение, быстрая защита от сбоев, обработка потерянных процессов, активация по запросу и наблюдение за работоспособностью. Подробные сведения см. в разделе [AppFabric Hosting Features](https://go.microsoft.com/fwlink/?LinkId=196494) и [основы размещения AppFabric](https://go.microsoft.com/fwlink/?LinkId=196495).  
