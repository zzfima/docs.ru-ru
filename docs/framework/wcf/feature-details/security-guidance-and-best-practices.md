...
В этом разделе перечислены рекомендации по созданию безопасных приложений [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] и факторы, которые следует при этом учитывать. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]Windows Server AppFabric и безопасности. в разделе, [безопасности модели для Windows Server App Fabric](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x409)  
...
## <a name="in-this-section"></a>Содержание раздела  
 ...
 Факторы, которые необходимо учитывать при создании приложения [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
