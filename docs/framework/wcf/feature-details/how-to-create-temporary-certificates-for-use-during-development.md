...
## <a name="using-certificates-with-wcf"></a><span data-ttu-id="15de0-158">Использование сертификатов с WCF</span><span class="sxs-lookup"><span data-stu-id="15de0-158">Using Certificates With WCF</span></span>  
