...
Транзакции Windows Communication Foundation (WCF) позволяет нескольким компонентам одновременно участвовать в операции с данными. Эта возможность подробно описана в следующих подразделах.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Общие сведения о возможности транзакций, предоставляемые WCF.  
 ...
 Описание WS-AtomicTransaction (WS-AT), протокола распространения транзакций взаимодействия, реализованного в WCF.  
 ...
 Описываются функции транзакций, предоставляемые WCF.  
