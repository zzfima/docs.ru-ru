...
## <a name="see-also"></a>См. также  
 ...
 [Сопоставление объектной модели синдикации WCF Atom и RSS](../../../../docs/framework/wcf/feature-details/how-the-wcf-syndication-object-model-maps-to-atom-and-rss.md)  
