...
### <a name="24-algorithm-suite"></a>2.4 Набор алгоритмов  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]поддерживает все наборы алгоритмов, перечисленные в версии 1.2 политики безопасности.  
