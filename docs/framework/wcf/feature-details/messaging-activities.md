---
title: Действия обмена сообщениями — WCF
ms.date: 03/30/2017
...
## <a name="messaging-activities-and-message-exchange-patterns"></a>Действия обмена сообщениями и обмена сообщениями
...
## <a name="message-formatting-and-messaging-activities"></a>Форматирование сообщений и действий по обмену сообщениями
