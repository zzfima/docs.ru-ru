---
title: "Протокол обмена контекстом | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Режим 1: управление контекстом канала  
...
## Режим 2: управление контекстом приложения  
...
-   Для <xref:System.ServiceModel.Channels.ContextExchangeMechanism> создается следующее утверждение.  
