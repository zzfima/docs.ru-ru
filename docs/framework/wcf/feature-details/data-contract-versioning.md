...
## <a name="schema-considerations"></a>Замечания по схемам  
 Описание схемы, создаваемой для типов контрактов данных, см. в разделе [Data Contract Schema Reference](../../../../docs/framework/wcf/feature-details/data-contract-schema-reference.md).  
 ...
 Следует учитывать возможность круговой передачи. Дополнительные сведения см. в разделе «Замечания по схемам» в [контракты данных обладает прямой совместимостью](../../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md).  
