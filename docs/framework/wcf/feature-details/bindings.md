...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает использование и изменение привязки, предоставляемые WCF для поддержки стандартных сценариев.  
 ...
 Описывает императивное определение привязки Windows Communication Foundation (WCF) для служб и клиентов в коде или декларативно с помощью конфигурации.  
