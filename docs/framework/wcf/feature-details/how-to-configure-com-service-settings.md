...
>  Идентификатор интерфейса формирует часть исходного пространства имен для контракта.  
 ...
 В следующем примере кода показан файл конфигурации по умолчанию. Возможности использования Windows Communication Foundation (WCF) веб-службы, он соответствует стандартной модели схеме конфигурации службы и могут редактироваться в так же, как другие файлы конфигурации службы WCF.  
...
-   Изменение пространства имен службы по умолчанию «http://tempuri.org/InterfaceID» формы на более подходящую форму.  
