...
### <a name="encoding-data-text-vs-binary"></a>Кодирование данных: Текстовый формат и. Бинарный  
...
|-----------------------------|-----------------|  
|<xref:System.ServiceModel.Channels.TextMessageEncodingBindingElement>|Кодировщик текстовых сообщений является кодировщиком по умолчанию для всех привязок на основе HTTP и представляет собой правильный выбор для всех пользовательских привязок, где наибольшее значение имеет взаимодействие. Этот кодировщик считывает и записывает текстовые сообщения стандарта SOAP 1.1/SOAP 1.2 без специальной обработки двоичных данных. Если <xref:System.ServiceModel.Channels.MessageVersion?displayProperty=nameWithType> сообщения свойству <xref:System.ServiceModel.Channels.MessageVersion.None?displayProperty=nameWithType>, программа-оболочка конверта SOAP исключается из выходных данных и сериализуется только содержимое тела сообщения.|  
