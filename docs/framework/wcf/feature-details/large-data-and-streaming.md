...
### <a name="special-security-considerations-for-large-data"></a>Особые вопросы по безопасности данных большого объема  
 ...
 Также важно понимать, что эта квота ограничивает только буферизацию, выполняемую [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)], и не поможет защитить от буферизации, выполняемой в собственной службе или реализации клиента. Дополнительные сведения о Дополнительные вопросы безопасности см. в разделе [вопросы безопасности для данных](../../../../docs/framework/wcf/feature-details/security-considerations-for-data.md).  
