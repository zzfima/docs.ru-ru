...
1. *Svcutil.exe* также создает конфигурацию для клиента, использующего <xref:System.ServiceModel.WSHttpBinding> класса. Имя файла конфигурации *App.config* при использовании Visual Studio.
