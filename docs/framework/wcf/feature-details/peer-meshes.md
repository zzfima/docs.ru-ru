...
- **Упорядочение сообщений:** Сообщения из одного источника не может поступать со всеми другими сторонами, в том же порядке или в порядке, в котором были отправлены. Приложения, требующие доставки сообщений в определенном порядке, должны самостоятельно реализовывать такие функции (например, путем включения во все сообщения идентификаторов с возрастающими значениями);  
