...
|WS-SecurityPolicy 1.1<br /><br /> (2005/07)|http://msdn.microsoft.com/ws/2005/07/ws-security-policy/<br /><br /> в Технический комитет OASIS WS-SX списка ошибок http://www.oasis-open.org/archives/ws-sx/200512/msg00017.html|  
...
### <a name="24-algorithm-suite"></a>2.4 Набор алгоритмов  
 WCF поддерживает все наборы алгоритмов, перечисленные в спецификации Security Policy 1.1.  
