...
## <a name="chain-trust-and-certificate-authorities"></a>Цепочка доверия и центры сертификации  
 ...
 Цифровые сертификаты используются для удостоверения подлинности сущности на основе этой иерархии, которая также называется *цепочкой сертификатов*. Цепочку любого сертификата можно просмотреть с помощью оснастки MMC, дважды щелкнув сертификат и выбрав вкладку **Путь сертификата**. Дополнительные сведения об импорте цепочек сертификатов центра сертификации см. в разделе [как: Указание цепочки сертификатов центра сертификат, используемый для проверки подписей](specify-the-certificate-authority-chain-verify-signatures-wcf.md).  
...
4. Пошаговые инструкции см. в разделе [как: Создание временных сертификатов для использования во время разработки](how-to-create-temporary-certificates-for-use-during-development.md).  
