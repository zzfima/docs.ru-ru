---
title: "Совместное использование портов Net.TCP | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Архитектура совместного использования портов  
 Архитектура совместного использования портов в [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] включает три основных компонента.  
  
-   Рабочий процесс: любой процесс, обменивающийся данными по протоколу net.tcp:\/\/ через совместно используемые порты.  
  
-   Транспорт TCP [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]: реализует протокол net.tcp:\/\/.  
...
## Включение совместного использования портов Net.TCP в приложении  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] том, как это сделать, см. в разделе [Как настраивать службы WCF на совместное использование портов](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-service-to-use-port-sharing.md).  
...
## См. также  
 ...
 [Как настраивать службы WCF на совместное использование портов](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-service-to-use-port-sharing.md)   
