---
title: Общие сведения о безопасности — WCF
ms.date: 03/30/2017
helpviewer_keywords:
...
### <a name="standards-and-interoperability"></a>Стандарты и взаимодействие  
 ...
 Чтобы можно было использовать системы безопасности с возможностью взаимодействия, компании, активно работающие в индустрии веб-служб, разработали множество стандартов. В частности, были предложены некоторые важные стандарты безопасности: WS-Security: Безопасность сообщений SOAP (принимается телом стандартов OASIS и ранее назывался WS-Security), WS-Trust, WS-SecureConversation и WS-SecurityPolicy.  
