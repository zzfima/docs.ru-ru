...
## <a name="configuring-contract-first-options"></a>Настройка параметров на основе контракта  
 В меню "Свойства" проекта WCF можно настроить параметры на основе контракта. Чтобы включить разработку на основе контракта, установите **включить XSD в качестве языка определения типов** флажок на странице WCF окна свойств проекта.  
