...
В этом разделе содержится сводная информация о системе обмена сообщениями [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] и классах, поддерживающих ее использование.  
  
## <a name="in-this-section"></a>В этом разделе  
 [Что такое Windows Communication Foundation](../../../docs/framework/wcf/whats-wcf.md)  
 Краткие общие сведения о [!INCLUDE[indigo2](../../../includes/indigo2-md.md)].  
  
 [Основные понятия Windows Communication Foundation](../../../docs/framework/wcf/fundamental-concepts.md)  
 Общее описание основных концепций модели программирования [!INCLUDE[indigo2](../../../includes/indigo2-md.md)].  
  
 [Архитектура Windows Communication Foundation](../../../docs/framework/wcf/architecture.md)  
 Графическое представление архитектуры [!INCLUDE[indigo2](../../../includes/indigo2-md.md)].  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 [Инструменты](../../../docs/framework/wcf/diagnostics/exceptions-reference/tools.md)  
