...
## <a name="in-this-section"></a>В этом разделе  
 ...
 В этой статье описывается создание контракта WCF с помощью интерфейса, определяемые пользователем. Контракт определяет функциональные возможности, предоставляемые службой.  
 ...
 Описывает, как получить метаданные, используемые для создания прокси клиента WCF из службы WCF. В этом процессе используется функция добавления ссылки на службу в среде Visual Studio 2011.  
 ...
 Описывает способы использования прокси-класса клиента WCF для вызова операций службы.  
