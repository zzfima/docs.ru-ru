...
|/out:\<file>|Задает имя файла созданного кода.<br /><br /> По умолчанию: наследуется от имени определения WSDL, имени службы WSDL или целевого пространства имен одной из схем.<br /><br /> Краткая форма: `/o`|  
...
|/out:\<file>|Задает имя файла созданного кода. При передаче в средство нескольких сборок в качестве входных данных этот параметр игнорируется.<br /><br /> По умолчанию: наследуется от имени сборки.<br /><br /> Сокращенная форма: `/o`|  
