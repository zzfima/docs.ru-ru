...
- Если операции вызываются из приложения промежуточного уровня. (Дополнительные сведения о таких сценариях см. в статье о [клиентских приложениях среднего уровня](../../../docs/framework/wcf/feature-details/middle-tier-client-applications.md).)  
...
#### <a name="iasyncresult-asynchronous-pattern"></a>Асинхронная модель IAsyncResult  
 ...
 Пример см. в статье [Практическое руководство. Реализуйте асинхронную операцию](../../../docs/framework/wcf/how-to-implement-an-asynchronous-service-operation.md)службы.  
