---
title: "Использование средств разработки WCF | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] Netsh.exe см. в разделе [Использование средства Netsh.exe и переключателей командной строки](http://go.microsoft.com/fwlink/?LinkId=97877).  
