...
|-Макстимеаут: @no__t — 0sec >|Позволяет указать максимальное время ожидания в секундах. Допустимые значения: от 0 до 3600.|  
...
|-Виртуального: @no__t — 0virtualServer >|Позволяет указать имя кластера ресурсов DTC.|  
