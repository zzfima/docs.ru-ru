...
## <a name="remarks"></a>Заметки  
 ...
 Если используется [!INCLUDE[wxp](../../../includes/wxp-md.md)] или [!INCLUDE[ws2003](../../../includes/ws2003-md.md)], необходимо выполнить загрузку и обновление перед запуском WsatConfig.exe. Дополнительные сведения об этом обновлении см. в [статье обновление для Windows Communication Foundation (KB912817)](https://www.microsoft.com/en-us/download/details.aspx?id=21520).  
