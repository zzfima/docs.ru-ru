---
title: "Добавление ссылки на службу в проект переносного вложенного набора | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
5.  Непереносимые атрибуты <xref:System.ComponentModel.DesignerCategoryAttribute>, <xref:System.Serializable>и <xref:System.ServiceModel.TransactionFlow> удаляются из созданного прокси\-кода клиентов.  
  
6.  Непереносимые свойства ProtectionLevel, SessionMode, IsInitiating, IsTerminating удаляются из <xref:System.ServiceModel.ServiceContractAttribute>, <xref:System.ServiceModel.OperationContract> и <xref:System.ServiceModel.FaultContract>.  
