---
title: Как выполнить Блокировка конечных точек на предприятии
ms.date: 03/30/2017
...
---
# <a name="how-to-lock-down-endpoints-in-the-enterprise"></a>Как выполнить Блокировка конечных точек на предприятии
