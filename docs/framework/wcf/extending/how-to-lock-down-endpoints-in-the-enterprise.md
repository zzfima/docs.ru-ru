...
В следующем примере кода показано, как добавить общее поведение в файл machine.config и сохранить копию файла на диске. Берется из примера [проверки безопасности.](../samples/security-validation.md) `InternetClientValidatorBehavior`
