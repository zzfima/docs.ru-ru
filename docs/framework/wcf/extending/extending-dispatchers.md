...
![Архитектура среды выполнения диспетчеризации](./media/wcfc-dispatchruntimearchc.gif "wcfc_DispatchRuntimeArchc")
...
- Пользовательская модель данных Пользователи могут использовать модель сериализации данных, отличную от той, <xref:System.Runtime.Serialization.DataContractSerializer?displayProperty=nameWithType> <xref:System.Xml.Serialization.XmlSerializer?displayProperty=nameWithType>которая поддерживается по умолчанию в WCF (а именно, и необработанные сообщения). Для этого также можно реализовать интерфейсы модулей форматирования сообщений. Пример см. в разделе [модуль форматирования операций и селектор операций](../samples/operation-formatter-and-operation-selector.md).
...
- [Практическое руководство. Блокировка конечных точек предприятия](how-to-lock-down-endpoints-in-the-enterprise.md)
