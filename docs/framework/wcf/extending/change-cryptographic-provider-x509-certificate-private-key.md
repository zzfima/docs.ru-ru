---
title: 'Практическое: изменить поставщика служб шифрования для сертификата X.509&#39;s закрытого ключа'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "43510483"
---
# <a name="how-to-change-the-cryptographic-provider-for-an-x509-certificate39s-private-key"></a>Практическое: изменить поставщика служб шифрования для сертификата X.509&#39;s закрытого ключа
