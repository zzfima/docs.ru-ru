...
ms.locfileid: "61929562"
---
# <a name="general-reference"></a>Общие справочные сведения
Разделе [ \<system.serviceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) описаны элементы, которые используются для настройки клиентов Windows Communication Foundation (WCF) и служб.
