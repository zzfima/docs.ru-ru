...
### <a name="lax-versioning"></a>Нестрогое управление версиями  
 ...
 WCF, веб-служб ASP.NET и многих других веб-службы поддержки стеки *Нестрогое управление версиями*: т. е. они не создают исключений для новых неизвестных членов данных в получаемых данных.  
