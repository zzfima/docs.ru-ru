...
|<xref:System.ServiceModel.NetTcpBinding>|.NET|(Транспорта), сообщения, нет, смешанный|(Транспорт), Надежный сеанс, Безопасный сеанс|(Нет), да|Да|Бинарный|Да<br />(с буферизацией)|
|<xref:System.ServiceModel.NetNamedPipeBinding>|.NET|(Транспорта), нет|Нет, (Транспорт)|(Нет), да|Да|Бинарный|Да<br />(с буферизацией)|
|<xref:System.ServiceModel.NetMsmqBinding>|.NET|Сообщения, (транспорта), нет|(Нет), Транспорт|(Нет), да|Нет|Бинарный|Нет|
...
|<xref:System.ServiceModel.NetTcpContextBinding>|.NET|(Транспорта), сообщения, нет, смешанный|(Транспорт), Надежный сеанс, Безопасный сеанс|(Нет), да|Да|Бинарный|Да<br />(с буферизацией)|
