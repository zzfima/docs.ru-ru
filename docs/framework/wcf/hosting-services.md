...
|-------------------------|----------------------|----------------------------------|  
|Управляемое приложение (резидентное размещение)|— Консольное приложение, используемое во время разработки.<br />-Насыщенное WinForm и клиентские приложения WPF, доступ к службам.|-Гибкие.<br />-Проста в развертывании.<br />-Не корпоративного решения для служб.|  
...
|IIS 5.1 И IIS 6.0|-Запуск службы WCF side-by-side с содержимым ASP.NET в Интернете по протоколу HTTP.|-Перезапуск процессов.<br />-Shutdown простоя.<br />— Мониторинг работоспособности процессов.<br />-Активация основе сообщений.<br />— Только для HTTP.|  
