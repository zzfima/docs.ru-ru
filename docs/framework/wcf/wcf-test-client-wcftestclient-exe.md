...
Тестовый клиент Windows Communication Foundation (WCF) (WcfTestClient.exe) является средство с графическим Интерфейсом, позволяет пользователям вводить тестовые параметры, отправить их в службу и просмотреть ответ, то служба отправляет обратно. При совместном использовании с узлом службы [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] это обеспечивает удобную практику тестирования служб.  
  
 Обычно можно найти [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] тестовый клиент (WcfTestClient.exe в следующей папке): C:\Program Files (x86) \Microsoft Visual Studio\2017\Community\Common7\IDE - сообщества может быть «Фейерверк», «Professional» или «Сообщество» в зависимости от того, который устанавливается уровень Visual Studio.
