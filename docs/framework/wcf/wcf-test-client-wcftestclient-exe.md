...
>
> \Documents and Settings @ no__t-0 [учетная запись пользователя] \ \ мои проекты клиентов Документс\тест.
>
