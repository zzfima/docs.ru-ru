...
3.  Открытие образца, созданные в [учебник по началу работы](../../../../docs/framework/wcf/getting-started-tutorial.md) в [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)]. Обратите внимание, что для создания службы необходимо запустить [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)] в качестве администратора. Если у вас есть [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] образцы, устанавливаемые, можно открыть [Приступая к работе](../../../../docs/framework/wcf/samples/getting-started-sample.md), который содержит завершенный проект, созданный в учебнике.  
  
4.  Щелкните правой кнопкой мыши **службы** проект и выберите **добавить**, **новый элемент**. Выберите **файла конфигурации приложения** и нажмите кнопку **ОК**.  
...
6.  Выполните серверное приложение без отладки, нажав CTRL+F5. Выполнить, щелкнув правой кнопкой мыши проект клиента **клиента** проекта и выбрав **отладки**, **запустить новый экземпляр**.  
...
10. Обновите и просмотрите **аналитический** журнала.  Найдите событие с идентификатором 220.  Выберите событие и нажмите кнопку **сведения** на панели предварительного просмотра. Это событие будет содержать идентификатор корреляции для вызывающего действия.  
