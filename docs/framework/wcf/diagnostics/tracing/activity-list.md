---
title: "Список действий | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  Кроме того, действия можно определить программно для группирования пользовательских трассировок.Дополнительные сведения см. в разделе [Создание трассировки пользовательского кода](../../../../../docs/framework/wcf/diagnostics/tracing/emitting-user-code-traces.md).  
  
## Действия ServiceModel  
 В следующей таблице перечислены все действия для основных сценариев использования.  
  
|Метка|Название действия|Тип действия|Описание|  
|-----------|-----------------------|------------------|--------------|  
...
|Название действия|Тип действия|Описание|  
|-----------------------|------------------|--------------|  
|Создание безопасного сеанса|SetupSecurity|Существует только на стороне клиента.Содержит все передаваемые данные RST\*\/SCT для проверки подлинности и установки контекста безопасности.Если `propagateActivity`\=`true`, это действие объединяется с соответствующими действиями Process Action RST\*\/SCT службы.|  
...
|Выполнение операции \<operation\> COM\+|TransferToCOMPlus|1 экземпляр действия для каждого вызова COM\+ из кода [!INCLUDE[indigo2](../../../../../includes/indigo2-md.md)].|  
