...
## <a name="description"></a>Описание  
 При ответе на операцию типа "запрос-ответ" создается исключение. Эту трассировку удобно использовать для отладки во время разработки.  
