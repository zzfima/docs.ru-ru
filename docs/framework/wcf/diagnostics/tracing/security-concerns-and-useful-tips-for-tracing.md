...
```  
 ...
 Дополнительные сведения о регистрации персональных данных, см. в разделе [блокировка безопасности PII](../../../../../docs/framework/wcf/samples/pii-security-lockdown.md) образца.  
