...
4.  Клиент получает ответ "Добавить".  
 ...
 ![Trace Viewer: Выдача пользователя &#45; код трассировки](../../../../../docs/framework/wcf/diagnostics/tracing/media/242c9358-475a-4baf-83f3-4227aa942fcd.gif "242c9358-475a-4baf-83f3-4227aa942fcd")  
Действия, перечисленные по времени создания (левая панель), и связанные с ними вложенные действия (верхняя правая панель)  
 ...
 ![Использование Trace Viewer для выдачи пользователя &#45; код отслеживает](../../../../../docs/framework/wcf/diagnostics/tracing/media/e2etrace2.gif "e2eTrace2")  
Если идентификатор действия запроса был распространен, ошибки, вызванные данным запросом в конечных точках, отображаются в том же действии.  
 ...
 ![Использование Trace Viewer для выдачи пользователя &#45; код отслеживает](../../../../../docs/framework/wcf/diagnostics/tracing/media/e2etrace3.gif "e2eTrace3")  
