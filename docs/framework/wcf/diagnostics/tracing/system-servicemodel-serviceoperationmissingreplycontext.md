...
## <a name="description"></a>Описание:  
 Для двусторонней операции ReplyContext имеет значение Null. Данные трассировки отображается следующее сообщение: «Операция ответа не имеет контекста IRequestContext используемого для ответа.»  
