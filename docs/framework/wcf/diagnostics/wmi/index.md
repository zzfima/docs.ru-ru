...
Windows Communication Foundation (WCF) предоставляет данные проверки службы во время выполнения посредством [!INCLUDE[indigo2](../../../../../includes/indigo2-md.md)] поставщик инструментария управления Windows (WMI).  
