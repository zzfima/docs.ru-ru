...
## <a name="description"></a><span data-ttu-id="2a5c4-104">Описание</span><span class="sxs-lookup"><span data-stu-id="2a5c4-104">Description</span></span>  
 <span data-ttu-id="2a5c4-105">Количество операций с поддержкой транзакций, имеющих сомнительный результат, произошедших в данной службе.</span><span class="sxs-lookup"><span data-stu-id="2a5c4-105">Number of transactional operations with an in-doubt outcome in this service.</span></span>
