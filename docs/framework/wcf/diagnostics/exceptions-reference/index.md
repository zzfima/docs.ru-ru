...
В данном разделе перечислены все исключения, создаваемые [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] в следующих областях:  
 ...
 [Размещение](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/hosting-exceptions.md)  
 ...
 [Надежный обмен сообщениями](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/reliable-messaging.md)  
  
 [Исключения безопасности](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/security-exceptions.md)  
  
 [Инфраструктура службы](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework.md)  
  
 [Данные инфраструктуры службы](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework-data.md)  
  
 [Модуль форматирования транзакций](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/transaction-formatter.md)  
