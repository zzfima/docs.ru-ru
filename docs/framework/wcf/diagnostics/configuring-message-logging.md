...
Дополнительные сведения о параметрах ведения журнала сообщений см. в разделе [Рекомендуемые параметры для трассировки и ведения журнала сообщений](./tracing/recommended-settings-for-tracing-and-message-logging.md).
...
- [\<Мессажелоггинг >](../../configure-apps/file-schema/wcf/messagelogging.md)
