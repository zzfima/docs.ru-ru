...
1.  Если применяется лицензированный элемент управления `MyCompany.Samples.LicControl1`, который содержится в библиотеке `Samples.DLL` приложения `HostApp.exe`*,* можно создать файл `HostAppLic.txt`, содержащий указанные ниже сведения.  
...
## Пример файла ответов  
 Ниже приведен пример файла ответов `response.rsp`.  Подробнее о файлах ответов см. в разделе [Файлы ответов](../Topic/MSBuild%20Response%20Files.md).  
