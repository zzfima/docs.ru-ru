---
title: "Aximp.exe (программа импорта элементов ActiveX в Windows Forms) | Документы Майкрософт"
ms.custom: 
ms.date: 03/30/2017
...
|`/rcw:` *filename*|Использует указанную вызываемую оболочку времени выполнения вместо создания новой. Можно указать несколько экземпляров. Для относительных путей используется текущий каталог. Дополнительные сведения см. в разделе [Вызываемая оболочка времени выполнения](../../../docs/framework/interop/runtime-callable-wrapper.md).|  
