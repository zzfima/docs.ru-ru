...
## <a name="remarks"></a>Примечания  
 ...
 Для работы с расширением отладчика SOS в Visual Studio установите [Комплект разработки драйверов для Windows (WDK)](https://msdn.microsoft.com/windows/hardware/hh852362). Дополнительные сведения об интегрированной среде отладки в Visual Studio см. в разделе [Среды отладки](https://msdn.microsoft.com/library/windows/hardware/hh406268.aspx) в Центре разработки для Windows.  
  
 Расширение отладки SOS можно также загрузить в отладчик WinDbg.exe (доступен на [веб-сайте WDK и средств разработки](https://go.microsoft.com/fwlink/?LinkId=103787)) и выполнять команды в отладчике WinDbg.exe.  
