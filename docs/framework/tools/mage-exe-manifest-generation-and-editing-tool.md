...
|**-kc, -KeyContainer** `name`||Все типы файлов.|Указывает контейнер ключа, содержащий имя закрытого ключа. Для этого параметра требуется параметр **CyproProvider**.<br/><br/>Данный параметр доступен, начиная с .NET Framework 4.7.|
...
|**-kc, -KeyContainer** `name`|Указывает контейнер ключа, содержащий имя закрытого ключа. Для этого параметра требуется параметр **CyproProvider**.<br/><br/>Данный параметр доступен, начиная с .NET Framework 4.7.|
