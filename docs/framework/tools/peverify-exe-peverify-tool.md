...
## <a name="see-also"></a>См. также  
 ...
 [NIB. Написание проверяемого типобезопасного кода](https://msdn.microsoft.com/library/d18f10ef-3b48-4f47-8726-96714021547b)  
 [Безопасность типа и безопасность](https://msdn.microsoft.com/library/095cd1f6-d8db-4c0e-bce2-83ccb34dd5dc)  
