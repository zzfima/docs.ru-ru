...
## <a name="using-mpgoexe-from-visual-studio"></a>Запуск Mpgo.exe в Visual Studio  
 Средство Mpgo.exe можно запускать из Visual Studio (см. статью [Практическое руководство. Назначение событий сборки (C#)](/visualstudio/ide/how-to-specify-build-events-csharp)) со следующими ограничениями.  
