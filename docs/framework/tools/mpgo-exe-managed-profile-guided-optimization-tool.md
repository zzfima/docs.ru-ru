...
## <a name="using-mpgoexe-from-visual-studio"></a>Запуск Mpgo.exe в Visual Studio  
 Средство Mpgo.exe можно запускать из Visual Studio (см. статью [Практическое руководство. Назначение событий сборки (C#)](https://msdn.microsoft.com/library/b4ce1ad9-5215-4b6f-b6a2-798b249aa335)) со следующими ограничениями.  
