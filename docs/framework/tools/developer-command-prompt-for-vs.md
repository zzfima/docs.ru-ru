...
1. Введите **Название** для нового пункта меню, например `Command Prompt`.
...
1. Нажмите кнопку **ОК** .
   ...
   В меню добавляется новый пункт, и командную строку можно вызвать из меню **Сервис**.
