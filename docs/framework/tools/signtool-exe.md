---
title: "SignTool.exe (программа подписывания) | Документы Майкрософт"
ms.custom: 
ms.date: 03/30/2017
...
|`/p7` *Path*|Указывает, что для каждого заданного файла содержимого создается файл PKCS #7. Файлы PKCS #7 имеют имена вида *путь*\\*имя_файла*.p7.|  
