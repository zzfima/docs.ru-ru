...
|`/ms`|Использует несколько семантик проверки. Это поведение по умолчанию вызова [WinVerifyTrust](/windows/desktop/api/wintrust/nf-wintrust-winverifytrust) в [!INCLUDE[win8](../../../includes/win8-md.md)] и более поздних версиях.|  
