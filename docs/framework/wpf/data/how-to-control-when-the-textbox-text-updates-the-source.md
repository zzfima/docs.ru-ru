---
title: Как выполнить Управление обновлением источника из поля TextBox
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54690375"
---
# <a name="how-to-control-when-the-textbox-text-updates-the-source"></a>Как выполнить Управление обновлением источника из поля TextBox
