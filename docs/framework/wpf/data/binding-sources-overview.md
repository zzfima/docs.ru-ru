...
|Объекты <xref:System.Windows.DependencyObject>.|Можно привязать к свойствам зависимости любого <xref:System.Windows.DependencyObject>. Пример см. в разделе [Как привязать свойства двух элементов управления](../../../../docs/framework/wpf/data/how-to-bind-the-properties-of-two-controls.md).|  
