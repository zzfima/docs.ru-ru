...
> [!NOTE]
>  Дополнительные сведения о создании удаленных объектов [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] см. в разделе [Обеспечение поддержки удаленного взаимодействия с объектами](https://msdn.microsoft.com/library/01197253-3f13-43b7-894d-9683e431192a).  
...
2.  Контракт должен реализовывать <xref:System.AddIn.Contract.IContract> а для возврата [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)], контракт должен быть объявлен метод с возвращаемым значением типа <xref:System.AddIn.Contract.INativeHandleContract>.  
  
3.  [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] , Передаваемый между надстройкой и хостом приложения должен прямо или косвенно быть производным от <xref:System.Windows.FrameworkElement>.  
  
4.  [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] , Возвращаемый надстройка должна быть преобразована из <xref:System.Windows.FrameworkElement> для <xref:System.AddIn.Contract.INativeHandleContract> перед пересечением границы изоляции.  
  
5.  [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] Возвращаемый должны преобразовываться из <xref:System.AddIn.Contract.INativeHandleContract> для <xref:System.Windows.FrameworkElement> после пересечения границы изоляции.  
...
-   На стороне ведущего приложения [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] переупаковывает <xref:System.Windows.Interop.HwndSource> как внутренний [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] класс, производный от <xref:System.Windows.Interop.HwndHost> и использует <xref:System.AddIn.Contract.INativeHandleContract>. Экземпляр этого класса возвращается с <xref:System.AddIn.Pipeline.FrameworkElementAdapters.ContractToViewAdapter%2A> ведущему приложению.  
 ...
 <xref:System.Windows.Interop.HwndHost> существует для отображения [!INCLUDE[TLA2#tla_ui#plural](../../../../includes/tla2sharptla-uisharpplural-md.md)], определенные с помощью дескрипторов окон из [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] [!INCLUDE[TLA2#tla_ui#plural](../../../../includes/tla2sharptla-uisharpplural-md.md)]. Более подробную информацию см. в разделе [Взаимодействие WPF и Win32](../../../../docs/framework/wpf/advanced/wpf-and-win32-interoperation.md).  
  
 Таким образом <xref:System.AddIn.Contract.INativeHandleContract>, <xref:System.AddIn.Pipeline.FrameworkElementAdapters.ViewToContractAdapter%2A>, и <xref:System.AddIn.Pipeline.FrameworkElementAdapters.ContractToViewAdapter%2A> позволяют использовать дескриптор окна для [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] передается из надстройки в ведущее приложение, где он инкапсулируется <xref:System.Windows.Interop.HwndHost> и отображается узел приложения [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)].  
...
-   Никакую часть надстройки [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] может визуализироваться с помощью <xref:System.Windows.Media.VisualBrush>. Вместо этого надстройка может сделать моментальный снимок созданного [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)], чтобы создать растровое изображение, которое может быть передано ведущему приложению с использованием методов, определенных в контракте.  
  
-   Файлы мультимедиа невозможно воспроизвести из <xref:System.Windows.Controls.MediaElement> в надстройке [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)].  
