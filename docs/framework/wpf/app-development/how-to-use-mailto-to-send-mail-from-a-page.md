...
ms.locfileid: "33544821"
---
# <a name="how-to-use-mailto-to-send-mail-from-a-page"></a>Как: использовать mailto: для отправки сообщения со страницы
...
## <a name="example"></a>Пример  
 Следующий код показывает, как использовать **mailto:** [!INCLUDE[TLA#tla_uri](../../../../includes/tlasharptla-uri-md.md)] откройте новое окно почты, содержащего адрес электронной почты и адрес электронной почты и темы и адреса электронной почты, тема и текст.  
