...
## <a name="related-sections"></a>Связанные разделы  
 ...
 [Как: Создание нового проекта приложения WPF](http://msdn.microsoft.com/library/1f6aea7a-33e1-4d3f-8555-1daa42e95d82)  
  
 [Как: Создание нового проекта приложения браузера WPF](http://msdn.microsoft.com/library/72ef4d90-e163-42a1-8df0-ea7ccfd1901f)
