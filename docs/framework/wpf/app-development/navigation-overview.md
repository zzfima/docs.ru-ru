...
В этом разделе приводится обзор основных возможностей навигации в [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]. Эти возможности доступны как для автономных приложений, так и для XBAP, хотя в этом разделе они представлены в контексте XBAP.
...
Для XBAP, размещенных в Internet Explorer, [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] интегрирует журнал в [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] навигации Internet Explorer. Это позволяет пользователям перемещаться по страницам в XBAP с помощью кнопок **назад**, **вперед**и **Последние страницы** в Internet Explorer.
...
- [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] автономные приложения и XBAP могут создавать файлы cookie и управлять ими.
...
- В Internet Explorer политика P3P, относящаяся к файлам cookie, обрабатывается [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)], особенно в отношении разработчиков XBAP и сторонних разработчиков.
...
Поддержка навигации [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] позволяет переходить к XBAP через Интернет, что позволяет приложениям размещать сторонние материалы. Чтобы защитить как приложения, так и пользователей от вредоносного поведения, [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] предоставляет разнообразные функции безопасности, обсуждаемые в разделе [Безопасность](../security-wpf.md) и [Безопасность частичного доверия в WPF](../wpf-partial-trust-security.md).
