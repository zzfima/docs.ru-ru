...
- Сингальский
 ...
 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]Визуализация текста осуществляется с [!INCLUDE[TLA#tla_ct](../../../../includes/tlasharptla-ct-md.md)] помощью технологии подраздела, которая поддерживает независимость от разрешения. Это значительно улучшает читаемость и предоставляет возможность поддержки качественных документов журнального стиля для всех скриптов.
