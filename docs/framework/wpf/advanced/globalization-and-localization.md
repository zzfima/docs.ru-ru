---
title: "Глобализация и локализация | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "Глобализация [WPF]"
  - "локализация [WPF]"
  - "Windows Presentation Foundation (WPF), глобализация"
  - "Windows Presentation Foundation (WPF), локализация"
  - "WPF, глобализация"
  - "WPF, локализация"
...
## В этом подразделе  
 ...
 [Практические руководства](../../../../docs/framework/wpf/advanced/globalization-and-localization-how-to-topics.md)  
