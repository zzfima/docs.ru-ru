...
### <a name="property-element-syntax"></a>Синтаксис элемента свойства  
 ...
 Для открывающего тега элемента свойства используется следующий синтаксис: `<`*имя_типа*`.`*имя_свойства*`>`. Как правило содержимое тега является объектным элементом типа, который принимает в качестве значения свойства. После указания содержимого, необходимо завершить элемент свойства закрывающим тегом. Для закрывающего тега используется синтаксис `</`*имя_типа*`.`*имя_свойства*`>`.  
