...
|Видеопамять|Должно быть больше или равна 60 МБ.|Должно быть больше или равна 120 МБ.|  
...
|Отрисовка текста|Субпиксельная визуализация шрифта использует доступные пиксельные затеи на графическом оборудовании.|  
...
### <a name="directx-diagnostic-tool"></a>средство диагностики DirectX  
 ...
 ![Скриншот: Диагностический инструмент DirectX](./media/directxdiagnostictool-01.png "DirectXDiagnosticTool_01")  
