---
title: Как выполнить Обработка события ContextMenuOpening
ms.date: 03/30/2017
helpviewer_keywords:
...
ms.locfileid: "54655846"
---
# <a name="how-to-handle-the-contextmenuopening-event"></a>Как выполнить Обработка события ContextMenuOpening
