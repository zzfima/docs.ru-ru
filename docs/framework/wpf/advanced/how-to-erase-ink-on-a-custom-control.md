...
## <a name="example"></a><span data-ttu-id="1d9df-105">Пример</span><span class="sxs-lookup"><span data-stu-id="1d9df-105">Example</span></span>  
 <span data-ttu-id="1d9df-106">В следующем примере создается пользовательский элемент управления, который позволяет пользователю стирать части росчерков.</span><span class="sxs-lookup"><span data-stu-id="1d9df-106">The following example creates a custom control that enables the user to erase parts of strokes.</span></span>  <span data-ttu-id="1d9df-107">В этом примере создается элемент управления, содержащий рукописного ввода при ее инициализации.</span><span class="sxs-lookup"><span data-stu-id="1d9df-107">This example creates a control that contains ink when it is initialized.</span></span>  <span data-ttu-id="1d9df-108">Создание элемента управления, который собирает рукописного ввода — [создания элемента управления ввода рукописного ввода](../../../../docs/framework/wpf/advanced/creating-an-ink-input-control.md).</span><span class="sxs-lookup"><span data-stu-id="1d9df-108">To create a control that collects ink, see [Creating an Ink Input Control](../../../../docs/framework/wpf/advanced/creating-an-ink-input-control.md).</span></span>  
