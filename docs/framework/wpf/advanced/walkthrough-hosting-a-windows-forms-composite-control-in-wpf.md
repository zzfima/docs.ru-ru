...
## <a name="implementing-the-windows-forms-composite-control"></a>Реализация составного элемента управления Windows Forms  
 ...
 ![Элемент управления простого Windows Forms](../../../../docs/framework/wpf/advanced/media/wfcontrol.gif "WFControl")  
...
## <a name="implementing-the-wpf-host-application"></a>Реализация ведущего приложения WPF
 ...
 ![Элемент управления, встроенный в страницу WPF](../../../../docs/framework/wpf/advanced/media/avalonhost.gif "AvalonHost") полного приложения, отображение элемента управления внедренных в приложение WPF
