...
### <a name="ngen-and-clickonce"></a>NGen и ClickOnce  
 ...
 См. дополнительные сведения о [файле Ngen.exe (генераторе образов в машинном коде)](../../../../docs/framework/tools/ngen-exe-native-image-generator.md).  
...
### <a name="rebasing-and-dll-address-collisions"></a>Изменение базового адреса и конфликты DLL-адресов  
 ...
 Дополнительные сведения о настройке базового адреса см. в разделе [Ngen.exe (генератор образов в машинном коде)](../../../../docs/framework/tools/ngen-exe-native-image-generator.md).  
