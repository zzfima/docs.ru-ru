 ...
 **Примечание.** Дополнительные сведения о функциях документов нефиксированного формата и способах их создания см. в разделе [Общие](../../../../docs/framework/wpf/advanced/flow-document-overview.md).  
