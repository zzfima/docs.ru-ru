...
|<xref:System.Windows.Forms.ListView>|<xref:System.Windows.Controls.ListView>|Элемент управления <xref:System.Windows.Controls.ListView> содержит подробное представление только для чтения.|  
...
|<xref:System.Windows.Forms.WebBrowser>|<xref:System.Windows.Controls.Frame>, <xref:System.Windows.Controls.WebBrowser?displayProperty=nameWithType>|Элемент управления  <xref:System.Windows.Controls.Frame> может содержать HTML-страницы.<br /><br /> Начиная с версии [!INCLUDE[net_v35SP1_short](../../../../includes/net-v35sp1-short-md.md)], элемент управления <xref:System.Windows.Controls.WebBrowser?displayProperty=nameWithType> может использоваться для размещения HTML-страниц, а также обеспечивает работу элемента управления <xref:System.Windows.Controls.Frame>.|  
