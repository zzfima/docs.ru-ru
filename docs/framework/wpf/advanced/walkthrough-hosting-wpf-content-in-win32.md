...
4. Обработайте уведомление [WM_CREATE](/windows/desktop/winmsg/wm-create)в окне процедуры и выполните следующие действия.  
...
5. Реализуйте управляемый класс, содержащий статическое поле для хранения ссылки на ваше содержимое [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]. Этот класс позволяет получить ссылку на [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] содержимое из кода Win32.  
...
### <a name="hosting-the-wpf-content"></a>Размещение содержимого WPF
 ...
 Код для размещения содержимого [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] реализуется в обработчике для [WM_CREATE](/windows/desktop/winmsg/wm-create) уведомления в окне главного приложения.
