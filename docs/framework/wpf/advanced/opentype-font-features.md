...
### <a name="superscripts-and-subscripts"></a>надстрочные и подстрочные  
 ...
 ![Текст, использующий верхние индексы OpenType],(./media/opentype-font-features/opentype-superscripts.gif "использующие надстрочные знаки OpenType")  
 ...
 ![Текст, использующий текст подстрочных символов OpenType](./media/opentype-font-features/opentype-subscripts.gif "с использованием индексов OpenType")  
...
### <a name="decorative-uses-of-superscripts-and-subscripts"></a>Применение надстрочных и подстрочных знаков в декоративных целях  
 ...
 ![Текст, использующий верхние и]нижние индексы OpenType,(./media/opentype-font-features/opentype-superscripts-subscripts.gif "использующие верхние и") нижние индексы OpenType  
...
## <a name="capitals"></a>Capitals  
 ...
 ![Текст, использующий прописные буквы OpenType],(./media/opentype-font-features/opentype-capitals.gif "с использованием прописных букв OpenType")  
...
### <a name="titling-capitals"></a>Титульные прописные буквы  
 ...
 ![Текст, использующий титульные]прописные буквы OpenType(./media/opentype-font-features/opentype-titling-capitals.gif "текст с титульными прописными буквами OpenType")  
...
### <a name="capital-spacing"></a>Интервалы прописных букв  
 ...
 ![Текст, использующий прописные расстояния OpenType],(./media/opentype-font-features/opentype-capital-spacing.gif "с использованием прописных расстояний OpenType")  
 
 В следующем примере разметки показано, как задать прописные расстояния для шрифта Pescadero, используя свойства объекта <xref:System.Windows.Documents.Typography>.  
...
- **Исторические лигатуры**. Предназначены для исторических целей и не разрабатывались для удобочитаемости.  
 ...
 ![Текст, использующий стандартные]лигатуры OpenType,(./media/opentype-font-features/opentype-standard-ligatures.gif "используя стандартные лигатуры OpenType")  
 ...
 ![Текст, использующий дискреционные лигатуры OpenType](./media/opentype-font-features/opentype-discretionary-ligatures.gif "с использованием дискреционных лигатур OpenType")  
 ...
 ![Текст, использующий стандартные лигатуры OpenType с Palatino Linotype](./media/opentype-font-features/opentype-standard-ligatures-palatino.gif "Text с использованием стандартных лигатур OpenType и Palatino Linotype")    
 ...
 ![Текст, использующий отключенные стандартные]лигатуры OpenType,(./media/opentype-font-features/disabled-opentype-standard-ligatures.gif "используя отключенные стандартные лигатуры OpenType")  
...
## <a name="swashes"></a>Орнаменты  
 ...
 ![Текст, использующий стандартные и swash]глифы OpenType,(./media/opentype-font-features/opentype-standard-swash-glyphs.gif "с использованием стандартных и swash глифов OpenType")  
 ...
 ![Текст, использующий]каллиграфические символы OpenType(./media/opentype-font-features/opentype-swashes.gif "с использованием swash глифов OpenType")  
...
### <a name="contextual-swashes"></a>Контекстные орнаментированные глифы  
 ...
 ![Текст, использующий контекстные глифы OpenType](./media/opentype-font-features/opentype-contextual-swashes.gif "с контекстными глифами OpenType")  
...
## <a name="alternates"></a>Варианты  
 ...
 ![Текст, использующий стандартные]глифы OpenType,(./media/opentype-font-features/opentype-standard-glyphs.gif "с использованием стандартных глифов OpenType")  
 ...
 ![Текст, использующий стилистические альтернативные глифы OpenType],(./media/opentype-font-features/opentype-stylistic-alternate-glyphs.gif "с использованием стилистических альтернативных глифов OpenType")  
 ...
 ![Текст, использующий стилистические альтернативные глифы OpenType для текста шрифта Pericles](./media/opentype-font-features/opentype-stylistic-alternate-glyphs-pericles.gif "с использованием стилистических альтернативных глифов OpenType для шрифта Pericles")
...
### <a name="random-contextual-alternates"></a>Случайные контекстные варианты  
 ...
 ![Текст, использующий случайный контекст OpenType], выбирает(./media/opentype-font-features/opentype-random-contextual-alternates.gif "текст с использованием случайных контекстных вариантов OpenType")  
  
 В следующем примере разметки показано, как определить Случайные контекстные альтернативы для шрифта Lindsey, используя свойства объекта <xref:System.Windows.Documents.Typography>.  
...
### <a name="historical-forms"></a>Исторические формы  
 ...
 ![Текст, использующий исторические формы OpenType](./media/opentype-font-features/opentype-historical-forms.gif "с использованием исторических форм OpenType")  
...
### <a name="fractions"></a>Дроби  
 ...
 ![Текст, использующий текст с косой чертой OpenType и с накоплением,](./media/opentype-font-features/opentype-slashed-stacked-fractions.gif "с использованием") вертикальных и вертикальных дробей OpenType  
...
### <a name="old-style-numerals"></a>Числа в старом стиле  
 ...
 ![Текст, использующий старый стиль OpenType],(./media/opentype-font-features/opentype-old-style-numerals.gif "использует цифры в старом стиле OpenType")  
    
 Следующий текст демонстрирует стандартные числа и числа в старом стиле для шрифта Palatino Linotype.  
  
 ![Текст, использующий старое начертание OpenType, задает](./media/opentype-font-features/opentype-old-style-numeral-sets.gif "текст, использующий наборы цифр OpenType старого стиля")  
...
### <a name="proportional-and-tabular-figures"></a>Пропорциональные и табличные цифры  
 ...
 ![Текст, использующий пропорциональные & табличных цифр OpenType](./media/opentype-font-features/opentype-proportional-tabular-figures.gif ", использующий пропорциональные и табличные цифры OpenType")  
    
 В следующем примере разметки показано, как определить пропорциональные и табличные рисунки для шрифта Miramonte, используя свойства объекта <xref:System.Windows.Documents.Typography>.  
...
### <a name="slashed-zero"></a>Перечеркнутый нуль  
 ...
 ![Текст, использующий косую черту OpenType, вычислить](./media/opentype-font-features/opentype-slashed-zero-numerals.gif "текст с помощью символов OpenType, перечеркнутого нуля")  
    
 В следующем примере разметки показано, как определить ноль цифр для шрифта Miramonte, используя свойства объекта <xref:System.Windows.Documents.Typography>.  
  
 [!code-xaml[OpenTypeFontSamples#OpenTypeFontSnippet15](~/samples/snippets/csharp/VS_Snippets_Wpf/OpenTypeFontSamples/CS/PageOne.xaml#opentypefontsnippet15)]  
  
<a name="typography_class"></a>   
## <a name="typography-class"></a>Класс Typography  
 Объект <xref:System.Windows.Documents.Typography> предоставляет набор функций, поддерживаемых шрифтом OpenType. Установив свойства <xref:System.Windows.Documents.Typography> в разметке, можно легко создавать документы, использующие преимущества функций OpenType.  
