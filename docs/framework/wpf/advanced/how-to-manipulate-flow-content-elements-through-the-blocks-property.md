...
---
# <a name="how-to-manipulate-flow-content-elements-through-the-blocks-property"></a>Как выполнить Управление элементами потокового содержимого через свойство Blocks
