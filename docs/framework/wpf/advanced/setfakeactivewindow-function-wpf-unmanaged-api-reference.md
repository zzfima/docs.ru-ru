...
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>Функция Сетфакеактивевиндов (Справочник по неуправляемым интерфейсам API WPF)
 ...
 **Библиотека DLL:** PresentationHost_v0400. dll  
