...
ms.locfileid: "33543206"
---
# <a name="how-to-drag-and-drop-ink"></a>Практическое руководство. Перетаскивание рукописного ввода
## <a name="example"></a>Пример  
 В следующем примере создается приложение, позволяющее пользователю перетащить один из выбранных штрихов <xref:System.Windows.Controls.InkCanvas> в другой.  
