...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Функция ForwardTranslateAccelerator](../../../../docs/framework/wpf/advanced/forwardtranslateaccelerator-function-wpf-unmanaged-api-reference.md)  
 [Функция LoadFromHistory](../../../../docs/framework/wpf/advanced/loadfromhistory-function-wpf-unmanaged-api-reference.md)  
 [Функция ProcessUnhandledException](../../../../docs/framework/wpf/advanced/processunhandledexception-function-wpf-unmanaged-api-reference.md)  
 [Функция SaveToHistory](../../../../docs/framework/wpf/advanced/savetohistory-function-wpf-unmanaged-api-reference.md)  
 [Функция SetFakeActiveWindow](../../../../docs/framework/wpf/advanced/setfakeactivewindow-function-wpf-unmanaged-api-reference.md)  
