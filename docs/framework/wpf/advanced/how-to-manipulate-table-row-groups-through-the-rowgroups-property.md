...
---
# <a name="how-to-manipulate-a-table39s-row-groups-through-the-rowgroups-property"></a>Как выполнить Управлять таблицы&#39;s группы строк с помощью свойства RowGroups
