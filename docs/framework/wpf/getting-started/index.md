...
|Не знакомы с .NET?|[Общие сведения о платформе .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Основные сведения о приложениях .NET Framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Начало работы с Visual C# и Visual Basic](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|  
