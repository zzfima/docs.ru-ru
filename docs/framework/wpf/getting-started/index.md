...
|Не знакомы с .NET?|[Обзор рамочной программы .NET](../../get-started/overview.md)<br /><br /> [Основные сведения о приложениях .NET Framework](../../../standard/application-essentials.md)<br /><br /> [Начало работы с Visual C# и Visual Basic](/visualstudio/ide/quickstart-visual-basic-console)|  
|Дополнительные сведения о WPF...|[Введение в WPF в Visual Studio](introduction-to-wpf-in-vs.md)<br /><br /> [Обзор XAML (WPF)](../advanced/xaml-overview-wpf.md)<br /><br /> [Управление](../controls/index.md)<br /><br /> [Обзор связывания данных](../../../desktop-wpf/data/data-binding-overview.md)|  
...
- [Классная библиотека](../class-library-wpf.md)
