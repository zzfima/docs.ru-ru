...
### <a name="microsoft-windows-xp-service-pack-2-sp2"></a>Microsoft Windows XP с пакетом обновления 2 (SP2)  
 Помимо общей проверки и усиления Windows, существует три основных функции Windows XP с пакетом обновления 2 (SP2), которые мы рассмотрим в этом разделе:  
