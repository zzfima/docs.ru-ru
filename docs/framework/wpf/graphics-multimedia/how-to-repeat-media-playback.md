...
---
# <a name="how-to-repeat-media-playback"></a>Как повторить воспроизведение мультимедиа
...
## <a name="example"></a>Пример  
 В следующем примере используется <xref:System.Windows.Controls.MediaElement> и <xref:System.Windows.Media.MediaTimeline> в <xref:System.Windows.Media.Animation.Storyboard> воспроизвести клип мультимедиа в бесконечный цикл.  
