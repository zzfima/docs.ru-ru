---
title: "Геометрия | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "двумерная графика [WPF]"
  - "классы, геометрия"
  - "определение областей отсечения [WPF]"
...
---
# Геометрия
<xref:System.Windows.Media.Geometry> — это универсальный класс, используемый для отображения [!INCLUDE[TLA#tla_2d](../../../../includes/tlasharptla-2d-md.md)] графики, объектов проверки нажатия и определения области отсечения  
