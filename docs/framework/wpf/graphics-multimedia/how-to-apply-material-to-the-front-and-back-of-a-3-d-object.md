...
---
# <a name="how-to-apply-material-to-the-front-and-back-of-a-3-d-object"></a>Как выполнить Применение материала к лицевой и обратной стороне трехмерного объекта
