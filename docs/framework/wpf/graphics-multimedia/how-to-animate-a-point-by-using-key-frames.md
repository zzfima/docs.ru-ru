---
title: Как выполнить Анимация точки с помощью ключевых кадров
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54738343"
---
# <a name="how-to-animate-a-point-by-using-key-frames"></a>Как выполнить Анимация точки с помощью ключевых кадров
