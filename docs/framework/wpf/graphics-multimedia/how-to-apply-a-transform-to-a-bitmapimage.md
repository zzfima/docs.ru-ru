---
title: "Практическое руководство. Применение преобразования к объекту BitmapImage | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Практическое руководство. Применение преобразования к объекту BitmapImage
В этом примере демонстрируется применение <xref:System.Windows.Media.Transform> к <xref:System.Windows.Media.Imaging.BitmapImage>.  
