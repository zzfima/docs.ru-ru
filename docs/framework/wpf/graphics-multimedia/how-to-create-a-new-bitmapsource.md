---
title: Как создать новый объект BitmapSource
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
## <a name="example"></a><span data-ttu-id="562df-104">Пример</span><span class="sxs-lookup"><span data-stu-id="562df-104">Example</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="562df-105">См. также</span><span class="sxs-lookup"><span data-stu-id="562df-105">See Also</span></span>  
 [<span data-ttu-id="562df-106">Общие сведения об обработке изображений</span><span class="sxs-lookup"><span data-stu-id="562df-106">Imaging Overview</span></span>](../../../../docs/framework/wpf/graphics-multimedia/imaging-overview.md)
