...
---
# <a name="how-to-apply-a-drawing-to-a-3-d-model"></a>Как выполнить Применение рисования к трехмерной модели
 ...
 **Примечание.** Часто желательно, чтобы определить сложные объекты и значения, как на рисунке ниже как ресурсы, которые можно использовать повторно и упростить код. См. в разделе [ресурсы XAML](../../../../docs/framework/wpf/advanced/xaml-resources.md) Дополнительные сведения.  
