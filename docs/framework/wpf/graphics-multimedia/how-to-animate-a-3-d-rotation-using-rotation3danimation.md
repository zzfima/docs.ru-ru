...
Следующий пример показывает, как сделать трехмерный поворот во время его «качания» с помощью объекта <xref:System.Windows.Media.Animation.Rotation3DAnimation> для анимации <xref:System.Windows.Media.Media3D.RotateTransform3D.Rotation%2A> свойство <xref:System.Windows.Media.Media3D.RotateTransform3D> объекта применены 3D-объект.  
