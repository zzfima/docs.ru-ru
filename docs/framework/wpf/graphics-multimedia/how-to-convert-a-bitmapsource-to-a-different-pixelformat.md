...
---
# <a name="how-to-convert-a-bitmapsource-to-a-different-pixelformat"></a>Как выполнить Преобразование BitmapSource в другой индексированный формат точек PixelFormat
