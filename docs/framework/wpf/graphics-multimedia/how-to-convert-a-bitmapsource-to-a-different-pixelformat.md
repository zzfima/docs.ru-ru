...
## <a name="example"></a><span data-ttu-id="6379e-104">Пример</span><span class="sxs-lookup"><span data-stu-id="6379e-104">Example</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="6379e-105">См. также</span><span class="sxs-lookup"><span data-stu-id="6379e-105">See Also</span></span>  
 [<span data-ttu-id="6379e-106">Общие сведения об обработке изображений</span><span class="sxs-lookup"><span data-stu-id="6379e-106">Imaging Overview</span></span>](../../../../docs/framework/wpf/graphics-multimedia/imaging-overview.md)
