...
![Пример стиля снимка экрана](../controls/./media/stylingintro-eventtriggers.png "StylingIntro_EventTriggers")
...
<xref:System.Windows.Controls.MediaElement> может воспроизводить видео и аудио, и достаточно расширяемо, чтобы обеспечить простое создание пользовательских интерфейсов пользователя.
