...
## <a name="prerequisites"></a>Предварительные требования  
 Для понимания этого раздела необходимо ознакомиться с базовыми средствами анимации. Дополнительные сведения см. в разделе [Общие сведения об анимации](../../../../docs/framework/wpf/graphics-multimedia/animation-overview.md).  
...
### <a name="the-autoreverse-property"></a>Свойство AutoReverse  
 ...
 Если у контейнера временной шкалы есть дочерние <xref:System.Windows.Media.Animation.Timeline> объекты, они изменяют направление при временной шкалы контейнера. Дополнительные примеры см. в разделе [укажите временной шкалы автоматического реверса](../../../../docs/framework/wpf/graphics-multimedia/how-to-specify-whether-a-timeline-automatically-reverses.md).  
