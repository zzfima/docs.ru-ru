---
title: "Практические руководства, посвященные 3-D графике | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Практические руководства, посвященные 3-D графике
Темы в этом разделе описывают использование [!INCLUDE[TLA#tla_3d](../../../../includes/tlasharptla-3d-md.md)] графики в приложениях [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)].  
