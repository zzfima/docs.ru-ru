---
title: Как выполнить Включение проверки орфографии в элементе управления редактирования текста
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54605634"
---
# <a name="how-to-enable-spell-checking-in-a-text-editing-control"></a>Как выполнить Включение проверки орфографии в элементе управления редактирования текста
