...
## <a name="example"></a><span data-ttu-id="ecbc2-104">Пример</span><span class="sxs-lookup"><span data-stu-id="ecbc2-104">Example</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="ecbc2-105">См. также</span><span class="sxs-lookup"><span data-stu-id="ecbc2-105">See Also</span></span>  
 [<span data-ttu-id="ecbc2-106">Использование проверки орфографии с помощью контекстного меню</span><span class="sxs-lookup"><span data-stu-id="ecbc2-106">Use Spell Checking with a Context Menu</span></span>](../../../../docs/framework/wpf/controls/how-to-use-spell-checking-with-a-context-menu.md)  
 [<span data-ttu-id="ecbc2-107">Общие сведения о TextBox</span><span class="sxs-lookup"><span data-stu-id="ecbc2-107">TextBox Overview</span></span>](../../../../docs/framework/wpf/controls/textbox-overview.md)  
 [<span data-ttu-id="ecbc2-108">Общие сведения о RichTextBox</span><span class="sxs-lookup"><span data-stu-id="ecbc2-108">RichTextBox Overview</span></span>](../../../../docs/framework/wpf/controls/richtextbox-overview.md)
