...
## <a name="reference"></a><span data-ttu-id="a2c64-105">Ссылка</span><span class="sxs-lookup"><span data-stu-id="a2c64-105">Reference</span></span>  
 <xref:System.Windows.Controls.Frame>  
  
## <a name="related-sections"></a><span data-ttu-id="a2c64-106">Связанные разделы</span><span class="sxs-lookup"><span data-stu-id="a2c64-106">Related Sections</span></span>  
 [<span data-ttu-id="a2c64-107">Общие сведения о переходах</span><span class="sxs-lookup"><span data-stu-id="a2c64-107">Navigation Overview</span></span>](../../../../docs/framework/wpf/app-development/navigation-overview.md)
