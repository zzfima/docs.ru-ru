...
helpviewer_keywords: 
  ...
  - "наложение элементов [WPF]"
  - "StackPanel - элемент управления [WPF]"
...
---
# StackPanel
Элемент <xref:System.Windows.Controls.StackPanel> используется для расположения дочерних элементов по горизонтали или вертикали в виде стека.  
  
## В этом подразделе  
 [Практические руководства](../../../../docs/framework/wpf/controls/stackpanel-how-to-topics.md)  
