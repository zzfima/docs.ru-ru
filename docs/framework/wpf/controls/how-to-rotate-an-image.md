...
ms.locfileid: "33551899"
---
# <a name="how-to-rotate-an-image"></a>Практическое руководство. Поворот изображения
В этом примере показано, как поворот изображения на 90 градусов с помощью <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> свойство <xref:System.Windows.Media.Imaging.BitmapImage>.  
