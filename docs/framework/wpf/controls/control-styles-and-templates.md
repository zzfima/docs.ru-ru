---
title: "Стили и шаблоны элемента Control | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
У элементов управления в Windows Presentation Foundation \(WPF\) есть <xref:System.Windows.Controls.ControlTemplate>, содержащий [визуальное дерево](GTMT) этого элемента управления.  Разработчик может изменить структуру и внешний вид элемента управления, изменяя шаблон <xref:System.Windows.Controls.ControlTemplate> этого элемента управления.  Невозможно заменить только часть визуального дерева элемента управления; чтобы изменить визуальное дерево, необходимо установить в свойстве <xref:System.Windows.Controls.Control.Template%2A> элемента управления его новый и завершенный шаблон <xref:System.Windows.Controls.ControlTemplate>.  
  
 Используемый словарь ресурсов определяется темами рабочего стола.  Используемый словарь ресурсов определяется темами рабочего стола.  Для получения словарей ресурсов для тем рабочего стола см. документ [Default WPF Themes](http://go.microsoft.com/fwlink/?LinkID=158252).  
  
 В следующей таблице перечислены имена файлов словарей ресурсов и соответствующие им темы рабочего стола.  
  
|Файл темы|Тема рабочего стола|  
|---------------|-------------------------|  
|Classic.xaml|Классический внешний вид Windows \(из Windows 95, Windows 98 и Windows 2000\) в операционной системе Windows XP.|  
...
|Royale.NormalColor.xaml|Тема по умолчанию в операционной системе Windows XP Media Center Edition.|  
|Aero.NormalColor.xaml|Тема по умолчанию в операционной системе Windows Vista.|  
...
## В этом подразделе  
 ...
 [Стили и шаблоны элемента DatePicker](../../../../docs/framework/wpf/controls/datepicker-syles-and-templates.md)  
 ...
 [Стили и шаблоны элемента PasswordBox](../../../../docs/framework/wpf/controls/passwordbox-syles-and-templates.md)  
 ...
 [Стили и шаблоны элемента RepeatButton](../../../../docs/framework/wpf/controls/repeatbutton-syles-and-templates.md)  
 ...
 [Стили и шаблоны элемента Thumb](../../../../docs/framework/wpf/controls/thumb-syles-and-templates.md)  
 [Стили и шаблоны элемента ToggleButton](../../../../docs/framework/wpf/controls/togglebutton-syles-and-templates.md)  
