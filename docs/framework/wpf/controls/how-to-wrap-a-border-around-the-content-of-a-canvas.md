...
## <a name="example"></a>Пример  
 В следующем примере показано, как отобразить `Hello World!` внутри <xref:System.Windows.Controls.Canvas> элемента. <xref:System.Windows.Controls.Canvas> Элемент находится в оболочке <xref:System.Windows.Controls.Border> элемент, чтобы граница выделяет элемент.  
