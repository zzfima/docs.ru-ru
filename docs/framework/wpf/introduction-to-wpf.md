...
Следующий пример использует XAML для реализации внешнего вида окна, содержащего одну кнопку:
...
Следующая цифра показывает пользовательский интерфейс (UI), который определяется XAML в предыдущем примере:
...
Для получения дополнительной информации [см.](controls/index.md)

### <a name="wpf-controls-by-function"></a>Функциональная классификация элементов управления WPF

Встроенные элементы управления WPF перечислены здесь:

- **Кнопки** <xref:System.Windows.Controls.Button> : <xref:System.Windows.Controls.Primitives.RepeatButton>и .

- **Дисплей данных**: <xref:System.Windows.Controls.DataGrid>, <xref:System.Windows.Controls.ListView>и <xref:System.Windows.Controls.TreeView>.

- **Дата отображения и выбора**: <xref:System.Windows.Controls.Calendar> и <xref:System.Windows.Controls.DatePicker>.

- **Диалог Коробки** <xref:Microsoft.Win32.OpenFileDialog>: <xref:System.Windows.Controls.PrintDialog>, <xref:Microsoft.Win32.SaveFileDialog>, и .

- **Цифровые чернила**: <xref:System.Windows.Controls.InkCanvas> и <xref:System.Windows.Controls.InkPresenter>.

- **Документы** <xref:System.Windows.Controls.DocumentViewer> <xref:System.Windows.Controls.FlowDocumentPageViewer>: <xref:System.Windows.Controls.FlowDocumentReader> <xref:System.Windows.Controls.FlowDocumentScrollViewer>, <xref:System.Windows.Controls.StickyNoteControl>, , и .

- **Вход**: <xref:System.Windows.Controls.TextBox> <xref:System.Windows.Controls.RichTextBox>, <xref:System.Windows.Controls.PasswordBox>, и .

- **Укладка** <xref:System.Windows.Controls.Border>: <xref:System.Windows.Controls.Primitives.BulletDecorator> <xref:System.Windows.Controls.Canvas>, <xref:System.Windows.Controls.DockPanel> <xref:System.Windows.Controls.Expander>, <xref:System.Windows.Controls.Grid> <xref:System.Windows.Controls.GridView>, <xref:System.Windows.Controls.GridSplitter> <xref:System.Windows.Controls.GroupBox>, <xref:System.Windows.Controls.Panel> <xref:System.Windows.Controls.Primitives.ResizeGrip>, <xref:System.Windows.Controls.Separator> <xref:System.Windows.Controls.Primitives.ScrollBar>, <xref:System.Windows.Controls.ScrollViewer> <xref:System.Windows.Controls.StackPanel>, <xref:System.Windows.Controls.Primitives.Thumb> <xref:System.Windows.Controls.Viewbox>, <xref:System.Windows.Controls.VirtualizingStackPanel> <xref:System.Windows.Window>, <xref:System.Windows.Controls.WrapPanel>, , , , , , , , и .

- **Медиа** <xref:System.Windows.Controls.Image>: <xref:System.Windows.Controls.MediaElement>, <xref:System.Windows.Controls.SoundPlayerAction>и .

- **Меню**: <xref:System.Windows.Controls.ContextMenu> <xref:System.Windows.Controls.Menu>, <xref:System.Windows.Controls.ToolBar>и .

- **Навигация** <xref:System.Windows.Controls.Frame> <xref:System.Windows.Documents.Hyperlink>: <xref:System.Windows.Controls.Page> <xref:System.Windows.Navigation.NavigationWindow>, <xref:System.Windows.Controls.TabControl>, , и .

- **Выбор** <xref:System.Windows.Controls.CheckBox>: <xref:System.Windows.Controls.ComboBox> <xref:System.Windows.Controls.ListBox>, <xref:System.Windows.Controls.RadioButton>, <xref:System.Windows.Controls.Slider>, и .

- **Информация о пользователях** <xref:System.Windows.Controls.AccessText> <xref:System.Windows.Controls.TextBlock>: <xref:System.Windows.Controls.ToolTip>, <xref:System.Windows.Controls.Label>, <xref:System.Windows.Controls.Primitives.Popup> <xref:System.Windows.Controls.ProgressBar>, <xref:System.Windows.Controls.Primitives.StatusBar>, , и .
...
В следующем примере используется <xref:System.Windows.Controls.DockPanel> <xref:System.Windows.Controls.TextBox> для выкладывания нескольких элементов управления:
...
Следующая цифра показывает результат разметки XAML в предыдущем примере:
...
Следующая разметка <xref:System.Windows.Controls.TextBox> связывает экземпляр пользовательского `Person` объекта:
...
Для получения дополнительной информации смотрите [обзор связывания данных](../../desktop-wpf/data/data-binding-overview.md).
...
Интересной особенностью фигур является то, что они предназначены не только для отображения. В них реализованы многие возможности элементов управления, включая ввод с клавиатуры и с помощью мыши. В следующем примере <xref:System.Windows.UIElement.MouseUp> показано <xref:System.Windows.Shapes.Ellipse> событие обрабатываемых:
...
Следующая цифра показывает, что производится предыдущим кодом:

![Окно с текстом "you clicked the ellipse&#33;"](media/introduction-to-wpf/wpfintrofigure12.png)

Для получения дополнительной [информации см. формы и основные чертежи в обзоре WPF](../../desktop-wpf/data/data-binding-overview.md).
...
В число возможностей двумерной графики WPF входят визуальные эффекты, такие как градиенты, растровые изображения, рисунки, рисование с видео, вращение, масштабирование и наклон. Все они достигаются с помощью кистей; ниже приведены некоторые примеры:
...
WPF также включает в себя возможности 3D-рендеринга, которые интегрируются с 2D графикой, чтобы позволить создавать более интересные и интересные пользовательские интерфейсы. Например, на следующем рисунке показаны 2D-изображения, отображаемые на 3D-формах:
...
Элемент управления <xref:System.Windows.Controls.MediaElement> позволяет воспроизводить как видео, так и звук и достаточно гибок для того, чтобы служить основой для пользовательского мультимедиапроигрывателя. Следующая разметка XAML реализует медиаплеер:

[!code-xaml[IntroToWPFSnippets#MediaElementMARKUP](~/samples/snippets/xaml/wpf/introduction-to-wpf/introduction-to-wpf_9.xaml)]

Окно на следующем рисунке <xref:System.Windows.Controls.MediaElement> показывает элемент управления в действии:
...
В качестве демонстрации интеграции текста с графикой, следующая цифра показывает применение текстовых декораций:
...
Следующая цифра показывает результат:

![Элемент управления TextBox с текстом](media/introduction-to-wpf/wpfintrofigure21.png)

Другие элементы управления, однако, могут содержать несколько объектов с различным типом содержимого. Содержимым элемента управления <xref:System.Windows.Controls.Button>, определяемым свойством <xref:System.Windows.Controls.ContentControl.Content%2A>, могут быть различные объекты, в том числе элементы управления макетом, текст, изображения и фигуры. Следующий пример <xref:System.Windows.Controls.Button> показывает <xref:System.Windows.Controls.DockPanel>с содержанием, <xref:System.Windows.Controls.Label>которое включает в себя, a <xref:System.Windows.Controls.Border>, <xref:System.Windows.Controls.MediaElement>и:
...
Следующая цифра показывает содержание этой кнопки:
...
Следующий пример показывает, как изменить <xref:System.Windows.Controls.Button> внешний <xref:System.Windows.Controls.ControlTemplate>вид:
...
В то время как шаблон элемента управления позволяет определять внешний вид элемента управления, шаблон данных дает возможность настраивать оформление его содержимого. Шаблоны данных часто используются для оптимизации отображения привязанных данных. Следующая цифра показывает внешний <xref:System.Windows.Controls.ListBox> вид по умолчанию `Task` для коллекции объектов, где каждая задача имеет имя, описание и приоритет:

![Список с видом по умолчанию](media/introduction-to-wpf/wpfintrofigure18.png)

Оформление по умолчанию является стандартным для элемента управления <xref:System.Windows.Controls.ListBox>. Однако оно предполагает, что для каждой задачи отображается только ее название. Чтобы отобразить название, описание и приоритет задачи, нужно изменить оформление по умолчанию для элементов списка, привязанных к элементу управления <xref:System.Windows.Controls.ListBox> , с помощью <xref:System.Windows.DataTemplate>. Следующий XAML определяет <xref:System.Windows.DataTemplate>такой , который применяется к <xref:System.Windows.Controls.ItemsControl.ItemTemplate%2A> каждой задаче с помощью атрибута:
...
Следующая цифра показывает эффект этого кода:
...
Стили позволяют разработчикам и дизайнерам стандартизировать внешний вид своего продукта. Платформа WPF предоставляет строгую модель стилей, в основе которой лежит элемент <xref:System.Windows.Style> . Следующий пример создает стиль, который устанавливает <xref:System.Windows.Controls.Button> цвет фона для каждого на окне: `Orange`
...
Следующий пример определяет общий цвет фона, <xref:System.Windows.Controls.Label>который разделяется и: <xref:System.Windows.Controls.Button>
...
Следующий пример ссылается на словарь ресурсов, определенный в предыдущем примере, чтобы он был общим для приложения:
...
Дополнительные сведения см. в статье о [ресурсах DSC](../../desktop-wpf/fundamentals/xaml-resources-define.md).
...
Следующий пример показывает пользовательский числовый вверх <xref:System.Windows.Controls.UserControl>/ вниз контроль, который вытекает из:
...
Следующий пример иллюстрирует XAML, который требуется для <xref:System.Windows.Window>включения управления пользователем в:
...
Следующая цифра `NumericUpDown` показывает элемент <xref:System.Windows.Window>управления, размещенный в:
...
- [Ресурсы сообщества WPF](getting-started/community-feedback.md)
