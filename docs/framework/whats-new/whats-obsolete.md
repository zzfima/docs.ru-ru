---
title: "Устаревшие классы библиотеки классов .NET Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "нерекомендуемые [.NET Framework]"
  - "устаревшие [.NET Framework]"
...
---
# Устаревшие классы библиотеки классов .NET Framework
...
|4.5 \(включая 4.5.1 и точечные выпуски\)|v4.0|  
|4|v4.0|  
|3.5|v2.0.50727|  
|2.0|v2.0.50727|  
|1.1|v1.1.4322|  
...
## Списки устаревших типов и членов для платформы .NET Framework 4.5  
...
## Списки устаревших типов и членов для предыдущих версий  
 [Устаревшие типы в .NET Framework 4](http://go.microsoft.com/fwlink/?LinkId=224224)  
  
 [Устаревшие члены в .NET Framework 4](http://go.microsoft.com/fwlink/?LinkId=224227)  
  
 [Список устаревших элементов в .NET Framework 3.5](http://go.microsoft.com/fwlink/?LinkId=163710)  
  
 [Список устаревших элементов в .NET Framework 2.0](http://go.microsoft.com/fwlink/?LinkID=125264)  
