---
title: Поле CoreResponseData.m_StatusCode
ms.date: 01/29/2018
topic_type:
- apiref
api_name:
...
---
# <a name="coreresponsedatamstatuscode-field"></a>CoreResponseData.m\_StatusCode поля

`CoreResponseData.m_StatusCode` — <xref:System.Net.HttpStatusCode> содержащий состояние ответа.
