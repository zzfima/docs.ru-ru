...
|AppDomainFlags|win:UInt32|0x1: Домен по умолчанию.<br /><br /> 0x2: Исполняемый файл.<br /><br /> 0x4: Домен приложения, бит 28 – 31: Совместное использование политики этого домена.<br /><br /> 0: Общий домен.|  
...
|AssemblyFlags|win:UInt32|0x1: Нейтральная сборка домена.<br /><br /> 0x2: Динамическая сборка.<br /><br /> 0x4: Сборка имеет образ в машинном коде.<br /><br /> 0x8: Собираемая сборка.|  
...
|ModuleFlags|win:UInt32|0x1: Модуль нейтральный домена.<br /><br /> 0x2: Модуль содержит образ в машинном коде.<br /><br /> 0x4: Динамический модуль.<br /><br /> 0x8: Модуль манифеста.|  
