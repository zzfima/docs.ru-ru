...
|AppDomainFlags|win:UInt32|0x1 Домен по умолчанию.<br /><br /> 0x2 Объектов.<br /><br /> 0x4 Домен приложения, бит 28-31: Политика общего доступа этого домена.<br /><br /> 0,0 Общий домен.|  
...
|AssemblyFlags|win:UInt32|0x1 Сборка, нейтральная к домену.<br /><br /> 0x2 Динамическая сборка.<br /><br /> 0x4 Сборка имеет образ в машинном код.<br /><br /> 0x8 Собираемая сборка.|  
...
|ModuleFlags|win:UInt32|0x1 Модуль, нейтральный к домену.<br /><br /> 0x2 Модуль содержит образ в машинном код.<br /><br /> 0x4 Динамический модуль.<br /><br /> 0x8 Модуль манифеста.|  
