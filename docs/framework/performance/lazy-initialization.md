...
*Отложенная инициализация* объекта означает, что его создание откладывается до первого использования. (Для этой темы, термины *ленивый инициализации* и *ленивый мгновенности* являются синонимами.) Ленивая инициализация в первую очередь используется для повышения производительности, избежания расточительных вычислений и снижения требований к памяти программы. Ниже приведены наиболее распространенные сценарии.  
...
|Потокобезопасность объекта|`LazyThreadSafetyMode``mode` параметр|Логический параметр `isThreadSafe`|Без параметров потокобезопасности|  
|---------------------------------|---------------------------------------------|--------------------------------------|---------------------------------|  
...
- [Управляемые основы резьбы](../../standard/threading/managed-threading-basics.md)
- [Нити и резьба](../../standard/threading/threads-and-threading.md)
