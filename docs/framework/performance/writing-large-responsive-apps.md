...
## <a name="why-the-new-compiler-performance-applies-to-your-app"></a>Как производительность нового компилятора затрагивает ваше приложение  
 ...
 Дополнительные сведения о Roslyn компиляторы, см. в разделе [пакета SDK для платформы компилятора .NET](../../csharp/roslyn-sdk/index.md).
...
### <a name="fact-2-if-youre-not-measuring-youre-guessing"></a>Факт 2. Если вы не измеряете, вы угадываете  
...
### <a name="fact-4-its-all-about-allocations"></a>Факт 4. Все дело выделения  
