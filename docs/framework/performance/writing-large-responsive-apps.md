...
### <a name="fact-1-dont-prematurely-optimize"></a>Факт 1. Не нужно преждевременно оптимизировать  
...
### <a name="fact-2-if-youre-not-measuring-youre-guessing"></a>Факт 2: Если вы не измеряете, то можете предположить  
...
### <a name="fact-3-good-tools-make-all-the-difference"></a>Факт 3. Хорошие средства делают все различие  
...
### <a name="fact-4-its-all-about-allocations"></a>Факт 4. Все о выделении  
