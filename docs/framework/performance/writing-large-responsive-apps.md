...
### <a name="fact-3-good-tools-make-all-the-difference"></a>Факт 3. Значение хороших средств трудно переоценить  
 Хорошие средства позволяют вам быстро выявлять наиболее важные проблемы с производительностью (ЦП, память или диск) и помогают локализовать код, вызывающий такие узкие места.  Корпорация Майкрософт предоставляет разнообразные средства оценки производительности, такие как [профилировщик Visual Studio](/visualstudio/profiling/beginners-guide-to-performance-profiling), [средство анализа Windows Phone](http://msdn.microsoft.com/en-us/e67e3199-ea43-4d14-ab7e-f7f19266253f) и [PerfView](http://www.microsoft.com/download/details.aspx?id=28567).  
