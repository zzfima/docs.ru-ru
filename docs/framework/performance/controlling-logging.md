...
## Просмотр событий ETW среды CLR  
 Перечисленные ниже команды используются для просмотра событий ETW среды CLR.  Описание событий см. в разделе [CLR ETW Events](../../../docs/framework/performance/clr-etw-events.md).  
