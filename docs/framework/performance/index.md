...
|Тип приложения|См.|  
|--------------|---------|  
|Приложения .NET Framework для всех платформ|[Сборка мусора и производительность](../../../docs/standard/garbage-collection/performance.md)<br /><br /> [Performance Tips](../../../docs/framework/performance/performance-tips.md) (Советы по производительности)|  
...
|Windows Phone|[Вопросы производительности приложений для Windows Phone](http://msdn.microsoft.com/library/windowsphone/develop/ff967560\(v=vs.105\).aspx)<br /><br /> [Анализ приложения Windows Phone](http://msdn.microsoft.com/library/windowsphone/develop/hh202934\(v=vs.105\).aspx)<br /><br /> [Ускорьте размещение ваших приложений Windows Phone в Marketplace](http://msdn.microsoft.com/magazine/hh781024.aspx)|  
...
|Silverlight|[Советы по производительности](http://msdn.microsoft.com/library/cc189071\(v=vs.95\).aspx)|  
|ASP.NET|[Общие сведения о производительности ASP.NET](http://msdn.microsoft.com/library/f882bf1b-a009-4312-ac06-74370ffabc0b)|  
