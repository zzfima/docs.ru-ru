...
> [!NOTE]
>  В системах, на которых установлено .NET Framework 4, в системном мониторе могут не отображаться данные счетчиков производительности в некоторых категориях, таких как **данные CLR .NET** и **Организация сети CLR .NET**, для приложения, разработанные с помощью [!INCLUDE[net_v11_short](../../../includes/net-v11-short-md.md)]. Если это так, можно настроить монитор производительности для отображения этих данных, добавив элемент [\<forcePerformanceCounterUniqueSharedMemoryReads>](../../../docs/framework/configure-apps/file-schema/runtime/forceperformancecounteruniquesharedmemoryreads-element.md) в файле конфигурации приложения.  
