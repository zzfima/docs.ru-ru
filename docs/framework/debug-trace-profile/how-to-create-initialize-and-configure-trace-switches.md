...
2. Если в проекте отсутствует файл конфигурации (app.config или Web.config), выберите **Добавить новый элемент** в меню **Проект**.  
    ...
    - **Визуальный C#элемент:** В диалоговом окне **Добавление нового элемента** выберите **XML-файл**. Укажите имя этого файла: **app.config**. В редакторе XML после объявления XML добавьте следующий XML-код:  
