...
> [!NOTE]
>  В Visual Basic **Debug.Write**, **Debug.WriteIf**, **Debug.WriteLine**, и **Debug.WriteLineIf** методы были заменены **Debug.Print** метод, который был доступен в более ранних версиях Visual Basic.  
