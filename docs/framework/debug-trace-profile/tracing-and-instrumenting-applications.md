...
- **Счетчики производительности** — компоненты, позволяющие отслеживать производительность приложения. Дополнительные сведения см. в разделе [Счетчики производительности](performance-counters.md).  
...
```  
 ...
 С помощью методов класса <xref:System.Diagnostics.Trace> можно отслеживать выполнение кода в установленном приложении. Поместив в свой код [переключатели трассировки](trace-switches.md), можно управлять тем, выполняется ли трассировка и насколько полной она является. Это позволяет наблюдать за состоянием приложения в рабочей среде. Это особенно важно в бизнес-приложении, использующем множественные компоненты, выполняющиеся на нескольких компьютерах. Вы можете управлять порядком использования переключателей после развертывания с помощью файла конфигурации. Дополнительные сведения см. в разделе [Практическое руководство. Создание, инициализация и настройка переключателей](how-to-create-initialize-and-configure-trace-switches.md)трассировки.  
...
2. Создайте набора переключателей. Дополнительные сведения см. в разделе [Практическое руководство. Настройка переключателей](how-to-create-initialize-and-configure-trace-switches.md)трассировки.  
...
## <a name="strategic-placement-of-trace-statements"></a>Стратегическое размещение операторов трассировки  
 Необходимо уделить особое внимание размещению операторов трассировки для использования во время выполнения. Вы должны учесть, какие сведения трассировки скорее всего потребуются в развертываемом приложении, чтобы в полной мере охватить все вероятные сценарии трассировки. Поскольку приложения, использующие трассировку, могут быть самыми разными, не существует общих принципов стратегического размещения трассировки. Дополнительные сведения о размещении инструкций трассировки см. [в разделе как Добавление операторов трассировки в код](how-to-add-trace-statements-to-application-code.md)приложения.  
