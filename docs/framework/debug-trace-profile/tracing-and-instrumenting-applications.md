...
2. Создайте набора переключателей. Дополнительные сведения см. в разделе [Практическое руководство. Настройте переключатели трассировки](how-to-create-initialize-and-configure-trace-switches.md).  
