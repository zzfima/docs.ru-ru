---
title: "Установка .NET Framework | Документы Майкрософт"
ms.custom: 
ms.date: 04/28/2017
...
> [!NOTE]
> Сведения о .NET Framework 3.5 см. в разделе [Установка платформы .NET Framework 3.5 в Windows 8 и более поздних версий](~/docs/framework/install/net-framework-3-5-on-windows-8-plus.md).
