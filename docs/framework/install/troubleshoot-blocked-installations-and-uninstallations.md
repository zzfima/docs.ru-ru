...
---
# <a name="troubleshooting-blocked-net-framework-installations-and-uninstallations"></a>Устранение неполадок заблокированных установок и удалений .NET Framework
...
4.  В столбце "Имя" найдите загрузки [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1 или 4.6.2 (в зависимости от устанавливаемой версии) и удалите их. Сведения о загрузках см. в [руководстве по установке](../../../docs/framework/install/guide-for-developers.md).  
  
5.  Перезапустите установщик .NET Framework для версий 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 или 4.7.  
