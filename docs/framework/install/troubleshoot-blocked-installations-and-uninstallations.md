...
> [!IMPORTANT]
> Так как версии платформы .NET Framework 4.x обновления на месте, невозможно установить более ранней версии платформы .NET Framework 4.x в системе, где уже есть более поздней версии. Например в системе с центром обновления Windows 10 Осень создатели не может установить .NET Framework 4.6.2, так как платформа .NET Framework 4.7.1 предустановлен с операционной системой.
...
В этой таблице 4.5. *x* ссылается на .NET Framework 4.5 и ее вспомогательным выпускам — 4.5.1, 4.5.2, 4.6. *x* ссылается на .NET Framework 4.6 и ее точечные выпуски 4.6.1 и 4.6.2 и 4.7. *x* ссылается на .NET Framework 4.7 и 4.7.1 точки выхода.
...
|.NET Framework 4.5*.x*/4.6*.x*/4,7*.x* распространяемый пакет неприменим к этой операционной системе. Загрузите .NET Framework 4.5*.x*/4.6*.x*/4,7*.x* для вашей операционной системы из центра загрузки Майкрософт.|Вы пытаетесь установить [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, или 4.7.1 на платформу, которая не поддерживается или выбрали пакет установки, не включают в себя компоненты для всех поддерживаемых операционных систем. Повторите установку с помощью автономного установщика ([4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=309493), [4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706), [для 4.6](http://go.microsoft.com/fwlink/p/?LinkId=528233), [4.6.1](http://go.microsoft.com/fwlink/p/?LinkId=671744), для [ 4.6.2](http://go.microsoft.com/fwlink/p/?LinkId=780604), для [4.7](http://go.microsoft.com/fwlink/p/?LinkId=825306)), или для [4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090). Дополнительные сведения см. в [руководстве по установке](../../../docs/framework/install/guide-for-developers.md) и в [требованиях к системе](../../../docs/framework/get-started/system-requirements.md) для поддерживаемых операционных систем.|  
...
|.NET framework 4.5*.x*/4.6*.x*/4,7*.x* не была установлена, так как хранилище компонентов повреждено.|Дополнительные сведения см. в статье [Исправление ошибок Центра обновления Windows с помощью системы DISM или средства проверки готовности системы к обновлению](https://support.microsoft.com/en-us/kb/947821).|  
...
|.NET Framework 4.5. *.x*/4.6*.x*/4,7*.x* уже является частью этой операционной системе. Необходимо установить .NET Framework 4.5*.x*/4.6*.x*/4,7*.x* распространяемого пакета.|Никаких действий не требуется.<br /><br /> Сведения об определении установленных версий .NET Framework на компьютере см. в разделе [Практическое руководство. Определение установленных версий .NET Framework](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md). Список поддерживаемых операционных систем см. в разделе [Требования к системе](../../../docs/framework/get-started/system-requirements.md).|  
...
1. В столбце «Имя» найдите [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], загрузки 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 или 4.7.1, в зависимости от версии вы устанавливаете и удалите их. Скачиваемые файлы см. в разделе [Установка .NET Framework для разработчиков](../../../docs/framework/install/guide-for-developers.md).

1. Перезапустите установщик .NET Framework для версии 4.5, 4.5.1, 4.5.2 или 4.6, 4.6.1, 4.6.2 4.7 или 4.7.1.
