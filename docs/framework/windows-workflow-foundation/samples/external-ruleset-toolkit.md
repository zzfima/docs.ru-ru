...
![Общие сведения о примером External RuleSet](./media/rulesettoolkitsampleoverview.gif "RuleSetToolkitSampleOverview")
...
![Внешние RuleSet Toolkit пример выходных данных](./media/rulesetbrowser.gif "RuleSetBrowser")
...
![Пример выходных данных средств внешнего набора правил](./media/ruleseteditor.gif "RuleSetEditor")
...
![Ошибки проверки, выдаваемые примером External RuleSet](./media/validationerrorsruleset.png "ValidationErrorsRuleSet")
...
![Выбор набора правил](./media/rulesetselector.gif "RuleSetSelector")
