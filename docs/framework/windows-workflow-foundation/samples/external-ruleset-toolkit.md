...
## <a name="ruleset-tool"></a>Средство "RuleSet"  
 ...
 ![Внешний набор правил вывода пример выходных данных](../../../../docs/framework/windows-workflow-foundation/samples/media/rulesetbrowser.gif "RuleSetBrowser")  
