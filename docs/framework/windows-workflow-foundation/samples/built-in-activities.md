...
Этот раздел содержит образцы, демонстрирующие встроенные действия Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Использование действий коллекции](../../../../docs/framework/windows-workflow-foundation/samples/using-collection-activities.md)  
 Показано применение действий коллекции (<xref:System.Activities.Statements.AddToCollection%601>, <xref:System.Activities.Statements.ClearCollection%601>, <xref:System.Activities.Statements.ExistsInCollection%601>, и <xref:System.Activities.Statements.RemoveFromCollection%601>) с классом, реализующим интерфейс <xref:System.Collections.ICollection>, и показано создание пользовательского действия, которое выполняет итерацию по коллекции для распечатки содержания каждого из элементов коллекции.  
  
 [Использование действия InvokeMethod](../../../../docs/framework/windows-workflow-foundation/samples/using-the-invokemethod-activity.md)  
 Показано, как использовать действие <xref:System.Activities.Statements.InvokeMethod> для вызова открытых методов из открытых классов.  
  
 [Использование действия Pick](../../../../docs/framework/windows-workflow-foundation/samples/using-the-pick-activity.md)  
 Демонстрирует применение действия <xref:System.Activities.Statements.Pick>.  
  
 [Использование процедурных действий](../../../../docs/framework/windows-workflow-foundation/samples/using-procedural-activities.md)  
 Продемонстрировано использование действий <xref:System.Activities.Statements.Sequence>, <xref:System.Activities.Statements.Assign>, <xref:System.Activities.Statements.If>, <xref:System.Activities.Statements.While>, <xref:System.Activities.Statements.Switch%601>, <xref:System.Activities.Statements.TryCatch> и <xref:System.Activities.Statements.WriteLine> для реализации игры по отгадыванию.  
 ...
 Описан способ включения действия <xref:System.Activities.Statements.Switch%601> для вычисления определяемого пользователем сложного типа во время выполнения.  
  
 [Взаимодействие с набором правил 3.5](../../../../docs/framework/windows-workflow-foundation/samples/interop-with-3-5-rule-set.md)  
 Показано использование действия <xref:System.Activities.Statements.Interop> для интеграции с пользовательским действием в [!INCLUDE[netfx35_short](../../../../includes/netfx35-short-md.md)] с применением действия <xref:System.Workflow.Activities.PolicyActivity> и правил.
