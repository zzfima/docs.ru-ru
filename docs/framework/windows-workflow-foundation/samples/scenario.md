...
## <a name="in-this-section"></a>Содержание  
 ...
 Демонстрирует создание приложения, которое использует функции [!INCLUDE[avalon1](../../../../includes/avalon1-md.md)] и [!INCLUDE[wf](../../../../includes/wf-md.md)] в одном документе XAML. Для этого в образце используется расширяемость XAML и [!INCLUDE[wf](../../../../includes/wf-md.md)].  
