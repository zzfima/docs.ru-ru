---
title: "Сохраняемая задержка | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Подробные сведения о рабочем процессе  
...
1.  Настройка базы данных сохраняемости.  
    ...
    2.  Перейдите в каталог [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] \(C:\\Windows\\Microsoft.NET\\Framework\\v4.X\\\).  
  
    3.  Измените файл WorkflowManagementService.exe.config и добавьте следующую строку соединения в элемент \<`database`\>.  
...
2.  Запустите [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)], используя повышенные разрешения. Для этого щелкните правой кнопкой мыши значок [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] и выберите команду **Запуск от имени администратора**.  
...
>   
>  `<диск_установки>:\WF_WCF_Samples\WF\Basic\Services\DurableDelay`  
