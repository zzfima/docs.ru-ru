...
## <a name="in-this-section"></a>Содержание  
 ...
 [Настраиваемое действие для переключения на диапазон значений](../../../../docs/framework/windows-workflow-foundation/samples/custom-activity-to-switch-on-a-range-of-values.md)  
 ...
 [LINQ to SQL образца](../../../../docs/framework/windows-workflow-foundation/samples/linq-to-sql-sample.md)  
 ...
 [Регулируемые параллельных ForEach](../../../../docs/framework/windows-workflow-foundation/samples/throttled-parallel-foreach.md)  
 ...
 [Действий сущностей](../../../../docs/framework/windows-workflow-foundation/samples/entity-activities.md)  
