...
2. Установка базы данных SQL Server.
    ...
    1. Из командной строки Visual Studio 2010 выполните команду «setup.cmd» из каталога образцов SuspendedInstanceManagement, которая выполняет следующее:
...
3. Настройка очереди обслуживания.
    ...
    1. В Visual Studio 2010, щелкните правой кнопкой мыши **SampleWorkflowApp** проекта и нажмите кнопку **Назначить запускаемым проектом**.
