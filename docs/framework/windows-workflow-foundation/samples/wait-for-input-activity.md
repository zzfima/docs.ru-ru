---
title: "Ожидание входного действия | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|BookmarkName|InArgument\<string\>|Имя закладки.|  
|Result|InArgument\<TResult\>|Данные, передаваемые действию при продолжении с закладки.|  
...
## Конструктор действия WaitForInput  
 ...
 ![Снимок панели элементов WaitForInput](../../../../docs/framework/windows-workflow-foundation/samples/media/waitforinputtoolbox.jpg "WaitForInputToolbox")  
