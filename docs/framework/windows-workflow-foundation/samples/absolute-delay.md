---
title: "Абсолютная задержка | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
6.  Обновите поля SendMailTo, SendMailFrom, SendMailSubject, SendMailBody и SmtpHost в действии SendMail.  
    ...
    > [!NOTE]
    >  Если не указан допустимый хост SMTP, приложение выдаст исключение SMTP.  
  
7.  Постройте решение, выбрав пункт **Построить решение** из меню **Построить**.  
...
>   
>  `<диск_установки>:\WF_WCF_Samples\WF\Basic\Services\AbsoluteDelay`