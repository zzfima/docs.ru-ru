...
Этот раздел содержит образцы, показывающие сохранение рабочих процессов на постоянном носителе в Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Демонстрирует использование и конфигурацию распространяемых свойств в хранилище экземпляров рабочих процессов SQL.  
  
 [Действие Property Promotion](../../../../docs/framework/windows-workflow-foundation/samples/property-promotion-activity.md)  
 Этот образец представляет собой законченное решение, в котором средства повышения уровня <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore> встраиваются непосредственно в среду разработки рабочих процессов.
