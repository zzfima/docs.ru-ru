...
|Участники отслеживания|Потребляет записи отслеживания. [!INCLUDE[netfx40_short](../../../../includes/netfx40-short-md.md)] поставляется с участником отслеживания, который записывает записи отслеживания в виде трассировки событий для Windows (ETW).|
