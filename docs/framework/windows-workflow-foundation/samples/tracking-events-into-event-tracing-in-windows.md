---
title: "Отслеживание событий в системе трассировки событий Windows | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Участники отслеживания|Открывает записи отслеживания.[!INCLUDE[netfx_current_short](../../../../includes/netfx-current-short-md.md)] поставляется с участником отслеживания, который записывает записи отслеживания в виде событий средства отслеживания событий для Windows \(ETW\).|  
...
5.  В тестовом клиенте WCF выберите в меню **Файл** команду **Добавить службу**.  
...
6.  Откройте приложение просмотра событий.  
     ...
     Перед вызовом службы запустите средство просмотра событий из меню **Пуск**, где выберите пункт **Выполнить** и введите `eventvwr.exe`.Убедитесь, что журнал событий прослушивает события отслеживания, создаваемые службой рабочего процесса.  
  
7.  В представлении дерева в средстве просмотра событий выберите **Средство просмотра событий**, **Журналы приложений и служб**, **Microsoft**.Щелкните правой кнопкой мыши пункт **Microsoft**, выберите пункт **Вид** и пункт **Отобразить аналитический и отладочный журналы**, чтобы включить аналитический и отладочный журналы.  
  
     Установите флажок **Отобразить аналитический и отладочный журналы**.  
  
8.  В древовидном представлении средства просмотра событий перейдите на вкладку **Средство просмотра событий**, **Журналы приложений и служб**, **Microsoft**, **Windows**, **Сервер приложений — приложения**.Щелкните правой кнопкой мыши пункт **Аналитический** и выберите **Включить журнал**, чтобы включить **Аналитический** журнал.  
...
10. Просмотрите события, переданные из рабочего процесса.  
     ...
     Вернитесь в средство просмотра событий и перейдите к окну **Средство просмотра событий**, **Журналы приложений и служб**, **Microsoft**, **Windows**, **Сервер приложений — приложения**.Щелкните правой кнопкой мыши пункт **Аналитический** и выберите команду **Обновить**.  
...
>   
>  `<диск_установки>:\WF_WCF_Samples\WF\Basic\Tracking\EtwTracking`  
