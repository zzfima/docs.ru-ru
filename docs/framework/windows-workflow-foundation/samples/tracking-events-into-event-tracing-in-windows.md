...
1. Откройте файл решения EtwTrackingParticipantSample.sln в Visual Studio 2010.
...
4. С помощью [!INCLUDE[fileExplorer](../../../../includes/fileexplorer-md.md)] откройте тестовый клиент WCF.
     ...
     Папку установки Visual Studio 2010 по умолчанию — C:\Program Files\Microsoft Visual Studio 10.0.
