...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Дерево элементов модели программирования](../../../../docs/framework/windows-workflow-foundation/samples/programming-model-item-tree.md)  
 Демонстрирует навигацию по <xref:System.Activities.Presentation.Model.ModelItem> дерева, используя привязку декларативных данных из представления дерева Windows Presentation Foundation (WPF).  
