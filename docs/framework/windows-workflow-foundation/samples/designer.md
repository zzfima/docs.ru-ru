...
## <a name="in-this-section"></a>Содержание  
 [Удаление состояния представления конструктора добавляет в файл XAML](../../../../docs/framework/windows-workflow-foundation/samples/removing-the-view-state-the-designer-adds-to-an-xaml-file.md)  
 ...
 [Служба панели инструментов](../../../../docs/framework/windows-workflow-foundation/samples/toolbox-service.md)  
