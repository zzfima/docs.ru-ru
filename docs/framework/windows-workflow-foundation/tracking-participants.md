---
title: "Участники отслеживания | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 ![Блок&#45;схема отслеживания и поставщика трассировки событий Windows](../../../docs/framework/windows-workflow-foundation//media/trackingdatathroughetwparticipant.gif "TrackingDatathroughETWParticipant")  
  
## Данные события участника отслеживания  
 Участник отслеживания сериализует данные отслеживания события в сеансе ETW в формате «одно событие \- одна запись отслеживания».  Событие определяется по идентификатору в диапазоне от 100 до 199.  Определения записей событий отслеживания, созданных участником отслеживания, см. в разделе [Отслеживание ссылок на события](../../../docs/framework/windows-workflow-foundation//tracking-events-reference.md).  
...
2.  Выберите **Обозреватель событий, журналы приложений и служб, Майкрософт, Windows, сервер приложений\-приложения**.  
  
3.  Чтобы включить журнал, щелкните правой кнопкой мыши и убедитесь, что параметр **Вид, показать аналитические журналы и журналы отладки** выбран.  Если он еще не выбран, выберите его, чтобы рядом появилась галочка.  При этом будут отображены журналы **Аналитика**, **Производительность** и **Отладка**.  
  
4.  Щелкните правой кнопкой мыши журнал **Аналитика** и выберите **Включить журнал**.  Журнал будет существовать в файле %SystemRoot%\\System32\\Winevt\\Logs\\Microsoft\-Windows\-Application Server\-Applications%4Analytic.etl.  
