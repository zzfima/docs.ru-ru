...
## <a name="etw-tracking-participant"></a>Участник отслеживания ETW  
 [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] включает участника отслеживания ETW, который пишет записи отслеживания в сеанс ETW. Это делается очень эффективно, с минимальным воздействием на работу приложения и пропускную способность сервера. Преимущество использования стандартного участника отслеживания трассировки событий Windows в том, что получаемые им записи отслеживания можно просматривать в других приложениях и системных журналах в обозревателе событий Windows.  
...
## <a name="tracking-participant-event-data"></a>Данные события участника отслеживания  
 ...
 Сложные типы в переменных, аргументах и настраиваемых данных сериализуются записи события трассировки событий Windows с помощью [класс NetDataContractSerializer](https://go.microsoft.com/fwlink/?LinkId=177537). Этот класс включает информацию о типе CLR в сериализованном XML-потоке.  
...
3. Щелкните правой кнопкой мыши и убедитесь, что **вид, Показать аналитические журналы и журналы отладки** выбран. Если он еще не выбран, выберите его, чтобы рядом появилась галочка. Откроется **аналитический**, **Perf**, и **Отладка** журналы.  
  
4. Щелкните правой кнопкой мыши **аналитический** журнала, а затем выберите **включить журнал**. Журнал будет существовать в файле %SystemRoot%\System32\Winevt\Logs\Microsoft-Windows-Application Server-Applications%4Analytic.etl.  
