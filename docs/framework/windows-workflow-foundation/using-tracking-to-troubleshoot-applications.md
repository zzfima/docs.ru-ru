---
title: "Использование отслеживания для устранения неполадок приложений | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Устранение неполадок WF с помощью отслеживания WF  
...
```  
 ...
 Если отслеживание включено с использованием участника отслеживания ETW, события ошибок создаются в сеансе ETW.События можно просмотреть с помощью средства «Просмотр событий».Найти его можно на узле **Event Viewer\-\>Applications and Services Logs\-\>Microsoft\-\>Windows\-\>Application Application Server\-Applications Server\-Applications** в канале аналитики.  
