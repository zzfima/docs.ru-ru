...
---
# <a name="how-to-create-and-run-a-long-running-workflow"></a>Практическое руководство. создать и запустить долговременный рабочий процесс
...
4.  Добавьте в форму следующие элементы управления в указанном порядке и задайте значения свойств.  
    ...
    |**Button**|Имя. QuitGame<br /><br /> Расположение: 274, 42<br /><br /> Размер: 75, 23<br /><br /> Text: Выйти|  
