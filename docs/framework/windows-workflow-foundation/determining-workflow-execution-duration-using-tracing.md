...
1.  Откройте [!INCLUDE[vs2010](../../../includes/vs2010-md.md)].  Выберите **файл**, **новый**, **проекта**.  В разделе **C#** выберите **рабочего процесса** узла.  Выберите **консольное приложение рабочего процесса** из списка шаблонов.  Назовите новый проект `WorkflowDurationTracing` и нажмите кнопку **ОК**.  
...
4.  Если вы еще не включена трассировка рабочего процесса, разверните **журналы приложений и служб**, **Microsoft**, **Windows**, **сервер приложений-приложения** . Выберите **представление**, **Отобразить аналитический и отладочный журналы**. Щелкните правой кнопкой мыши **Отладка** и выберите **включить журнал**. Оставьте окно просмотра событий открытым, чтобы можно было просмотреть трассировки после запуска рабочего процесса.  
 ...
 **Родительское действие '', DisplayName: '', InstanceId: '' запланировало дочернее действие 'WorkflowDurationTracking.Workflow1', DisplayName: 'Workflow1', InstanceId: "1".**  
 ...
 **WorkflowInstance Id: '1bbac57b-3322-498e-9e27-8833fda3a5bf' завершено в состоянии Closed.**  
