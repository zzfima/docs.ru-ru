...
[!INCLUDE[wfd1](../../../includes/wfd1-md.md)] Может быть повторно размещен в средах за пределами Visual Studio 2012 в рамках создание, изменение и рабочие процессы наблюдения.
...
## <a name="in-this-section"></a>В этом разделе
 ...
 [Поддержка новых возможностей Workflow Foundation 4.5 в отдельно размещенном конструкторе рабочих процессов](../../../docs/framework/windows-workflow-foundation/wf-features-in-the-rehosted-workflow-designer.md)
