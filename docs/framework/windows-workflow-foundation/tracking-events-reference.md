...
|[115 — WorkflowInstanceAbortedRecordWithId](115-workflowinstanceabortedrecordwithid.md)|Предупреждение|TrackRecord = Воркфловинстанцеабортедрекорд, InstanceID =% 1, RecordNumber =% 2, EventTime =% 3, ActivityDefinitionId =% 4, Reason =% 5, Annotations =% 6, имя_профиля =% 7, Воркфловдефинитионидентити =% 8|HealthMonitoring, WFTracking|  
...
|[117 — WorkflowInstanceTerminatedRecordWithId](117-workflowinstanceterminatedrecordwithid.md)|Ошибка|TrackRecord = Воркфловинстанцетерминатедрекорд, InstanceID =% 1, RecordNumber =% 2, EventTime =% 3, ActivityDefinitionId =% 4, Reason =% 5, Annotations =% 6, имя_профиля =% 7, Воркфловдефинитионидентити =% 8|HealthMonitoring, WFTracking|  
|[118 — WorkflowInstanceUnhandledExceptionRecordWithId](118-workflowinstanceunhandledexceptionrecordwithid.md)|Ошибка|TrackRecord = Воркфловинстанцеунхандледексцептионрекорд, InstanceID =% 1, RecordNumber =% 2, EventTime =% 3, ActivityDefinitionId =% 4, SourceName =% 5, SourceId =% 6, Саурцеинстанцеид =% 7, Саурцетипенаме =% 8, Exception =% 9, аннотации =% 10, имя файла = % 11, Воркфловдефинитионидентити =% 12|HealthMonitoring, WFTrackingHealthMonitoring, WFTracking|  
...
|[1014 — ScheduleCompletionWorkItem](1014-schedulecompletionworkitem.md)|Verbose|Комплетионворкитем был запланирован для родительского действия "% 1", DisplayName: "% 2", InstanceId: "% 3".  Завершено действие «%4», DisplayName «%5», InstanceId «%6».|WFRuntime|  
...
|[1020 — CreateBookmark](1020-createbookmark.md)|Verbose|Создана закладка для действия "% 1", DisplayName: "% 2", InstanceId: "% 3".  BookmarkName: %4, BookmarkScope: %5.|WFRuntime|  
|[1021 — ScheduleBookmarkWorkItem](1021-schedulebookmarkworkitem.md)|Verbose|Букмаркворкитем был запланирован для действия "% 1", DisplayName: "% 2", InstanceId: "% 3".  BookmarkName: %4, BookmarkScope: %5.|WFRuntime|  
|[1022 — StartBookmarkWorkItem](1022-startbookmarkworkitem.md)|Verbose|Запуск выполнения Букмаркворкитем для действия "% 1", DisplayName: "% 2", InstanceId: "% 3".  BookmarkName: %4, BookmarkScope: %5.|WFRuntime|  
...
|[1029 — ScheduleFaultWorkItem](1029-schedulefaultworkitem.md)|Verbose|Фаултворкитем был запланирован для действия "% 1", DisplayName: "% 2", InstanceId: "% 3".  Исключение распространено из действия «%4», DisplayName «%5», InstanceId «%6».|WFRuntime|  
|[1030 — StartFaultWorkItem](1030-startfaultworkitem.md)|Verbose|Запуск выполнения Фаултворкитем для действия "% 1", DisplayName: "% 2", InstanceId: "% 3".  Исключение распространено из действия «%4», DisplayName «%5», InstanceId «%6».|WFRuntime|  
...
|[1035 — RuntimeTransactionSet](1035-runtimetransactionset.md)|Verbose|Транзакция среды выполнения была задана действием "% 1", DisplayName: "% 2", InstanceId: "% 3".  Выполнение изолировано с действием "% 4", DisplayName: "% 5", InstanceId: "% 6".|WFRuntime|  
...
|[3552 — MaxPendingMessagesPerChannelExceeded](3552-maxpendingmessagesperchannelexceeded.md)|Предупреждение|Достигнуто предельное значение регулирования "MaxPendingMessagesPerChannel" в "% 1". Для увеличения этого предела настройте свойство MaxPendingMessagesPerChannel для поведения BufferedReceiveServiceBehavior.|Квота WFServices|  
