...
## <a name="in-this-section"></a><span data-ttu-id="0544a-104">В этом разделе</span><span class="sxs-lookup"><span data-stu-id="0544a-104">In This Section</span></span>  
 [<span data-ttu-id="0544a-105">Закладки</span><span class="sxs-lookup"><span data-stu-id="0544a-105">Bookmarks</span></span>](../../../docs/framework/windows-workflow-foundation/bookmarks.md)  
 <span data-ttu-id="0544a-106">Содержит описание использования закладок.</span><span class="sxs-lookup"><span data-stu-id="0544a-106">Describes how to use bookmarks.</span></span>
