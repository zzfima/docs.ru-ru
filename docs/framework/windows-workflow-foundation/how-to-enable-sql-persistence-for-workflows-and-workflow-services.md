...
---
# <a name="how-to-enable-sql-persistence-for-workflows-and-workflow-services"></a>Практическое руководство. включить сохраняемость в SQL для рабочих процессов и служб рабочих процессов
...
>
> System.Data.SqlClient.SqlException: Не удалось найти хранимую процедуру «System.Activities.DurableInstancing.CreateLockOwner»
...
1. Добавьте ссылку на System.Activities.DurableInstancing.dll.
...
> [!NOTE]
> См. в разделе [как: Создание и запуск длительно выполняющегося рабочего процесса](how-to-create-and-run-a-long-running-workflow.md) шаге [Приступая к работе](getting-started-tutorial.md) для пошаговой инструкцией.
...
- Добавляет к файлу Machine.config следующий элемент расширения поведения, которые можно использовать \<sqlWorkflowInstanceStore > элемента поведения службы в файле конфигурации для настройки сохраняемости служб.
