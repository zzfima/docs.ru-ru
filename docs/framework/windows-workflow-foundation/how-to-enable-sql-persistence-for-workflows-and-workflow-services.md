...
>
> System. Data. SqlClient. SqlException: Не удалось найти хранимую процедуру "System. Activitys. DurableInstancing. Креателокковнер"
...
> [!NOTE]
> См. раздел [How: Создайте и запустите длительный рабочий процесс @ no__t-0 в [Начало работы руководстве](getting-started-tutorial.md) для пошаговых инструкций.
