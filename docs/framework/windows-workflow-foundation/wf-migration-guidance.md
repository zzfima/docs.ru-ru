...
Этот раздел содержит разделы, в которых описывается миграция рабочих процессов из предыдущих версий Windows Workflow Foundation (WF).
...
[Использование действий .NET Framework 3.0 WF в .NET Framework 4 с действием Interop](~/docs/framework/windows-workflow-foundation/net-framework-3-0-wf-in-net-framework-4-interop.md)   
