...
## <a name="compiled-activities"></a>Скомпилированные действия  
 ...
 Действия, производные от <xref:System.Activities.NativeActivity>, могут определять свою логику с помощью императивного кода и содержать дочерние действия, определяющие логику. Кроме того, они имеют полный доступ к возможностям среды выполнения, таким как создание закладок. Примеры создания <xref:System.Activities.NativeActivity>-действия, на основе разделе [базовый класс NativeActivity](../../../docs/framework/windows-workflow-foundation/nativeactivity-base-class.md), [как: создается действие](../../../docs/framework/windows-workflow-foundation/how-to-create-an-activity.md)и [пользовательский составной, использующее собственное действие](../../../docs/framework/windows-workflow-foundation/samples/custom-composite-using-native-activity.md)образца.  
