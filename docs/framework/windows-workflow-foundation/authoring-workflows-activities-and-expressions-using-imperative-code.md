---
title: "Разработка рабочих процессов, действий и выражений с помощью императивного кода | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### Использование инициализаторов объектов  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)]об инициализаторах объектов см. в разделах [Практическое руководство. Инициализация объектов без вызова конструктора \(Руководство по программированию на C\#\)](http://go.microsoft.com/fwlink/?LinkId=161015) и [Как объявить объект с помощью инициализатора объектов](http://go.microsoft.com/fwlink/?LinkId=161016).  
...
```  
 ...
 Недопустимо инициализировать литеральное выражение любым ссылочным типом, за исключением <xref:System.String>.В следующем примере свойство <xref:System.Activities.Statements.Assign.Value%2A> действия <xref:System.Activities.Statements.Assign> инициализируется литеральным выражением с помощью `List<string>`.  
...
```  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] выражениях см. в разделе [Выражения](../../../docs/framework/windows-workflow-foundation//expressions.md).  
