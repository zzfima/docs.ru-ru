...
### <a name="using-object-initializers"></a>Использование инициализаторов объектов  
 ...
 Для получения дополнительной информации о инициализаторах объектов см. [Как: Инициализация объектов без вызова конструктора (Руководство по программированию)](../../csharp/programming-guide/classes-and-structs/how-to-initialize-objects-by-using-an-object-initializer.md) и [Как: объявить объект с помощью инициализатора объектов.](../../visual-basic/programming-guide/language-features/objects-and-classes/how-to-declare-an-object-by-using-an-object-initializer.md)  
...
```  
 ...
 Выражения C# необходимо компилировать до того, как будет вызван рабочий процесс, содержащий их. Если выражения C's не компилируются, то <xref:System.NotSupportedException> он выбрасывается, когда рабочий ``Expression Activity type 'CSharpValue`1' requires compilation in order to run.  Please ensure that the workflow has been compiled.`` процесс вызывается с сообщением, аналогичным следующему: В большинстве сценариев, связанных с рабочими процессами, созданными в Visual Studio, выражения C's компилируются автоматически, но в некоторых сценариях, таких как рабочие процессы кода, выражения C's должны быть собраны вручную. На примере компиляции выражений C', см. [выражения «Использование C» в разделе «Рабочие процессы кода»](csharp-expressions.md#CodeWorkflows) в теме [«Выражения С».](csharp-expressions.md)  
...
> Обратите внимание, что в обоих примерах используется код на языке C#, но в одном используется <xref:Microsoft.VisualBasic.Activities.VisualBasicValue%601>, а во втором - <xref:Microsoft.CSharp.Activities.CSharpValue%601>. <xref:Microsoft.VisualBasic.Activities.VisualBasicValue%601> и <xref:Microsoft.CSharp.Activities.CSharpValue%601> могут использоваться в проектах Visual Basic и C#. По умолчанию выражения, созданные в конструкторе рабочих процессов, соответствуют языку проекта для размещения. При создании рабочих процессов в коде выбор языка остается за автором рабочего процесса.  
 ...
 Для получения дополнительной информации о выражениях lambda, см [Lambda Выражения (C » Программирование Руководство)](../../csharp/programming-guide/statements-expressions-operators/lambda-expressions.md) или [Lambda Выражения (Visual Basic)](../../visual-basic/programming-guide/language-features/procedures/lambda-expressions.md).  
...
```  
 ...
 Для получения дополнительной информации о выражениях [см.](expressions.md)  
