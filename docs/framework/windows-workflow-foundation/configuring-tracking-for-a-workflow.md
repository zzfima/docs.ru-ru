...
- Располагается в среде <xref:System.ServiceModel.Activities.WorkflowServiceHost>
...
> [!NOTE]
> Если вы хотите просмотреть пример кода, который показывает, как создать пользовательский элемент поведения, который добавляет пользовательского участника отслеживания, обратитесь к образцам [отслеживания.](./samples/tracking.md)
...
Особый интерес представляют два журнала средства просмотра при отслеживании выполнения WF - аналитический журнал и журнал отладки. Оба они находятся под Microsoft&#124;Windows&#124;узла приложений Сервер-приложения. В этом разделе журналы содержат события из одного приложения, а не события, влияющие на всю систему.
...
1. Чтобы открыть Event Viewer, нажмите **«Начать»,** а затем нажмите **«Бег».** В диалоге Run `eventvwr`введите тип .

2. В диалоге Event Viewer расширьте узло **журналов приложений и служб.**

3. Расширьте узлы **Microsoft,** **Windows**и **Application Server-Applications.**

4. Нажмите правой кнопкой мыши узла **Debug** под узлам **Application Server-Applications** и выберите **Включить журнал.**

5. Чтобы сформировать события трассировки, запустите приложение с включенной функцией трассировки.

6. Нажмите правой кнопкой мыши на узла **Debug** и выберите **Обновление.** На центральную панель будут выведены события трассировки.
...
4. Нажмите справа на **аналитический** узла под узла **application Server-Applications** и выберите **Включить журнал**.

5. Чтобы сформировать записи отслеживания, запустите приложение с включенной функцией отслеживания.

6. Нажмите справа на **аналитический** узлы и выберите **Refresh.** В центральную область будут выведены записи отслеживания.

Следующее изображение показывает отслеживание событий в телезрителе события:
...
2. Копируйте файл манифеста с\\\<последней версии [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)]>-Microsoft.Windows.ApplicationServer.Applications.man на временное место, и переименуйте его на Microsoft.Windows.ApplicationServer.Applications_Provider1.man
...
6. Сформируйте DLL-библиотеку ресурсов, выполнив следующие действия.
    ...
    1. Установите пакет Windows SDK. SDK Windows включает в себя компилятор сообщений ([mc.exe](/windows/win32/wes/message-compiler--mc-exe-)) и компилятор ресурсов[(rc.exe](/windows/win32/menurc/using-rc-the-rc-command-line-)).
    ...
    6. Измените ресурс и имя сообщения dll `Microsoft.Windows.ApplicationServer.Applications.Provider1.man` в файле манифеста с нового имени dll.

        ```xml
        <provider name="Microsoft-Windows-Application Server-Applications_Provider1" guid="{2720e974-9fe9-477a-bb60-81fe3bf91eec}" symbol="Microsoft_Windows_ApplicationServer_ApplicationEvents" resourceFileName="<dll directory>\Microsoft.Windows.ApplicationServer.Applications_Provider1.dll" messageFileName="<dll directory>\Microsoft.Windows.ApplicationServer.Applications_Provider1.dll" />
        ```

    7. Используйте [wevtutil](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732848(v=ws.10)) для регистрации манифеста.
