...
## <a name="in-this-section"></a>В этом разделе  
 [Практическое руководство. Создание пользовательского конструктора действий](how-to-create-a-custom-activity-designer.md)  
...
## <a name="external-resources"></a>Внешние ресурсы  
 [Настраиваемые действия](./samples/custom-activities.md)
