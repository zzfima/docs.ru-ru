---
title: "Использование каналов OData из рабочего процесса | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  [!INCLUDE[crabout](../../../includes/crabout-md.md)]разбиении на страницы в службе WCF см. в разделе[Практическое руководство. Загрузка результатов, разбитых на страницы \(службы данных WCF\)](http://go.microsoft.com/fwlink/?LinkId=193452).  
