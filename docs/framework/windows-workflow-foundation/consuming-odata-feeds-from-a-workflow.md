...
> [!NOTE]
>  Дополнительные сведения о разбиения на страницы в службах данных WCF см. в разделе. [Практическое руководство. Загрузка результатов, разбитых на страницы (службы данных WCF)](http://go.microsoft.com/fwlink/?LinkId=193452).  
