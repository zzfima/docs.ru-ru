...
В примерах этого раздела используется образец службы данных Northwind в [ http://services.odata.org/Northwind/Northwind.svc/ ](https://go.microsoft.com/fwlink/?LinkID=187426). Эта служба поставляется в составе [OData SDK](https://go.microsoft.com/fwlink/?LinkID=185248) и предоставляет доступ только для чтения к базе данных Northwind. Если необходим доступ для чтения или если требуется Локальная служба данных WCF, можно выполнить действия по [краткое руководство по службам данных WCF](https://go.microsoft.com/fwlink/?LinkID=131076) создать локальную службу OData, который предоставляет доступ к базе данных "Борей". При выполнении инструкций, описанных в кратком руководстве, необходимо заменить локальный URI на тот, который указан в коде в этом разделе.
...
> [!NOTE]
> Дополнительные сведения см. в разделе [Создание клиентской библиотеки службы данных (службы данных WCF)](https://go.microsoft.com/fwlink/?LinkID=191611).
...
> [!NOTE]
> Дополнительные сведения см. в разделе [асинхронные операции (службы данных WCF)](https://go.microsoft.com/fwlink/?LinkId=193396) и [создание асинхронных действий](../../../docs/framework/windows-workflow-foundation/creating-asynchronous-activities-in-wf.md).
...
> [!NOTE]
> Дополнительные сведения о разбиении на страницы в службах WCF Data Services см. в разделе. [Практическое: загрузка разбитых на страницы результатов (службы данных WCF)](https://go.microsoft.com/fwlink/?LinkId=193452).
