...
- **Завершил** Действие завершило свою работу и завершило работу.  
...
- **Faulted** Действие обнаружило ошибку и завершило работу без завершения его работы.  
