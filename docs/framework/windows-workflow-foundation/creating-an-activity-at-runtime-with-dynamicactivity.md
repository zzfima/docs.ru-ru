...
2. Выберите **файл**, **создать**, **проект**. Выберите **Рабочий процесс 4,0** в поле **визуальный C#**  элемент в окне **типы проектов** и выберите узел **v2010** . Выберите в окне **шаблоны** **консольное приложение последовательного рабочего процесса** . Задайте имя для нового проекта DynamicActivitySample.  
...
2. Выберите **файл**, **создать**, **проект**. Выберите **Рабочий процесс 4,0** в поле **визуальный C#**  элемент в окне **типы проектов** и выберите узел **v2010** . Выберите **консольное приложение рабочего процесса** в окне **шаблоны** . Задайте имя для нового проекта DynamicActivitySample.  
...
7. Выполните приложение. Окно консоли с текстом "Hello World!" отображен.  
