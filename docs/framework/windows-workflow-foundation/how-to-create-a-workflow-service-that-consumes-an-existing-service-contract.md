...
1.  В Visual Studio, выберите **файл**, **новый проект**. Выберите **WCF** узле **C#** узел в **шаблоны** дерева, а затем выберите **приложение службы рабочего процесса WCF** шаблона.  
