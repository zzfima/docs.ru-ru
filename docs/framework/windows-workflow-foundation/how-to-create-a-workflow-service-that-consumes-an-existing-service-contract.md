...
5.  Выберите **последовательности** действия. В окне «Свойства» щелкните **...** кнопки в **ImplementedContract** свойство. В **редактор коллекции типов** щелкните в появившемся окне **тип** раскрывающийся список и выберите **Выбор типов...** запись. В **Обзор и выбор .net типа** диалогового окна в разделе  **\<текущий проект >** откройте все подузлы и выберите **IBookService**. Нажмите кнопку **ОК**. В **редактор коллекции типов** диалоговое окно, нажмите кнопку **ОК**.  
