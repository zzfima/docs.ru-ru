...
> [!NOTE]
>  Поддержка C# выражения в проекты рабочих процессов появилась в .NET Framework 4.5. Дополнительные сведения см. в разделе [ C# выражения](csharp-expressions.md).  
