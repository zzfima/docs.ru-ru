...
## <a name="remote-debugging"></a>Remote Debugging  
 Удаленная отладка в Windows Workflow Foundation (WF) работает так же, как у удаленной отладки для других компонентов Visual Studio. Сведения об использовании удаленной отладки, см. в разделе [как: Включить удаленную отладку](https://go.microsoft.com/fwlink/?LinkId=196257).  
