---
title: "Оптимальные методы сохраняемости | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Оптимальные методы сохраняемости
...
## Проектирование и реализация устойчивых рабочих процессов  
 ...
 Применение Windows Server App Fabric весьма способствует упрощению настройки и использования сохраняемости.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Сохраняемость Windows Server App Fabric](http://go.microsoft.com/fwlink/?LinkID=201200&clcid=0x419)  
...
### Сценарий. Небольшое количество экземпляров рабочего процесса, которые требуют оптимального времени ответа  
...
### Сценарий. Экземпляры рабочего процесса простаивают в течение продолжительных промежутков времени  
...
### Сценарий. Экземпляры рабочих процессов получают множество сообщений за короткий период времени  
...
### Сценарий. В рабочем процессе используются действия задержки с краткими продолжительностями  
