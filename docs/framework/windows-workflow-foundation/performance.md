...
## <a name="terminology"></a>Терминология
 ...
 Windows Communication Foundation (WCF) является единой моделью программирования корпорации Microsoft для построения сервисноориентированных приложений. Он впервые появилась в составе .NET 3.0 вместе с WF3 и теперь является одним из ключевых компонентов [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)].
