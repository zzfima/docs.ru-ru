...
## <a name="interop"></a>Interop  
 WF4 представляет собой почти полностью переписанный [!INCLUDE[wf1](../../../includes/wf1-md.md)], поэтому рабочие процессы и действия WF3 не являются непосредственно совместимыми c WF4.  Многие клиенты, которые реализуют [!INCLUDE[wf2](../../../includes/wf2-md.md)] уже имеют собственные или сторонние определения и настраиваемых действий для WF3.  Одним из способов облегчить переход на WF4 является использование действия Interop, которое способно выполнять действия WF3 в рабочих процессах WF4.  Рекомендуется использовать действие <xref:System.Activities.Statements.Interop> только при необходимости. [!INCLUDE[crabout](../../../includes/crabout-md.md)] Переход на WF4 извлечение [руководство по миграции для WF4](http://go.microsoft.com/fwlink/?LinkID=153313).  
