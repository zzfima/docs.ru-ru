...
### <a name="wf-runtime"></a>Среда выполнения WF
 ...
 Планировщик среды выполнения WF4 более эффективен по сравнению с WF3. При этом используется тот же пул потоков ввода-вывода, который используется для WCF, который является очень эффективен при выполнении пакетных рабочих элементов. Внутренняя очередь рабочих элементов оптимизирована для самых распространенных шаблонов использования. Среда выполнения WF4 также обеспечивает значительно облегченное управление состоянием выполнения с минимальной степенью синхронизации и логикой обработки событий, тогда как в WF3 это делается с помощью громоздкой регистрации событий и их вызова для выполнения сложной синхронизации при смене состояний.
