...
## <a name="terminology"></a>Терминология
 ...
 Windows Communication Foundation (WCF) является единой моделью программирования корпорации Microsoft для построения сервисноориентированных приложений. Этот компонент впервые появился в составе .Net 3.0 вместе с WF3 и теперь является одним из ключевых компонентов платформы [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)].
...
### <a name="environment-setup"></a>Настройка среды
 ![Среда тестирования производительности рабочих процессов](./media/wfperfenvironment.gif "WFPerfEnvironment")
...
### <a name="replicator-compared-to-parallelforeach"></a>Сравнение действий Replicator и ParallelForEach
 ...
 ![WF3 ReplicatorActivity и WF4 ParallelForEach](./media/replicatorandparallelforeach.gif "ReplicatorAndParallelForEach")
...
```
 ...
 ![Рабочие процессы базовой компенсации WF3 и WF](./media/basiccompensationworkflows.gif "BasicCompensationWorkflows")
...
### <a name="performance-test-results"></a>Результаты теста производительности
 ![Результаты теста производительности](./media/performancedata.gif "PerformanceData")

 ![Граф данных теста производительности](./media/performancetestchart.gif "PerformanceTestChart")
...
### <a name="performance"></a>Производительность
 ![Граф производительности службы Online Store](./media/onlinestoreperfgraph.gif "OnlineStorePerfGraph")
...
##### <a name="environment-setup"></a>Настройка среды
 ![Настройка среды для тестов задержки и пропускной способности](./media/latencyandthroughputenvironment.gif "LatencyAndThroughputEnvironment")
...
##### <a name="test-setup"></a>Настройка теста
 ...
 ![Область корреляции WF 4](./media/correlationscopeworkflow.gif "CorrelationScopeWorkflow")
...
##### <a name="test-results"></a>Результаты теста
 ![Результаты задержки](./media/latencyresultsgraph.gif "LatencyResultsGraph")
...
#### <a name="test-setup"></a>Настройка теста
 ![Тест рабочего процесса пропускной способности корреляции](./media/correlationthroughputworkflow.gif "CorrelationThroughputWorkflow")

 Рабочий процесс, показанный выше аналогичен тому, который используется в приведенном ниже разделе «Сохраняемость».  Для тестов корреляции без сохраняемости в среде выполнения поставщик сохраняемости не устанавливается.  Корреляция происходит в двух местах: CreateOrder и CompleteOrder.

#### <a name="test-results"></a>Результаты теста
 ![Пропускная способность корреляции](./media/correlationthroughputgraph.gif "CorrelationThroughputGraph")
...
#### <a name="correlation-with-persistence"></a>Корреляция с сохраняемостью
 ...
 ![Результаты корреляции и сохраняемости](./media/correlationandpersistencegraph.gif "CorrelationAndPersistenceGraph")
...
### <a name="test-setup"></a>Настройка теста
 ...
 ![Уравнение для подсчета числа действий](./media/numberofactivitiesequation.gif "NumberOfActivitiesEquation")
 ...
 ![Уравнение для подсчета числа действий](./media/w3numberofactivitiesequation.gif "W3NumberOfActivitiesEquation")
 ...
 ![Сравнивает число действий, используемых в каждом тесте](./media/comparechart.gif "CompareChart")
 ...
 ![Сложный рабочий процесс](./media/complexworkflowthroughputworkflow.gif "ComplexWorkflowThroughputWorkflow")
 ...
 ![WF3 Рабочий процесс](./media/wf3workflow.gif "WF3Workflow")
 ...
 ![Вложенные последовательности](./media/nestedsequencewf.gif "NestedSequenceWF")

 Отслеживание и сохраняемость в этом тесте не используются.

### <a name="test-results"></a>Результаты теста
 ![Диаграмма пропускной способности](./media/testresults1.gif "TestResults1")
...
### <a name="workflow-complexity-test"></a>Тест сложности рабочего процесса
 ...
 ![Сложные рабочие процессы](./media/complexworkflowboth.gif "ComplexWorkflowBoth")
 ...
 ![Граф использования памяти](./media/complexmemoryusage.gif "ComplexMemoryUsage")
...
### <a name="multiple-workflow-definitions-test"></a>Тест нескольких определений рабочих процессов
 ...
 ![Службы рабочих процессов в WF3 и WF4](./media/receiveworkflowboth.gif "ReceiveWorkflowBoth")
...
### <a name="test-setup"></a>Настройка теста
 ...
 ![Сохраняемость рабочих процессов](./media/persistworkflow.gif "PersistWorkflow")
...
### <a name="test-results"></a>Результаты теста
 ![Сохраняемость пропускной способности](./media/throughputpersistence.gif "ThroughputPersistence")
...
### <a name="test-results"></a>Результаты теста
 ![Стоимость трассировки рабочего процесса](./media/workflowtracingcost.gif "WorkflowTracingCost")
