...
### <a name="replicator-compared-to-parallelforeach"></a>Сравнение действий Replicator и ParallelForEach  
 ...
 ![WF3 ReplicatorActivity и WF4 ParallelForEach](../../../docs/framework/windows-workflow-foundation/media/replicatorandparallelforeach.gif "ReplicatorAndParallelForEach")  
...
```  
 ...
 ![Рабочие процессы базовой компенсации WF3 и WF](../../../docs/framework/windows-workflow-foundation/media/basiccompensationworkflows.gif "BasicCompensationWorkflows")  
...
### <a name="performance-test-results"></a>Результаты теста производительности  
 ...
 ![Граф данных теста производительности](../../../docs/framework/windows-workflow-foundation/media/performancetestchart.gif "PerformanceTestChart")  
...
### <a name="performance"></a>Производительность  
 ![Граф производительности службы Online Store](../../../docs/framework/windows-workflow-foundation/media/onlinestoreperfgraph.gif "OnlineStorePerfGraph")  
...
##### <a name="test-results"></a>Результаты тестов  
 ![Результаты задержки](../../../docs/framework/windows-workflow-foundation/media/latencyresultsgraph.gif "LatencyResultsGraph")  
...
#### <a name="test-setup"></a>Настройка теста  
 ...
 Рабочий процесс, показанный выше аналогичен тому, который используется в приведенном ниже разделе «Сохраняемость».  Для тестов корреляции без сохраняемости в среде выполнения поставщик сохраняемости не устанавливается.  Корреляция происходит в двух методах: CreateOrder и CompleteOrder.  
...
### <a name="test-setup"></a>Настройка теста  
 ...
 ![Уравнение для подсчета числа действий](../../../docs/framework/windows-workflow-foundation/media/numberofactivitiesequation.gif "NumberOfActivitiesEquation")  
 ...
 ![Уравнение для подсчета числа действий](../../../docs/framework/windows-workflow-foundation/media/w3numberofactivitiesequation.gif "W3NumberOfActivitiesEquation")  
 ...
 ![Сравнивает число действий, используемых в каждом тесте](../../../docs/framework/windows-workflow-foundation/media/comparechart.gif "CompareChart")  
 ...
 ![WF3 Рабочий процесс](../../../docs/framework/windows-workflow-foundation/media/wf3workflow.gif "WF3Workflow")  
...
### <a name="workflow-complexity-test"></a>Тест сложности рабочего процесса  
 ...
 ![Граф использования памяти](../../../docs/framework/windows-workflow-foundation/media/complexmemoryusage.gif "ComplexMemoryUsage")  
...
### <a name="test-setup"></a>Настройка теста  
 ...
 ![Сохраняемость рабочих процессов](../../../docs/framework/windows-workflow-foundation/media/persistworkflow.gif "PersistWorkflow")  
