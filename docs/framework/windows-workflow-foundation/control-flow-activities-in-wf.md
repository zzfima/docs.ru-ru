---
title: "Действия потока управления потока в WF | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
[!INCLUDE[netfx_current_long](../../../includes/netfx-current-long-md.md)] содержит несколько действий для управления потоком выполнения внутри рабочего процесса.Некоторые из этих действий \(например, `Switch` и `If`\) реализуют структуры управления потоком, аналогичные структурам в средах программирования, таких как [!INCLUDE[csprcs](../../../includes/csprcs-md.md)], а другие \(например, `Pick`\) моделируют новые структуры программирования.  
...
|<xref:System.Activities.Statements.Pick>|Выполняет моделирование потока управления на основе событий.|  
