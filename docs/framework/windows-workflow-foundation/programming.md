...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Разделы, которые описывают действия, предоставляемые системой и доступные в [!INCLUDE[wf](../../../includes/wf-md.md)].  
 ...
 Описывает производительность [!INCLUDE[wf2](../../../includes/wf2-md.md)] 4 и сравнивает ее с предыдущей версией WF.
