...
2. Нажмите кнопку **Назад** в браузере. Вы увидите **ошибка сервера в приложении «/»** страницы со следующим описанием: *ID1062: Обнаружено для: Маркер: «System.IdentityModel.Tokens.SamlSecurityToken»*, за которым следует *AssertionId* и *издателя*.  
