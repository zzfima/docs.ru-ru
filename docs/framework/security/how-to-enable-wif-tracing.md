...
---
# <a name="how-to-enable-wif-tracing"></a>Как выполнить: Включение трассировки WIF
...
6.  Создайте новую папку в с именем **журналы** в корне **C:** диска, как показано: **C:\logs**  
