...
---
# <a name="how-to-enable-wif-tracing"></a>Как Включение трассировки WIF
...
6. Создайте новую папку с именем **logs** в корне диска **C:** , как показано ниже. **C:\logs**
