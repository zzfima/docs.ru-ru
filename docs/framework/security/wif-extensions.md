...
-   [<span data-ttu-id="e3f9c-104">Обработчик веб-токенов JSON</span><span class="sxs-lookup"><span data-stu-id="e3f9c-104">JSON Web Token Handler</span></span>](../../../docs/framework/security/json-web-token-handler.md)  
  
-   [<span data-ttu-id="e3f9c-105">Проверка реестра имен поставщиков</span><span class="sxs-lookup"><span data-stu-id="e3f9c-105">Validating Issuer Name Registry</span></span>](../../../docs/framework/security/validating-issuer-name-registry.md)
