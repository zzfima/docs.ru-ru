...
2. Обратите внимание, что браузер автоматически перенаправляет запрос к службе маркеров безопасности, после чего открывает страницу Default.aspx. Если WIF настроен правильно, вы увидите, что сайт отображает следующий текст: **"Вы вошли"** .
