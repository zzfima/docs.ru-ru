...
---
# <a name="how-to-display-signed-in-status-using-wif"></a>Как Отображение состояния входа с помощью WIF
...
2. Обратите внимание, что браузер автоматически перенаправляет запрос к службе маркеров безопасности, после чего открывает страницу Default.aspx. Если WIF правильно настроена, вы должны увидеть сайт отображать следующий текст: **«Вы вошли в»** .
