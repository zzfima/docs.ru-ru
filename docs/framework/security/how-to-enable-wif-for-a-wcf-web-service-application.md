...
1. Нажмите клавишу **F5**, чтобы выполнить сборку приложения и запустить его. Вы увидите окно консоли и следующий текст: **Нажмите клавишу ВВОД, чтобы вызвать службу, или любую другую клавишу для выхода из приложения:**  
