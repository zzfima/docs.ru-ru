...
---
# <a name="how-to-enable-wif-for-a-wcf-web-service-application"></a>Как Включение WIF для приложения веб-службы WCF
...
1. Нажмите клавишу **F5**, чтобы выполнить сборку приложения и запустить его. Должно быть окно консоли и следующий текст: **Нажмите клавишу ВВОД, чтобы вызвать службу, любой другой ключ для выхода из приложения:**
