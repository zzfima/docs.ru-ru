...
---
# <a name="how-to-debug-claims-aware-applications-and-services-using-wif-tracing"></a>Как Отладка приложений и служб с помощью трассировки WIF
...
3. Приведенная выше конфигурация предписывает WIF создавать подробные события трассировки и регистрировать их в файле *WIFTrace.e2e*. Полный список значений для параметра **switchValue** см. в таблице уровень трассировки, которую можно найти в следующем разделе: [Настройка трассировки](../wcf/diagnostics/tracing/configuring-tracing.md).  
...
1. Средство Trace Viewer (SvcTraceViewer.exe) поставляется в составе пакета Windows SDK. Если вы еще не установили Windows SDK, его можно скачать здесь: [Windows SDK](https://www.microsoft.com/download/en/details.aspx?id=8279).  
...
5. Перейдите на вкладку **Действия**. Вы увидите подробные записи трассировки в главной области средства. Используйте раскрывающийся список **уровень** в меню для фильтрации конкретного уровня трассировок, например: **Все**, **предупреждение**, **ошибки**, **информация**и т. д.  
