...
## Использование атрибута SuppressUnmanagedCodeSecurityAttribute  
...
## Соглашения об именовании для методов неуправляемого кода  
