...
> [!NOTE]
> Этот набор содержимого .NET Framework включает сведения для версий .NET Framework с 4.5 по 4.8. Сведения о скачивании .NET Framework см. в [руководстве по установке](./install/guide-for-developers.md). Список новых функций и изменений в .NET Framework см. в статье [Новые возможности .NET Framework](./whats-new/index.md). Список поддерживаемых платформ см. в описании [системных требований .NET Framework](./get-started/system-requirements.md). Сведения о более старых версиях .NET Framework см. в [документации по предыдущим версиям .NET](https://docs.microsoft.com/previous-versions/dotnet/).
...
Общие сведения о платформе .NET Framework для пользователей и разработчиков см. в разделе [Начало работы](./get-started/index.md). См. [обзорные сведения](./get-started/overview.md) об архитектуре и основных возможностях платформы .NET Framework.
...
Сведения о скачивании .NET Framework см. в разделе [Установка .NET Framework для разработчиков](./install/guide-for-developers.md).
