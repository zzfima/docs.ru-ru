...
5.  Задайте для свойства <xref:System.Windows.Automation.CacheRequest.AutomationElementMode%2A> значение <xref:System.Windows.Automation.AutomationElementMode>, если хотите повысить эффективность, не получая полную ссылку на объекты. \(Это сделает невозможным получение текущих значений из этих объектов.\)  
...
### Кэширование свойств AutomationElement  
...
### Получение кэшированных шаблонов и их свойств  
