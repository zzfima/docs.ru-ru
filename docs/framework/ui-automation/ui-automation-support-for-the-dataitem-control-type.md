...
|----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|  
|DataItem<br /><br /> -   Изменяется \(0 и более; возможна иерархическая структуризация\)|DataItem<br /><br /> -   Изменяется \(0 и более; возможна иерархическая структуризация\)|  
...
## Пример элемента управления DataItem  
 ...
 ![График элемента управления представления списка с двумя элементами данных](../../../docs/framework/ui-automation/media/uiauto-data-grid-detailed.GIF "uiauto\_data\_grid\_detailed")  
