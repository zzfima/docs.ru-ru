...
|------------------|------------------|  
|Образ —|Image (зависит от того, содержит ли изображение информацию (на основе значения свойства `IsContentElement` ))|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Образ —|Это значение одинаково для всех инфраструктур пользовательского интерфейса.|  
...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IGridItemProvider>|Зависит|Элемент управления "Изображение" поддерживает шаблон Grid Item, если этот элемент управления находится внутри контейнера сетки.|  
|<xref:System.Windows.Automation.Provider.ITableItemProvider>|Зависит|Элемент управления "Изображение" поддерживает шаблон Table Item, если этот элемент управления находится внутри контейнера, имеющего элементы управления "Заголовок".|  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.InvokePatternIdentifiers.InvokedEvent>|Никогда|None|  
|<xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementAddedToSelectionEvent>|Никогда|None|  
|<xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementRemovedFromSelectionEvent>|Никогда|None|  
|<xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementSelectedEvent>|Никогда|None|  
