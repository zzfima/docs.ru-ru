...
|---------------------------------------|-------------------------------|  
|TabItem<br /><br /> <ul><li>Image \(0 или 1\)</li><li>Text</li><li>Панель<br /><br /> <ul><li>Различные элементы управления \(0 или более\)</li></ul></li></ul>|TabItem<br /><br /> <ul><li>Панель<br /><br /> <ul><li>Различные элементы управления \(0 или более\)</li></ul></li></ul>|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControllerForProperty>|См. примечания.|Это свойство может использоваться как указатель на связанную панель вкладки. Это полезно, если невозможно разместить панель как дочерний объект элемента вкладки.|  
