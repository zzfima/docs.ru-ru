...
|--------------------|---------------|  
|<xref:System.InvalidOperationException>|<xref:System.Windows.Automation.ValuePattern.SetValue%2A><br /><br /> -Если языкового стандарта передается в элемент управления имеет неверный формат, например дату в неправильном формате.|  
...
|<xref:System.Windows.Automation.ElementNotEnabledException>|<xref:System.Windows.Automation.ValuePattern.SetValue%2A><br /><br /> -Если попытка работы с элементом управления, который не включен.|  
...
## <a name="see-also"></a>См. также  
 ...
 [Пример текста TextPattern Insert](http://msdn.microsoft.com/en-us/67353f93-7ee2-42f2-ab76-5c078cf6ca16)  
