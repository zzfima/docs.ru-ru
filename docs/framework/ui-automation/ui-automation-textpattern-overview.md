...
## API поставщика TextPattern  
 ...
 Поставщик <xref:System.Windows.Automation.TextPattern> всегда должен поддерживать константы <xref:System.Windows.Automation.Text.TextUnit><xref:System.Windows.Automation.Text.TextUnit> и <xref:System.Windows.Automation.Text.TextUnit>, а также любые другие константы <xref:System.Windows.Automation.Text.TextUnit>, которые он способен поддерживать.  
  
> [!NOTE]
>  Поставщик может пропустить поддержку определенных <xref:System.Windows.Automation.Text.TextUnit> откладывая поддержку до следующего наибольшего объекта <xref:System.Windows.Automation.Text.TextUnit>, поддерживаемого в следующем порядке: <xref:System.Windows.Automation.Text.TextUnit>, <xref:System.Windows.Automation.Text.TextUnit>, <xref:System.Windows.Automation.Text.TextUnit>, <xref:System.Windows.Automation.Text.TextUnit>, <xref:System.Windows.Automation.Text.TextUnit>, <xref:System.Windows.Automation.Text.TextUnit> и <xref:System.Windows.Automation.Text.TextUnit>.  
 ...
 **Конечная точка**  
 Абсолютная точка <xref:System.Windows.Automation.Text.TextPatternRangeEndpoint> или <xref:System.Windows.Automation.Text.TextPatternRangeEndpoint> текстового диапазона в текстовом контейнере.  
  
 ![TextPatternRangeEndpoints &#40;начало и конец&#41;.](../../../docs/framework/ui-automation/media/uia-textpattern-endpoints.png "UIA\_TextPattern\_Endpoints")  
...
## См. также  
 ...
 [инфраструктуры текстовых служб \(TSF\)](http://msdn.microsoft.com/library/default.asp?url=/library/tsf/tsf/text_services_framework.asp)