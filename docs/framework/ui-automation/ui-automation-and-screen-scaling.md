...
> [!CAUTION]
>  Не используйте <xref:System.Windows.Forms.Cursor.Position%2A?displayProperty=fullName>. Поведение этого свойства вне клиентских окон в масштабируемой среде не определено.  
...
## См. также  
 [Highlighter Sample](http://msdn.microsoft.com/ru-ru/19ba4577-753e-4efd-92cc-c02ee67c1b69)