...
|Поиск нужных элементов управления|Скрипты автоматических тестов находят элементы автоматизации пользовательского интерфейса, представляющие нужные элементы управления в дереве автоматизации.<br /><br /> Существует несколько способов получения элементов автоматизации пользовательского интерфейса с помощью кода.<br /><br /> — Запрос [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)] <xref:System.Windows.Automation.Condition> с помощью инструкции. Обычно здесь используется не зависящее от языка свойство <xref:System.Windows.Automation.AutomationElement.AutomationIdProperty> . **Примечание.**  Можно получить с помощью средства, такого как проверка. exe, которое может выполнить детализацию [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] свойств элемента управления. <xref:System.Windows.Automation.AutomationElement.AutomationIdProperty> <br /><br /> — Используйте <xref:System.Windows.Automation.TreeWalker> класс для прохода по всему [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] дереву или подмножеству.<br />— Отслеживание фокуса.<br />— Используйте hWnd элемента управления.<br />— Используйте место на экране, например расположение курсора мыши.<br /><br /> См. раздел [Obtaining UI Automation Elements](obtaining-ui-automation-elements.md).|  
...
- Средство проверки. exe — это приложение графического пользовательского интерфейса, которое можно использовать для сбора [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] информации о разработке и отладке поставщика и клиента. Программа проверки. exe включена в Windows SDK.  
  
- Мсаабридже предоставляет [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] сведения для Active Accessibility клиентов. Основная цель моста [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] с Active Accessibility — разрешить существующим клиентам Active Accessibility возможность взаимодействия с любой реализуемой [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]платформой.  
