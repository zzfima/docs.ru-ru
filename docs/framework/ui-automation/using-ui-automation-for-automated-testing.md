...
|Поиск нужных элементов управления|Скрипты автоматических тестов находят элементы автоматизации пользовательского интерфейса, представляющие нужные элементы управления в дереве автоматизации.<br /><br /> Существует несколько способов получения элементов автоматизации пользовательского интерфейса с помощью кода.<br /><br /> -Query [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)] с помощью <xref:System.Windows.Automation.Condition> инструкции. Обычно здесь используется не зависящее от языка свойство <xref:System.Windows.Automation.AutomationElement.AutomationIdProperty> . **Примечание:** <xref:System.Windows.Automation.AutomationElement.AutomationIdProperty> можно получить с помощью такого средства, как Inspect.exe, способного выделить [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] свойства элемента управления. <br /><br /> -Используйте <xref:System.Windows.Automation.TreeWalker> класс для обхода всего [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] дерево или его подмножества.<br />-Отслеживать фокус.<br />-Используйте hWnd элемента управления.<br />-Используйте местоположение на экране, такие как расположение указателя мыши.<br /><br /> См. раздел [Obtaining UI Automation Elements](../../../docs/framework/ui-automation/obtaining-ui-automation-elements.md).|  
