...
3. [Создание прототипов в управляемом коде](creating-prototypes-in-managed-code.md).  
     ...
     (К) Используйте **DllImportAttribute** для определения DLL и функции. Пометьте метод модификаторами **static** и **extern**.  
...
- [Взаимодействие с неуправляемым кодексом](index.md)
