...
-   Функция **TestArrayOfStructs2**, экспортированная из PinvokeLib.dll.  
 ...
 [PinvokeLib.dll](http://msdn.microsoft.com/ru-ru/5d1438d7-9946-489d-8ede-6c694a08f614) — это пользовательская неуправляемая библиотека, содержащая реализации ранее описанных функций и две переменные структуры: **MYPOINT** и **MYPERSON**. Структуры содержат следующие элементы:  
...
## См. также  
 [Маршалинг массивов типов](http://msdn.microsoft.com/ru-ru/049b1c1b-228f-4445-88ec-91bc7fd4b1e8)   
 [Типы данных в вызове неуправляемого кода](http://msdn.microsoft.com/ru-ru/16014d9f-d6bd-481e-83f0-df11377c550f)   
