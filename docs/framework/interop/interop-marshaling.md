...
- COM-взаимодействие, позволяющее управляемому коду взаимодействовать с COM-объектами с помощью интерфейсов.  
 ...
 ![Вызов неуправляемого кода](./media/interop-marshaling/interop-marshaling-invoke-and-com.png "Вызов неуправляемого кода и вызов потока COM-взаимодействия")  
...
|MTA|`Both` становится MTA.|Маршалинг в том же подразделении.|  
 ...
 ![Маршалинг взаимодействия между управляемыми и неуправляемыми кучами](./media/interop-marshaling/interop-heaps-managed-and-unmanaged.gif "Маршалинг процессов в рамках того же подразделении")  
...
|STA|MTA<br /><br /> STA|Маршалинг взаимодействия и маршалинг COM.<br /><br /> Маршалинг взаимодействия.|  
 ...
 ![Маршалинг COM](./media/interop-marshaling/single-process-across-multi-apartment.gif "Вызов между подразделениями между клиентом .NET и объектом COM")  
...
- Управляемый клиент, обращающийся к СОМ-серверу на удаленном компьютере, использует DCOM.  
 ...
 ![Маршалинг COM](./media/interop-marshaling/interop-and-com-marshaling.gif "Маршалинг между процессами")  
...
### <a name="preserving-identity"></a>Сохранение идентификаторов  
 ...
 ![Вызываемая оболочка COM и вызываемая оболочка времени выполнения](./media/interop-marshaling/interop-direct-ref-across-process.gif "Ссылка, передаваемая между процессами и границами узлов")  
...
### <a name="managed-remoting"></a>Управляемое удаленное взаимодействие  
 ...
 ![SOAP или TcpChannel](./media/interop-marshaling/interop-remote-soap-or-tcp.gif "Удаленные вызовы между брандмауэрами с использованием класса SOAP или TcpChannel")  
