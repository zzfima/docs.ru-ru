...
> [!NOTE]
>  Маршалинг универсальных типов не поддерживается. Дополнительные сведения см. в разделе [Взаимодействие с помощью универсальных типов](http://msdn.microsoft.com/en-us/26b88e03-085b-4b53-94ba-a5a9c709ce58).  
...
## <a name="see-also"></a>См. также  
 ...
 [Маршалинг по умолчанию для массивов](../../../docs/framework/interop/default-marshaling-for-arrays.md)   
 [Маршалинг по умолчанию для объектов](../../../docs/framework/interop/default-marshaling-for-objects.md)   
