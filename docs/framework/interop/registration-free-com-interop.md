...
1.  Чтобы COM-компонент участвовал в активации без регистрации, его необходимо развернуть как параллельную сборку. Параллельные сборки являются неуправляемыми.  Дополнительные сведения см. в разделах, посвященных [использованию параллельных сборок](https://msdn.microsoft.com/library/windows/desktop/aa376618.aspx).  
     ...
     Активация без регистрации не является обязательной для COM-компонентов, установленных в ОС Windows XP. Подробные инструкции по добавлению параллельной сборки в приложение см. в [этих разделах](https://msdn.microsoft.com/library/windows/desktop/aa376618.aspx).  
