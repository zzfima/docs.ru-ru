...
2. В Visual Studio выберите элемент управления в форме, а затем откройте окно **Свойства** .

3. Разверните свойство **(DataBindings)** , а затем в поле **(дополнительно)** нажмите кнопку с многоточием (![кнопку с многоточием (...) в окно свойств Visual Studio](./media/how-to-create-a-bound-control-and-format-the-displayed-data/visual-studio-ellipsis-button.png)), чтобы отобразить **Форматирование и расширенный формат.** Диалоговое окно "привязка", содержащее полный список свойств для этого элемента управления.
...
6. Выберите имя элемента для привязки.

7. В поле **тип формата** выберите формат, который необходимо применить к данным, отображаемым в элементе управления.
