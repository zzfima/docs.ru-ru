...
## <a name="in-this-section"></a>В этом разделе  
 [Windows Forms координаты](windows-forms-coordinates.md).  
 Описывает координаты клиентского приложения и экранные координаты.  
  
 [Практическое руководство. Создание приложения Windows Forms из командной строки](how-to-create-a-windows-forms-application-from-the-command-line.md)  
