...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Предоставляет несколько вариантов обновления приложений ClickOnce.  
  
 [Защита приложений ClickOnce](/visualstudio/deployment/securing-clickonce-applications)  
 Объясняет влияние развертывания ClickOnce на безопасность.  
  
 [Устранение неполадок развертывания ClickOnce](/visualstudio/deployment/troubleshooting-clickonce-deployments)  
 Описывает различные проблемы, которые могут возникнуть при развертывании приложений ClickOnce, и документирует сообщения об ошибках верхнего уровня, которые могут быть созданы в ClickOnce.  
  
 [ClickOnce и параметры приложения](/visualstudio/deployment/clickonce-and-application-settings)  
 Описание работы развертывания ClickOnce с параметрами приложения, в котором хранятся параметры приложения и пользователя для будущего извлечения.  
  
 [Общие сведения о развертывании доверенных приложений](/visualstudio/deployment/trusted-application-deployment-overview)  
 Описывает функцию ClickOnce, которая позволяет доверенным приложениям работать с более высоким уровнем разрешений на клиентских компьютерах.  
 ...
 Демонстрирует использование средств командной строки и пакета SDK для развертывания приложения ClickOnce без использования Visual Studio.  
 ...
 Демонстрируется настройка приложения ClickOnce с помощью средств пакета SDK для проверки другого расположения новых версий приложения.  
 ...
 Демонстрируется получение параметров из URL-адреса, используемого для запуска приложения ClickOnce.  
  
 [Общие сведения о кэше ClickOnce](/visualstudio/deployment/clickonce-cache-overview)  
 Описывает кэш, используемый для хранения приложений ClickOnce на локальном компьютере.  
