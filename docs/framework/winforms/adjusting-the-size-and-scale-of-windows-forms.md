...
## <a name="in-this-section"></a>Содержание  
 [Практическое руководство. Изменение размера формы в Windows Forms](~/docs/framework/winforms/how-to-resize-windows-forms.md)  
 ...
 [Поддержка высокого Разрешения в Windows Forms](../../../docs/framework/winforms/high-dpi-support-in-windows-forms.md)    
