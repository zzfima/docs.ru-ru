...
5.  Откройте производную форму (**Form2**) в конструкторе, дважды щелкнув его, если он еще не открыт.  
     ...
     В конструкторе производные кнопки имеют символ (![VisualBasicInheritanceSymbol screenshot](../../../../docs/framework/winforms/advanced/media/vbinheritanceglyph.gif "vbInheritanceGlyph")) в верхнем углу, указывающее, они унаследованы.  
