...
- <xref:System.Drawing.FontFamily.GetLineSpacing%2A>(FontStyle)  
 ...
 Значения, возвращаемые этими методами, заданы в единицах шрифта, поэтому они не зависят от размера и единиц измерений конкретного объекта <xref:System.Drawing.Font>.  
