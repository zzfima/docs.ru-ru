---
title: Как выполнить Добавление данных в буфер обмена
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54682814"
---
# <a name="how-to-add-data-to-the-clipboard"></a>Как выполнить Добавление данных в буфер обмена
