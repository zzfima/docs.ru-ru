...
---
# <a name="how-to-draw-with-opaque-and-semitransparent-brushes"></a>Как выполнить Рисование непрозрачными и полупрозрачными кистями
...
## <a name="example"></a>Пример  
 ...
 ![Непрозрачных и полупрозрачных](../../../../docs/framework/winforms/advanced/media/compqualellipse.png "compqualellipse")  
