...
## <a name="graphics-file-formats"></a>Графические форматы файлов  
 Существует множество стандартных форматов сохранение растровых изображений в файлы на диске. Описанных ниже форматов графических файлов, поддерживаемые GDI +.  
