...
## <a name="specify-whether-a-component-is-a-member-of-the-form"></a>Укажите, является ли компонент членом формы

1. В Visual Studio, в конструкторе Windows Forms откройте форму.
