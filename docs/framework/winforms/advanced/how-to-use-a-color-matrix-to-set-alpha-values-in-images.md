...
---
# <a name="how-to-use-a-color-matrix-to-set-alpha-values-in-images"></a>Как выполнить Использование матрицы цветов для задания значений прозрачности в изображениях
