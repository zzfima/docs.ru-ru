...
*Глобализация* — это процесс проектирования и разработки программных продуктов, которые работают в средах с различными языками и региональными параметрами.  
...
-   [Практическое руководство. Установка значений Culture и UICulture для глобализации форм Windows Forms](http://msdn.microsoft.com/library/b28bx3bh\(v=vs.110\))  
  
-   [Руководство: создание отраженных форм и элементов управления Windows Forms](http://msdn.microsoft.com/library/xwbz5ws0\(v=vs.110\))  
...
-   [Пошаговое руководство. Создание структуры, сохраняющей пропорции при локализации](http://msdn.microsoft.com/ru-ru/library/7k9fa71y\(v=vs.110\))  
  
-   [Практическое руководство. Создание окон сообщений для форм Windows Forms с двунаправленным письмом](http://msdn.microsoft.com/library/k1689bxh\(v=vs.110\))  
