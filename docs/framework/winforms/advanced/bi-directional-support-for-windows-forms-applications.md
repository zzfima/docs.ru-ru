...
|<xref:System.Windows.Forms.OpenFileDialog>|В операционных системах справа налево, установка содержащего формы <xref:System.Windows.Forms.Control.RightToLeft> свойства <xref:System.Windows.Forms.RightToLeft.Yes?displayProperty=nameWithType> есть перевод диалогового окна |Не влияет.|Нет|  
