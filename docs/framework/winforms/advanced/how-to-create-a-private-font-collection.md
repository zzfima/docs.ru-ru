---
title: Как выполнить Создание частной коллекции шрифтов
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54505839"
---
# <a name="how-to-create-a-private-font-collection"></a>Как выполнить Создание частной коллекции шрифтов
