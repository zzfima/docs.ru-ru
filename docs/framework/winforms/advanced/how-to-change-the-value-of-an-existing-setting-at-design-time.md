...
### <a name="to-change-the-value-of-an-existing-setting-at-design-time-in-c"></a>Чтобы изменить значение существующего параметра во время разработки в C#  
...
3.  В конструкторе параметров найти нужный параметр, для которого требуется изменить значение и введите новое значение в столбце значение.  
