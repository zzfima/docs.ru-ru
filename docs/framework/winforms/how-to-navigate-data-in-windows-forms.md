---
title: Как выполнить Переход между данными в Windows Forms
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54586908"
---
# <a name="how-to-navigate-data-in-windows-forms"></a>Как выполнить Переход между данными в Windows Forms
