...
## <a name="types-of-data-binding"></a>Типы привязки данных  
 Windows Forms можно использовать преимущества двух типов привязки данных: простой привязки и сложной привязки. Каждая имеет собственные преимущества.  
