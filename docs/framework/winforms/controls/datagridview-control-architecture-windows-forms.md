...
### <a name="datagridview-editing-controls"></a>Элементы управления редактирования DataGridView  
 ...
 ![Редактирование объектная модель элемента управления DataGridView](../../../../docs/framework/winforms/controls/media/datagridviewediting.gif "DataGridViewEditing")  
...
-   <xref:System.Windows.Forms.DataGridViewTextBoxEditingControl>  
 ...
 Сведения о создании собственных редактирования элементов управления, см. в разделе [как: Ведущие элементы управления в формах Windows Forms ячеек элемента управления DataGridView](../../../../docs/framework/winforms/controls/how-to-host-controls-in-windows-forms-datagridview-cells.md).  
