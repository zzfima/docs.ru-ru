...
---
# <a name="how-to-host-controls-in-windows-forms-datagridview-cells"></a>Как выполнить  Элементы управления ведущего приложения в ячеек элемента управления DataGridView Windows Forms
