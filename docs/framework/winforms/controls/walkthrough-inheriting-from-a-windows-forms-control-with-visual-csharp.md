...
2.  В списке проектов [!INCLUDE[csprcs](../../../../includes/csprcs-md.md)] выберите шаблон проекта **Библиотека элементов управления Windows Forms** и введите `ValueButtonLib` в поле **Имя**.  
