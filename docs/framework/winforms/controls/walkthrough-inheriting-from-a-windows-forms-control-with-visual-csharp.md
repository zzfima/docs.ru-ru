...
2. В **обозревателе решений** щелкните правой кнопкой мыши **UserControl1.cs** и выберите в контекстном меню команду **Переименовать**. Измените имя файла на **ValueButton.CS**. Чтобы переименовать все ссылки на элемент кода ' **', в соответствующем запросе нажмите кнопку** Да`UserControl1`.
