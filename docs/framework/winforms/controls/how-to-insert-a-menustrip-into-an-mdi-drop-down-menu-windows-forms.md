...
---
# <a name="how-to-insert-a-menustrip-into-an-mdi-drop-down-menu-windows-forms"></a>Как выполнить Вставка элемента MenuStrip в раскрывающемся меню интерфейса MDI (Windows Forms)
