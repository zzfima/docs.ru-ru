...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Объясняется, как отслеживать изменения шрифта и форматирование абзацев в `RichTextBox` элемента управления.  
 ...
 Описаны варианты полос прокрутки в `RichTextBox` элемента управления.  
 ...
 Объясняется, как создавать ссылки на веб-сайты из `RichTextBox` элемента управления.  
 ...
 Инструкции по перетаскиванию данных в `RichTextBox` элемента управления.  
 ...
 Приводятся инструкции по загрузке существующего файла в `RichTextBox` элемента управления.  
 ...
 Приводятся инструкции по записи содержимого `RichTextBox` элемента управления в файл.  
 ...
 Описывает, как установить семейство шрифтов, размер, стиль и цвет текста в `RichTextBox` элемента управления.  
