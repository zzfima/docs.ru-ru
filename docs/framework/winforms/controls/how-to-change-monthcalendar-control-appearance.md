...
---
# <a name="how-to-change-the-windows-forms-monthcalendar-control39s-appearance"></a>Практическое: изменение элемента управления MonthCalendar в Windows Forms&#39;вида
