---
title: "Практическое руководство. Определение z-порядка закрепленных элементов управления ToolStrip | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "панели инструментов [Windows Forms], определение z-порядка"
