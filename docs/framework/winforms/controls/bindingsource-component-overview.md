---
title: "Общие сведения о компоненте BindingSource | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "элементы управления [Windows Forms], привязка к данным"
