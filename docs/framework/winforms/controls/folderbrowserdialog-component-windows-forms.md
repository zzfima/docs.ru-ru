...
## <a name="in-this-section"></a>Содержание  
 ...
 Объясняется, как программным образом извлечь выбранную папку из диалогового окна, а также работать с некоторыми другие дополнительные свойства компонента.  
