...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Инструкции по заданию, где курсор будет отображаться, когда элемент управления редактированием сначала получает фокус.  
 ...
 Описание способов скрытия, введенных в текстовое поле.  
 ...
 Описывает, как запретить изменение содержимого текстового поля.  
 ...
 Описание добавления кавычек в строку в текстовое поле.  
 ...
 Объясняется, как выделение текста в текстовом поле.  
 ...
 Описывает, как сделать прокручиваемый текстовое поле.  
