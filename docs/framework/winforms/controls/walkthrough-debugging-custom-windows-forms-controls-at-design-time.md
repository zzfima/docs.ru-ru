...
-   Создайте проект приложения Windows, называется «DebuggingExample». Дополнительные сведения см. в разделе [Практическое руководство. Создание проекта приложения Windows](http://msdn.microsoft.com/library/b2f93fed-c635-4705-8d0e-cf079a264efa).  
...
2.  Добавьте новый **UserControl** DebugControlLibrary проект. Дополнительные сведения см. в разделе [NIB: Практическое: Добавление новых элементов проекта](http://msdn.microsoft.com/library/63d3e16b-de6e-4bb5-a0e3-ecec762201ce). Предоставьте новый исходный файл базовое имя «DebugControl».  
  
3.  С помощью **обозревателе решений**, удалите элемент управления проекта по умолчанию путем удаления файла с базовым именем «`UserControl1`». Дополнительные сведения см. в разделе [NIB: Практическое: удаление, Delete и исключить элементы](http://msdn.microsoft.com/library/6dffdc86-29c8-4eff-bcd8-e3a0dd9e9a73).  
