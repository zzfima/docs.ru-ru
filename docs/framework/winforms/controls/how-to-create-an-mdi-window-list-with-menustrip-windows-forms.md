...
---
# <a name="how-to-create-an-mdi-window-list-with-menustrip-windows-forms"></a>Как выполнить Создание списка в окне интерфейса MDI с помощью MenuStrip (Windows Forms)
