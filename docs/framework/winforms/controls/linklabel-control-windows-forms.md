...
## <a name="in-this-section"></a>в этом разделе  
 ...
 Описывает способы указания цвета и подчеркивания ссылок в стиле Web в метках ссылок.  
 ...
 Содержит инструкции по открытию формы или веб-страницы при щелчке ссылки.  
