...
Компонент Windows Forms <xref:System.Windows.Forms.FontDialog> является стандартным диалоговым окном. Он аналогичен **шрифта** диалоговому операционной системы Windows. Компонент наследуется от <xref:System.Windows.Forms.CommonDialog> класса.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Основные понятия <xref:System.Windows.Forms.FontDialog> компонент, который используется для отображения предварительно настроенным диалоговым окном. Пользователи могут использовать диалоговое окно для управления шрифтами и их параметрами.  
 ...
 Объясняется, как выбрать шрифт во время выполнения с помощью экземпляра <xref:System.Windows.Forms.FontDialog> компонента.  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Описание набора элементов управления и компонентов, которые позволяют пользователям выполнять стандартные действия в приложении или системе.  
