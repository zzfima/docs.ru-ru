...
---
# <a name="how-to-perform-a-custom-action-based-on-changes-in-a-cell-of-a-windows-forms-datagridview-control"></a>Как выполнить Выполнение пользовательских действий на основе изменений в ячейке элемента управления DataGridView в Windows Forms
