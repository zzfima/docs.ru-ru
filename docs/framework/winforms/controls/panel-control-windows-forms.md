...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описание способов отображения цвета фона и фоновое изображение на панели с помощью конструктора.  
 ...
 Описание способов отображения на панели Цвет фона и фоновое изображение.  
