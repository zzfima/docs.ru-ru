...
1. В Visual Studio создайте новый проект библиотеки элементов управления Windows с именем `StackViewLibrary`.
...
## <a name="design-the-stackview-control"></a>Порядок проектирования элемента управления StackView
...
## <a name="handle-events"></a>Обработка событий
...
## <a name="define-icons"></a>Определить значки
...
## <a name="implement-a-custom-renderer"></a>Реализовать пользовательское средство отрисовки
...
## <a name="test-the-stackview-control"></a>Тестирование элемента управления StackView
...
1. Нажмите клавишу **F5** для построения проекта и запуска **тестовом контейнере элементов управления**.
