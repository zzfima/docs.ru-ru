---
title: "Общие сведения об элементе управления BindingNavigator (Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "BindingNavigator - элемент управления [Windows Forms], сведения об элементе управления BindingNavigator"
  - "данные [Windows Forms], переходы"
  - "перемещение по данным"
  - "записи, перемещение по форме"
