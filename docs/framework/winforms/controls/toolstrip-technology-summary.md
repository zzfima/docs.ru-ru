---
title: "Технологии, положенные в основу работы элемента управления ToolStrip | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "меню [Windows Forms], сводка по технологиям"
  - "строки состояния, сводка по технологиям"
  - "панели инструментов [Windows Forms], сводка по технологиям"
  - "ToolStrip - элемент управления [Windows Forms], сводка по технологиям"
...
-   [Диалоговое окно задач ContextMenuStrip](http://msdn.microsoft.com/library/ms233646\(v=vs.110\))  
  
-   [Диалоговое окно задач StatusStrip](http://msdn.microsoft.com/library/ms233642\(v=vs.110\))  
  
-   [Диалоговое окно задач ToolStripContainer](http://msdn.microsoft.com/library/ms233647\(v=vs.110\))  
...
-   [Редактор коллекции элементов StatusStrip](http://msdn.microsoft.com/library/ms233631\(v=vs.110\))  
  
-   [Редактор коллекции элементов ContextMenuStrip](http://msdn.microsoft.com/library/ms233641\(v=vs.110\))  
  
-   [Редактор набора элементов ToolStrip](http://msdn.microsoft.com/library/ms233643\(v=vs.110\))  
...
## Размещение элементов управления  
 ...
 Пример размещения элементов управления см. в разделе [Практическое руководство. Заключение элемента управления в оболочку ToolStripControlHost в Windows Forms](../../../../docs/framework/winforms/controls/how-to-wrap-a-windows-forms-control-with-toolstripcontrolhost.md).  
...
## Отрисовка  
 ...
 Чтобы применить стиль к <xref:System.Windows.Forms.ToolStrip> и всем содержащимся в нем элементам <xref:System.Windows.Forms.ToolStripItem>, не нужно обрабатывать событие <xref:System.Windows.Forms.ToolStripItem.Paint> для каждого элемента.  Вместо этого можно задать для свойства <xref:System.Windows.Forms.ToolStrip.RenderMode%2A> одно из значений <xref:System.Windows.Forms.ToolStripRenderMode>, отличных от <xref:System.Windows.Forms.ToolStripRenderMode>.  Кроме того, можно задать <xref:System.Windows.Forms.ToolStrip.Renderer%2A> непосредственно для любого класса, наследуемого от класса <xref:System.Windows.Forms.ToolStripRenderer>.  При задании этого свойства автоматически устанавливается параметр <xref:System.Windows.Forms.ToolStrip.RenderMode%2A>.  
  
 Тот же стиль можно применить к нескольким элементам <xref:System.Windows.Forms.ToolStrip> в одном приложении, задав для <xref:System.Windows.Forms.ToolStrip.RenderMode%2A> значение <xref:System.Windows.Forms.ToolStripRenderMode> и для свойства <xref:System.Windows.Forms.ToolStripManager.RenderMode%2A> или <xref:System.Windows.Forms.ToolStripManager.Renderer%2A> необходимое значение <xref:System.Windows.Forms.ToolStripManagerRenderMode> или <xref:System.Windows.Forms.ToolStripRenderer> соответственно.  
  
 Примеры отрисовки см. в разделе [Практическое руководство. Создание и определение пользовательского средства визуализации для элемента управления ToolStrip в Windows Forms](../../../../docs/framework/winforms/controls/create-and-set-a-custom-renderer-for-the-toolstrip-control-in-wf.md).  
