---
title: "элемент управления DataGridView (Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "DataGridView - элемент управления [Windows Forms]"
  - "наборы данных [Windows Forms], отображение данных в элементе управления DataGridView"
  - "наборы данных [Windows Forms], пользовательский интерфейс"
  - "элементы управления [Windows Forms]"
  - "таблицы [Windows Forms]"
  - "табличные данные, отображение в формах Windows Forms"
...
## В этом подразделе  
 ...
 См. также [Использование конструктора с элементом управления DataGridView Windows Forms](http://msdn.microsoft.com/library/ms171593\(v=vs.110\)).  
