...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает, как получить допустимый экземпляр <xref:System.Windows.Forms.HtmlDocument> из приложения Windows Forms или <xref:System.Windows.Forms.UserControl> размещенного в Internet Explorer.  
 ...
 Описывает способы получения исходного, неизмененного HTML-код и получить «live» источника, которая отражает текущее состояние модели DOM.  
 ...
 Описание способов управления стилями, которые используются для управления визуальным представлением элементов.  
 ...
 Описание фреймы и наборы фреймов и как получить доступ к модели DOM рамки.  
 ...
 Описывает, как получить доступ к членам базовой модели DOM, у которых нет управляемый эквивалент.  
...
## <a name="see-also"></a>См. также  
 [Об объектной модели DHTML](http://msdn.microsoft.com/library/default.asp?url=/workshop/author/om/doc_object.asp)
