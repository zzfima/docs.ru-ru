...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описание способа отключения определенных столбцов в элементе управления.  
 ...
 Описание способов предотвратить появление в элементе управления заголовков столбцов.  
 ...
 Описывает, как разрешить пользователям для изменения порядка столбцов в элементе управления.  
 ...
 Описывает способ избежать прокрутки один или несколько смежных столбцов.  
 ...
 Описывает способ запретить пользователям изменять определенные столбцы в элементе управления.  
 ...
 В этой статье описывается удаление строки для новых записей в нижней части элемента управления, чтобы запретить пользователям добавлять строки. Также описывает способ запретить пользователям удалять строки.  
 ...
 Описание способов доступа к ячейке, которая в данный момент имеет фокус в элементе управления.  
 ...
 В этой статье описывается создание столбца с изображением, в каждой ячейке отображается значок.  
