...
---
# <a name="how-to-access-objects-in-a-windows-forms-datagridviewcomboboxcell-drop-down-list"></a>Как выполнить Доступ к объектам в Windows Forms элемента управления DataGridViewComboBoxCell с раскрывающимся списком
