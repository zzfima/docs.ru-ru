...
---
# <a name="how-to-add-tables-and-columns-to-the-windows-forms-datagrid-control"></a>Как выполнить Добавление таблиц и столбцов элемента управления DataGrid в Windows Forms
> [!NOTE]
