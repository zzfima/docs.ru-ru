...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывается задание свойств страницы с помощью экземпляра <xref:System.Windows.Forms.PageSetupDialog> компонента во время выполнения.  
