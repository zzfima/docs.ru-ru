...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Объясняет, что <xref:System.Windows.Forms.PictureBox.SizeMode%2A> свойство выполняет и как его задать.  
 ...
 Описание способа отображения и очистки рисунка во время выполнения.  
 ...
 Описывает, как загружать и отображать рисунок на форме во время разработки.  
