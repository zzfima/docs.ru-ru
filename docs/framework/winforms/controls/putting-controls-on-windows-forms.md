...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Указания по размещению элементов управления в форму.  
  
 [Практическое руководство. Добавление элементов управления, для которых не существует пользовательского интерфейса, в формы Windows Forms](../../../../docs/framework/winforms/controls/how-to-add-controls-without-a-user-interface-to-windows-forms.md)  
 Указания по добавлению элементов управления без пользовательского интерфейса для приложения.  
  
 [Практическое руководство. Добавление или удаление элемента в коллекции элементов управления во время выполнения](../../../../docs/framework/winforms/controls/how-to-add-to-or-remove-from-a-collection-of-controls-at-run-time.md)  
 ...
 Показано, как сделать пользовательский компонент автоматически отображаются в **элементов** после создания компонента.  
 ...
 [Вопросы размещения элемента управления ActiveX в форме Windows Forms](../../../../docs/framework/winforms/controls/considerations-when-hosting-an-activex-control-on-a-windows-form.md)  
 Описывает действия, которые следует учитывать при планировании приложения, использующего элементы управления ActiveX.  
  
## <a name="related-sections"></a>Связанные разделы  
 [Элементы управления Windows Forms](../../../../docs/framework/winforms/controls/index.md)  
 Ссылки на вводные разделы в элементах управления и работе с ними.  
