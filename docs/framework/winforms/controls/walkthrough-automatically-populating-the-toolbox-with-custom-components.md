...
> [!NOTE]
> **Элементов** не отслеживает цепочки ссылок, поэтому оно не будет отображаться элементы, которые не были собраны проекта в решении.
...
1. В Visual Studio создайте проект приложения на основе Windows с именем `ToolboxExample` (**файл** > **New** > **проекта**  >  **Visual C#**  или **Visual Basic** > **классический рабочий стол** > **Windows Forms Приложение**).
...
## <a name="create-an-instance-of-a-custom-component"></a>Создание экземпляра пользовательского компонента
...
## <a name="unload-and-reload-a-custom-component"></a>Выгрузите и перезагрузите пользовательского компонента
