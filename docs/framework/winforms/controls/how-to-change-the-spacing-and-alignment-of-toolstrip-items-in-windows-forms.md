...
---
# <a name="how-to-change-the-spacing-and-alignment-of-toolstrip-items-in-windows-forms"></a>Как выполнить Изменить интервал и выравнивание элемента управления ToolStrip в Windows Forms
