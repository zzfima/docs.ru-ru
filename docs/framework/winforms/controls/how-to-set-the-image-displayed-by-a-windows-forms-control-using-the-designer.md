...
1.  В **свойства** выберите **изображения** или **BackgroundImage** свойству элемента управления, затем нажмите кнопку с многоточием ()  
  
     ![Снимок экрана VisualStudioEllipsesButton](../../../../docs/framework/winforms/media/vbellipsesbutton.png "vbEllipsesButton")  
  
     ) для отображения **выберите ресурс** диалоговое окно.  
  
2.  Выберите изображение, которое нужно отобразить.  
