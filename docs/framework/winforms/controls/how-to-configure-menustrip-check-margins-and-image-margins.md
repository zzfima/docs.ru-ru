---
title: "Практическое руководство. Настройка полей флажков и значков для объекта MenuStrip | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "поля, установки в элементах управления MenuStrip"
  - "меню, установка полей"
  - "MenuStrip - элемент управления [Windows Forms], настройка полей флажков и значков"
