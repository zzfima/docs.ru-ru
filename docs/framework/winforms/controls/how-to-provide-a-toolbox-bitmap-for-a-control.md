...
Если требуется, чтобы на **панели элементов**отображался Специальный значок для элемента управления, можно указать конкретное изображение с помощью <xref:System.Drawing.ToolboxBitmapAttribute>. Он представляет собой *атрибут* — особый вид классов, который можно прикреплять к другим классам. Дополнительные сведения об атрибутах см. в разделе [Общие сведения о атрибутах (Visual Basic)](../../../visual-basic/programming-guide/concepts/attributes/index.md) для Visual Basic C#или [атрибутов (C#)](../../../csharp/programming-guide/concepts/attributes/index.md) для.  
