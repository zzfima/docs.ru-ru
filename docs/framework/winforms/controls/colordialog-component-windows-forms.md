...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Основные понятия <xref:System.Windows.Forms.ColorDialog> компонент, который позволяет отображать стандартным диалоговым окном, чтобы пользователи, можно использовать для выбора цветов из палитры.  
 ...
 Описание изменения цветов, доступных для пользователей, и других свойств.  
 ...
 Объясняется, как выбрать цвет во время выполнения с помощью экземпляра <xref:System.Windows.Forms.ColorDialog> компонента.  
