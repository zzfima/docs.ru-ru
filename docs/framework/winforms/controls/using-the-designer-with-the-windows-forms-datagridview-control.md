...
Visual Studio предоставляет поддержку конструктора для элемента управления `DataGridView`, который позволяет выполнять множество задач по настройке без написания кода. Эти задачи включают привязку элемента управления к источнику данных, изменение столбцов, используемых для отображения данных, а также настройку внешнего вида и основного поведения элемента управления.  
...
## <a name="in-this-section"></a>в этом разделе  
 ...
 Описывает использование диалоговых окон **Добавление столбцов** и **Изменение столбцов** для заполнения и изменения коллекции Columns.  
 ...
 Описывает, как использовать параметр **Выбор источника данных** в смарт-теге элемента управления для подключения к данным.  
 ...
 Описывает, как использовать диалоговое окно **Изменение столбцов** для изменения порядка столбцов.  
 ...
 Описывает использование диалогового окна **Изменение столбцов** для изменения типов столбцов.  
 ...
 Описывает, как использовать смарт-тег элемента управления, чтобы разрешить пользователям изменять порядок столбцов.  
 ...
 Описывает использование диалогового окна **Изменение столбцов** для предотвращения прокрутки отдельных столбцов.  
 ...
 Описывает использование диалогового окна **Изменение столбцов** для скрытия конкретных столбцов.  
 ...
 Описывает, как использовать диалоговое окно **Изменение столбцов** , чтобы запретить пользователям изменять значения в конкретных столбцах.  
 ...
 Описывает, как использовать смарт-тег элемента управления, чтобы запретить пользователям добавлять или удалять строки.  
 ...
 Описывает использование диалогового окна « **Построитель** полей» для создания внешнего вида, похожего на главную книгу, в элементе управления.  
 ...
 Описывает использование диалогового окна « **Построитель** полей» для настройки основного внешнего вида и форматов отображения данных для элемента управления.  
