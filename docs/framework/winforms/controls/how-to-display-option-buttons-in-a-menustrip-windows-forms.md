...
---
# <a name="how-to-display-option-buttons-in-a-menustrip-windows-forms"></a>Как выполнить Отображение переключателей в элементе управления MenuStrip (Windows Forms)
