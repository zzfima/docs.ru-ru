...
### <a name="to-align-multiple-controls-on-a-form"></a>Выравнивание нескольких элементов управления в форму  
  
1.  Откройте форму, содержащую элементы управления, можно разместить в **конструктор Windows Forms**.  
  
2.  Выберите элементы управления, которые требуется выровнять таким образом, первый выбранный элемент управления является основной элемент управления, к которому другие должны быть выровнены.  
