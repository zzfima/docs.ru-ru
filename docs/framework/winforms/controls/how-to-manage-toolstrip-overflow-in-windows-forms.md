...
---
# <a name="how-to-manage-toolstrip-overflow-in-windows-forms"></a>Как выполнить Управление переполнения элемента управления ToolStrip в Windows Forms
...
-   Задайте <xref:System.Windows.Forms.ToolStripItem.Overflow%2A> свойство <xref:System.Windows.Forms.ToolStripItem> нужное значение. Возможные значения — `Always`, `Never`, и `AsNeeded`. Defaultis `AsNeeded`.  
