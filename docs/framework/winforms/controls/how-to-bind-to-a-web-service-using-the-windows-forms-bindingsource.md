...
---
# <a name="how-to-bind-to-a-web-service-using-the-windows-forms-bindingsource"></a>Как выполнить Связывание веб-службой, с помощью компонента BindingSource в Windows Forms
