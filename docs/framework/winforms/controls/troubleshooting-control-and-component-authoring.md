...
---
# <a name="troubleshoot-control-and-component-authoring"></a>Устранение неполадок при создании элементов управления и компонентов
