...
---
# <a name="how-to-validate-input-with-the-windows-forms-datagrid-control"></a>Как выполнить Проверки входных данных с помощью элемента управления DataGrid в Windows Forms
> [!NOTE]
