...
---
# <a name="how-to-wrap-a-windows-forms-control-with-toolstripcontrolhost"></a>Как выполнить Заключение элемента управления Windows Forms с помощью ToolStripControlHost
