...
`DataGridView` Управления предоставляет несколько функций, позволяющих настраивать способ добавления или изменения данных в элементе управления. Например ввод данных можно сделать более эффективным, путем предоставления значения по умолчанию для новых строк и уведомления пользователей о времени этой ошибки.  
...
## <a name="in-this-section"></a>Содержание  
 ...
 Описывает, как изменить способ редактирования пользователями ячеек.  
 ...
 Описывает, как нужно заполнить строку для новых записей для экономии времени при вводе данных.  
 ...
 Описание строки для новых записей в сведениях о, включая информацию о его нужно скрыть, настроить его внешний вид, и его связь с <xref:System.Windows.Forms.DataGridView.Rows%2A> коллекции.  
 ...
 Описание процедуры проверки пользовательского ввода для предотвращения ошибок форматирования при вводе данных.  
 ...
 Описывает способы обработки ошибок ввода данных, создаваемых из источника данных, когда пользователь пытается зафиксировать новое значение.  
