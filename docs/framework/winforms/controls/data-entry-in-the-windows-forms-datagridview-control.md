...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает, как предварительно заполнить строку для новых записей, чтобы сэкономить время ввода данных.  
 ...
 Подробное описание строки для новых записей, включая сведения о ее скрытии, о настройке внешнего вида и о том, как она связана с коллекцией <xref:System.Windows.Forms.DataGridView.Rows%2A>.  
 ...
 Описывает, как проверить введенные пользователем данные для предотвращения ошибок форматирования при вводе данных.  
...
## <a name="reference"></a>Справочные сведения  
 ...
 Содержит справочную документацию по свойству <xref:System.Windows.Forms.DataGridView.EditMode%2A>.  
  
 <xref:System.Windows.Forms.DataGridView.DefaultValuesNeeded?displayProperty=nameWithType>  
 Содержит справочную документацию по событию <xref:System.Windows.Forms.DataGridView.DefaultValuesNeeded>.  
  
 <xref:System.Windows.Forms.DataGridView.DataError?displayProperty=nameWithType>  
 Содержит справочную документацию по событию <xref:System.Windows.Forms.DataGridView.DataError>.  
