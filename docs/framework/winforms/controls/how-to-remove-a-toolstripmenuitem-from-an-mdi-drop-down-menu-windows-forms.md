...
---
# <a name="how-to-remove-a-toolstripmenuitem-from-an-mdi-drop-down-menu-windows-forms"></a>Как выполнить Удаление элемента ToolStripMenuItem из раскрывающегося меню MDI (Windows Forms)
