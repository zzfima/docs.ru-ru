...
1. В окне **Свойства** Щелкните заблокированное свойство и выберите `true`. (Двойной щелчок по имени переключает параметр свойства.)
...
1. В меню **Формат** выберите пункт **Блокировать элементы управления**.
...
1. В окне **Свойства** Щелкните заблокированное свойство и выберите `false`. (Двойной щелчок по имени переключает параметр свойства.)
