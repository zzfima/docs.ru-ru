...
Элемент управления могут быть скопированы на той же формы в другую форму в проекте или в буфер обмена для использования в других решениях.  
  
### <a name="to-copy-a-control"></a>Чтобы скопировать элемент управления  
  
1.  Выберите элемент управления и из **изменить** меню щелкните **копирования**.  
  
 Теперь этот элемент управления можно вставить в любую форму, принимающую этот тип элемента управления. Кроме того элемент управления добавлен в буфер обмена.  
