...
## <a name="frames-and-security"></a>Фреймы и безопасность  
 ...
 Дополнительные сведения о межузловых сценариев, см. в разделе [о Межкадровые скрипты и вопросы безопасности](https://msdn.microsoft.com/library/ms533028.aspx).  
  
## <a name="see-also"></a>См. также
- [Элемент FRAME &#124; объект frame](https://msdn.microsoft.com/library/ms535250.aspx)
