...
---
# <a name="how-to-determine-which-modifier-key-was-pressed"></a>Как выполнить Определение нажатой управляющей клавиши
...
- [Практическое руководство. Определить, что если CapsLock включен в Visual Basic](https://msdn.microsoft.com/library/91e60f5c-dd61-4222-ba5f-39af803afd8c)
