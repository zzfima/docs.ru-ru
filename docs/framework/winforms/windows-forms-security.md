...
## <a name="related-sections"></a>Связанные разделы  
 [NIB: Политика безопасности по умолчанию](http://msdn.microsoft.com/en-us/2c086873-0894-4f4d-8f7e-47427c1a3b55)  
 Перечисляет разрешения по умолчанию в наборах разрешений полного доверия, локальной интрасети и Интернета.  
  
 [NIB: Общее администрирование политики безопасности](http://msdn.microsoft.com/en-us/5121fe35-f0e3-402c-94ab-4f35b0a87b4b)  
 ...
 [NIB: Запрос прав доступа](http://msdn.microsoft.com/en-us/0447c49d-8cba-45e4-862c-ff0b59bebdc2)  
 ...
 [NIB: Определение необходимости изменения политики безопасности](http://msdn.microsoft.com/en-us/af749b17-e461-409d-84b9-a3d44789db16)  
 Объясняется, как определить, когда приложения, для которых нужно из политики безопасности по умолчанию.  
  
 [NIB: Развертывание политики безопасности](http://msdn.microsoft.com/en-us/f936c1e5-033b-4bd9-a3bd-a39ba733a681)  
