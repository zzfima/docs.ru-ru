...
## <a name="see-also"></a>См. также  
 ...
 [Как: создание службы программным способом](../../../docs/framework/windows-services/how-to-write-services-programmatically.md)  
 ...
 [Как: журнал информации о службах](../../../docs/framework/windows-services/how-to-log-information-about-services.md)  
