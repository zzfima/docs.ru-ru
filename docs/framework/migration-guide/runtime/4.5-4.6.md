...
ms.locfileid: "59768947"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="09af7-102">Изменение среды выполнения для миграции с .NET Framework 4.5 на 4.6</span><span class="sxs-lookup"><span data-stu-id="09af7-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="09af7-103">Если выполняется миграция с .NET Framework версии 4.5 на 4.6, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="09af7-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="09af7-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="09af7-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="09af7-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="09af7-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="09af7-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="09af7-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="09af7-107">Данные</span><span class="sxs-lookup"><span data-stu-id="09af7-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="09af7-108">Отладчик</span><span class="sxs-lookup"><span data-stu-id="09af7-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="09af7-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="09af7-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="09af7-110">Сетевое взаимодействие</span><span class="sxs-lookup"><span data-stu-id="09af7-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="09af7-111">Сериализация</span><span class="sxs-lookup"><span data-stu-id="09af7-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="09af7-112">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="09af7-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="09af7-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="09af7-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="09af7-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="09af7-114">Windows Presentation Foundation (WPF)</span></span>
