...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-472"></a><span data-ttu-id="b9897-102">Изменение среды выполнения для миграции с .NET Framework 4.5 на 4.7.2</span><span class="sxs-lookup"><span data-stu-id="b9897-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b9897-103">Если выполняется миграция с .NET Framework версии 4.5 на 4.7.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="b9897-103">If you are migrating from the .NET Framework 4.5 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b9897-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b9897-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b9897-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b9897-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b9897-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="b9897-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b9897-107">Данные</span><span class="sxs-lookup"><span data-stu-id="b9897-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b9897-108">Отладчик</span><span class="sxs-lookup"><span data-stu-id="b9897-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b9897-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b9897-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b9897-110">Глобализация</span><span class="sxs-lookup"><span data-stu-id="b9897-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="b9897-111">Сетевое взаимодействие</span><span class="sxs-lookup"><span data-stu-id="b9897-111">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="b9897-112">Среда выполнения</span><span class="sxs-lookup"><span data-stu-id="b9897-112">Runtime</span></span>

[!include[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="b9897-113">Безопасность</span><span class="sxs-lookup"><span data-stu-id="b9897-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b9897-114">Сериализация</span><span class="sxs-lookup"><span data-stu-id="b9897-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b9897-115">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="b9897-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b9897-116">Инструменты</span><span class="sxs-lookup"><span data-stu-id="b9897-116">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-application"></a><span data-ttu-id="b9897-117">Веб-приложение</span><span class="sxs-lookup"><span data-stu-id="b9897-117">Web Application</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b9897-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b9897-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b9897-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b9897-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b9897-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b9897-120">Windows Workflow Foundation (WF)</span></span>
