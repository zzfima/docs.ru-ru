...
ms.locfileid: "67857605"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="26c9c-102">Изменение среды выполнения для миграции с .NET Framework 4.6.1 на 4.7</span><span class="sxs-lookup"><span data-stu-id="26c9c-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="26c9c-103">Если выполняется миграция с .NET Framework версии 4.6.1 на 4.7, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="26c9c-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="26c9c-104">Данные</span><span class="sxs-lookup"><span data-stu-id="26c9c-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="26c9c-105">Глобализация</span><span class="sxs-lookup"><span data-stu-id="26c9c-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="26c9c-106">JIT</span><span class="sxs-lookup"><span data-stu-id="26c9c-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="26c9c-107">Безопасность</span><span class="sxs-lookup"><span data-stu-id="26c9c-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="26c9c-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="26c9c-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="26c9c-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="26c9c-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="26c9c-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="26c9c-110">Windows Workflow Foundation (WF)</span></span>
