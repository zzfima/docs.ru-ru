---
title: "Изменения среды выполнения для миграции из .NET Framework 4.6.1 для 4.7"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="5c8b6-102">Изменения среды выполнения для миграции из .NET Framework 4.6.1 для 4.7</span><span class="sxs-lookup"><span data-stu-id="5c8b6-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="5c8b6-103">Если выполняется миграция из .NET Framework 4.6.1 для 4.7, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения.</span><span class="sxs-lookup"><span data-stu-id="5c8b6-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="5c8b6-104">Ядро</span><span class="sxs-lookup"><span data-stu-id="5c8b6-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="5c8b6-105">Данные</span><span class="sxs-lookup"><span data-stu-id="5c8b6-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="5c8b6-106">Глобализация</span><span class="sxs-lookup"><span data-stu-id="5c8b6-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="5c8b6-107">JIT</span><span class="sxs-lookup"><span data-stu-id="5c8b6-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="5c8b6-108">Безопасность</span><span class="sxs-lookup"><span data-stu-id="5c8b6-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5c8b6-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="5c8b6-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5c8b6-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="5c8b6-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="5c8b6-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="5c8b6-111">Windows Workflow Foundation (WF)</span></span>
