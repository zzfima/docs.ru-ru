...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="663e1-102">Изменения среды выполнения для миграции из .NET Framework 4.5 для 4.5.1</span><span class="sxs-lookup"><span data-stu-id="663e1-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="663e1-103">Если выполняется миграция из .NET Framework 4.5 4.5.1, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения.</span><span class="sxs-lookup"><span data-stu-id="663e1-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="663e1-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="663e1-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="663e1-105">Ядро</span><span class="sxs-lookup"><span data-stu-id="663e1-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="663e1-106">Сериализация</span><span class="sxs-lookup"><span data-stu-id="663e1-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="663e1-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="663e1-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="663e1-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="663e1-108">Windows Presentation Foundation (WPF)</span></span>
