...
ms.locfileid: "33396783"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-461"></a>Изменение среды выполнения для миграции с .NET Framework 4.0 на 4.6.1
