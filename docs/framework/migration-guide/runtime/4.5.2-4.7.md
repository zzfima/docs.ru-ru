...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a><span data-ttu-id="a4527-102">Изменение среды выполнения для миграции с .NET Framework 4.5.2 на 4.7</span><span class="sxs-lookup"><span data-stu-id="a4527-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a4527-103">Если выполняется миграция с .NET Framework версии 4.5.2 на 4.7, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="a4527-103">If you are migrating from the .NET Framework 4.5.2 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a4527-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a4527-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a4527-105">Ядро</span><span class="sxs-lookup"><span data-stu-id="a4527-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a4527-106">Data</span><span class="sxs-lookup"><span data-stu-id="a4527-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a4527-107">Отладчик</span><span class="sxs-lookup"><span data-stu-id="a4527-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a4527-108">Глобализация</span><span class="sxs-lookup"><span data-stu-id="a4527-108">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="a4527-109">JIT</span><span class="sxs-lookup"><span data-stu-id="a4527-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="a4527-110">Сети</span><span class="sxs-lookup"><span data-stu-id="a4527-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="a4527-111">Безопасность</span><span class="sxs-lookup"><span data-stu-id="a4527-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a4527-112">Сериализация</span><span class="sxs-lookup"><span data-stu-id="a4527-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a4527-113">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="a4527-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a4527-114">Инструменты</span><span class="sxs-lookup"><span data-stu-id="a4527-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a4527-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a4527-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a4527-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a4527-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a4527-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a4527-117">Windows Workflow Foundation (WF)</span></span>
