...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a>Изменения среды выполнения для миграции из .NET Framework 4.5.2 для 4.7

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Если выполняется миграция из .NET Framework 4.5.2 для 4.7, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения.
