...
ms.locfileid: "33392786"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a>Изменение среды выполнения для миграции с .NET Framework 4.0 на 4.5.2
