...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="c358b-102">Изменение среды выполнения для миграции с .NET Framework 4.5.1 на 4.6</span><span class="sxs-lookup"><span data-stu-id="c358b-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c358b-103">Если выполняется миграция с .NET Framework версии 4.5.1 на 4.6, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="c358b-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c358b-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c358b-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c358b-105">Ядро</span><span class="sxs-lookup"><span data-stu-id="c358b-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c358b-106">Данные</span><span class="sxs-lookup"><span data-stu-id="c358b-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c358b-107">Отладчик</span><span class="sxs-lookup"><span data-stu-id="c358b-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c358b-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c358b-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="c358b-109">Сетевое взаимодействие</span><span class="sxs-lookup"><span data-stu-id="c358b-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c358b-110">Сериализация</span><span class="sxs-lookup"><span data-stu-id="c358b-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c358b-111">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="c358b-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c358b-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c358b-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c358b-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c358b-113">Windows Presentation Foundation (WPF)</span></span>
