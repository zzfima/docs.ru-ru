...
ms.locfileid: "59770507"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a><span data-ttu-id="14a40-102">Изменение среды выполнения для миграции с .NET Framework 4.5.1 на 4.6.2</span><span class="sxs-lookup"><span data-stu-id="14a40-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="14a40-103">Если выполняется миграция с .NET Framework версии 4.5.1 на 4.6.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="14a40-103">If you are migrating from the .NET Framework 4.5.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="14a40-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="14a40-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="14a40-105">Ядро</span><span class="sxs-lookup"><span data-stu-id="14a40-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="14a40-106">Данные</span><span class="sxs-lookup"><span data-stu-id="14a40-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="14a40-107">Отладчик</span><span class="sxs-lookup"><span data-stu-id="14a40-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="14a40-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="14a40-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="14a40-109">Глобализация</span><span class="sxs-lookup"><span data-stu-id="14a40-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="14a40-110">Сетевое взаимодействие</span><span class="sxs-lookup"><span data-stu-id="14a40-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="14a40-111">Безопасность</span><span class="sxs-lookup"><span data-stu-id="14a40-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="14a40-112">Сериализация</span><span class="sxs-lookup"><span data-stu-id="14a40-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="14a40-113">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="14a40-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="14a40-114">Инструменты</span><span class="sxs-lookup"><span data-stu-id="14a40-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="14a40-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="14a40-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="14a40-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="14a40-116">Windows Presentation Foundation (WPF)</span></span>
