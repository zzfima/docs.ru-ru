...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="00ae0-102">Изменение среды выполнения для миграции с .NET Framework 4.6.1 на 4.6.2</span><span class="sxs-lookup"><span data-stu-id="00ae0-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="00ae0-103">Если выполняется миграция с .NET Framework версии 4.6.1 на 4.6.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="00ae0-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="00ae0-104">Data</span><span class="sxs-lookup"><span data-stu-id="00ae0-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="00ae0-105">Глобализация</span><span class="sxs-lookup"><span data-stu-id="00ae0-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="00ae0-106">Безопасность</span><span class="sxs-lookup"><span data-stu-id="00ae0-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="00ae0-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="00ae0-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="00ae0-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="00ae0-108">Windows Presentation Foundation (WPF)</span></span>
