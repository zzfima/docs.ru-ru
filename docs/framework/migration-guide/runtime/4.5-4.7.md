...
ms.locfileid: "58462881"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="bd695-102">Изменение среды выполнения для миграции с .NET Framework 4.5 на 4.7</span><span class="sxs-lookup"><span data-stu-id="bd695-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="bd695-103">Если выполняется миграция с .NET Framework версии 4.5 на 4.7, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="bd695-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="bd695-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="bd695-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="bd695-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="bd695-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="bd695-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="bd695-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="bd695-107">Данные</span><span class="sxs-lookup"><span data-stu-id="bd695-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="bd695-108">Отладчик</span><span class="sxs-lookup"><span data-stu-id="bd695-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="bd695-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="bd695-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="bd695-110">Глобализация</span><span class="sxs-lookup"><span data-stu-id="bd695-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="bd695-111">JIT</span><span class="sxs-lookup"><span data-stu-id="bd695-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="bd695-112">Сетевое взаимодействие</span><span class="sxs-lookup"><span data-stu-id="bd695-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="bd695-113">Безопасность</span><span class="sxs-lookup"><span data-stu-id="bd695-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="bd695-114">Сериализация</span><span class="sxs-lookup"><span data-stu-id="bd695-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="bd695-115">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="bd695-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="bd695-116">Инструменты</span><span class="sxs-lookup"><span data-stu-id="bd695-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="bd695-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="bd695-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="bd695-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="bd695-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="bd695-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="bd695-119">Windows Workflow Foundation (WF)</span></span>
