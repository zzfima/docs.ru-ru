...
ms.locfileid: "33391746"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a>Изменение среды выполнения для миграции с .NET Framework 4.5 на 4.6.1
