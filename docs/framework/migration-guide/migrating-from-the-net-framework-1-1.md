...
- В документе с описанием [изменений в .NET Framework 3.5 с пакетом обновления 1 (SP1)](https://go.microsoft.com/fwlink/?LinkID=186989) перечислены различия между .NET Framework 3.5 и [!INCLUDE[net_v35SP1_short](../../../includes/net-v35sp1-short-md.md)].
