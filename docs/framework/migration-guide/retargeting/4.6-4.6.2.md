...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-462"></a>Изменение целевой платформы для миграции из .NET Framework 4.6 для 4.6.2

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Если выполняется миграция из .NET Framework 4.6 для 4.6.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения.
