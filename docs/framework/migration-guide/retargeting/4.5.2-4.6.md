...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a>Изменение целевой платформы для миграции из .NET Framework 4.5.2 для 4.6

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Если выполняется миграция из .NET Framework 4.5.2 для 4.6, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения.
