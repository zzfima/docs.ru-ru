...
Начиная с приложений, предназначенных для [!INCLUDE[net_v462](../../../includes/net-v462-md.md)], методы ввода-вывода файловой системы больше не будут автоматически вызывать исключение <xref:System.IO.PathTooLongException>, если длина пути или полного имени файла превышает 260 (или `MAX_PATH`) символов. Вместо этого поддерживаются длинные пути до 32 тыс. символов.  
  
## <a name="impact"></a>Последствия  
 Приложения, перекомпилированные для целевой платформы [!INCLUDE[net_v462](../../../includes/net-v462-md.md)], которые ранее автоматически вызывали исключение <xref:System.IO.PathTooLongException> из-за того, что длина пути превышала 260 символов, теперь будут вызывать <xref:System.IO.PathTooLongException> только при следующих условиях:  
  
-   длина пути превышает <xref:System.Int16.MaxValue?displayProperty=fullName> (32767) символов;  
  
-   операционная система возвращает `COR_E_PATHTOOLONG` или его эквивалент;  
  
 устаревшее поведение для приложений, предназначенных для [!INCLUDE[net_v461](../../../includes/net-v461-md.md)] и более ранних версий, состоит в том, что среда выполнения автоматически вызывает исключение <xref:System.IO.PathTooLongException> всякий раз, когда путь превышает 260 символов.  
