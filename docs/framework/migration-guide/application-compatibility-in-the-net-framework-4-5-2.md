---
title: "Совместимость приложений в .NET Framework 4.5.2 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Совместимость приложений в .NET Framework 4.5.2
В этом разделе приводятся ссылки на сведения о проблемах совместимости приложений .NET Framework версий 4.5.1 и 4.5.2.  Проблемы можно разделить на три категории.  
  
 [Изменения среды выполнения](../../../docs/framework/migration-guide/runtime-changes-in-the-net-framework-4-5-2.md)  
 Изменения в среде выполнения влияют на все приложения, выполняющиеся в среде .NET Framework 4.5.2 и использующие определенную функцию.  
  
 [Изменение целевой платформы](../../../docs/framework/migration-guide/retargeting-changes-in-the-net-framework-4-5-2.md)  
 Изменение целевой платформы влияет на приложения, которые перекомпилируются для использования в среде .NET Framework 4.5, 4.5.1 или 4.5.2.  В их число входят следующее.  
...
-   Изменения в среде выполнения.  Влияют только на приложения, которые предназначены специально для .NET Framework 4.5.2.  Приложения, которые предназначены для предыдущих версий .NET Framework, работают нормально.  
