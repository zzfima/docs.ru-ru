---
title: "Уменьшение. Протоколы TLS | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Уменьшение. Протоколы TLS
Начиная с версии .NET Framework 4.6, классы <xref:System.Net.ServicePointManager?displayProperty=fullName> и <xref:System.Net.Security.SslStream?displayProperty=fullName> могут использовать один из трех следующих протоколов: Tls1.0, Tls1.1 или Tls 1.2.  Протокол SSL 3.0 и шифрование RC4 не поддерживаются.  
