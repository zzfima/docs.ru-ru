...
Дополнительные сведения см. в разделе [Практическое руководство. Настройка в приложении поддержки .NET Framework 4 или 4.5](../migration-guide/how-to-configure-an-app-to-support-net-framework-4-or-4-5.md).
