...
## <a name="backward-compatibility-and-the-net-framework-45"></a>Обратная совместимость и .NET Framework 4.5  
 ...
 Если приложение или компонент не работает в .NET Framework 4.5 (и в доработанных выпусках [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 или 4.7.1) ожидаемым образом, воспользуйтесь следующими контрольными списками:  
