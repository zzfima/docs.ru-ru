---
title: "Совместимость приложений в .NET Framework 4.7 | Документация Майкрософт"
ms.custom: 
ms.date: 04/07/2017
...
---
# <a name="application-compatibility-in-the-net-framework-47"></a>Совместимость приложений в .NET Framework 4.7
Эта статья содержит ссылки на сведения о проблемах совместимости приложений .NET Framework версий 4.6.2 и 4.7. Проблемы можно разделить на две категории.  
  
 [Изменения среды выполнения](../../../docs/framework/migration-guide/runtime-changes-in-the-net-framework-4-7.md)  
 Изменения в среде выполнения влияют на все приложения, выполняющиеся в среде .NET Framework 4.7 и использующие определенную возможность.  
  
 [Изменение целевой платформы](../../../docs/framework/migration-guide/retargeting-changes-in-the-net-framework-4-7.md)  
 Изменение целевой платформы влияет на приложения, которые перекомпилируются для использования в среде .NET Framework 4.7. В их число входят следующее.  
...
-   Изменения в среде выполнения. Влияют только на приложения, которые предназначены специально для .NET Framework 4.7. Приложения, которые предназначены для предыдущих версий .NET Framework, работают нормально.  
  
В обоих статьях указана классификация отдельных элементов по ожидаемому влиянию, как показано ниже:  
