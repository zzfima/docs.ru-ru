---
title: "Средство анализа композиции (Mefx) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Средство анализа композиции [MEF]"
  - "MEF, средство анализа композиции"
  - "Mefx [MEF], средство анализа композиции"
...
---
# Средство анализа композиции (Mefx)
...
## Получение Mefx  
 Средство Mefx доступно на сайте Codeplex по следующей ссылке: [Extensibility Framework Managed](http://go.microsoft.com/fwlink/?LinkID=187078). Просто загрузите и распакуйте средство.  
...
## Составление списка доступных частей  
...
## Составление списка импортируемых и экспортируемых элементов  
