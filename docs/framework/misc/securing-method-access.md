...
-   Ограничить доступ к методу вызывающим объектам с определенными удостоверениями — по существу, какое-либо конкретное [свидетельства](http://msdn.microsoft.com/en-us/64ceb7c8-a0b4-46c4-97dc-6c22da0539da) (строгое имя, издатель, зона и т. д) выберите.  
