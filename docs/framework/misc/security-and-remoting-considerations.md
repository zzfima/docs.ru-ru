...
## <a name="protected-objects"></a>Защищенные объекты  
 ...
 Простейшей защитой в такой ситуации является требование наличия **FileIOPermission** из любого кода, пытающегося получить ссылку на объект с помощью общего элемента API.  
