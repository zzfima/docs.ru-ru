...
## <a name="walking-the-call-stack"></a>Обход стека вызова  
 ...
 ![Безопасность доступа к коду](media/slide-10a.gif "slide_10a")  
...
|[Прозрачный с точки зрения безопасности код, уровень 2](security-transparent-code-level-2.md)|Описывает модель прозрачности безопасности в рамочном 4 .NET.|  
...
|[Cryptographic Services](../../standard/security/cryptographic-services.md)|Описывается использование шифрования в приложениях.|
