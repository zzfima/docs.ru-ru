...
> [!IMPORTANT]
>  Политика безопасности была ключевым элементом в предыдущих версиях платформы .NET Framework. Начиная с версии [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)], политика безопасности считается устаревшей. Устранение политики безопасности выполняется независимо от прозрачности безопасности. Сведения о влиянии этого изменения см. в разделе [Code Access Security Policy Compatibility and Migration](../../../docs/framework/misc/code-access-security-policy-compatibility-and-migration.md).  
...
-   уровень 2 \(<xref:System.Security.SecurityRuleSet>\) — правила прозрачности [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)];  
  
-   уровень 1 \(<xref:System.Security.SecurityRuleSet>\) — правила прозрачности .NET Framework 2.0.  
