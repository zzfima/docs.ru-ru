...
### <a name="more-information-on-building-a-codedom-graph"></a>Дополнительные сведения о построении графа CodeDOM  
 ...
 Быстро найти элемент CodeDOM, представляющий определенный тип элемента кода, можно в разделе [Краткий справочник по CodeDOM](https://msdn.microsoft.com/library/c77b8bfd-0a32-4e36-b59a-4f687f32c524).
