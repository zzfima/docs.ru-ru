---
title: Как выполнить Определение универсального метода с порождаемым отражением
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54596867"
---
# <a name="how-to-define-a-generic-method-with-reflection-emit"></a>Как выполнить Определение универсального метода с порождаемым отражением
