---
title: "Практическое руководство. Определение универсального метода с порождаемым отражением | Документы Майкрософт"
ms.custom: 
ms.date: 03/30/2017
