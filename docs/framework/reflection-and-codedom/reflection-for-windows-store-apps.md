...
## См. также  
 ...
 [.NET для приложений магазина Windows — поддерживаемые API](http://go.microsoft.com/fwlink/?LinkID=225700)