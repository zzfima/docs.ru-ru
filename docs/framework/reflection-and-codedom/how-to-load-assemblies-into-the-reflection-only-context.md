...
3.  Определите, загружена ли сборка в контекст, предназначенный только для отражения, путем использования свойства сборки <xref:System.Reflection.Assembly.ReflectionOnly%2A>.  
