...
В этом разделе описываются интерфейсы, которые неуправляемые узлы могут использовать для интеграции общеязыковой среды выполнения (CLR) в свои приложения.  
 ...
 Интерфейсы размещения платформы .NET Framework версии 2.0 заменяют собой интерфейсов платформы .NET Framework версий 1.0 и 1.1. Существуют значительные различия между двумя наборами интерфейсов. Смешивание их могло вызвать неожиданное поведение и не рекомендуется.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описание размещения интерфейсов, доступных в .NET Framework версий 1.0 и 1.1.  
