...
В этом разделе описываются интерфейсы, которые неуправляемые узлов можно использовать для интеграции общеязыковой среды выполнения (CLR) в свои приложения.  
  
 Интерфейсы размещения платформы .NET Framework версии 2.0 заменяют интерфейсы платформы .NET Framework версий 1.0 и 1.1. Существуют значительные различия между двумя наборами интерфейсов. Смешивание их могут вызвать непредвиденное поведение и не рекомендуется.  
  
 Версии платформы .NET Framework 3.0 и 3.5 использовать интерфейсы размещения платформы .NET Framework версии 2.0 и не предоставляет дополнительные функции размещения.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описание интерфейсов размещения, доступных в .NET Framework версий 1.0 и 1.1.  
