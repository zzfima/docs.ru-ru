...
|[Метод Wait](../../../../docs/framework/unmanaged-api/hosting/ihostautoevent-wait-method.md)|Вызывает текущий `IHostAutoEvent` экземпляр ожидать признания события или определенного времени.|  
