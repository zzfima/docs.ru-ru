...
Указывает, была ли запущена среда выполнения (т. е. был ли вызван [метод ICLRRuntimeHost:: Start](../../../../docs/framework/unmanaged-api/hosting/iclrruntimehost-start-method.md) и он был успешно выполнен).  
...
## <a name="parameters"></a>Параметры  
 `pbStarted`  
 [out] `true`, если эта среда выполнения запущена; в противном случае `false`.  
