...
#### <a name="parameters"></a>Параметры  
 `lcid`  
 [in] Значение идентификатора языкового стандарта, сопоставленное с только что назначенного региональные параметры и язык интерфейса пользователя.  
...
## <a name="remarks"></a>Примечания  
 `SetUILocale`дает возможность для узла выполнить какие-либо у него механизмы для синхронизации языковых стандартов.  
