...
|ЗНАЧЕНИЕ HOST_E_CLRNOTAVAILABLE|Среда CLR не было загружено в процесс или находится в состоянии, в котором не может выполнять управляемый код или успешно обработать вызов.|  
