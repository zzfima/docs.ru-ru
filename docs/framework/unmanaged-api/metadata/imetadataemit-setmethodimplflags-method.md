...
## <a name="parameters"></a>Параметры  
 ...
 `dwImplFlags`  
 окне Сочетание значений перечисления [кормесодимпл](../../../../docs/framework/unmanaged-api/metadata/cormethodimpl-enumeration.md) , определяющих функции реализации метода.  
