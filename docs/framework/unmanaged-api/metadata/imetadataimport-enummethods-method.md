...
#### <a name="parameters"></a>Параметры  
 ...
 `cl`  
 [in] Токен TypeDef, представляющий тип с методами для перечисления.  
  
 `rMethods`  
 [out] Массив для хранения токенов MethodDef.  
  
 `cMax`  
 [in] Максимальный размер MethodDef `rMethods` массива.  
