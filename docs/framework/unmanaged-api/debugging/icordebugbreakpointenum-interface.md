...
|Метод|Описание|  
|------------|-----------------|  
|[Метод Next](icordebugbreakpointenum-next-method.md)|Возвращает указанное число экземпляров `ICorDebugBreakpoint` из перечисления, начиная с текущей позиции.|  
