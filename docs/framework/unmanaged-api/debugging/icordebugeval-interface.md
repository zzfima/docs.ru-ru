...
|Метод|Описание|  
|------------|-----------------|  
|[Abort-метод](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-abort-method.md)|Прерывает вычисление это `ICorDebugEval` объекта в данный момент производит.|  
...
|[IsActive-метод](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-isactive-method.md)|Возвращает значение, указывающее, является ли это `ICorDebugEval` объекта в данный момент.|  
|[NewArray-метод](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-newarray-method.md)|Выделяет новый массив с заданным типом элементов и измерений. (Устарело в .NET Framework 2.0; используйте [ICorDebugEval2::NewParameterizedArray](../../../../docs/framework/unmanaged-api/debugging/icordebugeval2-newparameterizedarray-method.md) вместо.)|  
|[NewObject-метод](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-newobject-method.md)|Выделяет новый экземпляр объекта и вызывает заданный метод конструктора. (Устарело в .NET Framework 2.0; используйте [ICorDebugEval2::NewParameterizedObject](../../../../docs/framework/unmanaged-api/debugging/icordebugeval2-newparameterizedobject-method.md) вместо.)|  
