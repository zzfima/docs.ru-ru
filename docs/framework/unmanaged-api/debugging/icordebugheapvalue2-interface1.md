...
|Метод|Описание|  
|------------|-----------------|  
|[Метод CreateHandle](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue2-createhandle-method.md)|Создает дескриптор указанного типа для данного `ICorDebugHeapValue2` объекта.|  
