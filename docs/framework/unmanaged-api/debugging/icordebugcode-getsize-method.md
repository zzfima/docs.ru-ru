...
Возвращает размер в байтах двоичного кода, представленного «ICorDebugCode».  
...
#### <a name="parameters"></a>Параметры  
 `pcBytes`  
 [out] Указатель на размер в байтах двоичного кода, который `ICorDebugCode` представляет.  
