...
Содержит значения, указывающие версию среды common language runtime (CLR): рабочего стола и CoreCLR, который используется в Silverlight.  
...
|`COR_PRF_CORE_CLR`|Версия core CLR, используемых в Silverlight.|  
