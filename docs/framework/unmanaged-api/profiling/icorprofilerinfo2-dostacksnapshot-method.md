...
- Не блокируйте данные на период обращения вашего профилировщика к функции CLR, способной запустить сбор мусора. Это значит, что блокировка не удерживается, если владеющий поток может выполнить вызов, который активирует сборку мусора.  
