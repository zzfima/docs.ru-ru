...
## <a name="remarks"></a>Заметки  
 ...
 Обратный вызов `RuntimeSuspendFinished` будет гарантированно выполняться в том же потоке, что и обратный вызов [ICorProfilerCallback:: рунтимесуспендстартед](icorprofilercallback-runtimesuspendstarted-method.md) .  
