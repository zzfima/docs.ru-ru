# [Хранилище символов диагностики](index.md)
...
#### [Метод Destroy](isymunmanageddispose-destroy-method.md)
...
#### [Метод GetOffset](isymunmanagedmethod-getoffset-method.md)
...
#### [Метод GetNamespaces](isymunmanagednamespace-getnamespaces-method.md)
...
#### [Метод GetNamespaces](isymunmanagedreader-getnamespaces-method.md)
...
#### [Метод GetNamespaces](isymunmanagedscope-getnamespaces-method.md)
...
#### [Метод Abort](isymunmanagedwriter-abort-method.md)
#### [Метод Close](isymunmanagedwriter-close-method.md)
