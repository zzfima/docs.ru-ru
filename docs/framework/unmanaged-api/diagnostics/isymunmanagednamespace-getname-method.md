...
## <a name="parameters"></a>Параметры  
 ...
 `pcchName`  
 заполняет Указатель на `ULONG32`, который получает размер (в символах) буфера, необходимого для хранения имени пространства имен, включая завершение значения NULL.  
