...
|serializationFormat|Задает модуль форматирования, используемый для сериализации объектов, отправляемых как часть сообщения MSMQ. Допустимы следующие значения:<br /><br /> ActiveX Модуль форматирования ActiveX используется при сериализации COM-объектов.<br />Двоичный  Сериализует объект в двоичный пакет.<br />-Битеаррай:  Сериализует объект в массив байтов.<br />Вышестоящий  Выполняет сериализацию объекта в поток.<br />Код  Сериализует объект в XML-пакет. Значение по умолчанию - XML.<br /><br /> Это атрибут типа <xref:System.ServiceModel.MsmqIntegration.MsmqMessageSerializationFormat>.|  
