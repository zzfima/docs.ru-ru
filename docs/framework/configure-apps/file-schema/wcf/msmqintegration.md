...
|serializationFormat|Задает модуль форматирования, используемый для сериализации объектов, отправляемых как часть сообщения MSMQ.  Допустимы следующие значения:<br /><br /> -   ActiveX: модуль форматирования ActiveX используется при сериализации объектов COM.<br />-   Binary: сериализует объект в двоичный пакет.<br />-   ByteArray: сериализует объект в массив байтов.<br />-   Stream: сериализует объект в поток.<br />-   Xml: сериализует объект в пакет XML.  Значение по умолчанию \- XML.<br /><br /> Это атрибут типа <xref:System.ServiceModel.MsmqIntegration.MsmqMessageSerializationFormat>.|  
