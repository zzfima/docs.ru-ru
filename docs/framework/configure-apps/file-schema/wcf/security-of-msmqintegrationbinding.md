...
|Элемент|Описание|  
|-------------|-----------------|  
|[> привязки \<](bindings.md)|Элемент Binding [\<> MsmqIntegrationBinding](msmqintegrationbinding.md).|  
