...
## <a name="attributes-and-elements"></a><span data-ttu-id="f6c21-106">Атрибуты и элементы</span><span class="sxs-lookup"><span data-stu-id="f6c21-106">Attributes and Elements</span></span>  
