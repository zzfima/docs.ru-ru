...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<Дисковериклиентсеттингс >](discoveryclientsettings.md)|Содержит параметры, необходимые приложению для участия в процессе обнаружения служб в качестве клиента.|  
