...
---
# <a name="endpoint-of-client"></a>\<Конечная точка \<> клиента >
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<заголовки >](headers.md)|Коллекция заголовков адреса.|  
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<> клиента](client.md)|Раздел конфигурации, определяющий список конечных точек, к которым может подключаться клиент.|  
