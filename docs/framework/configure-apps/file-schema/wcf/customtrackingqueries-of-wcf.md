...
---
# <a name="customtrackingqueries-of-wcf"></a>\<Кустомтраккингкуериес > WCF
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<Кустомтраккингкуери >](customtrackingquery-of-wcf.md)|Запрос, который используется для отслеживания событий, определенных в действиях кода.|  
