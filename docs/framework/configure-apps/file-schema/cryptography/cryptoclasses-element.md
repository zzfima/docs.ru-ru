...
---
# <a name="cryptoclasses-element"></a>Элемент > @no__t 0cryptoClasses
...
|Элемент|Описание|  
|-------------|-----------------|  
|[@no__t 1cryptoClass >](cryptoclass-element.md)|Содержит криптографический класс, сопоставленный с понятным именем, указанным в элементе **\<nameEntry>** .|  
