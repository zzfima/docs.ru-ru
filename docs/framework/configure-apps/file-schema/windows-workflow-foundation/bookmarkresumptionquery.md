...
---
# <a name="bookmarkresumptionquery"></a>\<Букмаркресумптионкуери >
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ **\<Букмаркресумптионкуериес >** ](bookmarkresumptionqueries.md)\
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<Букмаркресумптионкуериес >](bookmarkresumptionqueries.md)|Представляет коллекцию запросов, используемых для отслеживания возобновления чтения с закладок в экземпляре рабочего процесса.|  
