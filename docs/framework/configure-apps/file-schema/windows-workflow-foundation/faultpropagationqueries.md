...
---
# <a name="faultpropagationqueries"></a>\<Фаултпропагатионкуериес >
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<Фаултпропагатионкуери >](faultpropagationquery.md)|Запрос, который используется для отслеживания обработки ошибок, возникающих в рамках действия.  Это событие возникает каждый раз, когда FaultHandler обрабатывает ошибку.|  
