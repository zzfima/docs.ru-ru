...
### <a name="attributes"></a><span data-ttu-id="ade51-111">Атрибуты</span><span class="sxs-lookup"><span data-stu-id="ade51-111">Attributes</span></span>  
