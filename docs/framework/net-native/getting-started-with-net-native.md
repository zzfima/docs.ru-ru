---
title: "Начало работы с машинным кодом .NET | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  [обработайте дополнительные использования отражения и сериализации](#Step4).  
  
3.  [Разверните и протестируйте выпускаемые сборки приложения](#Step5).  
  
4.  [Вручную разрешите отсутствующие метаданные](#Step6) и повторяйте [шаг 3](#Step5) до тех пор, пока все вопросы не будут разрешены.  
...
-   метод <xref:System.Reflection.MethodInfo.MakeGenericMethod%2A?displayProperty=fullName>;  
 ...
 Дополнительные сведения см. в разделе [API\-интерфейсы, основанные на отражении](../../../docs/framework/net-native/apis-that-rely-on-reflection.md).  
...
## Шаг 3. Развертывание и тестирование выпускаемых сборок приложения  
 ...
 Если приложение работает плохо \(особенно в случае создания исключений [MissingMetadataException](../../../docs/framework/net-native/missingmetadataexception-class-net-native.md) или [MissingInteropDataException](../../../docs/framework/net-native/missinginteropdataexception-class-net-native.md) во время выполнения\), следуйте инструкциям в следующем разделе, [Step 5: Устранение вручную проблем с отсутствующими метаданными](#Step6). Включение исключений первого шанса может помочь в обнаружении этих ошибок.  
...
> [!NOTE]
>  Дополнительные сведения об устранении проблем, возникающих из\-за различий в отражении и доступности метаданных в классических приложениях и [!INCLUDE[net_native](../../../includes/net-native-md.md)], см. в разделе [API\-интерфейсы, основанные на отражении](../../../docs/framework/net-native/apis-that-rely-on-reflection.md).  
...
## См. также  
 ...
 [NIB: установка и настройка машинного кода .NET](http://msdn.microsoft.com/ru-ru/7c9bc375-8b87-4c33-bede-72d513e362ec)   
