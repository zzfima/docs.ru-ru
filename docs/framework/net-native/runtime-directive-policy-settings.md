---
title: "Параметры политики директив среды выполнения | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   Типы политики отражения определяют, какие метаданные доступны во время выполнения для отражения:  
    ...
    |Элемент|Активировать|Обзор|Динамические|  
    |-------------|------------------|-----------|------------------|  
