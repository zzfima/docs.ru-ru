---
title: "Общие сведения о платформе .NET Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "разработка приложений [платформа .NET Framework]"
  - "CLR - среда"
  - "CLR - среда, сведения"
  - "CLR - среда, общие сведения"
...
> [!NOTE]
>  Общие сведения о платформе .NET Framework для пользователей и разработчиков см. в разделе [Начало работы](../../../docs/framework/get-started/index.md).  Чтобы скачать платформу .NET Framework, изучите раздел [Руководство по установке](../../../docs/framework/install/guide-for-developers.md).  
...
-   консольные приложения;  См. раздел [Построение консольных приложений](../../../docs/standard/building-console-apps.md).  
  
-   приложения с графическим интерфейсом пользователя Windows \(Windows Forms\);  См. раздел [Windows Forms](../../../docs/framework/winforms/index.md).  
  
-   приложения Windows Presentation Foundation \(WPF\);  См. раздел [Windows Presentation Foundation \(WPF\)](../../../docs/framework/wpf/index.md).  
  
-   приложения ASP.NET;  См. раздел [Веб\-приложения с ASP.NET](../../../docs/framework/develop-web-apps-with-aspnet.md).  
  
-   службы Windows;  См. раздел [Introduction to Windows Service Applications](../../../docs/framework/windows-services/introduction-to-windows-service-applications.md).  
  
-   сервисноориентированные приложения с помощью Windows Communication Foundation \(WCF\);  См. раздел [Сервисноориентированные приложения с WCF](../../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md).  
  
-   приложения поддерживающие бизнес\-процессы Windows Workflow Foundation \(WF\).  См. раздел [Building Workflows in the .NET Framework](http://msdn.microsoft.com/ru-ru/cbf3880f-dc7b-466d-b808-1109b1223f4a).  
...
## См. также  
 ...
 [Библиотеки классов .NET Framework](http://go.microsoft.com/fwlink/?LinkID=227195)