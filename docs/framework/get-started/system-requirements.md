...
- Платформа .NET Framework поддерживается в роли Server Core в Windows Server 2008 R2 с пакетом обновления 1 (SP1) или более поздней версии, но не поддерживается в Windows Server 2008 R2 для систем на платформе Itanium.
