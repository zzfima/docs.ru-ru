---
title: "Требования к системе для .NET Framework | Документы Майкрософт"
ms.custom: 
ms.date: 03/30/2017
...
|----------------------|------------------------|------------------------------|----------------------------|  
| Обновление Windows 10 Creators Update|32- и 64-разрядные версии|.NET Framework 4.7|| 
...
- Платформа .NET Framework 4.7 предустановлена в обновлении Windows 10 Creators Update. Она недоступна для установки в других операционных системах Windows.
...
|Операционная система|Поддерживаемые выпуски|Предустановлена с операционной системой|Может устанавливаться отдельно|  
|----------------------|------------------------|------------------------------|----------------------------|  
|Windows Server 2016|64-разрядная|[!INCLUDE[net_v462](../../../includes/net-v462-md.md)]||  
