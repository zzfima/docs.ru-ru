...
## <a name="whitespace-definition"></a>Определение пробела  
...
## <a name="whitespace-normalization"></a>Нормализация пробелов  
...
## <a name="whitespace-in-inner-text-and-string-primitives"></a>Пробел во внутреннем тексте и строковые примитивы  
...
## <a name="preserving-whitespace"></a>Сохранение пробелов  
...
## <a name="whitespace-and-text-content-models"></a>Пробелы и модели текстового содержимого  
...
### <a name="whitespace-and-text-content-models-in-wpf"></a>Пробелы и модели текстового содержимого в WPF  
