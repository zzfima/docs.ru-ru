...
### x:Boolean  
 ...
 XAML анализирует значения `x:Boolean` без учета регистра. Обратите внимание, что `x:Bool` не является допустимой альтернативой. Определение спецификации языка XAML см. в [разделах 5.2.17 и 5.4.4 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
  
### x:Char  
 Для резервирования CLR примитив `x:Char` соответствует <xref:System.Char>.  
  
 Строковые и символьные типы взаимодействуют со всей кодировкой файла на уровне XML. Определение спецификации языка XAML см. в [разделах 5.2.7 и 5.4.1 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
  
### x:String  
 Для резервирования CLR примитив `x:String` соответствует <xref:System.String>.  
  
 Строковые и символьные типы взаимодействуют со всей кодировкой файла на уровне XML. Определение спецификации языка XAML см. в [разделе 5.2.6 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Decimal  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.14 и 5.4.8 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Single  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.8 и 5.4.2 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Double  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.9 и 5.4.3 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Int16  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.11 и 5.4.5 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Int32  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.12 и 5.4.6 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Int64  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.13 и 5.4.7 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:TimeSpan  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.16 и 5.4.10 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Uri  
 ...
 Определение спецификации языка XAML см. в [разделах 5.2.15 и 5.4.9 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
  
### x:Byte  
 Для резервирования CLR примитив `x:Byte` соответствует <xref:System.Byte>.<xref:System.Byte> \/ `x:Byte` рассматривается как число без знака.  
  
 Определение спецификации языка XAML см. в [разделах 5.2.10 и 5.4.4 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
...
### x:Array  
 ...
 Определение спецификации языка XAML см. в [разделе 5.2.18 руководства \[MS\-XAML\]](http://go.microsoft.com/fwlink/?LinkId=114525).  
