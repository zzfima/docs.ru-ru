...
3. Определение строки соединения.  
     ...
     Entity Framework использует специально отформатированную строку соединения при выполнении запросов к концептуальной модели. В нее инкапсулированы сведения о файлах модели и сопоставления, а также о соединении с источником данных. Дополнительные сведения см. в разделе [Практическое руководство. Определите строку](how-to-define-the-connection-string.md)подключения.  
