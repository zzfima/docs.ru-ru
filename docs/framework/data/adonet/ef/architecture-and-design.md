...
## <a name="data-structures"></a>Структуры данных  
 В этом разделе рассматриваются типы, используемые в [образец поставщика](https://go.microsoft.com/fwlink/?LinkId=180616) , используемой для построения инструкции SQL.  
