...
---
# <a name="how-to-use-edmgenexe-to-generate-the-model-and-mapping-files"></a>Как выполнить Использование EdmGen.exe для создания файлов модели и сопоставления
