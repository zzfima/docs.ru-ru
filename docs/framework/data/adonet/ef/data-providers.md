...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] поставщик данных, поддерживающий [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] для использования с базой данных SQL Server.  
