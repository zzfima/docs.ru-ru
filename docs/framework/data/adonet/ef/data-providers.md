...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] поставщик данных, который поддерживает [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] для использования с базой данных SQL Server.  
  
## <a name="related-sections"></a>Связанные разделы  
 [Платформа Entity Framework (SQL Server Compact)](http://go.microsoft.com/fwlink/?LinkId=135638)  
 ...
 [Сторонние поставщики для Entity Framework](http://go.microsoft.com/fwlink/?LinkId=143699)  
