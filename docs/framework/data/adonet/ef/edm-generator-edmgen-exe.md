...
|`/pl[uralize]`|Применяет к концептуальной модели правила английского языка для форм единственного и множественного числа в именах `Entity`, `EntitySet` и `NavigationProperty`. Этот параметр выполняет следующие действия:<br /><br /> — Сделать все `EntityType` имена в единственном числе.<br />— Сделать все `EntitySet` имена во множественном числе.<br />-Для каждого `NavigationProperty` , возвращающего более одной сущности, единственному имя.<br />-Для каждого `NavigationProperty` , возвращающего более одной сущности, сделать имя во множественном числе.|
