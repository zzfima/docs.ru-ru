...
-   [Примеры синтаксиса выражений запросов. Статистические операторы](../../../../../../docs/framework/data/adonet/ef/language-reference/query-expression-syntax-examples-aggregate-operators.md)  
