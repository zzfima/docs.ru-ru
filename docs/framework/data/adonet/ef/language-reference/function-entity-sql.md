...
## <a name="remarks"></a>Примечания  
 ...
 Дополнительные сведения см. в разделе [Как Вызов определяемой пользователем функции](https://msdn.microsoft.com/library/ad131b86-8b4e-4747-8605-d4fc64fb9d02).  
