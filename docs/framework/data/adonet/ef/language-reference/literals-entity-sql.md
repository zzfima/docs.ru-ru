...
## <a name="datetime"></a>DateTime  
 ...
 Часть даты должна иметь следующий формат: `YYYY` @ no__t-1 @ no__t-2 @ no__t-3 @ no__t-4, где `YYYY` — это четырехзначное значение года между 0001 и 9999, `MM` — это месяц от 1 до 12, а `DD` — это значение дня, допустимое для данного месяца `MM`.  
...
## <a name="guid"></a>GUID  
 Литерал `GUID` представляет собой идентификатор GUID. Это последовательность, сформированная с помощью ключевого слова `GUID`, за которыми следуют шестнадцатеричные цифры в формате *реестра* : 8-4-4-4-12, заключенные в одинарные кавычки. Шестнадцатеричные цифры являются нечувствительными к регистру.  
