---
title: "Литералы (язык Entity SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Null  
 ...
 Типизированные значения null могут быть созданы путем применения операции приведения к типу по отношению к литералу NULL.  Для получения дополнительной информации см. [CAST](../../../../../../docs/framework/data/adonet/ef/language-reference/cast-entity-sql.md).  
  
 Правила, касающиеся того, где могут использоваться без ограничений литералы null в формате с плавающей запятой, см. в разделе [Литералы NULL и вывод типов](../../../../../../docs/framework/data/adonet/ef/language-reference/null-literals-and-type-inference-entity-sql.md).  
