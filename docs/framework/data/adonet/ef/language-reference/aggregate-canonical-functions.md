...
Тип `expression` `null` или `null` значение, если все входные значения являются значениями.
...
А `Double` `null` или `null` , если все входные значения являются значениями.
