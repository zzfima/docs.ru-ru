...
## <a name="performance-data"></a>Данные производительности  
 Некоторые данные о производительности для Entity Framework публикуются в следующих сообщениях в [блоге группы разработчиков ADO.NET](https://docs.microsoft.com/archive/blogs/adonet/):  
  
- [Изучение производительности ADO.NET Entity Framework. часть 1](https://docs.microsoft.com/archive/blogs/adonet/exploring-the-performance-of-the-ado-net-entity-framework-part-1)  
  
- [Изучение производительности ADO.NET Entity Framework – часть 2](https://docs.microsoft.com/archive/blogs/adonet/exploring-the-performance-of-the-ado-net-entity-framework-part-2)  
  
- [Сравнение производительности ADO.NET Entity Framework](https://docs.microsoft.com/archive/blogs/adonet/ado-net-entity-framework-performance-comparison)  
