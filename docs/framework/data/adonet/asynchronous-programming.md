...
### <a name="using-the-base-provider-model-and-the-new-asynchronous-feature"></a>Использование модели базового поставщика и новых асинхронных функциональных возможностей  
 ...
 Для использования распределенных транзакций необходимо включить на сервере MSDTC. Сведения о включении MSDTC см. в разделе [как включить MSDTC на веб-сервере](https://msdn.microsoft.com/library/dd327979.aspx).  
