...
### <a name="query-expression-syntax"></a>Синтаксис выражения запроса  
...
### <a name="method-based-query-syntax"></a>Синтаксис запросов, основанных на методе  
 Другой способ формулировки LINQ to DataSet запросов — использование запросов на основе методов. Синтаксис запросов на основе методов представляет собой последовательность прямых вызовов методов операторов LINQ, передавая лямбда-выражения в качестве параметров. Дополнительные сведения см. в разделе [Лямбда-выражения](../../../csharp/programming-guide/statements-expressions-operators/lambda-expressions.md).  
