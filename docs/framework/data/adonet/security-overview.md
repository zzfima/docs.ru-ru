...
|Resource|Описание|  
|--------------|-----------------|  
|Сайт [моделирования угроз](https://go.microsoft.com/fwlink/?LinkId=98353) в центре разработчиков безопасности MSDN|Ресурсы на этой странице помогут понять процесс моделирования угроз и построить модели угроз, которые можно использовать для защиты приложений.|  
