...
|[NIB: Рекомендации по обеспечению безопасности политики](https://msdn.microsoft.com/library/d49bc4d5-efb7-4caa-a2fe-e4d3cec63c05)|Предоставляет ссылки на описание реализации политики безопасности.|  
