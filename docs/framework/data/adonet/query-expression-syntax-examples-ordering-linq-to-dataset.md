---
title: "Примеры синтаксиса для выражений запросов: упорядочение (LINQ to DataSet) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Примеры синтаксиса для выражений запросов: упорядочение (LINQ to DataSet)
