...
## <a name="sql-server-decimal-type"></a>Тип decimal SQL Server  
 ...
 [!INCLUDE[vstecado](../../../../includes/vstecado-md.md)] 2.0 появилась расширенная поддержка <xref:System.Data.SqlTypes> в `DataSet`. Дополнительные сведения см. в разделе [SqlTypes and the DataSet](../../../../docs/framework/data/adonet/sql/sqltypes-and-the-dataset.md).  
