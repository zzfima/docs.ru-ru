...
-   Ограничение первичного ключа в родительской таблице, определяющее дополнительный столбец как первичный ключ (задавая **IsPrimaryKey** свойства **True**). Ограничению назначается имя Constraint*#* где *#* — 1, 2, 3 и т. д. Например, имя первого ограничения по умолчанию - Constraint1;  
