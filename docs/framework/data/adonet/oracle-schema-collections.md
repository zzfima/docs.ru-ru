...
|GENERATED|String|Является ли имя индекса — созданный системой (Y&#124;N).|  
|SECONDARY|String|Является ли индекс является вторичным объектом, созданным методом ODCIIndexCreate картриджа данных Oracle9i (Y&#124;N).|  
...
|SECONDARY|String|Является ли объект вторичным, созданным методом ODCIIndexCreate картриджа данных Oracle9i (Y &#124; N).|  
