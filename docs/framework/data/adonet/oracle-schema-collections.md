...
|GENERATED|Строка|Является ли имя индекса, сформированное системой (Y &#124; N).|  
|SECONDARY|Строка|Является ли индекс является вторичным объектом, созданным методом ODCIIndexCreate картриджа данных Oracle9i (Y &#124; N).|  
...
|SECONDARY|Строка|Является ли объект вторичным, созданным методом ODCIIndexCreate картриджа данных Oracle9i (Y &#124; N).|  
