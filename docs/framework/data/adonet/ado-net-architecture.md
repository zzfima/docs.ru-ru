...
## <a name="xml-and-adonet"></a>XML и ADO.NET  
 ADO.NET использует возможности XML для предоставления отключенный доступ к данным. ADO.NET был спроектированный руки идут рука об руку с классами XML в .NET Framework; они являются компонентами одной архитектуры.  
