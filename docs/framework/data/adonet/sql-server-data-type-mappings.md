...
|datetime2<br /><br /> (SQL Server 2008 и более поздние версии)|DateTime|<xref:System.Data.SqlDbType.DateTime2>|Отсутствуют|<xref:System.Data.DbType.DateTime2>|<xref:System.Data.SqlClient.SqlDataReader.GetDateTime%2A>|  
|datetimeoffset<br /><br /> (SQL Server 2008 и более поздние версии)|DateTimeOffset|<xref:System.Data.SqlDbType.DateTimeOffset>|none|<xref:System.Data.DbType.DateTimeOffset>|<xref:System.Data.SqlClient.SqlDataReader.GetDateTimeOffset%2A>|  
...
|числовой|Decimal|<xref:System.Data.SqlDbType.Decimal>|<xref:System.Data.SqlClient.SqlDataReader.GetSqlDecimal%2A>|<xref:System.Data.DbType.Decimal>|<xref:System.Data.SqlClient.SqlDataReader.GetDecimal%2A>|  
...
|time<br /><br /> (SQL Server 2008 и более поздние версии)|TimeSpan|<xref:System.Data.SqlDbType.Time>|none|<xref:System.Data.DbType.Time>|<xref:System.Data.SqlClient.SqlDataReader.GetDateTime%2A>|  
...
<sup>1</sup> нельзя задать `DbType` для `SqlParameter` свойствазначение`SqlDbType.Date`.  
<sup>2</sup> используйте конкретный типизированный метод доступа, если вы знакомы с базовым `sql_variant`типом.  
