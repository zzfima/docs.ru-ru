---
title: "Примеры синтаксиса запросов на основе методов: статистические операторы (LINQ to DataSet) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Примеры синтаксиса запросов на основе методов: статистические операторы (LINQ to DataSet)
