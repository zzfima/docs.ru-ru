...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Приводит ссылки на разделы, посвященные безопасности в Visual Studio и .NET Framework, а также шифрованию.  
  
 [Встроенный язык запросов LINQ](https://msdn.microsoft.com/library/a73c4aec-5d15-4e98-b962-1274021ea93d)  
 Приводит ссылки на разделы о LINQ и образцы применения.  
 ...
 [Основные технологии разработки](https://msdn.microsoft.com/library/csxbhtye.aspx)  
 Приводит ссылки на сведения о стандартных задачах разработки с применением платформы .NET Framework.  
  
 [Расширенные технологии разработки](https://msdn.microsoft.com/library/a493kdy6.aspx)  
 Приводятся ссылки на сведения о сложных задачах разработки и приемах их решения на платформе .NET Framework.  
