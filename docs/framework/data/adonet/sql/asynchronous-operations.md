...
## <a name="in-this-section"></a>Содержание  
 [Приложения Windows с помощью обратных вызовов](../../../../../docs/framework/data/adonet/sql/windows-applications-using-callbacks.md)  
 ...
 [Опросов в консольных приложениях](../../../../../docs/framework/data/adonet/sql/polling-in-console-applications.md)  
