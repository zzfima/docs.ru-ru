...
-   Используемый тип проверки подлинности (`MultiSubnetFailover`, Kerberos или Windows) не влияет на работу приложения, использующего свойство соединения [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)].  
