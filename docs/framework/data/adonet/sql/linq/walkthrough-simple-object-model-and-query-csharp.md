...
2. Нажмите клавишу F5, чтобы начать отладку приложения.
    ...
    > [!NOTE]
    >  Если приложение создает ошибку во время выполнения, см. пошаговые [руководства](../../../../../../docs/framework/data/adonet/sql/linq/learning-by-walkthroughs.md)в разделе Устранение неполадок.
