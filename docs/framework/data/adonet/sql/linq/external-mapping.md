...
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] поддерживает *внешнее сопоставление*— процесс, в котором для указания сопоставления между моделью данных и объектной моделью используется отдельный XML-файл. Файл внешнего сопоставления имеет следующие преимущества.  
...
## <a name="requirements"></a>Требования  
 Файл сопоставления должен быть XML-файлом, а файл должен быть проверен на соответствие файлу определения схемы [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] (. xsd).  
  
 Действуют следующие правила.  
  
- Файл сопоставления должен быть файлом XML.  
  
- Файл сопоставления XML должен быть проверен на соответствие файлу определения схемы XML. Дополнительные сведения см. в разделе [Практическое руководство. Проверьте DBML и внешние файлы сопоставления @ no__t-0.  
...
> [!NOTE]
> Пользователи Visual Studio также будут искать этот XSD-файл в диалоговом окне схемы XML в формате "Линктосклмаппинг. xsd". Чтобы правильно использовать этот файл для проверки внешнего файла сопоставления, см. раздел [How to: Проверьте DBML и внешние файлы сопоставления @ no__t-0.  
...
- [Ссылки](reference.md)
- [Практическое руководство. Создать объектную модель как внешний файл @ no__t-0
