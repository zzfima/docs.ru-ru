---
title: "Настройка операций вставки, обновления и удаления | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  Если вы используете [!INCLUDE[vs_current_short](../../../../../../includes/vs-current-short-md.md)], то операции вставки, обновления и удаления можно настроить с помощью [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)].  
...
## В этом подразделе  
 [Настройка операций. Общие сведения](../../../../../../docs/framework/data/adonet/sql/linq/customizing-operations-overview.md)  
 ...
 [Добавление бизнес\-логики с помощью разделяемых методов](../../../../../../docs/framework/data/adonet/sql/linq/adding-business-logic-by-using-partial-methods.md)  
