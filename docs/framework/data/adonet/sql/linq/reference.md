...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] подхода внешнего сопоставления для сопоставления [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] объектную модель для базы данных SQL Server. Предоставляет определение схемы XSD для файлов сопоставлений.  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Предоставляет портал для тем [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)].  
  
 [Общие сведения о технологии LinqDataSource](http://msdn.microsoft.com/en-us/104cfc3f-7385-47d3-8a51-830dfa791136)  
