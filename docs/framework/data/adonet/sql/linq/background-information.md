...
- Документация Microsoft поиска для конкретных проблем.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описана связь между ADO.NET и [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)].  
 ...
 [Оптимистичный параллелизм. обзор](../../../../../../docs/framework/data/adonet/sql/linq/optimistic-concurrency-overview.md)  
