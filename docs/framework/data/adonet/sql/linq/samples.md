...
## <a name="in-this-section"></a>В этом разделе  
 Версии Visual Basic этого решения SampleQueries  
 ...
 [Примеры C# LINQ решения](http://msdn.microsoft.com/library/23852e6b-b9a9-4a06-aedb-b27a5930ed74)  
...
-   Поиск конкретных проблем в документы Microsoft.  
...
-   Изучите технические документы, содержащие сведения о [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] технологии, дополненный примерами кода Visual Basic и C#. Дополнительные сведения см. в разделе [LINQ to SQL: запросы LINQ .NET запросов для реляционных данных](http://go.microsoft.com/fwlink/?LinkId=93205).  
