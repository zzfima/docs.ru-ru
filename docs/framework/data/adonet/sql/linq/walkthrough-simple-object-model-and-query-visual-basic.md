...
В [этом пошаговом руководстве: В разделе "запросы по связям"](walkthrough-querying-across-relationships-visual-basic.md) (Visual Basic) продолжение этого руководства завершается. В пошаговом руководстве «запросы между [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] связями» показано, как можно выполнять запросы к нескольким таблицам, как и к *объединениям* в реляционной базе данных.
