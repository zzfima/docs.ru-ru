...
2. В **типы проектов** области в **новый проект** диалоговом окне щелкните **Visual Basic**.  
...
3. В редакторе кода добавьте следующие директивы перед **Module1**:  
...
2. В **добавить существующий элемент** диалоговом окне перейдите к c:\linqtest2\northwind.vb и нажмите кнопку **добавить**.  
...
2. Чтобы проверить приложение на этом этапе, нажмите клавишу F5.  
     ...
     Закройте приложение, нажав клавишу ВВОД в **консоли** окна, или щелкнув **остановить отладку** на Visual Studio **Отладка** меню.  
...
3. Нажмите клавишу ВВОД в **консоли** окно, чтобы остановить отладку.  
...
4. Нажмите клавишу ВВОД в **консоли** окно, чтобы остановить отладку.  
