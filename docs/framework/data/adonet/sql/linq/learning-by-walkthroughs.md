...
> [!NOTE]
>  В пошаговых руководствах этого раздела, предназначенного для начала работы, предоставляется основной код, который поддерживает технологию [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]. На практике обычно используется проекты реляционного конструктора объектов и Windows Forms для реализации вашей [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] приложений. Реляционный конструктор объектов документации содержатся примеры и пошаговые руководства для этой цели.  
