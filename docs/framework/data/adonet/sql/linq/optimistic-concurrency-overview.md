---
title: 'Оптимистичный параллелизм: Обзор'
ms.date: 03/30/2017
...
ms.locfileid: "54517465"
---
# <a name="optimistic-concurrency-overview"></a>Оптимистичный параллелизм: Обзор
Технология [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] поддерживает средства управления оптимистическим параллелизмом. В следующей таблице описаны условия, применяемые к оптимистическому параллелизму в [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] документации:  
