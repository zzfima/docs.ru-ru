...
-   `Nvarchar` и `DateTime` типов можно сравнивать в SQL без явных приведений; C# требует явного преобразования.  
...
-   `Round()` функция имеет различную семантику в [!INCLUDE[dnprdnshort](../../../../../../includes/dnprdnshort-md.md)] и в T-SQL.  
