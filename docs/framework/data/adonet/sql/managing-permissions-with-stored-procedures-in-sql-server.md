---
title: "Управление разрешениями с помощью хранимых процедур в SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Управление разрешениями с помощью хранимых процедур в SQL Server
...
|Ресурс|Описание|  
|------------|--------------|  
|[Хранимые процедуры](http://msdn.microsoft.com/library/ms190782.aspx) и [Атака путем внедрения кода SQL](http://go.microsoft.com/fwlink/?LinkId=98234) в электронной документации по SQL Server|Разделы описывают, как создавать хранимые процедуры и как работает внедрение кода SQL.|  
