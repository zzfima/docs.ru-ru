...
-   Он выполняет откат первой транзакции и очищает, удаляя **TestSnapshot** и выключения изоляции моментального снимка в **AdventureWorks** базы данных.  
