---
title: "Перечисление экземпляров SQL Server (ADO.NET) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|**Версия**|Версия сервера.  Например:<br /><br /> -   9,00.x \([!INCLUDE[ssVersion2005](../../../../../includes/ssversion2005-md.md)]\)<br />-   10.0.xx \([!INCLUDE[ssKatmai](../../../../../includes/sskatmai-md.md)]\)<br />-   10.50.x \([!INCLUDE[ssKilimanjaro](../../../../../includes/sskilimanjaro-md.md)]\)<br />-   11.0.xx \([!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)] 2012\)|  
