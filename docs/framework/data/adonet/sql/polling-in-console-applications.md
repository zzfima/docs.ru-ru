...
## <a name="example"></a>Пример  
 Следующее консольное приложение обновляет данные в пределах **AdventureWorks** образца базы данных, выполняет асинхронное. Для моделирования длительного процесса в данном примере в текст команды вставлена инструкция WAITFOR. Обычно замедление выполнения команд не производится, однако в данном случае это упрощает демонстрацию асинхронного поведения.  
