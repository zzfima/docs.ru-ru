---
title: "Подписывание хранимых процедур в SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Подписывание хранимых процедур в SQL Server
...
|[Подписание хранимых процедур с помощью сертификата](http://msdn.microsoft.com/library/bb283630.aspx) в электронной документации по SQL Server|Предоставляет учебник для подписания хранимой процедуры с помощью сертификата.|  
