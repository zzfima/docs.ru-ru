...
---
# <a name="how-to-implement-copytodatatablet-where-the-generic-type-t-is-not-a-datarow"></a>Как выполнить Реализовать метод CopyToDataTable\<T > где универсальный тип T не является DataRow
