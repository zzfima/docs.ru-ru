...
---
# <a name="how-to-implement-copytodatatablelttgt-where-the-generic-type-t-is-not-a-datarow"></a>Как выполнить Реализовать метод CopyToDataTable&lt;T&gt; где универсальный тип T не является DataRow
