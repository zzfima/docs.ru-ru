...
|Тип данных|Описание|  
|---------------|-----------------|  
|**Blob**|Oracle **BLOB-ОБЪЕКТОВ** тип данных, содержащий двоичные данные с максимальным размером 4 гигабайта. Это значение соответствует значению **массива** типа **байтов**.|  
