...
---
# <a name="method-based-query-syntax-examples-element-operators-linq-to-dataset"></a>Примеры синтаксиса запросов на основе методов. Операторы работы с элементами (LINQ to DataSet)
