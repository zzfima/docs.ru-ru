...
## <a name="using-the-string-based-sort-property"></a>Использование свойства сортировки на основе строк  
 ...
 Дополнительные сведения о строковыми <xref:System.Data.DataView.Sort%2A> фильтрации, в разделе [Сортировка и фильтрация данных](../../../../docs/framework/data/adonet/dataset-datatable-dataview/sorting-and-filtering-data.md).  
...
## <a name="see-also"></a>См. также  
 ...
 [Сортировка данных](http://msdn.microsoft.com/library/6d76e2d7-b418-49b5-ac78-2bcd61169c48)
