...
## <a name="windows-applications"></a>Windows-приложения  
 ...
 [Развертывание ClickOnce для Windows Forms приложений](http://msdn.microsoft.com/en-us/34d8c770-48f2-460c-8d67-4ea5684511df)  
...
|Ресурс|Описание:|  
|--------------|-----------------|  
|[NIB: Безопасность ASP.NET](http://msdn.microsoft.com/en-us/04b37532-18d9-40b4-8e5f-ee09a70b311d)|Обсуждается, как защищать приложения ASP.NET.|  
|[Защита веб-служб XML, созданных с помощью ASP.NET](http://msdn.microsoft.com/en-us/354b2ab1-2782-4542-b32a-dc560178b90c)|Обсуждается, как обеспечивать безопасность веб-службы ASP.NET.|  
...
|[NIB: основные рекомендации по обеспечению безопасности для веб-приложений ASP.NET](http://msdn.microsoft.com/en-us/94a52ab8-731d-417e-b997-721baf43df38)|Общие сведения о безопасности и ссылки на дополнительные разделы.|  
...
|Ресурс|Описание:|  
|--------------|-----------------|  
|[Конфигурация удаленных приложений](http://msdn.microsoft.com/en-us/92c0c097-d984-4315-835b-7490ecdf1097)|Обсуждается, как настраивать удаленно взаимодействующие приложения, чтобы избежать обычных проблем.|  
|[Безопасность в системе удаленного взаимодействия](http://msdn.microsoft.com/en-us/9574262c-d4b1-41c5-8600-24ff147c0add)|Описывает проверку подлинности и шифрование, а также другие разделы безопасности, имеющие отношение к удаленному взаимодействию.|  
