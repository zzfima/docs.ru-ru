---
title: "Вызов операций служб (службы данных WCF) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Вызов операций служб (службы данных WCF)
...
## Рассмотрение вызова операций службы  
...
-   При асинхронном доступе к службе данных необходимо использовать эквивалентные асинхронные методы <xref:System.Data.Services.Client.DataServiceContext.BeginExecute%2A>\/<xref:System.Data.Services.Client.DataServiceContext.EndExecute%2A> на <xref:System.Data.Services.Client.DataServiceContext> или методы <xref:System.Data.Services.Client.DataServiceQuery%601.BeginExecute%2A>\/<xref:System.Data.Services.Client.DataServiceQuery%601.EndExecute%2A> на <xref:System.Data.Services.Client.DataServiceQuery%601>.  
...
-   [Вызов операции службы, не возвращающей никаких данных](../../../../docs/framework/data/wcf/calling-service-operations-wcf-data-services.md#ExecuteVoid)  
...
### Вызов метода Execute\<T\> для возврата коллекции сущностей  
...
### Использование метода CreateQuery\<T\> для возврата коллекции сущностей  
 ...
 В этом примере метод <xref:System.Data.Services.Client.DataServiceQuery%601.AddQueryOption%2A> используется для добавления параметра к запросу, а метод <xref:System.Data.Services.Client.DataServiceQuery%601.Expand%2A> — для включения в результаты связанных объектов Order\_Details.  
  
<a name="ExecuteSingleEntity"></a>   
### Вызов метода Execute\<T\> для возврата одной сущности  
...
### Вызов метода Execute\<T\> для возврата коллекции значений\-примитивов  
...
### Вызов метода Execute\<T\> для возврата одного значения\-примитива  
...
### Вызов операции службы, не возвращающей никаких данных  
...
### Асинхронный вызов операции службы  
