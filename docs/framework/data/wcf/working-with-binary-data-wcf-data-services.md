...
ms.locfileid: "69930023"
---
# <a name="working-with-binary-data-wcf-data-services"></a>Работа с двоичными данными (службы данных WCF)
Клиентская библиотека позволяет извлекать и обновлять двоичные данные [!INCLUDE[ssODataFull](../../../../includes/ssodatafull-md.md)] из канала одним из следующих способов: [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]  
