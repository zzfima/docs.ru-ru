...
Вводные разделы по службам [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] можно найти в следующих местах. Во многих из них также есть ссылки на связанные разделы, содержащие более подробные сведения.  
 ...
 Описывает проектирование и обращение к службе данных с помощью [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)], как показано [краткое руководство](../../../../docs/framework/data/wcf/quickstart-wcf-data-services.md).  
...
## <a name="external-resources"></a>Внешние ресурсы  
 Следующие внешние ресурсы предоставляют дополнительные сведения и поддержку для создания [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] приложений, которые используют и предоставляют [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] веб-каналов.  
  
 [Форум по службам данных WCF](http://go.microsoft.com/fwlink/?LinkId=150512)  
 ...
 [Центр разработчиков хранилищ и доступа к данным](http://go.microsoft.com/fwlink/?LinkId=91903)  
 Центральный узел, где можно найти сведения и ресурсы для работы с данными.  
  
 [Как мне платформы данных? Видео: Серия служб данных WCF](http://go.microsoft.com/fwlink/?LinkId=124600)  
 Содержит набор видеороликов, демонстрирующих сборку и обращение к службам данных.  
  
 [Обзор: Службы данных WCF](http://go.microsoft.com/fwlink/?LinkID=131074)  
 ...
 [С помощью службы Microsoft WCF Data Services](http://go.microsoft.com/fwlink/?LinkID=131075)  
 ...
 [Модель сущность связь: К единому представлению данных](http://go.microsoft.com/fwlink/?LinkId=91909) , Питер ПИН Шань Чен, Массачусетский технологический институт  
