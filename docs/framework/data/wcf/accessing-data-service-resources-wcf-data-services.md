...
```  
 ...
 Дополнительные сведения см. в разделе [OData: соглашения URI](https://go.microsoft.com/fwlink/?LinkId=185564).  
...
|`$top`|Указывает количество сущностей, которые необходимо включить в возвращаемый канал. В следующем примере пропускаются первые 10 клиентов и возвращаются следующие 10:<br /><br /> `http://services.odata.org/Northwind/Northwind.svc/Customers?$skip=10&$top=10`<br /><br /> Дополнительные сведения см. в разделе [OData: системный параметр запроса ($top)](https://go.microsoft.com/fwlink/?LinkId=186969).|  
