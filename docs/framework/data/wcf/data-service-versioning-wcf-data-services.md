...
### <a name="version-negotiation"></a>Согласование версий
 ...
 В следующей таблице приведены версии платформы .NET Framework и [!INCLUDE[silverlight](../../../../includes/silverlight-md.md)] , которые включают службы WCF Data Services поддержки определенных версий протокола OData.
