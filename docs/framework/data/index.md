---
title: "Данные и модели в .NET Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "платформа .NET Framework, доступ к данным"
  - "данные [платформа .NET Framework], доступ"
  - "доступ к данным [платформа .NET Framework], сведения о доступе к данным платформы .NET Framework"
...
## В этом подразделе  
 ...
 [LINQ Portal](http://msdn.microsoft.com/ru-ru/6eb15c76-4ee6-4146-981e-b3429a945e6f)  
