...
### <a name="fulltrust-link-demands"></a>FullTrust (полное доверие)  
 ...
 Дополнительные сведения о устойчивых операциях прикрепления и восстановлении см. в разделе [прикрепление ресурсов в качестве участников транзакции](../../../../docs/framework/data/transactions/enlisting-resources-as-participants-in-a-transaction.md) и [выполнение](../../../../docs/framework/data/transactions/performing-recovery.md) разделов по восстановлению.  
