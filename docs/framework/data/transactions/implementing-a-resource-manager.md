---
title: "Реализация диспетчера ресурсов  | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## В этом подразделе  
 ...
 [Уровни доверия системы безопасности, используемые при доступе к ресурсам ](../../../../docs/framework/data/transactions/security-trust-levels-in-accessing-resources.md)  
