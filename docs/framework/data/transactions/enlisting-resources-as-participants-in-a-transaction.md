---
title: "Прикрепление ресурсов в качестве участников транзакции  | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Прикрепление ресурсов в качестве участников транзакции 
Каждым участвующим в транзакции ресурсом управляет диспетчер ресурсов, действия которого координируются диспетчером транзакций.Координация осуществляется посредством уведомлений, которые передаются подписчикам, зачисленным в транзакцию с помощью диспетчера транзакций.  
 ...
 В этом разделе описывается, как зачислить в транзакцию один или несколько ресурсов, и рассматриваются различные типы зачисления.В разделе [Однофазная и многофазная фиксация транзакции ](../../../../docs/framework/data/transactions/committing-a-transaction-in-single-phase-and-multi-phase.md) описывается порядок координации процесса фиксации транзакции между зачисленными ресурсами.  
