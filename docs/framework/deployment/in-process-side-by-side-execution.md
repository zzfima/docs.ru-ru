...
- **Сценарий 2**. Управляемое приложение, созданное в [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)], которое желательно запустить в [!INCLUDE[dnprdnext](../../../includes/dnprdnext-md.md)], но допустимо и в .NET Framework 4, если версия 2.0 отсутствует.  
