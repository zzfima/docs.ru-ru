---
title: "Обнаружение сборок в среде выполнения | Документы Майкрософт"
ms.custom: 
ms.date: 03/30/2017
...
<a name="step2"></a>   
## <a name="step-2-checking-for-previously-referenced-assemblies"></a>Шаг 2. Проверка наличия ранее связанных сборок  
