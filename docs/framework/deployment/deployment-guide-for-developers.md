...
|.NET Framework 4.5.1, установленная в [!INCLUDE[win8](../../../includes/win8-md.md)], Windows 7|378758|
...
Начиная с [!INCLUDE[win8](../../../includes/win8-md.md)], вы можете удалить платформу .NET Framework 4.5 или одну из ее доработанных версий через раздел **Включение или отключение компонентов Windows** на панели управления. В более ранних версиях Windows платформу .NET Framework 4.5 или одну из ее доработанных версий можно удалить с помощью пункта **Установка и удаление программ** на панели управления.
