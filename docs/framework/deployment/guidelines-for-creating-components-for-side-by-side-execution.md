---
title: "Рекомендации по созданию компонентов для параллельного выполнения | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "параллельное выполнение, несколько версий приложения"
  - "параллельное выполнение, несколько версий компонента"
