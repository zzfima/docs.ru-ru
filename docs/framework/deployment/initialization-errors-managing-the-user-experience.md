---
title: "Ошибки инициализации платформы .NET Framework. Управление взаимодействием с пользователем | Документы Майкрософт"
ms.custom: 
ms.date: 03/30/2017
...
## <a name="includewin8includeswin8-mdmd-behavior-and-ui"></a>Поведение [!INCLUDE[win8](../../../includes/win8-md.md)] и пользовательский интерфейс  
