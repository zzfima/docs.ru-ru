...
## <a name="gamepiece-class"></a>Класс GamePiece  
 Ниже приведен полный код класса **GamePiece**.  
...
## <a name="gamepiececollection-class"></a>Класс GamePieceCollection  
 Ниже приведен полный код класса **GamePieceCollection**.  
...
## <a name="game1-class"></a>Класс Game1  
 Ниже приведен полный код класса **Game1**.  
