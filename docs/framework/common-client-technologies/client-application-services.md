...
-   Хранение параметров пользовательских приложений на сервере и доступ к ним. Вы можете использовать веб-службу параметров (другое название — служба профилей) для разделения параметров между несколькими приложениями и расположениями.  
 ...
 Дополнительные сведения о службах приложений [!INCLUDE[ajax_current_short](../../../includes/ajax-current-short-md.md)] см. в разделе [Общие сведения о службах приложений ASP.NET](https://msdn.microsoft.com/library/1162e529-0d70-44b2-b3ab-83e60c695013).  
