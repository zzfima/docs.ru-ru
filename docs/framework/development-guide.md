---
title: "Руководство по разработке для .NET Framework | Документация Майкрософт"
ms.custom: 
ms.date: 03/30/2017
...
## <a name="reference"></a>Ссылка  
 [Библиотека классов .NET Framework](https://docs.microsoft.com/en-us/dotnet/api/?view=netframework-4.7)  
