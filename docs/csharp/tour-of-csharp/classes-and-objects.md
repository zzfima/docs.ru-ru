---
title: "Классы и объекты в C# — краткий обзор языка C# | Microsoft Docs"
...
* `protected internal`
    - Доступ ограничен содержащим классом или классами, которые являются производными от содержащего класса.
* `private`
