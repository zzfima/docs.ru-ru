...
Акцессор set имеет вид метода с одним именованным параметром и без возвращаемого типа. Если же свойство используется в качестве назначения в операторе присваивания или в качестве операнда для операции ++ или --, вызывается акцессор set с аргументом, содержащим новое значение.
