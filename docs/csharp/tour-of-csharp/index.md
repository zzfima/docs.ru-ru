...
C# (произносится "си-шарп") — это простой, современный, объектно-ориентированный и строго типизированный язык программирования. C# относится к широко известному семейству языков C, и покажется хорошо знакомым любому, кто работал с C, C++, Java или JavaScript.
