...
- В отличие от классов структуры можно создавать без использования оператора `new`.
   ...
   > [!NOTE]
   > В .NET Core 2.1 и выше типы структуры должны создаваться с использованием [нового оператора](language-reference/operators/new-operator.md), [литерала по умолчанию](language-reference/operators/default.md#default-literal) или путем инициализации каждого частного поля. См. сведения о [критических изменениях для перехода с версии 2.0 на 2.1](../core/compatibility/2.0-2.1.md#corefx).
