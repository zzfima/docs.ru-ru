...
## <a name="in-this-section"></a>Содержание  
 ...
 Демонстрируется создание асинхронных решений с помощью модификатора [async](../csharp/language-reference/keywords/async.md) и оператора [await](../csharp/language-reference/keywords/await.md), представленных в [!INCLUDE[vs_dev11_long](../csharp/includes/vs_dev11_long_md.md)].  
