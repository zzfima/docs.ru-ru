...
В оставшейся части этой статьи приведены общие сведения о каждой из этих функций со ссылкой для изучения каждого компонента. Вы также можете ознакомиться с функциями в [интерактивном учебнике по C# 6](../tutorials/exploration/csharp-6.yml) в разделе учебников.
