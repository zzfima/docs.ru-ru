...
Для разбора кортеж тремя способами:
...
- Наконец может деконструирования кортежа в переменные, которые уже объявлен.
...
Обратите внимание, что нельзя смешивать объявления и назначения для существующих переменных с левой стороны деконструкцией. Компилятор создает ошибку CS8184, «деконструкцией нельзя смешивать объявления и выражения в левой части». Когда входить только что объявленным и существующих переменных.
