...
Существуют различные виды `Action` делегат, который будет содержать до 16 аргументов, например <xref:System.Action%6016>.
...
Существуют различные виды `Func` делегат со до 16 входных аргументов, например <xref:System.Func%6017>.
...
Существует также специальный <xref:System.Predicate%601> тип делегата, который возвращает тест с одним значением:
