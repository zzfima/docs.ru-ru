...
Первый из этих типов — это тип @System.Action и несколько вариантов:
...
Существуют варианты делегата `Action`, содержащие до 16 аргументов, такие как @System.Action% 6016.
...
Существуют варианты делегата `Func`, содержащие до 16 входных аргументов, такие как @System.Func%6017.
...
Существует также специальный тип @System.Predicate%601, предназначенный для делегатов, возвращающих тест одного значения:
