---
title: "Дополнительные ресурсы для программистов Visual C# (C#) | Документация Майкрософт"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
## <a name="see-also"></a>См. также  
 ...
 [Настройка редактора](https://docs.microsoft.com/visualstudio/ide/customizing-the-editor)   
