...
Поздравляем! Вы выполнили задачи из краткого руководства по спискам. Можете продолжить обучение в своей среде разработки и перейти к краткому руководству с [общими сведениями о классах](introduction-to-classes.md).
