...
**Визуализатор синтаксиса** позволяет просматривать дерево синтаксиса для файла кода C# или VB в текущем активном окне редактора внутри интегрированной среды разработки Visual Studio. Визуализатор можно запустить, выбрав **Вид** > **Другие окна** > **Визуализатор синтаксиса**.  Вы также можете воспользоваться панелью инструментов **Быстрый запуск** в правом верхнем углу. Введите "синтаксис", после чего должна появиться команда, позволяющая открыть **визуализатор синтаксиса**.
...
![Окно инструментов визуализатора синтаксиса](media/syntax-visualizer.png)
...
Создайте проект с помощью команды **Файл** > **Создать проект**. Можно создать проект VB или C#. Когда Visual Studio открывает основной файл кода для этого проекта, визуализатор отображает для него дерево синтаксиса. Можно открыть любой существующий файл C#/VB в этом экземпляре Visual Studio, и визуализатор отобразит для него дерево синтаксиса. Если в Visual Studio открыто несколько файлов кода, визуализатор отображает дерево синтаксиса для активного файла (на который установлен фокус ввода).

# <a name="ctabcsharp"></a>[C#](#tab/csharp)
![Визуализация дерева синтаксиса C#](media/visualize-csharp.png)
# <a name="visual-basictabvisual-basic"></a>[Visual Basic](#tab/visual-basic)
<a name="visualizing-a-vb-syntax-treemediavisualize-visual-basicpng"></a>![Визуализация дерева синтаксиса VB](media/visualize-visual-basic.png)
---
...
* Щелкните или выберите текст в редакторе кода. Если в предыдущем примере VB выбрать в редакторе кода строку, содержащую "Module Module1", визуализатор автоматически переходит к соответствующему узлу ModuleStatement в дереве. 
...
![Просмотр графа синтаксиса C#](media/csharp-syntax-graph.png)
...
![Просмотр графа синтаксиса VB](media/visual-basic-syntax-graph.png)
...
![Один макет закрепления для окна визуализатора и графа синтаксиса](media/docking-layout.png)
...
![Свойства символов](media/symbol-properties.png)
...
![Свойства символа типа](media/type-symbol-properties.png)
...
![Свойства преобразованного символа типа](media/converted-type-symbol-properties.png)
...
![Постоянное значение](media/constant-value.png)

Предыдущий пример также можно воспроизвести в Visual Basic. Введите `Dim x As Double = 1 + 1` в файле VB. Выберите выражение `1 + 1` в окне редактора кода. Визуализатор выделяет соответствующий узел **AddExpression**. Повторите предыдущие шаги для данного узла **AddExpression**, полученные результаты должны быть теми же самыми.
...
![Свойства символов](media/symbol-visual-basic.png)
...
![Свойства символа псевдонима](media/alias-symbol.png)
...
![Просмотр символа для объявления метода](media/method-symbol.png)
