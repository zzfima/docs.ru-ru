...
* И, наконец, структура <xref:Microsoft.CodeAnalysis.SyntaxTrivia?displayProperty=nameWithType>, которая представляет синтаксически незначительные биты сведений, такие как пробелы между токенами, директивы предварительной обработки и комментарии.
...
Путем перемещения по структуре дерева можно найти в файле кода инструкции, выражения, токены и биты пробелов.
