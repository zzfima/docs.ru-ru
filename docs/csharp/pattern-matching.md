...
description: "Дополнительные сведения о выражениях сопоставления шаблонов в C#"
...
[!code-csharp[ShapeDefinitions](../../samples/csharp/PatternMatching/Shapes.cs#01_ShapeDefinitions "Определения фигур")]
...
[!code-csharp[ClassicIsExpression](../../samples/csharp/PatternMatching/GeometricUtilities.cs#02_ClassicIsExpression "Использование классического шаблона типов")]
...
[!code-csharp[IsPatternExpression](../../samples/csharp/PatternMatching/GeometricUtilities.cs#03_IsPatternExpression "Выражение шаблона is")]
...
[!code-csharp[ClassicSwitch](../../samples/csharp/PatternMatching/GeometricUtilities.cs#04_ClassicSwitch "Классический оператор switch")]
...
[!code-csharp[Switch Type Pattern](../../samples/csharp/PatternMatching/GeometricUtilities.cs#05_SwitchTypePattern "Вычисление с использованием выражения switch")]
...
[!code-csharp[ComputeDegenerateShapes](../../samples/csharp/PatternMatching/GeometricUtilities.cs#07_ComputeDegenerateShapes "Вычисление фигур с нулевой площадью")]
...
[!code-csharp[AddRectangleAndTriangle](../../samples/csharp/PatternMatching/GeometricUtilities.cs#09_AddRectangleAndTriangle "Добавление прямоугольника и треугольника")]
...
[!code-csharp[NullCase](../../samples/csharp/PatternMatching/GeometricUtilities.cs#10_NullCase "Добавление нулевого варианта")]

Особый случай с шаблоном `null` интересен тем, что константа `null` не имеет типа, но может быть преобразована в любой ссылочный тип или тип, допускающий значение NULL. 
