...
Использование локальной переменной "name", которой не присвоено значение  
 ...
 Дополнительные сведения см. на веб-сайте [http://blogs.msdn.com/ericlippert/archive/2006/08/18/706398.aspx](http://blogs.msdn.com/ericlippert/archive/2006/08/18/706398.aspx).  
