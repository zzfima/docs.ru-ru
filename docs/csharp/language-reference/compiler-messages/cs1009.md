...
Нераспознанная escape-последовательность  
 ...
 Непредвиденный символ после обратной косой черты (\\) в [строке](../../../csharp/language-reference/keywords/string.md). Компилятор ожидает один из допустимых escape-символов. Дополнительные сведения см. в разделе [Character Escapes](../../../standard/base-types/character-escapes-in-regular-expressions.md).  
