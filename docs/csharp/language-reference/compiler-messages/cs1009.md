...
Нераспознанная escape-последовательность  
 ...
 Непредвиденный символ после обратной косой черты (\\) в [строке](../keywords/string.md). Компилятор ожидает один из допустимых escape-символов. Дополнительные сведения см. в разделе [Escape-символы](../../../standard/base-types/character-escapes-in-regular-expressions.md).  
