...
## <a name="remarks"></a>Примечания  
 Оператор присваивания нельзя перегружать. Тем не менее можно определить операторы неявного преобразования типа, которые позволяют использовать оператор присваивания с этими типами. Дополнительные сведения см. в разделе [Использование операторов преобразования](../../../csharp/programming-guide/statements-expressions-operators/using-conversion-operators.md).  
