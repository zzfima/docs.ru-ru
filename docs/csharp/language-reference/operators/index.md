...
## <a name="true-operator"></a>Оператор true

Оператор [true](../keywords/true-false-operators.md) возвращает [логическое](../keywords/bool.md) значение `true`, указывая, что операнд имеет однозначное значение true. 

## <a name="false-operator"></a>Оператор false

Оператор [false](../keywords/true-false-operators.md) возвращает [логическое](../keywords/bool.md) значение `true`, указывая, что операнд имеет однозначное значение false. 
