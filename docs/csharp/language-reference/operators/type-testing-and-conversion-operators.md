...
---
# <a name="type-testing-and-conversion-operators-c-reference"></a>Операторы тестирования и преобразования типов (справочник по C#)
