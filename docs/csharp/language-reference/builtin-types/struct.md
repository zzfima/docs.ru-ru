...
Дополнительные сведения о структурах `readonly` см. в разделе [Структуры только для чтения](~/_csharplang/proposals/csharp-7.2/readonly-ref.md#readonly-structs).
