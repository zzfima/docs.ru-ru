...
ms.locfileid: "45591138"
---
# <a name="literal-keywords-c-reference"></a>Буквенные ключевые слова (справочник по C#)
В C# используются следующие буквенные ключевые слова:  
