...
Строковые литералы имеют тип `string` и могут быть записаны в двух формах: в кавычках (") или в кавычках с префиксом @.
...
Чтобы добавить в строку с префиксом @ двойные кавычки, продублируйте их:
