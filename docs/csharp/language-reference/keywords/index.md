...
|[in](../../../csharp/language-reference/keywords/foreach-in.md)|[in (универсальный модификатор)](../../../csharp/language-reference/keywords/in-generic-modifier.md)|[int](../../../csharp/language-reference/keywords/int.md)|[interface](../../../csharp/language-reference/keywords/interface.md)|  
...
|[var](../../../csharp/language-reference/keywords/var.md)|[when (условие фильтра)](when.md)|[where (ограничение универсального типа)](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|[where (предложение запроса)](../../../csharp/language-reference/keywords/where-clause.md)|  
