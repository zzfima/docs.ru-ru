...
- [Практическое руководство. Безопасное приведение с помощью сопоставления шаблонов, операторы as и is](../../how-to/safely-cast-using-pattern-matching-is-and-as-operators.md)  
