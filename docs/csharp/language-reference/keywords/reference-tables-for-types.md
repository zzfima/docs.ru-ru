...
- [Целочисленные типы](integral-types-table.md)

- [Типы с плавающей запятой](floating-point-types-table.md)

- [Значения по умолчанию](default-values-table.md)

- [Типы значений](value-types-table.md)

- [Неявные числовые преобразования](implicit-numeric-conversions-table.md)

- [Таблица явных числовых преобразований](explicit-numeric-conversions-table.md)

Дополнительные сведения о форматировании выходных данных числовых типов см. в разделе [Таблица форматирования числовых результатов](formatting-numeric-results-table.md).
