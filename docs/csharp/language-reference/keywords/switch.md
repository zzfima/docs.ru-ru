...
Начиная с C# 7, выражение соответствия может быть любым выражением, отличным от NULL.
...
Каждый оператор `case` определяет шаблон, который в случае совпадения с выражением соответствия вызывает выполнение входящего в него раздела switch. Шаблон константы поддерживают все версии C#. Остальные шаблоны поддерживаются, начиная с C# 7. 
