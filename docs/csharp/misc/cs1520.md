...
Метод должен иметь тип возвращаемого значения  
 ...
 Метод, объявленный в классе, структуре или интерфейсе, должен иметь явный тип возврата. В следующем примере метод Square имеет возвращаемое значение [string](../language-reference/keywords/string.md):  
