...
Событие "событие" может находиться только в левой части операции \+\= или \-\=  
 ...
 [Событие](../../csharp/language-reference/keywords/event.md) было вызвано неправильно. Дополнительные сведения см. в разделах [События](../../csharp/programming-guide/events/index.md) и [Делегаты](../../csharp/programming-guide/delegates/index.md).  
