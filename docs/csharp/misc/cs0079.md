...
Событие "событие" может находиться только в левой части операции += или -=  
 ...
 [Событие](../../csharp/language-reference/keywords/event.md) было вызвано неправильно. Дополнительные сведения см. в разделе [события](../../csharp/programming-guide/events/index.md) и [делегаты](../../csharp/programming-guide/delegates/index.md).  
