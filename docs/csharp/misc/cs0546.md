...
- Свойство базового класса не объявляет метод доступа [get](../../csharp/language-reference/keywords/get.md) или [set](../../csharp/language-reference/keywords/set.md) , который вы пытаетесь переопределить.  
 ...
 Если вы не хотите переопределять свойство базового класса, то можете использовать ключевое слово [new](../../csharp/language-reference/keywords/new-modifier.md) перед свойством в производном классе.  
