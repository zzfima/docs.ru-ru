...
Комментарий XML в конструкции "конструкция" имеет синтаксически недопустимый атрибут cref "имя"  
 ...
 Строка, передаваемая в тег cref, например, внутри \<исключение > тег, который ссылается на член, которая недоступна в текущей среде сборки. Строка, передаваемая в тег cref, должна быть синтаксически правильным именем члена или поля.  
