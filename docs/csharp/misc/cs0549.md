...
"функция" является новым виртуальным членом в запечатанном (sealed) классе "класс"  
 ...
 Объект [запечатанный](../../csharp/language-reference/keywords/sealed.md)[класс](../../csharp/language-reference/keywords/class.md) нельзя использовать в качестве базового класса.  Таким образом, бесполезно определять виртуальный метод в запечатанном классе.  
