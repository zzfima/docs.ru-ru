...
Не может определять перегруженные методы, которые различаются только параметрами ref и out  
 ...
 Методы, которые отличаются только использованием модификаторов [в](../../csharp/language-reference/keywords/in-parameter-modifier.md), [ref](../../csharp/language-reference/keywords/ref.md) и [out](../../csharp/language-reference/keywords/out-parameter-modifier.md) для параметра не допускаются.  
