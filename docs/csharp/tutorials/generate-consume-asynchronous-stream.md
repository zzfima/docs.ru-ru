...
Вам нужно настроить на компьютере выполнение .NET Core, включая бета-компилятор C# 8.0. Бета-компилятор C# 8 доступен, начиная с [Visual Studio 2019](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=inline+link&utm_content=download+vs2019), или в последней предварительной версии [пакета SDK для .NET Core 3.0](https://dotnet.microsoft.com/download/dotnet-core/3.0). Асинхронные потоки впервые доступны в предварительной версии 1 .NET Core 3.0.
