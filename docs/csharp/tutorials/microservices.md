...
Теперь, когда вы установили все нужные средства, создайте новое приложение ASP.NET Core. Для этого создайте новую папку с именем WeatherMicroservice и выполните следующую команду в выбранной оболочке в этом каталоге:
