---
title: "Микрослужбы, размещенные в Docker | C#"
...
Код любого из наших примеров вы можете получить в [репозитории GitHub.](https://github.com/dotnet/docs/tree/master/samples/csharp/getting-started/WeatherMicroservice)
...
### <a name="parsing-the-query-string"></a>Синтаксический анализ входящего запроса.
...
> [!Note]
> Эта команда копирования позволяет скопировать все активы сборки и исходный код вашего приложения.
> Перед созданием образа Docker следует удалить с локального компьютера каталоги `obj`, `bin` и `out`.
