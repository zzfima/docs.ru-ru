...
Обновление должно давать возможность задать два свойства: количество заказов, необходимое, чтобы иметь право на скидку, а также процент скидки. В результате мы получаем идеальный сценарий для применения элементов интерфейса по умолчанию. Можно добавить метод в интерфейс `ICustomer` и предоставить наиболее вероятную реализацию. Все существующие и любые новые реализации могут использовать реализацию по умолчанию или предоставить свои собственные.
