...
Необходимо настроить на компьютере выполнение .NET Core, включая бета-компилятор C# 8.0. Бета-компилятор C# 8 доступен в [предварительной версии 2 Visual Studio 2019 или более поздней версии](https://visualstudio.microsoft.com/vs/preview/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=inline+link&utm_content=download+vs2019+preview) или [в предварительной версии 2 .NET Core 3.0](https://dotnet.microsoft.com/download/dotnet-core/3.0).
...
Существует два класса, которые генерируют предупреждения. Начнем с класса `NewsStoryViewModel`. Удалите элемент `NullableContextOptions` из обоих CSPROJ-файлов, чтобы ограничить область предупреждений до фрагментов кода, над которыми вы работаете. Откройте файл *NewsStoryViewModel.cs* и добавьте следующие директивы, чтобы включить контекст заметок, допускающих значение null, для класса `NewsStoryViewModel`, и восстановите класс в соответствии со следующим определением:
