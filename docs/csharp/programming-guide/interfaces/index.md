...
- Интерфейсы не содержат реализации методов. (В C# 8.0 интерфейсы могут иметь [реализацию по умолчанию для методов](../../whats-new/csharp-8.md#default-interface-methods).)
