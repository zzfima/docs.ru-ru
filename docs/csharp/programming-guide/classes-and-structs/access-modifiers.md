...
## <a name="class-and-struct-accessibility"></a>Доступность классов и структур  
 ...
 Доступ к внутренним типам можно предоставить некоторым другим сборкам с помощью класса InternalsVisibleToAttribute. Дополнительные сведения см. в разделе [Дружественные сборки](../concepts/assemblies-gac/friend-assemblies.md).  
