...
Обратите внимание, что ключевое слово `ref` используется перед объявлением локальной переменной *и* до вызова метода. 
...
Обратите внимание, что ключевое слово `ref` используется перед объявлением локальной переменной *и* перед значением во втором примере. Если не указать ключевые слова `ref` одновременно в объявлении и присвоении переменной в обоих примерах, возникает ошибка компилятора CS8172 "Невозможно инициализировать значением переменную по ссылке". 
