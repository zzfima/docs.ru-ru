...
|\U|Escape-последовательность Юникода (UTF-32)|`\U00nnnnnn` (например, `\U0001F47D` = "&#x1F47D;")|  
|\u|Escape-последовательность Юникода (UTF-16)|`\unnnn` (например, `\u0041` = "A")|  
|\v|Вертикальная табуляция|0x000B|  
|\x|Escape-последовательность Юникода аналогична "\u", она отличается только длиной переменной.|`\x0041` или `\x41` = "A"|  
