---
title: Практическое руководство. Проверка ссылок на равенство (идентичность) (Руководство по программированию на C#)
ms.custom: seodec18
ms.date: 07/20/2015
helpviewer_keywords:
- object identity [C#]
...
---
# <a name="how-to-test-for-reference-equality-identity-c-programming-guide"></a>Практическое руководство. Проверка ссылок на равенство (идентичность) (Руководство по программированию на C#)
