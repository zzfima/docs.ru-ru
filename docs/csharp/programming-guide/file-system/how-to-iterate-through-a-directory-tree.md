---
title: "Практическое руководство. Перебор дерева папок (руководство по программированию на C#) | Документы Майкрософт"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
Под фразой "итерация дерева каталога" подразумевается доступ к каждому файлу в каждом вложенном подкаталоге в заданной корневой папке на любую глубину. Необязательно открывать каждый файл. Можно просто извлечь имя файла или подкаталога как `string` или извлечь дополнительные сведения в форме объекта <xref:System.IO.FileInfo?displayProperty=fullName> или <xref:System.IO.DirectoryInfo?displayProperty=fullName>.  
