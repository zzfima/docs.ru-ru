---
title: Практическое руководство. Руководство по программированию на C#. Обход дерева каталогов
ms.custom: seodec18
ms.date: 07/20/2015
helpviewer_keywords:
...
---
# <a name="how-to-iterate-through-a-directory-tree-c-programming-guide"></a>Практическое руководство. Руководство по программированию на C#. Обход дерева каталогов
...
## <a name="example"></a>Пример  
 В приведенном ниже примере показан обход файлов и папок в дереве каталога без использования рекурсии. Этот метод использует универсальный тип коллекции <xref:System.Collections.Generic.Stack%601>, который представляет стек типа "последним пришел — первым вышел" (LIFO).  
...
## <a name="robust-programming"></a>Отказоустойчивость  
 Надежный код обхода файлов должен учитывать сложности файловой системы. Дополнительные сведения о файловой системе Windows см. в статье с [обзором NTFS](/windows-server/storage/file-server/ntfs-overview).  
