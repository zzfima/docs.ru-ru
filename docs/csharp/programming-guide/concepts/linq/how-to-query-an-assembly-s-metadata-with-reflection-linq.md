---
title: Как выполнить  запрос к метаданным сборки при помощи отражения (LINQ) (C#)
ms.date: 07/20/2015
...
ms.locfileid: "55263502"
---
# <a name="how-to-query-an-assemblys-metadata-with-reflection-linq-c"></a>Как выполнить  запрос к метаданным сборки при помощи отражения (LINQ) (C#)
