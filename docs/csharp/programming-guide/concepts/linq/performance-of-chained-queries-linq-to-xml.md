---
title: "Производительность связанных запросов (LINQ to XML) (C#) | Документ Майкрософт"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
-   В запросе `query2` предложения `where` и `select` имеют такие же показатели производительности, как и в запросе `query1`.  
 ...
 Более подробные сведения об объединении запросов в цепочки см. в разделе [Учебное руководство. Связывание запросов](http://msdn.microsoft.com/library/c08d228a-f07a-4c98-810f-1bf0e8f2257c).  
