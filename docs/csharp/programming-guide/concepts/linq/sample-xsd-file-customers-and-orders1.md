---
title: "Пример XSD-файла. Клиенты и заказы в пространстве имен | Документы Майкрософт"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
