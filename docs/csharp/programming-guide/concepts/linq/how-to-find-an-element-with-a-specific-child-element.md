...
## <a name="example"></a>Пример  
 ...
 В этом примере используется следующий XML-документ: [Пример XML-файла. Конфигурация тестирования в пространстве имен](./sample-xml-file-test-configuration-in-a-namespace1.md).  
