---
title: "Практическое руководство. Поиск одного потомка с помощью метода потомков (C#) | Документ Майкрософт"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
