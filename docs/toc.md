...
## [Версия-кандидат 4 средств .NET Core](core/preview3/tools/index.md)
### [Общие сведения об изменениях CLI](core/preview3/tools/layering.md)
### [Управление зависимостями](core/preview3/tools/dependencies.md)
### [Развертывание приложений](core/preview3/deploying/index.md)
...
### [Непрерывная интеграция](core/preview3/tools/using-ci-with-cli.md)
