...
Вы можете узнать, какие версии пакета SDK для .NET Core установлены, с помощью терминала. Откройте терминал и выполните команду `dotnet --list-sdks`.
...
Вы можете узнать, какие версии пакета среды выполнения .NET Core установлены, с помощью команды `dotnet --list-runtimes`.
