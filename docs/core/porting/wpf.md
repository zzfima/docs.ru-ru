...
01. [Пакет обеспечения совместимости Windows][compat-pack] может помочь с переносом.
    ...
    Некоторые API, доступные в .NET Framework, недоступны в .NET Core 3.0. [Пакет обеспечения совместимости Windows][compat-pack] поддерживает многие из этих API и может обеспечить WPF-приложению совместимость с .NET Core.
