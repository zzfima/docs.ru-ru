---
title: "Перенос в .NET Core — библиотеки | Документация Майкрософт"
...
В этой статье предполагается, что вы используете Visual Studio 2017 или более поздней версии в ОС Windows. Двоичные файлы, необходимые для сборки кода .NET Core, недоступны в предыдущих версиях Visual Studio.
...
Дополнительные сведения см. в разделе [Библиотека платформы .NET Standard](../../standard/net-standard.md).

## Ключевые технологии, пока не доступные в .NET Standard или .NET Core
...
### Настройка для различных версий с помощью `project.json`
...
### Использование файла `project.json` в Visual Studio
...
#### Когда следует выбирать проект Xproj
...
#### Когда следует выбирать проект PCL
...
## Перенацеливание кода .NET Framework на версию .NET Framework 4.6.2
...
## Определение переносимости кода
...
### Использование .NET Framework до устранения проблем переносимости
...
## Рекомендуемый подход к переносу
