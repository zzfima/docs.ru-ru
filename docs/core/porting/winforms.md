...
- [Visual Studio 2019](https://visualstudio.microsoft.com/vs/preview/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=inline+link&utm_content=winforms+core) для выполнения конструкторских задач.
...
>[!NOTE]
>**Visual Studio 2017** не поддерживает проекты .NET Core 3.0. **Visual Studio 2019 (предварительная версия и версия RC)** поддерживает проекты .NET Core 3.0, но пока не поддерживает визуальный конструктор для проектов Windows Forms в .NET Core 3.0. Чтобы использовать визуальный конструктор, необходимо, чтобы решение проекта Windows Forms в .NET имело общие файлы форм с проектом .NET Core.
...
01. Visual Studio 2019 (предварительная версия и версия RC) пока не поддерживает конструктор форм для .NET Core 3.0.
