...
Для работы .NET Core 1.1 и более ранних версии .NET Core в версиях Windows, более ранних, чем Windows 10 и Windows Server 2016 требуется распространяемый пакет Visual C++. Эта зависимость устанавливается автоматически установщиком .NET Core.
