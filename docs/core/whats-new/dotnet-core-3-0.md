...
[Скачайте и начните работу с .NET Core 3 (предварительная версия 2)](https://aka.ms/netcore3download) прямо сейчас в Windows, Mac и Linux. Полное описание выпуска .NET Core 3 (предварительная версия 2) см. [здесь](https://aka.ms/netcore3releasenotes).

Дополнительные сведения о новых возможностях в предварительной версии 1 см. в разделе [Объявления о .NET Core 3.0, предварительная версия 1](https://blogs.msdn.microsoft.com/dotnet/2018/12/04/announcing-net-core-3-preview-1-and-open-sourcing-windows-desktop-frameworks/).

Дополнительные сведения о новых возможностях в предварительной версии 2 см. в разделе [Объявления о .NET Core 3.0, предварительная версия 1]().
...
[Проект упаковки приложений Windows](https://docs.microsoft.com/windows/uwp/porting/desktop-to-uwp-packaging-dot-net), доступный в Visual Studio 2019, предварительная версия 2, позволяет создавать пакеты MSIX с [автономными](../deploying/#self-contained-deployments-scd) приложениями .NET Core.

>Примечание. Файл проекта .NET Core должен указывать поддерживаемые среды выполнения в свойстве `<RuntimeIdentifiers>`:
```xml
