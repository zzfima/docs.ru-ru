...
- [Использование C# 8.0 для ускорения работы](https://devblogs.microsoft.com/dotnet/take-c-8-0-for-a-spin/)
- [Выполнение сборки C# 8.0](https://devblogs.microsoft.com/dotnet/building-c-8-0/)
...
* [Встроенные объекты оборудования Arm64 Base](https://github.com/dotnet/coreclr/pull/16822)
...
>
>Mac и Linux: `rm -r $HOME/.dotnet/toolResolverCache`
>
