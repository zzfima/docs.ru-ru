...
---
# <a name="unit-testing-best-practices"></a>Рекомендации по модульному тестированию

Автор: [Джон Риз (John Reese)](http://reesespieces.io) с особой благодарностью [Рою Ошерову (Roy Osherove)](http://osherove.com/)

Существует множество преимуществ написания модульных тестов: они помогают с регрессией, предоставляют документацию и способствуют хорошей структуре кода. Но трудночитаемые и ненадежные модульные тесты могут негативно отразиться на базе кода.
...
- **Уместный**. Время на написание модульного теста должно соответствовать объему тестируемого кода. Если вам кажется, что тестирование кода занимает слишком много времени по сравнению с написанием кода, продумайте структуру, более подходящую для тестирования.
