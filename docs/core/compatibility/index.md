...
- **✔️ Изменение имени класса или пространства имен**
...
- **✔️ Добавление в класс конструктора одновременно с конструктором по умолчанию (без параметров), если ранее у этого класса не было конструкторов**

   При этом добавление конструктора в класс, ранее не имевший конструкторов, *без* добавления конструктора по умолчанию, не разрешено.
...
- **❌ Добавление или удаление ключевых слов [in](../../csharp/language-reference/keywords/in.md), [out](../../csharp/language-reference/keywords/out.md) или [ref](../../csharp/language-reference/keywords/ref.md) из параметра**
...
- **❌ Добавление абстрактного элемента в общедоступный тип с доступными конструкторами (открытыми или защищенными) и [незапечатанный](../../csharp/language-reference/keywords/sealed.md) тип**
...
- **❌ Добавление конструктора в класс, ранее не имевший конструкторов, без добавления конструктора по умолчанию**

- **❌️ Добавление ключевого слова [readonly](../../csharp/language-reference/keywords/readonly.md) в поле**
...
- **❌ Преобразование асинхронного API в асинхронный (и наоборот)**

## <a name="code-changes"></a>Изменения в коде

- **✔️ Добавление [params](../../csharp/language-reference/keywords/params.md) в параметр**

- **❌ Изменение типа [struct](../../csharp/language-reference/keywords/struct.md) на [class](../../csharp/language-reference/keywords/class.md), и наоборот**
