...
## <a name="perproject-based-extensibility"></a>Расширяемость на основе отдельных проектов
...
### <a name="consuming-perproject-tools"></a>Использование средств для отдельных проектов
...
### <a name="pathbased-extensibility"></a>Расширяемость на основе пути
