...
&#8225;В столбце *Geography*, как правило, отображается название страны или региона. В некоторых случаях в этом столбце может указываться Антарктида, либо потому что исследователи используют .NET Core в Антарктиде, либо из-за неправильных сведений о расположении.
...
Корпорация Майкрософт предоставляет .NET Core по [условиям лицензионного соглашения на использование библиотека Microsoft .NET](https://aka.ms/dotnet-core-eula). Дополнительные сведения о сборе и обработке данных см. в разделе "Данные".
