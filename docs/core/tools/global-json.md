...
## <a name="troubleshoot-build-warnings"></a>Устранение неполадок с предупреждениями сборки

* Следующее предупреждение означает, что проект был скомпилирован с использованием предварительной версии пакета SDK для .NET Core:
