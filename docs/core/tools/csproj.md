...
Логическое значение, которое указывает, можно ли упаковать проект. По умолчанию используется значение `true`.
...
Логическое свойство, которое позволяет включить или отключить создание всех свойств AssemblyInfo. По умолчанию используется значение `true`.
