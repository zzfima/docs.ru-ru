...
> [!WARNING]
> Эта статья применима к инструментам .NET Core (предварительная версия 2). Сведения для версии-кандидата 4 средств .NET Core см. в разделе [Команда dotnet (версия-кандидат 4 средств .NET Core)](../preview3/tools/dotnet.md).
