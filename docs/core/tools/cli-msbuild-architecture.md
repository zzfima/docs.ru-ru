---
title: "Архитектура программ командной строки .NET Core | Документы Майкрософт"
...
# Краткий обзор изменений в средствах .NET Core
...
## Переход с использования project.json
...
## Многоуровневая архитектура средств
