...
Хотя основное приложение является единственным, большинство других компонентов находятся в каталогах с номерами версий (2, 3, 5, 6). Это означает, что в системе можно одновременно установить несколько версий.
