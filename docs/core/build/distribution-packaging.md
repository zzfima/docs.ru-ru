...
Например: номер версии 2.2.302 пакета SDK означает 2-й выпуск исправления 3-го выпуска возможностей пакета SDK, который поддерживает среду выполнения версии 2.2.
