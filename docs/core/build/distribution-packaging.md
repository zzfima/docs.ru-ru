...
- `dotnet-runtime-deps-[major].[minor]` _(Необязательно)_  — устанавливает зависимости для запуска автономных приложений
  ...
  - **Зависимости:** _зависимости для конкретного дистрибутива_
