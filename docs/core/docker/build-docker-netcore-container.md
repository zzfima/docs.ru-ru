...
В этом руководства рассматриваются следующие темы:

> [!div class="checklist"]
> * Создание Dockerfile
> * Извлечение базового образа Docker для Microsoft .NET Core
> * Настройка и развертывание приложения в образе
