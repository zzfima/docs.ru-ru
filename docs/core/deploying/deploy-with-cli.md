...
Если вы используете .NET Core SDK 3.0 или более позднюю, режим публикации по умолчанию для приложений, нацеленных на .NET Core версии 2.1, 2.2, 3.0 или более позднюю версию — это исполняемый файл, зависящий от платформы.

Если вы используете .NET Core SDK 2.1, режим публикации по умолчанию для приложений, нацеленных на .NET Core версии 2.1 и 2.2, — это развертывание, зависящее от платформы.
...
Для .NET Core 2.2 или более ранней версии необходимо использовать следующие параметры командной строки с командой `dotnet publish` для публикации FDE:
