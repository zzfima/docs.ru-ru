...
В окне терминала перейдите к папке _working\templates\\_ и создайте вложенную папку с именем _extensions_. Войдите в папку.
...
Шаблоны распознаются в .NET Core по специальной папке и файлу конфигурации, которые находятся в корневой папке шаблона. Для этого руководства папка шаблона расположена по пути _working\templates\extensions\\_ .
