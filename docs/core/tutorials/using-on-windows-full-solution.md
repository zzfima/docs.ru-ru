...
1. В Visual Studio последовательно щелкните **Файл**, **Создать**, **Проект**. В **новый проект** диалогового окна разверните **Visual C#** узел и выберите **.NET Standard** узел и выберите **библиотека классов (.NET Standard)**. 
