...
После того, как вы создали библиотеку классов .NET Standard, протестировали ее и построили окончательную версию, следующий шаг — сделать ее доступной для вызывающих объектов. Это можно сделать двумя способами.
...
1. Изначально у этого проекта нет доступа к библиотеке классов. Чтобы позволить приложению вызывать методы из библиотеки классов, создайте ссылку на библиотеку классов. В окне **Обозреватель решений** щелкните правой кнопкой мыши узел `ShowCase`Зависимости**проекта** и выберите команду **Добавить ссылку**.
