...
Visual Studio позволяет выполнять программу пошагово, отслеживая результат ее выполнения. Для этого обычно задают точку останова и затем используют эту возможность, чтобы отслеживать выполнение небольшого фрагмента программного кода. Так как наша программа невелика, давайте пошагово выполним всю программу. Для этого сделайте следующее:
