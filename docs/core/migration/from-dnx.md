---
title: "Переход с DNX на интерфейс CLI .NET Core | Документация Майкрософт"
...
# Переход с DNX на интерфейс CLI .NET Core (project.json)
...
## Основные изменения в инструментарии
...
## Неподдерживаемые возможности DNX
...
## Перенос проекта DNX в CLI .NET Core
