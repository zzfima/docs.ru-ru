...
1. Создайте **консольное приложение .NET Core C#** с именем TaxiFarePrediction. Убедитесь, что флажок **Поместить решение и проект в одной папке** **снят** (VS 2019) или флажок **Создать каталог для решения** **установлен** (VS 2017).
...
- [Метрики модели регрессии](../resources/metrics.md#evaluation-metrics-for-regression-and-recommendation)
