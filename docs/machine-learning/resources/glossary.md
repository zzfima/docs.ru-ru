...
- Регуляризация $L_2$ сводит к минимуму вес диапазона для незначащих признаков; это более общий процесс, который дает меньшую чувствительность к выбросам.
