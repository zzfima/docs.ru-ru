...
---
# <a name="load-data-from-file-and-in-memory-sources"></a>Загрузка данных из файлов и источников в памяти

В этой инструкции показано, как загружать данные для обработки и обучения в ML.NET. Изначально данные хранились в файлах или в источниках данных в режиме реального времени/потоковой передачи.
...
## <a name="load-data-from-a-streaming-source"></a>Загрузка из источника потоковой передачи данных

Помимо загрузки данных, хранящихся на диске, ML.NET позволяет загружать данные из различных источников потоковой передачи, в число которых входят:
