...
Узнайте, как объяснять прогнозы модели машинного обучения ML.NET, учитывая влияние различных компонентов на прогнозы с помощью функции PFI (Permutation Feature Importance — важность компонентов перестановки).
...
Данные в этом примере можно моделировать с помощью класса, например, `HousingPriceData`:
...
Загрузите данные в [`IDataView`](xref:Microsoft.ML.IDataView).
