...
Записи представляют собой простые агрегаты именованных значений, которые могут иметь элементы. Они могут входить структуры или ссылочный тип.  Они являются ссылочными типами, по умолчанию.
