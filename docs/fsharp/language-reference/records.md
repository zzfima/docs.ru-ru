...
Как типы объединения и структуры записи обладают семантикой структурного равенства. Классы имеют ссылки семантику равенства. Это показано в следующем примере кода.
...
[Равенство ссылок](https://msdn.microsoft.com/en-us/visualfsharpdocs/conceptual/core.referenceequalityattribute-class-%5bfsharp%5d)
