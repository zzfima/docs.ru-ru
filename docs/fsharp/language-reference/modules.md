...
Если у вас есть несколько файлов в проекте или в рамках одной процедуры компиляции, или если вы создаете библиотеку, необходимо включить объявление пространства имен или модуля в верхней части файла. Компилятор F # только определяет имя модуля неявно при имеется только один файл в командной строке, проекта или компиляции, и при создании приложения.
