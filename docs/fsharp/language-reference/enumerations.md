...
`enum` Работать в F# библиотека может использоваться для создания значения перечисления, даже значение, отличное от одного из стандартных именованных значений. Использовании `enum` работать следующим образом.
