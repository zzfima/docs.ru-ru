...
|Ограничение NULL|*параметр типа* : null|Переданный тип должен поддерживать литерал null. Сюда входят все типы объектов .NET, но не F # список, кортежа, функции, класса, записи или типы объединений.|
