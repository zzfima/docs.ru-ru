...
description: Узнайте, как использовать F# файлы сигнатур для хранения сведений об открытых сигнатурах набора элементов F# программы, таких как типы, пространства имен и модули.
ms.date: 06/15/2018
...
Дополнительные сведения о специальных возможностях по умолчанию см. в разделе [Управление доступом](access-control.md).
