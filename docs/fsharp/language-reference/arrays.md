...
Тип всех F# массивы — это тип .NET Framework <xref:System.Array?displayProperty=nameWithType>. Таким образом F# массивы поддерживают все функциональные возможности, доступные в <xref:System.Array?displayProperty=nameWithType>.
...
Начиная с версии F# 3.1, можно разложить многомерный массив на подмассивы с тем же или более низким измерением. Например можно получить вектор из матрицы, указав одну строку или столбец.
