...
Например, вот как можно определить срезы для <xref:System.ArraySegment%601> класс, позволяющий для удобное управление данными:
