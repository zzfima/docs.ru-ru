...
ms.locfileid: "44273480"
---
# <a name="f-language-reference"></a>Справочник по языку F#

Этот раздел представляет ссылку на языке F #, мультипарадигматическим языком программирования, предназначенных для .NET. Язык F# поддерживает функциональные, объектно-ориентированные и императивные модели программирования.
...
|[Базовые типы](basic-types.md)|Описывает основные базовые типы, которые используются в языке F #. Кроме того, указывает соответствующие типы .NET и минимальное и максимальное значения для каждого из них.|
...
|[Отложенные вычисления](lazy-computations.md)|Описывает отложенные вычисления, которые выполняются не сразу, а когда возникает потребность в результате.|
