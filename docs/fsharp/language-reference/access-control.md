...
- Специальные возможности для отдельных полей типа записи не могут определяться специальными возможностями записи. Это означает, что конкретная метка записи не менее доступна, чем сама запись.
