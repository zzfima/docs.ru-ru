...
Ключевое слово `val` используется для объявления расположения для сохранения значения в типе класса или структуры без его инициализации. Места хранения, объявленные таким образом, называются *явные поля*. Ключевое слово 
