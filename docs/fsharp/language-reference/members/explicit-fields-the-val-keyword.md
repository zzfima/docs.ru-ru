...
> [!WARNING]
> Пространство имен `System.ComponentModel` .NET Framework содержит атрибут с таким же именем. Сведения об этом атрибуте см. в разделе <xref:System.ComponentModel.DefaultValueAttribute>.
