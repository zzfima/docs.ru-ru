...
description: 'Дополнительные сведения о F # «val» ключевое слово, которое используется для объявления места хранения значения в типе класса или структуры без инициализации.'
ms.date: 05/16/2016
...
Например, неизменяемое поле с именем `someField` имеет базовое поле в скомпилированном в .NET представлении с именем `someField@`, и вы обращаетесь к хранимому значению, используя свойство с именем `someField`.
