...
|Заголовок|Описание|
|-----|-----------|
|[Параметры F# Interactive](../../language-reference/fsharp-interactive-options.md)|Описывает синтаксис командной строки и параметры F# Interactive, fsi.exe.|
