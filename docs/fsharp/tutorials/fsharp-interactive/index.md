...
description: "Справочник по F# Interactive (fsi.exe)"
...
Чтобы открыть F# Interactive из консоли, запустите fsi.exe.  fsi.exe находится в следующем каталоге: c:\Program Files (x86)\Microsoft SDKs\F#\<версия>\Framework\<версия>\. Дополнительные сведения о доступных параметрах командной строки см. в статье [Параметры F# Interactive](fsharp-interactive-options.md).
...
## <a name="scripting-with-f"></a>Написание скриптов с использованием F# #
...
|Заголовок|Описание|
|-----|-----------|
|[Параметры окна "Интерактивный F#"](fsharp-interactive-options.md)|Описание синтаксиса командной строки и параметры для F# Interactive, fsi.exe.|
