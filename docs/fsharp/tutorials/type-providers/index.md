...
> [!NOTE]
Данное руководство было написано для F# 3.0 и будет обновлено.  Актуальные сведения о кроссплатформенных поставщиках типов см. в описании [FSharp.Data](http://fsharp.github.io/FSharp.Data/).
