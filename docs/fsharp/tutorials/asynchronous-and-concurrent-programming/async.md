...
---
# <a name="async-programming-in-f"></a>Асинхронное программирование вF# #
...
## <a name="how-to-start-async-code-in-f"></a>Запуск асинхронного кода вF# #
...
## <a name="for-the-cvb-programmer-looking-into-f"></a>Для C#и Visual Basic программист, рассматриваяF# #
