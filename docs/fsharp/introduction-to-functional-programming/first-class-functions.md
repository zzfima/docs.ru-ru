...
F# предоставляет следующий сокращенный синтаксис для достижения того же результата с облегчен.
...
В следующем примере состояние первого класса функций в F# для объявления функции, `compose`, которая возвращает композицию двух аргументов функции.
...
В примерах в предыдущих разделах показано, что в F# функции удовлетворяют критериям значений первого класса F#:
