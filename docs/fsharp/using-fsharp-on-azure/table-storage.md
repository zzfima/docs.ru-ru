...
---
# <a name="get-started-with-azure-table-storage-and-the-azure-cosmos-db-table-api-using-f"></a>Начало работы с хранилищем таблиц Azure и Azure Cosmos DB API таблиц с помощью F @ no__t-0
