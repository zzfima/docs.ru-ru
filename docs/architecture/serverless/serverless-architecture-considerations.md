...
Также важно учитывать *шаблон*автоматического деостановки: Если по какой-либо причине происходит сбой службы, не рекомендуется многократно вызывать эту службу. Вместо этого вызывается альтернативная служба или сообщение, возвращенное до тех пор, пока не будет восстановлена работоспособность зависимой службы. Бессерверная архитектура должна учитывать стратегию разрешения и управления зависимостями между службами.
