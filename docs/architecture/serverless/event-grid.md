...
Все сведения о сообщении являются стандартными, за исключением свойства `data`. Вы можете проверить сообщение и использовать `eventType` и `dataVersion` для десериализации пользовательской части полезных данных.
...
- [Azure: перевод приложения в облако с помощью безсерверных функций Azure](https://channel9.msdn.com/events/Connect/2017/E102)
