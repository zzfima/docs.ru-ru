...
|---------|---------|---------|---------|----------|
|**Масштаб**|ВМ       |Экземпляр |Приложение      |Функция  |
|**Абстрагирование**|Оборудование|Платформа|Узел ОС|Среда выполнения   |
|**Единица измерения** |ВМ       |Проект  |Изображение    |Код      |
|**Время существования**|Месяцы|От нескольких дней до нескольких месяцев|От нескольких минут до нескольких дней|От нескольких миллисекунд до нескольких минут|
|**Обязательство**|Приложения, зависимости, среда выполнения и операционная система|Приложения и зависимости|Приложения, зависимости и среда выполнения|Функция
