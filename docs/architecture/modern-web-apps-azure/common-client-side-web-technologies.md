...
> [!NOTE]
> Blazor предоставляет альтернативу платформам JavaScript для создания полнофункциональных интерактивных пользовательских интерфейсов клиента. Поддержка Blazor на стороне клиента по-прежнему доступна в предварительной версии, поэтому теперь она выходит за рамки этой главы.
...
Angular остается одной из самых популярных в мире платформ JavaScript. Начиная с Angular версии 2, платформа была перестроена с нуля с использованием [TypeScript](https://www.typescriptlang.org/), после чего оригинальное наименование AngularJS было заменено на Angular. Сейчас, несколько лет спустя, Angular все равно остается одной из самых надежных платформ для построения одностраничных приложений.
...
> <https://www.codeinwp.com/blog/angular-vs-vue-vs-react/> (Сравнение Angular, React и Vue. Какую платформу выбрать в 2020 г.)
