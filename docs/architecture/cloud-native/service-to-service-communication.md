...
### <a name="materialized-view-pattern"></a>Шаблон материализованных представлений
...
**Рис. 4-18**. Концентратор событий Azure
