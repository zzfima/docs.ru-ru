...
> [!div class="checklist"]
> * **Инклюзивные** — хорошие библиотеки .NET поддерживают множество платформ и приложений.
...
В каждой статье приводится список рекомендаций для библиотек .NET с категориями **Do**, **Consider**, **Avoid** и **Do not**. Формулировка каждой рекомендации показывает, насколько строго ее следует придерживаться.

Рекомендациям **Do** нужно следовать практически всегда:
...
Наконец, **do not** указывает на то, что практически никогда не следует делать:
