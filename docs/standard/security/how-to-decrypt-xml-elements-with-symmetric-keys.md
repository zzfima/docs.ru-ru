...
Классы можно использовать в пространстве имен <xref:System.Security.Cryptography.Xml> для шифрования элемента XML\-документа.  Шифрование XML\-данных позволяет хранить или передавать важные XML\-данные, не беспокоясь о том, что они могут быть прочитаны.  Этот пример кода выполняет расшифровку XML\-элемента при помощи алгоритма AES, также известного как Rijndael.  
 ...
 Сведения о способах шифрования XML\-элемента при использовании этой процедуры см. в разделе [How to: Encrypt XML Elements with Symmetric Keys](../../../docs/standard/security/how-to-encrypt-xml-elements-with-symmetric-keys.md).  
...
### Расшифровка XML\-элемента при помощи симметричного ключа  
  
1.  Зашифруйте XML\-элемент с использованием ранее созданного ключа, используя методики, описанные в разделе [How to: Encrypt XML Elements with Symmetric Keys](../../../docs/standard/security/how-to-encrypt-xml-elements-with-symmetric-keys.md).  
