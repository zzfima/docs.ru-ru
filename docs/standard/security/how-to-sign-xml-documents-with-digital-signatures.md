...
10. Получить XML-представление подписи (<`Signature`> элемент) и сохраните его в новый <xref:System.Xml.XmlElement> объекта.  
