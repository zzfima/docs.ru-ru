...
---
# <a name="how-to-encrypt-xml-elements-with-x509-certificates"></a>Как выполнить Шифрование XML-элементов с помощью сертификатов X.509
...
1.  Используйте [инструмент для создания сертификатов (Makecert.exe)](https://msdn.microsoft.com/library/windows/desktop/aa386968.aspx), чтобы создать тестовый сертификат X.509 и поместить его в хранилище локального пользователя.  Необходимо создать ключ обмена и сделать его экспортируемым. Выполните следующую команду:  
...
- [Практическое руководство. Расшифровка XML-элементов с помощью сертификатов X.509](../../../docs/standard/security/how-to-decrypt-xml-elements-with-x-509-certificates.md)
