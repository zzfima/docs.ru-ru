...
## <a name="suite-b-support"></a>Поддержка пакета Suite B  
 Платформа [!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)] поддерживает набор криптографических алгоритмов Suite B, опубликованных Агентством национальной безопасности США (NSA). Подробнее о Suite B см. в разделе [NSA Suite B Cryptography Fact Sheet](https://www.nsa.gov/what-we-do/information-assurance/).  
