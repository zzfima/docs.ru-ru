...
-   Конфиденциальность: Для защиты удостоверения или данных пользователя от несанкционированного просмотра.  
  
-   Целостность данных: Для защиты данных от изменений.  
  
-   Проверка подлинности: Чтобы убедиться, что данные поступили от определенного лица.  
  
-   Неотрекаемость: Чтобы предотвратить сторона отрицать факт отправки сообщения.  
