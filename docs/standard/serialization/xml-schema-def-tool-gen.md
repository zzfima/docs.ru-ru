...
2. Передайте схему XML как аргумент в инструмент определения схемы XML, который создаст набор классов, точно соответствующих схеме XML, например:  
    ...
    ```  
     ...
     Средство может обрабатывать только схемы, которые ссылаются на спецификацию XML консорциума W3C от 16 марта 2001 г. Другими словами, пространство имен XML Schema должно быть «какhttp://www.w3.org/2001/XMLSchemaпоказано в следующем примере.  
