...
---
# <a name="schemaimporterextensions-element"></a>\<элемент schemaimporterextensions > элемент
...
|Элемент|Description|  
|-------------|-----------------|  
|[\<добавить элемент > для \<элемент schemaimporterextensions >](../../../docs/standard/serialization/add-element-for-schemaimporterextensions.md)|Добавляет типы, используемые <xref:System.Xml.Serialization.XmlSchemaImporter> для создания сопоставлений.|  
...
- [\<добавить элемент > для \<элемент schemaimporterextensions >](../../../docs/standard/serialization/add-element-for-schemaimporterextensions.md)
