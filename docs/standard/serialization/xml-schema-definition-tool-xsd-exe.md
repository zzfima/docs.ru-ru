...
|Классы в XSD| Создает схему XML из типа или типов в файле сборки среды выполнения. Созданная схема определяет формат XML, используемый <xref:System.Xml.Serialization.XmlSerializer>.|
 ...
 Xsd.exe позволяет управлять только схемами XML, которые соответствуют языку определения схемы XML (XSD), предложенному консорциумом World Wide Web Consortium (W3C). Дополнительные сведения о предложении по определению схемы XML или стандарту XML см. в разделе <https://w3.org>.
...
- [LINQ (интегрированный в язык запрос)C#()](../../csharp/programming-guide/concepts/linq/index.md)
- [LINQ (интегрированный в язык запрос) (Visual Basic)](../../visual-basic/programming-guide/concepts/linq/index.md)
