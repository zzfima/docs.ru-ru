...
- Объекты **DataSet**.
 ...
 Дополнительные сведения о сериализации и десериализации объектов см. в разделе [как: Сериализация объекта](how-to-serialize-an-object.md) и [как: Десериализация объекта](how-to-deserialize-an-object.md).

## <a name="advantages-of-using-xml-serialization"></a>Преимущества XML-сериализации

**XmlSerializer** класс обеспечивает всестороннее и гибкое управление сериализацией объекта как XML. При создании XML-веб-службы к классам и членам можно применять атрибуты управления сериализацией, чтобы выходные данные XML соответствовали определенной схеме.
