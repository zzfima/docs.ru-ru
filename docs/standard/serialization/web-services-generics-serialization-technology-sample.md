...
1. Откройте проводник и перейдите к подкаталогу \КС.  
...
2. Введите `http://localhost/[virtual directory]/Service.asmx`, где `[virtual directory]` представляет виртуальный каталог, созданный при построении образца.  
