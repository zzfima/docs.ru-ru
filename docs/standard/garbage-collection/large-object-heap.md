...
![Рис. 5. Проверка событий трассировки событий Windows с помощью PerfView](media/loh/perfview.png) Рис. 5. События трассировки событий Windows, отображаемые с помощью PerfView
...
Эта команда останавливает отладчик и показывает стек вызова только в том случае, если [VirtualAlloc](/windows/desktop/api/memoryapi/nf-memoryapi-virtualalloc) вызывается с объемом выделенной памяти более 8 МБ (0x800000).
