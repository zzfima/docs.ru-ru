...
|"X" или "x"|Шестнадцатеричный|Результат: ; шестнадцатеричная строка.<br /><br /> Поддерживается в: только целочисленные типы.<br /><br /> Описатель точности: число цифр в результирующей строке.<br /><br /> Дополнительная информация: [Описатель шестнадцатеричного формата ("X")](#XFormatString).|255 ("X") -> FF<br /><br /> -1 ("x") -> ff<br /><br /> 255 ("x4") -> 00ff<br /><br /> -1 ("X4") -> 00FF|  
