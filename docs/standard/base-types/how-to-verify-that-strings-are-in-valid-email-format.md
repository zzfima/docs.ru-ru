...
|<code>&#124;[-!#\$%&'\*\+/=\?\^\`{}&#124;~\w]</code>|Если следующий символ не является точкой, сопоставление с любым символом слова или одним из следующих символов: -!#$%'*+=?^\`{}&#124;~.|  
|<code>((\.(?!\.))&#124;[-!#\$%'\*\+/=\?\^\`{}&#124;~\w])*</code>|Сопоставление с шаблоном изменения (точка, после которой следует символ, отличающийся от точки, или одна цифра) 0 или несколько раз.|  
