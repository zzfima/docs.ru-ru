...
|private, family, assembly, family and assembly, family or assembly, public|All|Определяют доступность члена.<br /><br /> Частный пиринг<br /> Доступен только изнутри типа, к которому принадлежит член, или изнутри вложенного типа.<br /><br /> family<br /> Доступен изнутри типа, к которому принадлежит член, а также из производных от него типов.<br /><br /> сборка<br /> Доступен только в сборке, в которой определен тип.<br /><br /> family and assembly<br /> Доступен только в типах с уровнем доступа family и assembly.<br /><br /> family or assembly<br /> Доступен только в типах с уровнем доступа либо family, либо assembly.<br /><br /> таверна<br /> Доступен в любом типе.|  
...
|newslot или override|All|Определяет способ взаимодействия члена с унаследованными членами, имеющими ту же сигнатуру:<br /><br /> newslot<br /> Скрывает унаследованные члены с той же сигнатурой.<br /><br /> переопределенный<br /> Заменяет определение наследуемого виртуального метода.<br /><br /> По умолчанию используется характеристика newslot.|  
