...
|"."|Разделитель|Определяет расположение разделителя целой и дробной частей в результирующей строке.<br /><br /> Дополнительные сведения см. в разделе [ Настраиваемый описатель "."](#SpecifierPt).|0.45678 ("0.00", en-US) -> 0.46<br /><br /> 0.45678 ("0.00", fr-FR) -> 0,46|  
