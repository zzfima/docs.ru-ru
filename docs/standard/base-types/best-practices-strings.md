...
## <a name="choosing-a-stringcomparison-member-for-your-method-call"></a>Выбор элемента StringComparison для своего вызова метода  
...
|Данные|Поведение|Соответствующее сравнение System.StringComparison<br /><br /> value|  
|----------|--------------|-----------------------------------------------------|  
