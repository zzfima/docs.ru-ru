...
> [!NOTE]
>  Стратегии наилучшего соответствия не документированы подробно. Но для некоторых кодовых страниц их можно найти на веб-сайте [Unicode Consortium](http://www.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/WindowsBestFit/). Изучите файл **readme.txt** в предоставленной папке, где описаны правила интерпретации для файлов сопоставления.
