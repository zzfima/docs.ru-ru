...
## <a name="linear-comparison-without-backtracking"></a>Линейное сравнение без поиска с возвратом  
 ...
 Это показывается в следующем примере. Регулярное выражение `e{2}\w\b` ищет следующую строку: два вхождения буквы «e», затем символ слова, затем граница слова.  
...
|---------------|-------------------------|------------------------|------------|  
|1|Д.|"needing a reed" (позиция 0)|Нет совпадения.|  
|2|Д.|"eeding a reed" (позиция 1)|Возможное совпадение.|  
...
|6|Д.|"eding a reed" (позиция 2)|Возможное совпадение.|  
|7|e{2}|"ding a reed" (позиция 3)|Совпадение не подтвердилось.|  
|8|Д.|"ding a reed" (позиция 3)|Совпадение отсутствует.|  
|9|Д.|"ing a reed" (позиция 4)|Нет совпадения.|  
|10|Д.|"ng a reed" (позиция 5)|Нет совпадения.|  
|11|Д.|"g a reed" (позиция 6)|Нет совпадения.|  
|12|Д.|" a reed" (позиция 7)|Нет совпадения.|  
|13|й|a reed (позиция 8)|Нет совпадения.|  
|14|Д.|" reed" (позиция 9)|Нет совпадения.|  
|15|Д.|reed (позиция 10)|Нет совпадения.|  
|16|Д.|"eed" (позиция 11)|Возможное совпадение.|  
...
- [Конструкции группировки в регулярных выражениях](../../../docs/standard/base-types/grouping-constructs-in-regular-expressions.md)
