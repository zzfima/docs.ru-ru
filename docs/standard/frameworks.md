...
| :-------------------: | :------------: | :----------------------------: | :-------------------: | :---------: |
| .NET Standard         | 1.6.1          | netstandard1.6                 | Н/Д                   | [NETStandard.Library](https://www.nuget.org/packages/NETStandard.Library) |
| Приложение .NET Core | 1.1.2          | netcoreapp1.1                  | 1.6                   | [Microsoft.NETCore.App](https://www.nuget.org/packages/Microsoft.NETCore.App) |
...
Целевые платформы указываются в файле проекта. Если указана одна целевая платформа, используйте элемент **TargetFramework**. В следующем файле проекта консольного приложения показано, как указать целевую платформу .NET Core 1.1:
