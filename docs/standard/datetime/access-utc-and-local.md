...
---
# <a name="how-to-access-the-predefined-utc-and-local-time-zone-objects"></a>Как выполнить Доступ к предварительно определенным объектам UTC и местным временем объектам зоны
