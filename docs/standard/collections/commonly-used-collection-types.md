---
title: "Часто используемые типы коллекций | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "коллекции [платформа .NET Framework], универсальный"
  - "Collections - классы"
  - "универсальные коллекции"
  - "универсальные шаблоны [платформа .NET Framework], коллекции"
  - "группировка данных в коллекциях, универсальные типы коллекций"
  - "IDictionary - интерфейс, группировка данных в коллекциях"
  - "IList - интерфейс, группировка данных в коллекциях"
