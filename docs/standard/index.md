...
Руководство по .NET содержит информацию о .NET. В зависимости от вашего уровня знаний в области .NET вы можете изучить различные разделы данного руководства, а также другие руководства, например по [.NET Core](../core/index.md) или [.NET Framework](../framework/index.md).
