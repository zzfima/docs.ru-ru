---
title: "Метаданные и компоненты с самоописанием | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "CLR - среда, метаданные"
  - "компоненты [платформа .NET Framework], метаданные"
  - "языки, взаимодействие"
  - "метаданные, сведения о метаданных"
  - "PE-файлы, метаданные"
  - "переносимые исполняемые файлы, метаданные"
  - "среда выполнения, метаданные"
...
|Строка|Относительный виртуальный адрес \(RVA\)|Неявные флаги|Флаги|Имя<br /><br /> \(Указывает на кучу строк.\)|Сигнатура \(указывает на кучу больших двоичных объектов\)|  
|------------|---------------------------------------------|-------------------|-----------|------------------------------------------|---------------------------------------------------------------|  
|1|0x00002050|IL<br /><br /> Управляемый|Открытый<br /><br /> ReuseSlot<br /><br /> SpecialName<br /><br /> RTSpecialName<br /><br /> .ctor|.ctor \(конструктор\)||  
|2|0x00002058|IL<br /><br /> Управляемый|Открытый<br /><br /> Static<br /><br /> ReuseSlot|Главная|Строка|  
|3|0x0000208c|IL<br /><br /> Управляемый|Открытый<br /><br /> Static<br /><br /> ReuseSlot|Добавить|int, int, int|  
