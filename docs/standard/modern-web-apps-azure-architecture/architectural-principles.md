...
[Дополнительные сведения об архитектуре микрослужб](http://aka.ms/MicroservicesEbook)
...
[Назад] (choose-between-traditional-web-and-single-page-apps.md) [Далее] (common-web-application-architectures.md)
