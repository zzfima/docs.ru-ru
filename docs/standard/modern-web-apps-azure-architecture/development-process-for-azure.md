...
Чтобы начать разработку приложения ASP.NET Core с поддержкой непрерывной интеграции или непрерывной поставки, вы можете использовать Visual Studio Team Services или собственный сервер Team Foundation Server (TFS) организации.
...
-   [Предоставьте общий доступ к своему коду в Git и Visual Studio](https://docs.microsoft.com/vsts/git/share-your-code-in-git-vs) или

-   [Предоставьте общий доступ к своему коду в TFVC и Visual Studio](https://docs.microsoft.com/vsts/tfvc/share-your-code-in-tfvc-vs)
...
[Определение процесса сборки в рамках процесса непрерывной интеграции](https://docs.microsoft.com/vsts/build-release/apps/aspnet/build-aspnet-core#ci)
...
[Определение процесса выпуска в рамках процесса непрерывной поставки](https://docs.microsoft.com/vsts/build-release/apps/aspnet/build-aspnet-core#cd)
...
#### <a name="step-5-azure-app-service-web-app"></a>Шаг 5. Служба приложений Azure. Веб-приложение.
...
[Назад] (test-asp-net-core-mvc-apps.md) [Далее] (azure-hosting-recommendations-for-asp-net-web-apps.md)
