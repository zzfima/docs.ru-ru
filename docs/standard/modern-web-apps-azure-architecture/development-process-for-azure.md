...
[Скачивание Visual Studio 2017](https://www.visualstudio.com/downloads/)
...
-   [Совместного использования кода с помощью Visual Studio и Git](https://www.visualstudio.com/docs/git/share-your-code-in-git-vs) или

-   [Совместного использования кода с TFVC и Visual Studio](https://www.visualstudio.com/docs/tfvc/share-your-code-in-tfvc-vs)
...
[Определите процесс сборки CI](https://www.visualstudio.com/docs/build/apps/aspnet/aspnetcore-to-azure#ci)
...
[Определите процесс выпуска компакт-диска](https://www.visualstudio.com/docs/build/apps/aspnet/aspnetcore-to-azure#cd)
