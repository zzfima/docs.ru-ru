...
-   **Ян Стенберг (Jan Stenberg). События домена и итоговая согласованность**
    [*https://www.infoq.com/news/2015/09/domain-events-consistency*](https://www.infoq.com/news/2015/09/domain-events-consistency)

-   **Джимми Богард (Jimmy Bogard). Лучший шаблон событий предметной области**
...
-   **Джимми Богард (Jimmy Bogard). Развитие модели предметной области: события предметной области**
...
-   **Уди Дахан (Udi Dahan). События предметной области — два важных момента**
...
-   **Ян Кронквист (Jan Kronquist). Не публикуйте события предметной области — возвращайте их!**
...
-   **Сезар де ла Торре (Cesar de la Torre). События предметной области и события иерархии в архитектурах DDD и микрослужб**
