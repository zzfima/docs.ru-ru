...
-   **Мэтью Кинг (Matthew King). Регистрация служб с помощью Scrutor**
...
Принципы и процесс регистрации очень похожи на регистрацию типов с помощью встроенного контейнера iOS ASP.NET Core, но синтаксис при использовании Autofac немного иной.
...
-   **Сравнение времени существования служб контейнеров IoC в ASP.NET Core с областями экземпляров контейнеров IoC в Autofac, Сезар де ла Торре (Cesar de la Torre).**
...
## <a name="applying-cross-cutting-concerns-when-processing-commands-with-the-behaviors-in-meadiatr"></a>Применение сквозной функциональности при обработке команд с помощью расширений функциональности в MeadiatR
...
-   **Посадите контроллеры на диету: запросы POST и команды**
    [*https://lostechies.com/jimmybogard/2013/12/19/put-your-controllers-on-a-diet-posts-and-commands/*](https://lostechies.com/jimmybogard/2013/12/19/put-your-controllers-on-a-diet-posts-and-commands/)

-   **Реализация сквозной функциональности с помощью конвейера медиатора**
...
-   **Средство тестирования вертикальных срезов для MediatR и ASP.NET Core**
    *<https://lostechies.com/jimmybogard/2016/10/24/vertical-slice-test-fixtures-for-mediatr-and-asp-net-core/> *

-   **Выпущены расширения MediatR для внедрения зависимостей Майкрософт**
...
[Назад] (microservice-application-layer-web-api-design.md) [Далее] (../implement-resilient-applications/index.md)
