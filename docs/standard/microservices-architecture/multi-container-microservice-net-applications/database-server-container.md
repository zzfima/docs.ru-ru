...
-   **Run the SQL Server Docker image on Linux, Mac или Windows**
...
[Назад] (multi-container-applications-docker-compose.md) [Далее] (integration-event-based-microservice-communications.md)
