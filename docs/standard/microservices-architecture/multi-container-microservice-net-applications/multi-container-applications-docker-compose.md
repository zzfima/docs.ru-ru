...
Для достижения этой цели команда разработчиков .NET предоставляет три базовых варианта по адресу [microsoft/dotnet](https://hub.docker.com/r/microsoft/dotnet/) (в центре Docker):
