...
-   **Эрик Брюер (Eric Brewer). Теорема CAP двенадцать лет спустя: как поменялись правила** <br/>
    [*https://www.infoq.com/articles/cap-twelve-years-later-how-the-rules-have-changed*](https://www.infoq.com/articles/cap-twelve-years-later-how-the-rules-have-changed)

-   **Служебная шина Azure. Обмен сообщениями через брокер: поиск повторяющихся данных**  <br/>
    [*https://code.msdn.microsoft.com/Brokered-Messaging-c0acea25*](https://code.msdn.microsoft.com/Brokered-Messaging-c0acea25)

-   **Руководство по обеспечению надежности** (документация RabbitMQ)* <br/>
    [*https://www.rabbitmq.com/reliability.html\#consumer*](https://www.rabbitmq.com/reliability.html#consumer)

-   **Участие во внешних транзакциях (DTC)** (MSMQ) <br/>
