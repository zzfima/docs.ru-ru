...
На рисунке 6-10 показаны метаданные JSON Swagger, созданные из микрослужбы eShopOnContainers (именно ее инструменты используют на внутреннем уровне) при запросе `http://<your-root-url>/swagger/v1/swagger.json` с помощью [Postman](https://www.getpostman.com/).
