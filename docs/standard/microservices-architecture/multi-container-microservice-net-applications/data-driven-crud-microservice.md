...
В настоящее время Swashbuckle состоит из нескольких независимых внутренних пакетов NuGet в высокоуровневом метапакете [Swashbuckle.AspNetCore](https://www.nuget.org/packages/Swashbuckle.AspNetCore/) версии 1.0.0 или более поздней для приложений ASP.NET Core.
...
Вы ранее видели пользовательский интерфейс, созданный Swashbuckle и доступный по URL-адресу, например `http://<your-root-url>/swagger/ui`. На рисунке 8-9 показано, как можно тестировать любой метод API.
