...
Руководство обновлено в соответствии с версией **.NET Core 2.2** и включает множество дополнений по тому же "поколению" технологий (то есть, технологий Azure и сторонних производителей), к которому относится .NET Core 2.2. В связи с этим книга теперь также получила версию издания **2.2**. 
