...
**Издание v2.1.03** — обновлено с учетом ASP.NET Core 2.1.
...
В руководство включены сведения об особенностях версии **.NET Core 2.1** и много дополнительных обновлений, связанных с этим же "поколением" технологий (в том числе технологии Azure и сторонних производителей), к которому относится .NET Core 2.1. По этой причине выпущена и новая версия книги с учетом версии **2.1**. 
...
>
> **Мигель Велосо (Miguel Veloso)**, старший консультант Turing Challenge.
