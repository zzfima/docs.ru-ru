...
Исходный набор возможностей включает в себя только просмотр каталога. Посредством обновлений обеспечивается весь набор возможностей контейнерного приложения. Более сложная архитектура монолитного веб-приложения описывается в электронной книге [Рекомендации по архитектуре веб-приложений ASP.NET](https://aka.ms/webappebook) и в [примере приложения eShopOnWeb](http://aka.ms/WebAppArchitecture).
