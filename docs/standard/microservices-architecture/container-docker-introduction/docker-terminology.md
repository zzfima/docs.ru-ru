...
**Мультиархитектурный образ**: функция мультиархитектурных образов упрощает выбор нужного образа в зависимости от платформы выполнения Docker. Например, если файл Dockerfile запрашивает из реестра базовый образ **FROM microsoft/dotnet:2.1-sdk**, он может получить образ **2.1-sdk-nanoserver-1709**, **2.1-sdk-nanoserver-1803** или **2.1-sdk-alpine** в зависимости от операционной системы и версии, на которых выполняется Docker.
