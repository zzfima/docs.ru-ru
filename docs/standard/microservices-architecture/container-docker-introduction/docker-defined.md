...
Для выполнения [контейнеров Windows](https://msdn.microsoft.com/en-us/virtualization/windowscontainers/about/about_overview) есть среды выполнения двух типов:
