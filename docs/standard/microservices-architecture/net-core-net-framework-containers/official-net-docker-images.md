...
Начиная с версии .NET Core 2.1 все образы .NET Core, в том числе для ASP.NET Core, можно найти в [репозитории образов .NET Core](https://hub.docker.com/r/microsoft/dotnet/) на сайте Docker Hub.
