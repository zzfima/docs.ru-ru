...
-   **Крис Ричардсон (Chris Richardson). Шаблон: отдельная база данных для каждой службы**
...
-   **Альберто Брандолини (Alberto Brandolini). Стратегическое проблемно-ориентированное проектирование с сопоставлением контекстов**
