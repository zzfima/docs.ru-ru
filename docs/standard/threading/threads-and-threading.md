...
-   Исключение <xref:System.Threading.ThreadAbortException>, которое создается в потоке из-за вызова <xref:System.Threading.Thread.Abort%2A>.  
