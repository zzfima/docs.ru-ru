---
title: "Доступ к XML-данным со строгой типизацией с помощью XPathNavigator | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
|<xref:System.Xml.XPath.XPathNavigator.ValueAs%2A>|Содержимое узла, приведенное к целевому типу согласно правилам приведения типов XPath 2.0.|  
 ...
 Дополнительные сведения о сопоставлении встроенных типов схемы с типами CLR см. в разделе [Поддержка типов в классах System.Xml](../../../../docs/standard/data/xml/type-support-in-the-system-xml-classes.md).  
