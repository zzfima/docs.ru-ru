...
-   [Иерархия модели объектов (DOM) документов XML](../../../../docs/standard/data/xml/xml-document-object-model-dom-hierarchy.md)  
...
-   [Считывание XML-документа в модели DOM](../../../../docs/standard/data/xml/reading-an-xml-document-into-the-dom.md)  
...
-   [Сравнение объектов с помощью XmlNameTable](../../../../docs/standard/data/xml/object-comparison-using-xmlnametable.md)  
...
-   [Обработка событий в XML-документе с помощью XmlNodeChangedEventArgs](../../../../docs/standard/data/xml/event-handling-in-an-xml-document-using-the-xmlnodechangedeventargs.md)  
