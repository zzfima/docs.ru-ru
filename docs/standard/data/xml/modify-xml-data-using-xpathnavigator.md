...
>  Атрибуты могут иметь только простой тип.  
 ...
 Дополнительные сведения о проверке схемы и <xref:System.Xml.XPath.XPathNavigator> см. в описании [проверки схемы с помощью класса XPathNavigator](../../../../docs/standard/data/xml/schema-validation-using-xpathnavigator.md).  
