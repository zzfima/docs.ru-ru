---
title: Копирование фрагментов документа
ms.date: 03/30/2017
...
## <a name="see-also"></a><span data-ttu-id="64148-105">См. также</span><span class="sxs-lookup"><span data-stu-id="64148-105">See Also</span></span>  
 [<span data-ttu-id="64148-106">Модель объектов документов XML (DOM)</span><span class="sxs-lookup"><span data-stu-id="64148-106">XML Document Object Model (DOM)</span></span>](../../../../docs/standard/data/xml/xml-document-object-model-dom.md)
