 ...
 **✓ CONSIDER** создание исключений влияет на производительность. Ставки throw выше 100 в секунду, могут существенно повлиять на производительность большинства приложений.  
 ...
 **X AVOID** явное создание исключений из блоков finally. Явно генерированные исключения, возникающие в результате вызова методов, которые вызывают являются допустимыми.  
