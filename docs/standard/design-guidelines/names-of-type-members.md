 ...
 **✓ DO**: называйте свойства коллекции, используя фразу во множественном числе, описывающую ее элементы. Не используйте фразу в единственном числе, добавляя к ней "List" или "Collection".  
  
 **✓ DO**: называйте логические свойства без отрицаний (`CanSeek`, а не `CantSeek`). При необходимости вы можете добавить префикс "Is", "Can" или "Has", но только если это действительно имеет смысл.  
