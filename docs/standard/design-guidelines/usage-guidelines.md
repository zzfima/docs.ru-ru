...
Этот раздел содержит рекомендации по использованию общих типов в общедоступный API. Он обрабатывает прямое использование встроенных типов (например, атрибуты сериализации) и Framework перегрузка общих операторов.  
 ...
 <xref:System.IDisposable?displayProperty=nameWithType> Интерфейс не рассматривается в этом разделе, но рассматривается в [шаблон Dispose](../../../docs/standard/design-guidelines/dispose-pattern.md) раздела.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Сериализация](../../../docs/standard/design-guidelines/serialization.md)  
