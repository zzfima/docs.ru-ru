 ...
 **X не** предоставить конструктор для структуры.  
  
 Следование этой рекомендации обеспечивает массивы структур создаваться без необходимости запуска в конструктор для каждого элемента массива. Обратите внимание, что C# не допускает структуры могут иметь конструкторы без параметров.  
