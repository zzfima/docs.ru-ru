 ...
 **X AVOID** универсального именования пространств имен, выделенных для методов расширения (например, «расширения»). Используйте описательное имя (например, «маршрут») вместо него.  
