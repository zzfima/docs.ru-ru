 ...
 **✓ DO** реализация базовый шаблон Dispose для типов, содержащей экземпляры высвобождаемые типы. В разделе [базовый шаблон Dispose](#basic_pattern) подробные сведения о базовый шаблон см.  
 ...
 **✓ DO** Разрешить `Dispose(bool)` метод, который вызывается несколько раз. Метод можно не выполнять никаких действий после первого вызова.  
