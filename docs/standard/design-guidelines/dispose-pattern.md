 ...
 **СДЕЛАТЬ ✓** объявить защищенный виртуальный void `Dispose(bool disposing)` метод для централизации всю логику, связанную с освобождением неуправляемые ресурсы.  
