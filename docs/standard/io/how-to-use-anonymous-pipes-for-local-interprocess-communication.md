...
---
# <a name="how-to-use-anonymous-pipes-for-local-interprocess-communication"></a>Как выполнить Использование анонимных каналов для локального взаимодействия между процессами
