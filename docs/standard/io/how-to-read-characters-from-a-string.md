...
---
# <a name="how-to-read-characters-from-a-string"></a>Руководство. Считывание символов из строки
...
- [Руководство. Создание списка каталогов](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/5cf8zcfh(v=vs.100))  
