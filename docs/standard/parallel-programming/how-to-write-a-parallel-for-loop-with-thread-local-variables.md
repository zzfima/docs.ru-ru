...
```  
 ...
 Дополнительные сведения об использовании лямбда-выражений см. в разделе [лямбда-выражения в PLINQ и TPL](../../../docs/standard/parallel-programming/lambda-expressions-in-plinq-and-tpl.md).  
