...
**Мультиархитектурный образ**: Для нескольких архитектуры — это функция, упрощает выбор соответствующий образ в соответствии с платформой, на котором Docker выполняется, например, когда Dockerfile запрашивает базовый образ **`FROM mcr.microsoft.com/dotnet/core/sdk:2.1`** из реестра фактически возвращает **`2.1-nanoserver-1709`**, **`2.1-nanoserver-1803`**, **`2.1-nanoserver-1809`** или **`2.1-stretch`**, в зависимости от операционной системы и версии, где выполняется Docker.
