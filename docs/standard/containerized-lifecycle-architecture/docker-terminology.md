...
**Мультиархитектурный образ**: Для нескольких архитектуры — это функция, упрощает выбор соответствующий образ в соответствии с платформой, на котором Docker выполняется, например, когда Dockerfile запрашивает базовый образ **`FROM microsoft/dotnet:2.1-sdk`** из реестра фактически возвращает **`2.1-sdk-nanoserver-1709`**, **`2.1-sdk-nanoserver-1803`** или **`2.1-sdk-alpine`** в зависимости от операционной системы и версии, где выполняется Docker.
