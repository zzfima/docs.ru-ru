...
- **Управление и мониторинг** ИТ могут управлять и отслеживать рабочими приложениями и службами несколькими способами, интеграция обеих перспектив в работе.
  ...
  - **Application Insights** soution — Azure, чтобы отслеживать все аспекты рабочую среду. Вы можете отслеживать рабочие приложения Docker, просто настроив его пакет SDK в ваших служб таким образом, чтобы данные системных журналов можно получить из приложения.
