...
Рис. 4-14: внутреннего цикла разработки контекста
...
Visual Studio Code предоставляется расширение, которое необходимо установить. Чтобы сделать это, нажмите клавиши Ctrl + Shift + P, введите **установить ext**, и запустите расширений: Установка расширения команду, чтобы открыть список расширений Marketplace. Затем введите **docker** для фильтрации результатов, затем выберите файл Dockerfile и файл Docker Compose (yml) расширения поддержки, как показано на рисунке 4-16.
...
***Вариант а используйте официальный образ Docker***
...
**Дополнительные сведения о** сведения о создании образов Docker для приложений .NET Core, см. в статье <https://docs.microsoft.com/dotnet/core/docker/building-net-docker-images>.
...
Рис. 4-20: Просмотр существующих образов, использование образов docker

### <a name="step-4-optional-define-your-services-in-docker-composeyml-when-building-a-composed-docker-app-with-multiple-services"></a>Шаг 4. (Необязательно) определите ваши службы в файле docker-compose.yml при создании составного приложения Docker с несколькими службами
...
***Параметр ответ запуска одного контейнера или службы***
...
***Вариант б Compose и выполнения приложения-контейнера с несколькими***
