...
Чтобы начать использовать AKS, мы Развернем кластер AKS с помощью портала Azure или с помощью интерфейса командной строки. Дополнительные сведения о развертывании кластера Kubernetes в Azure, см. в разделе [развертывание кластера службы Azure Kubernetes (AKS)](https://docs.microsoft.com/azure/aks/kubernetes-walkthrough-portal).
