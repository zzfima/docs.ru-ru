...
![Структура кластера Kubernetes: Имеется один главный узел, который обрабатывает DNS, планировщик, прокси-сервера, т. д. и нескольких рабочих узлов, на которых размещены контейнеры.](media/image36.png)
