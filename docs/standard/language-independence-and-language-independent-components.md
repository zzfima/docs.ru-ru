...
-   параметров и возвращаемых типов открытых методов открытых классов, а также параметров и возвращаемых типов методов, доступных производным классам.  
 ...
 В следующей таблице представлены правила CLS-совместимости. Это дословные выдержки из документа [Стандарт ECMA-335: общеязыковая инфраструктура (CLI)](http://go.microsoft.com/fwlink/?LinkID=116487) © Ecma International, 2012. Дополнительные сведения об этих правилах вы найдете в следующих разделах.  
...
```  
 ...
 Дополнительные сведения о синтаксисе командной строки для компилятора Visual Basic см. в разделе [Сборка из командной строки](~/docs/visual-basic/reference/command-line-compiler/building-from-the-command-line.md).  
...
```  
 ...
 Дополнительные сведения о синтаксисе командной строки для компилятора C# см. в разделе [Сборка из командной строки с помощью csc.exe](~/docs/csharp/language-reference/compiler-options/command-line-building-with-csc-exe.md).  
  
 Затем вызовите [компоновщик (Link.exe)](http://msdn.microsoft.com/library/c1d51b8a-bd23-416d-81e4-900e02b2c129), чтобы скомпилировать оба модуля в сборку.  
