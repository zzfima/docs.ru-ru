...
```  
 ...
 Затем вызовите [компоновщик (Link.exe)](https://msdn.microsoft.com/library/c1d51b8a-bd23-416d-81e4-900e02b2c129), чтобы скомпилировать оба модуля в сборку.  
