...
- <span data-ttu-id="197e1-131">Обработчик загружает сборку без контекста.</span><span class="sxs-lookup"><span data-stu-id="197e1-131">The handler loads an assembly without context.</span></span>  
