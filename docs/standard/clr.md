---
title: "Среда CLR | Документация Microsoft"
ms.custom: 
ms.date: 03/30/2017
ms.prod: .net
ms.reviewer: 
...
|[NIB: общие сведения о платформе .NET Framework](http://msdn.microsoft.com/en-us/ea38ac1e-92af-4d1b-8db1-e8a5ea10ed85)|Описание ключевых понятий платформы .NET Framework: системы общих типов CTS, межъязыкового взаимодействия, управляемого выполнения, доменов приложений и сборок.|  
