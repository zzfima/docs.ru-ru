...
## <a name="exceptions-vs-traditional-errorhandling-methods"></a>Сравнение исключений и традиционных методов обработки ошибок
...
## <a name="how-to-create-userdefined-exceptions"></a>Создание пользовательских исключений
