...
## <a name="deeper-dive-into-tasks-for-an-iobound-operation"></a>Подробный обзор задач, связанных с операциями ввода-вывода
...
## <a name="deeper-dive-into-task-and-taskt-for-a-cpubound-operation"></a>Подробный обзор Task и Task<T> для операций, связанных с ЦП
