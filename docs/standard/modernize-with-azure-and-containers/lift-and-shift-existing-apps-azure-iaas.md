...
Затем для приложений, по-прежнему невозможно переместить в контейнеры Windows и PaaS, например службы приложений или оркестраторы, как и служба Azure Kubernetes, перенести их на простой простой виртуальных машин (IaaS). 
