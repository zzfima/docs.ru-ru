...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает способы добавления пользовательских элементов и значения в `My` пространства имен в Visual Basic.  
 ...
 Описывает процесс публикации custom `My` расширения пространства имен с помощью шаблонов Visual Studio.  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Описывает, что `My` объекты доступны в различных типах проектов по умолчанию.  
 ...
 Описывает, как компилятор использует условной компиляции для выбора определенных частей кода для компиляции и исключения в других разделах.  
