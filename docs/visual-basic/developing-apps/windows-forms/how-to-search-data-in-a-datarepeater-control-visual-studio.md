...
---
# <a name="how-to-search-data-in-a-datarepeater-control-visual-studio"></a>Как выполнить Поиск данных в элементе управления DataRepeater (Visual Studio)
При использовании <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> элемент управления, который содержит большое количество записей, может потребоваться предоставить пользователям возможность поиска для определенной записи. Вместо того чтобы искать данные в сам элемент управления, можно реализовать поиск, запрашивая базовый <xref:System.Windows.Forms.BindingSource>. Если элемент найден, можно использовать <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.CurrentItemIndex%2A> свойства выберите элемент и его прокрутку и отобразить.  
  
### <a name="to-implement-search"></a>Реализация поиска  
...
5.  Дважды щелкните элемент управления <xref:System.Windows.Forms.Button> , чтобы открыть редактор кода, и добавьте следующий код в обработчик событий `SearchButton_Click` :  
     ...
     Замените *ProductsBindingSource* именем <xref:System.Windows.Forms.BindingSource> для вашей <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater>и замените *ProductID* с именем поля, которое требуется найти.  
