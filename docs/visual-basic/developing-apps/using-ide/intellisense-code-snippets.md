...
-   Загрузка дополнительных задач со сторонних ресурсов.  
 ...
 Эти блоки кода доступны повсеместно в [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)]:  
