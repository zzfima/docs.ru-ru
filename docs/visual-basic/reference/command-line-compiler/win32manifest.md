...
1. Вы используете `-nowin32manifest` параметр и не предоставляете манифест на более позднем этапе сборки или в составе файла ресурсов Windows (RES) с `-win32resource` помощью параметра.  
