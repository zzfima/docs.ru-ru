...
1. Вы используете параметр `-nowin32manifest` и не предоставляете манифест на более позднем этапе сборки или в составе файла ресурсов Windows (RES-файл) с помощью параметра `-win32resource`.  
