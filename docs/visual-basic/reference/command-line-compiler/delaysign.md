...
## <a name="remarks"></a>Примечания  
 Параметр `-delaysign` не действует, если он не используется с [-keyfile](../../../visual-basic/reference/command-line-compiler/keyfile.md) или [-keycontainer](../../../visual-basic/reference/command-line-compiler/keycontainer.md).  
