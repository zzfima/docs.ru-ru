...
|Any integer type|Десятичное число|Single|Double|Double|  
...
|Unary `+`|Short|SByte|Байт|Short|UShort|Целое число|UInteger|Long|ULong|  
|Unary `–`|Short|SByte|Short|Short|Целое число|Целое число|Long|Long|Десятичное число|  
...
|---|---|---|---|---|---|---|---|---|---|  
||`Boolean`|`SByte`|`Byte`|`Short`|`UShort`|`Integer`|`UInteger`|`Long`|`ULong`|  
|`Not`|логический|SByte|Байт|Short|UShort|Целое число|UInteger|Long|ULong|  
