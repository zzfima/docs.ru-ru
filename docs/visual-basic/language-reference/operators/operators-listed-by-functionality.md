...
Ознакомьтесь с одним из перечисленных ниже категорий или откройте эту часть содержание справки для просмотра списка операторов Visual Basic в алфавитном порядке.  
...
|[Операторы сдвига битов](../../../visual-basic/language-reference/operators/bit-shift-operators.md)|Эти операторы выполняют арифметические сдвиги на битовые шаблоны.|  
