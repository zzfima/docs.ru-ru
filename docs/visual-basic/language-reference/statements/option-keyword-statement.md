...
## <a name="remarks"></a>Примечания  
 Параметры компилятора указывают ли все переменные должны быть явно объявлены, ли сужающие преобразования типов должны быть явными или ли сравнения строк как текст или как двоичные последовательности.  
