...
## <a name="parts"></a>Части  
 ...
 `Overloads`  
 Необязательный параметр. См. в разделе [перегружает](../../../visual-basic/language-reference/modifiers/overloads.md).  
 ...
 `operand1`  
 Обязательный. Имя и тип один операнд унарного оператора (включая оператор преобразования) или левого операнда бинарного оператора.  
...
|`operandtype`|Необязательный Если `Option Strict` является `On`. Тип данных этого операнда.|  
 ...
 `statements`  
 Необязательный параметр. Блок операторов, процедура оператора.  
...
- [Практическое руководство. Используйте класс, в котором определяются операторы](../../../visual-basic/programming-guide/language-features/procedures/how-to-use-a-class-that-defines-operators.md)
