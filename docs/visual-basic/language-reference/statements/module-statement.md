...
-   [Friend](../../../visual-basic/language-reference/modifiers/friend.md)  
 ...
 `name`  
 Обязательно. Имя этого модуля. В разделе [имена объявленных элементов](../../../visual-basic/programming-guide/language-features/declared-elements/declared-element-names.md).  
