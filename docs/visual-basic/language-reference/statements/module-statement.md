...
## <a name="parts"></a>Части  
 `attributelist`  
 Необязательный параметр. См. [список атрибутов](../../../visual-basic/language-reference/statements/attribute-list.md).  
...
- [Friend](../../../visual-basic/language-reference/modifiers/friend.md)  
 ...
 `statements`  
 Необязательный параметр. Инструкции, которые определяют переменные, свойства, события, процедуры и вложенные типы этого модуля.  
...
## <a name="remarks"></a>Примечания  
 ...
 Модуль имеет то же время, что и программа. Так как все его члены `Shared`все же, они также имеют время существования, равное значению программы.  
...
- **Модификаторы.** Все члены модуля неявно являются [общими](../../../visual-basic/language-reference/modifiers/shared.md). Нельзя использовать `Shared` ключевое слово при объявлении члена, и изменить общее состояние любого члена нельзя.  
  
- **Наследование.** Модуль не может наследовать ни от какого типа <xref:System.Object>, от которого наследуют все модули. В частности, один модуль не может наследовать от другого.  
