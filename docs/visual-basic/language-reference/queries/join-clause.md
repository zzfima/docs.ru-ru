...
## <a name="parts"></a>Части  
 ...
 `collection`  
 Обязательно. Коллекция для объединения с коллекцией, определенной в левой части `Join` оператор. Объект `Join` предложение может быть вложенным в другой `Join` предложения, либо в `Group Join` предложения.  
  
 `joinClause`  
 Необязательный. Один или более дополнительных `Join` предложения для дальнейшего уточнения запроса.  
  
 `groupJoinClause`  
 Необязательный. Один или более дополнительных `Group Join` предложения для дальнейшего уточнения запроса.  
