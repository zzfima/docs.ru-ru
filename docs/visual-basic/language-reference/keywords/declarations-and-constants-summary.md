---
title: "Сводка по объявлениям и константам (Visual Basic) | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.suite: ""
ms.technology: 
...
helpviewer_keywords: 
  - "константы"
  - "объявления, элементы языка Visual Basic"
  - "объявление констант, ключевые слова"
...
|--------------|-------------------|  
|Присваивание значения.|[Get](../../../visual-basic/language-reference/statements/get-statement.md), [Property](../../../visual-basic/language-reference/statements/property-statement.md)|  
...
|Ссылка на текущий объект.|[Me](../../../visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass.md)|  
