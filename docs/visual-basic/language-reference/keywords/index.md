...
|Заголовок|Описание|  
|---------------|--------------|  
|[Сводка по массивам](../../../visual-basic/language-reference/keywords/arrays-summary.md)|Перечисление элементов языка, используемых для создания, определения и применения массивов.|  
