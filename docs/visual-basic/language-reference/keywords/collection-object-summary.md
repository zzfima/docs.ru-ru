...
|Добавьте элемент в коллекцию.|<xref:Microsoft.VisualBasic.Collection.Add*>|  
|Удаление объекта из коллекции.|<xref:Microsoft.VisualBasic.Collection.Remove*>|  
|Ссылка на элемент в коллекцию.|<xref:Microsoft.VisualBasic.Collection.Item*>|  
|Получите ссылку на <xref:System.Collections.IEnumerator> интерфейса.|<xref:Microsoft.VisualBasic.Collection.System%23Collections%23IEnumerable%23GetEnumerator%2A>|  
