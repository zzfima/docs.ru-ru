...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] Компилятор может обработать комментарии в коде в XML-файл. Дополнительные средства можно использовать для обработки XML-файла в документации.  
