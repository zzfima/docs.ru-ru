---
title: "Члены библиотеки времени выполнения Visual Basic | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
...
helpviewer_keywords: 
  ...
  - "члены, библиотеки времени выполнения в Visual Basic"
  - "Microsoft.VisualBasic - пространство имен"
...
Пространство имен `Microsoft.VisualBasic` содержит классы, модули, константы и перечисления, которые составляют библиотеку времени выполнения [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  Эти члены библиотеки предоставляют процедуры, свойства и константы, которые могут быть использованы в коде.  Каждый модуль и класс предоставляет конкретную категорию функциональных возможностей.  
  
## Класс Microsoft.VisualBasic.Collection  
...
## Класс Microsoft.VisualBasic.ComClassAttribute  
...
## Класс Microsoft.VisualBasic.ControlChars  
...
## Класс Microsoft.VisualBasic.Constants  
...
## Модуль Microsoft.VisualBasic.Conversion  
...
## Модуль Microsoft.VisualBasic.DateAndTime  
...
## Класс Microsoft.VisualBasic.ErrObject  
...
## Модуль Microsoft.VisualBasic.FileSystem  
...
## Модуль Microsoft.VisualBasic.Financial  
...
## Модуль Microsoft.VisualBasic.Globals  
...
## Класс Microsoft.VisualBasic.HideModuleNameAttribute  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## Модуль Microsoft.VisualBasic.Information  
...
## Модуль Microsoft.VisualBasic.Interaction  
...
## Класс Microsoft.VisualBasic.MyGroupCollectionAttribute  
...
## Модуль Microsoft.VisualBasic.Strings  
