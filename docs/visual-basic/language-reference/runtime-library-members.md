...
`Microsoft.VisualBasic` Пространство имен содержит классы, модули, константы и перечисления, которые составляют [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] библиотеки времени выполнения. Эти члены библиотеки предоставляют процедуры, свойства и значения констант, которые можно использовать в коде. Каждый модуль и класс предоставляет конкретную категорию функциональных возможностей.  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a>Класс Microsoft.VisualBasic.ComClassAttribute  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a>Класс Microsoft.VisualBasic.ControlChars  
...
## <a name="microsoftvisualbasicconstants-class"></a>Класс Microsoft.VisualBasic.Constants  
...
## <a name="microsoftvisualbasicconversion-module"></a>Модуль Microsoft.VisualBasic.Conversion  
...
## <a name="microsoftvisualbasicdateandtime-module"></a>Модуль Microsoft.VisualBasic.DateAndTime  
...
## <a name="microsoftvisualbasicerrobject-class"></a>Класс Microsoft.VisualBasic.ErrObject  
...
## <a name="microsoftvisualbasicfilesystem-module"></a>Модуль Microsoft.VisualBasic.FileSystem  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a>Класс Microsoft.VisualBasic.HideModuleNameAttribute  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a>Модуль Microsoft.VisualBasic.Information  
...
## <a name="microsoftvisualbasicinteraction-module"></a>Модуль Microsoft.VisualBasic.Interaction  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a>Класс Microsoft.VisualBasic.MyGroupCollectionAttribute  
...
## <a name="microsoftvisualbasicstrings-module"></a>Модуль Microsoft.VisualBasic.Strings  
