...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="93741-102">Члены библиотеки времени выполнения Visual Basic</span><span class="sxs-lookup"><span data-stu-id="93741-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="93741-103">`Microsoft.VisualBasic` Пространство имен содержит классы, модули, константы и перечисления, которые составляют библиотеку времени выполнения Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="93741-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="93741-104">Эти члены библиотеки предоставляют процедуры, свойства и значения констант, которые можно использовать в коде.</span><span class="sxs-lookup"><span data-stu-id="93741-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="93741-105">Каждый модуль и класс предоставляет конкретную категорию функциональных возможностей.</span><span class="sxs-lookup"><span data-stu-id="93741-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="93741-106">Класс Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="93741-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="93741-107">Класс Microsoft.VisualBasic.ComClassAttribute</span><span class="sxs-lookup"><span data-stu-id="93741-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="93741-108">Класс Microsoft.VisualBasic.ControlChars</span><span class="sxs-lookup"><span data-stu-id="93741-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="93741-109">Класс Microsoft.VisualBasic.Constants</span><span class="sxs-lookup"><span data-stu-id="93741-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="93741-110">Модуль Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="93741-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="93741-111">Модуль Microsoft.VisualBasic.DateAndTime</span><span class="sxs-lookup"><span data-stu-id="93741-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="93741-112">Класс Microsoft.VisualBasic.ErrObject</span><span class="sxs-lookup"><span data-stu-id="93741-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="93741-113">Модуль Microsoft.VisualBasic.FileSystem</span><span class="sxs-lookup"><span data-stu-id="93741-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="93741-114">Модуль Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="93741-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="93741-115">Модуль Microsoft.VisualBasic.Globals</span><span class="sxs-lookup"><span data-stu-id="93741-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="93741-116">Класс Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="93741-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="93741-117">Модуль Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="93741-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="93741-118">Модуль Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="93741-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="93741-119">Класс Microsoft.VisualBasic.MyGroupCollectionAttribute</span><span class="sxs-lookup"><span data-stu-id="93741-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="93741-120">Модуль Microsoft.VisualBasic.Strings</span><span class="sxs-lookup"><span data-stu-id="93741-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="93741-121">Класс Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="93741-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="93741-122">Класс Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="93741-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="93741-123">Модуль Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="93741-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="93741-124">Microsoft.VisualBasic константы и перечисления</span><span class="sxs-lookup"><span data-stu-id="93741-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="93741-125">`Microsoft.VisualBasic` Пространство имен предоставляет константы и перечисления как часть библиотеки времени выполнения Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="93741-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="93741-126">Эти константы можно использовать в коде.</span><span class="sxs-lookup"><span data-stu-id="93741-126">You can use these constant values in your code.</span></span> <span data-ttu-id="93741-127">Каждое перечисление представляет определенной категории функциональных возможностей.</span><span class="sxs-lookup"><span data-stu-id="93741-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="93741-128">Дополнительные сведения см. в разделе [константы и перечисления](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="93741-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="93741-129">См. также</span><span class="sxs-lookup"><span data-stu-id="93741-129">See also</span></span>

- [<span data-ttu-id="93741-130">Константы и перечисления</span><span class="sxs-lookup"><span data-stu-id="93741-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="93741-131">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="93741-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
