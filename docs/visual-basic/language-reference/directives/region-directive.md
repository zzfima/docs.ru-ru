...
## <a name="remarks"></a>Заметки  
 ...
 Используйте директиву `#Region`, чтобы указать блок кода, который можно разворачивать и сворачивать с помощью функции структурирования в редакторе кода Visual Studio. You can place, or *nest*, regions within other regions to group similar regions together.  
