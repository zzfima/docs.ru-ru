...
## <a name="remarks"></a>Примечания  
 Дополнительные сведения о методах и свойствах `My.Application` объекта, воспользуйтесь следующими ресурсами:  
