...
## <a name="remarks"></a>Примечания  
 Дополнительные сведения о методах и свойствах `My.Computer.Ports` см. в разделе <xref:Microsoft.VisualBasic.Devices.Ports>.  
...
> [!NOTE]
>  Можно также использовать свойства и методы класса <xref:System.IO.Ports.SerialPort?displayProperty=nameWithType> для доступа к последовательным портам компьютера.  
