...
## <a name="remarks"></a>Примечания  
 Сведения о методах и свойствах `My.Computer.Ports` объекта, см. в разделе <xref:Microsoft.VisualBasic.Devices.Ports>.  
...
> [!NOTE]
>  Можно также использовать свойства и методы <xref:System.IO.Ports.SerialPort?displayProperty=nameWithType> класс для доступа к последовательным портам компьютера.  
