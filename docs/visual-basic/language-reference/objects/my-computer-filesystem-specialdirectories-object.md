---
title: "Объект My.Computer.FileSystem.SpecialDirectories | Документы Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
Предоставляет свойства для доступа к часто используемым каталогам.  
  
## <a name="remarks"></a>Примечания  
 Дополнительные сведения о методах и свойствах `My.Computer.FileSystem.SpecialDirectories` объекта см. в разделе <xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>.</xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>  
 ...
 **Класс:** <xref:Microsoft.VisualBasic.MyServices.SpecialDirectoriesProxy>(предоставляет доступ к <xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>)</xref:Microsoft.VisualBasic.FileIO.SpecialDirectories> </xref:Microsoft.VisualBasic.MyServices.SpecialDirectoriesProxy>  
