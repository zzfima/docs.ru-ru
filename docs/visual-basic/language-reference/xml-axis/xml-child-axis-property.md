...
## Заметки  
 ...
 Компилятор [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] преобразует свойства дочерней оси для вызовов метода <xref:System.Xml.Linq.XContainer.Elements%2A>.  
