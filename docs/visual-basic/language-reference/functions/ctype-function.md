...
## <a name="parts"></a>Части  
 ...
 `typename`  
 Любое выражение, которое является допустимым в пределах `As` предложение в `Dim` инструкции, то есть имя типа данных, объекта, структуры, класса или интерфейса.  
