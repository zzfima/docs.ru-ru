...
---
# <a name="a-reference-was-created-to-embedded-interop-assembly-assembly1-because-of-an-indirect-reference-to-that-assembly-from-assembly-assembly2"></a>Была создана ссылка на внедренную сборку взаимодействия "\<сборка Assembly1 >" из-за косвенной ссылки на эту сборку из сборки\<"Assembly2 >"
