...
## <a name="to-correct-this-error"></a><span data-ttu-id="d0d1b-106">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="d0d1b-106">To correct this error</span></span>  
  
-   <span data-ttu-id="d0d1b-107">Проверьте и укажите путь повторно.</span><span class="sxs-lookup"><span data-stu-id="d0d1b-107">Verify and respecify the path.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="d0d1b-108">См. также</span><span class="sxs-lookup"><span data-stu-id="d0d1b-108">See Also</span></span>  
 [<span data-ttu-id="d0d1b-109">Типы ошибок</span><span class="sxs-lookup"><span data-stu-id="d0d1b-109">Error Types</span></span>](../../../visual-basic/programming-guide/language-features/error-types.md)
