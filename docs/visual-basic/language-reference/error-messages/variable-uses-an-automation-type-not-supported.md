...
Предпринята попытка использования переменной, определенной в библиотеке типов или библиотеку объектов, имеющего тип данных не поддерживается в Visual Basic.  
  
## <a name="to-correct-this-error"></a>Исправление ошибки  
  
-   Использование переменной типа, распознаваемые Visual Basic.  
