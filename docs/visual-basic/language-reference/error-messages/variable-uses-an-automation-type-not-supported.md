...
Предпринята попытка использования переменной, определенной в библиотеке типов или библиотеку объектов, имеющего тип данных не поддерживается [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
  
## <a name="to-correct-this-error"></a>Исправление ошибки  
  
-   Использование переменной типа, распознаваемые [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
