...
-   Если тип определен, но библиотека объектов или типов, в которой он определен, не зарегистрирована в [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], щелкните **Add Reference** в меню **Project** и выберите необходимую библиотеку.  
