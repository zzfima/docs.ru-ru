...
2.  Проверьте документацию объекта и убедитесь, что вы не пытаетесь получить доступ примерно свойством «text», если объект фактически поддерживает «заголовок» или свойство с похожим именем.  
