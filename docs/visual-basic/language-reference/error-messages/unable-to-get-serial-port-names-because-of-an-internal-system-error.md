---
title: "Не удалось получить имена последовательных портов из-за внутренней системной ошибки | Документы Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
1.  В разделе [основы отладчик](https://docs.microsoft.com/visualstudio/debugger/debugger-basics) Дополнительные сведения об устранении неполадок.  
