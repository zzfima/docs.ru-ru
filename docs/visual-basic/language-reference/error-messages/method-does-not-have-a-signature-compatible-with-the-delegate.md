...
Есть несоответствие между сигнатурами метода и делегата, к которому вы пытаетесь использовать. Типы параметров и значений, возвращаемых классом делегата, определяются оператором `Delegate` . Любая процедура, имеет соответствующие типами параметров и возвращаемые типы, которые можно использовать для создания экземпляра этого типа делегата.  
