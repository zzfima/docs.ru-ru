...
---
# <a name="cant-open-filename-for-writing"></a>Не удается открыть "\<имя_файла >" для записи
Указанный файл не удалось открыть для записи, возможно, так как он уже открыт.  
