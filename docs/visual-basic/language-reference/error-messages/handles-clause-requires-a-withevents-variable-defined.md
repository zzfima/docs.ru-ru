...
<span data-ttu-id="96565-103">Не была предоставлена `WithEvents` переменных в вашей `Handles` предложения.</span><span class="sxs-lookup"><span data-stu-id="96565-103">You did not supply a `WithEvents` variable in your `Handles` clause.</span></span> <span data-ttu-id="96565-104">`Handles` Вызывает обработки событий, вызванных объектной переменной, объявленной с помощью ключевого слова в конце объявления процедуры `WithEvents` ключевое слово.</span><span class="sxs-lookup"><span data-stu-id="96565-104">The `Handles` keyword at the end of a procedure declaration causes it to handle events raised by an object variable declared using the `WithEvents` keyword.</span></span>  
 ...
 <span data-ttu-id="96565-105">**Идентификатор ошибки:** BC30506</span><span class="sxs-lookup"><span data-stu-id="96565-105">**Error ID:** BC30506</span></span>  
  
## <a name="to-correct-this-error"></a><span data-ttu-id="96565-106">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="96565-106">To correct this error</span></span>  
  
-   <span data-ttu-id="96565-107">Укажите необходимую `WithEvents` переменной.</span><span class="sxs-lookup"><span data-stu-id="96565-107">Supply the necessary `WithEvents` variable.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="96565-108">См. также</span><span class="sxs-lookup"><span data-stu-id="96565-108">See Also</span></span>  
 [<span data-ttu-id="96565-109">Handles</span><span class="sxs-lookup"><span data-stu-id="96565-109">Handles</span></span>](../../../visual-basic/language-reference/statements/handles-clause.md)
