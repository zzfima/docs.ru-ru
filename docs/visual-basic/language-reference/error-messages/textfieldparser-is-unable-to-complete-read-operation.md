...
Невозможно выполнить операцию, так как был превышен максимальный размер буфера (10 000 000 байт).  
  
## <a name="to-correct-this-error"></a>Исправление ошибки  
  
- Убедитесь, что нет имеет неправильный формат полей в файле.  
