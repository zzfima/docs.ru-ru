...
2. Если требуется определенный размер массива, можно изменить размер динамического массива с помощью [оператора ReDim](../../../visual-basic/language-reference/statements/redim-statement.md) при выполнении кода. Это показано в следующем примере.  
