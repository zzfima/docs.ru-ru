---
title: "Класс&lt;classname&gt;&quot;не удается найти | Документы Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
Класс\<classname настроек "не найден. Это состояние, как правило, является результатом использования несоответствующей библиотеки "Microsoft.VisualBasic.dll".  
