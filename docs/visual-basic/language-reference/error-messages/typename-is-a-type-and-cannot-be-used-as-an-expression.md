...
ms.locfileid: "61764352"
---
# <a name="typename-is-a-type-and-cannot-be-used-as-an-expression"></a>"\<typename >" является типом и не может использоваться в качестве выражения
