 ...
 *Результат*(Object, ProcedureName, каллтипе, Arguments ()) = `CallByName`  
 ...
 В текущем решении `CallByName` можно использовать с классами, но чаще всего они используются для доступа к COM-объектам или объектам из .NET Framework сборок.  
