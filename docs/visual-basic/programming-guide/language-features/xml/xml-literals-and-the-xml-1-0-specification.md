---
title: "XML-литералы и XML 1.0 спецификация (Visual Basic) | Документы Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Синтаксис XML-литерала в [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] поддерживает большую часть спецификации языка (XML) 1.0. Дополнительные сведения о спецификации XML 1.0, в разделе [языка (XML) 1.0](http://go.microsoft.com/fwlink/?LinkId=73927) на веб-узле W3C.  
...
-   XML-литерал не может содержать более 65535 знаков в одной строке.  
...
-   Синтаксис внедренных выражений, разрешенных в документе, литералы элементов не является допустимым XML.  
