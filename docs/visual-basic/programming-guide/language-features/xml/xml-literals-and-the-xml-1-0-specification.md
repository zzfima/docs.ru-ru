...
Синтаксис XML\-литералов в [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] поддерживает большую часть спецификации XML 1.0.  Сведения о спецификации XML 1.0 содержатся на веб\-сайте W3C [Extensible Markup Language \(XML\) 1.0](http://go.microsoft.com/fwlink/?LinkId=73927).  
