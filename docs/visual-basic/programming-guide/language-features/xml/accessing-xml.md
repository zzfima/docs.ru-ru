...
## <a name="in-this-section"></a>В этом разделе  
 [Практическое руководство. Доступа к элементам-потомкам XML](../../../../visual-basic/programming-guide/language-features/xml/how-to-access-xml-descendant-elements.md)  
 ...
 [Практическое руководство. Дочерние элементы XML доступа](../../../../visual-basic/programming-guide/language-features/xml/how-to-access-xml-child-elements.md)  
 ...
 [Практическое руководство. Доступа к XML-атрибуты](../../../../visual-basic/programming-guide/language-features/xml/how-to-access-xml-attributes.md)  
