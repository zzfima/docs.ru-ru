---
title: "Обработка XML в Visual Basic | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "LINQ to XML [Visual Basic], управление XML"
  - "код Visual Basic, XML"
  - "XML [Visual Basic], обработка"
...
*XML\-литералы* можно использовать для загрузки XML из внешнего источника, таких как строка, файл или поток.  Затем можно использовать [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] для управления XML и [!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext_md.md)] для составления запросов XML.  
...
## В этом подразделе  
 ...
 Показано, как загрузить XML в объект <xref:System.Xml.Linq.XDocument> или в объект <xref:System.Xml.Linq.XElement> из текстового файла, строки или потока.  
 ...
 Показано, как преобразовать содержимое объекта <xref:System.Xml.Linq.XDocument> в новый XML\-документ.  
 ...
 Показано, как изменять элементы, атрибуты и значения в XML\-литерале.  
...
## Связанные подразделы  
 ...
 Показано, как получить доступ к частям элемента или документа XML в Visual Basic.  
