...
ms.locfileid: "33653680"
---
# <a name="xml-in-visual-basic"></a>XML в Visual Basic

Visual Basic поддерживает интегрированный язык, позволяющий ему взаимодействовать с [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].  
