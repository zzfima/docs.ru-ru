...
|Раздел|Описание|  
|-----------|-----------------|  
|[Общие сведения о LINQ to XML в Visual Basic](../../../../visual-basic/programming-guide/language-features/xml/overview-of-linq-to-xml.md)|Описание поддержки [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] в [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].|  
