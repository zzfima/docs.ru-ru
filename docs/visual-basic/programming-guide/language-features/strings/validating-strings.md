---
title: "Проверка строк в Visual Basic | Документы Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
В этом разделе описывает, как проверить строки в [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
...
## <a name="in-this-section"></a>Содержание  
 ...
 Демонстрируется преобразование простых регулярных выражений для работы с <xref:System.Windows.Forms.MaskedTextBox>управления.</xref:System.Windows.Forms.MaskedTextBox>  
