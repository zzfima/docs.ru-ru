...
## <a name="property-definitions-that-require-standard-syntax"></a>Определения свойств, для которых требуется стандартный синтаксис  
 Автоматически реализуемые свойства удобны и поддерживают множество сценариев программирования. Однако существуют ситуации, в которых автоматически реализуемые свойства и приходится применять стандартный, или *развернут*, синтаксис свойств.  
