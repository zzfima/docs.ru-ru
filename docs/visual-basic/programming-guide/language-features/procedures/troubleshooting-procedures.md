 ...
 **Правильный подход:** Чтобы иметь возможность изменять элементы возвращаемого массива, определите внутренний массив как локальную переменную. В следующем примере компиляция выполняется без ошибок.

 [!code-vb[VbVbcnProcedures#66](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbcnProcedures/VB/Class1.vb#66)]

## <a name="argument-not-being-modified-by-procedure-call"></a>Аргумент не изменяется при вызове процедуры
