...
## <a name="using-constructors-and-destructors"></a>Использование конструкторов и деструкторов  
 Конструкторы и деструкторы управляют созданием и уничтожением объектов. `Sub New` И `Sub Finalize` процедуры в Visual Basic инициализируют и уничтожают объекты; они заменяют `Class_Initialize` и `Class_Terminate` методы, используемые в Visual Basic 6.0 и более ранних версий.  
