...
Чтобы включить имена элементов кортежа interred, необходимо определить версии компилятора Visual Basic для использования в проекте Visual Basic (\*.vbproj) файла: 
