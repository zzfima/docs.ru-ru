...
|`$`|`String`|`Dim V$ = "Secret"`|  
 ...
 В некоторых случаях можно добавить символ `$` в функцию [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], например `Left$` вместо `Left`, для получения возвращаемого значения типа `String`.  
