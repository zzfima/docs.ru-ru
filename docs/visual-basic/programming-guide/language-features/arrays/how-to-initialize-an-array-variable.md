---
title: Как выполнить Инициализация переменной массива в Visual Basic
ms.date: 07/20/2015
helpviewer_keywords:
...
ms.locfileid: "54638936"
---
# <a name="how-to-initialize-an-array-variable-in-visual-basic"></a>Как выполнить Инициализация переменной массива в Visual Basic
