...
## В этом подразделе  
 ...
 Демонстрирует использование существующих элементов управления ActiveX для добавления возможностей в окно инструментов [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)].  
