...
-   [Распознавание поддержки повторного входа](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645)  
  
-   [Обработка поддержки повторного входа](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645)  
  
    -   [Отключение кнопки запуска](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645)  
  
    -   [Отмена и перезапуск операции](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645)  
  
    -   [Запуск нескольких операций и постановка выходных данных в очередь](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645)  
  
-   [Проверка и выполнение примера приложения](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645)  
...
###  <a name="BKMK_CancelAndRestart"></a> Отмена и перезапуск операции  
 ...
 Чтобы настроить этот сценарий, внесите следующие изменения в основной код, который содержится в разделе [Проверка и выполнение примера приложения](https://msdn.microsoft.com/library/5b54de66-6be3-459e-b869-65070b020645). Также можно загрузить готовое приложение в разделе [Async Samples: Reentrancy in .NET Desktop Apps](https://code.msdn.microsoft.com/Async-Sample-Preventing-a8489f06). Этот проект называется CancelAndRestart.  
