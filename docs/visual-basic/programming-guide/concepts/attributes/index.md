...
- [Практическое руководство. Создание C/C++ Union с помощью атрибутов (Visual Basic)](../../../../visual-basic/programming-guide/concepts/attributes/how-to-create-a-c-cpp-union-by-using-attributes.md)  
