...
---
# <a name="how-to-find-an-attribute-of-the-parent-xpath-linq-to-xml-visual-basic"></a>Как выполнить Поиск атрибута родительского элемента (XPath-LINQ to XML) (Visual Basic)
