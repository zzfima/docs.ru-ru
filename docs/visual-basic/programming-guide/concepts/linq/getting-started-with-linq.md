...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описание наиболее распространенных типов операций запроса и их выражение на языке Visual Basic.  
  
 [Возможности Visual Basic, поддерживающие LINQ](../../../../visual-basic/programming-guide/concepts/linq/features-that-support-linq.md)  
 Описание возможностей языка Visual Basic, поддерживающие LINQ, таких как анонимные типы и определения типа.  
  
 [Связи между типами в операциях запроса (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/type-relationships-in-query-operations.md)  
 Описывает, как типы данных сохраняются или преобразованы при написании и выполнении запросов.  
 ...
 Пошаговые инструкции для создания проекта Visual Basic LINQ, добавлению простого источника данных и выполнению некоторых базовых операций запроса.  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Включает в себя Выбор разделов с инструкциями по использованию LINQ с коллекциями в памяти.  
