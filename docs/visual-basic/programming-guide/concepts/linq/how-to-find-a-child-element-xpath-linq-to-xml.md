...
В этом разделе сравнивается ось дочернего элемента XPath с [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XContainer.Element%2A>метод.</xref:System.Xml.Linq.XContainer.Element%2A>  
