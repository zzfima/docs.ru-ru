---
title: "Учебник: Отложенного выполнения (Visual Basic) | Документы Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="tutorial-deferred-execution-visual-basic"></a>Учебник: Отложенного выполнения (Visual Basic)
