...
---
# <a name="how-to-find-preceding-siblings-xpath-linq-to-xml-visual-basic"></a>Как выполнить Поиск предшествующих элементов того же уровня (XPath-LINQ to XML) (Visual Basic)
