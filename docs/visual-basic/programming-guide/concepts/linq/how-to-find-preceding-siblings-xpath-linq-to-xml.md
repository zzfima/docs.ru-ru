...
---
# <a name="how-to-find-preceding-siblings-xpath-linq-to-xml-visual-basic"></a>Практическое: поиск предшествующих элементов того же уровня (XPath-LINQ to XML) (Visual Basic)
