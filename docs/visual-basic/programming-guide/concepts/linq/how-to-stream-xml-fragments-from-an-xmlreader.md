...
---
# <a name="how-to-stream-xml-fragments-from-an-xmlreader-visual-basic"></a>Как выполнить Stream XML-фрагментов из XmlReader (Visual Basic)
