...
---
# <a name="how-to-retrieve-the-shallow-value-of-an-element-visual-basic"></a>Практическое руководство. Извлечение поверхностного значения элемента (Visual Basic)
