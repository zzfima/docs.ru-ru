...
## <a name="who-should-read-this-documentation"></a>Кому необходимо ознакомиться с этой документацией  
 ...
 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] основывается на использовании универсальных классов. Поэтому очень важно понимать использование универсальных типов и классов. Дополнительные сведения см. в разделе [универсальных типов в Visual Basic](../../../../visual-basic/programming-guide/language-features/data-types/generic-types.md).  
...
|[Расширенные программированию LINQ to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/advanced-linq-to-xml-programming.md)|Предоставляет сведения о заметках, событиях, данных потоковой передачи и других расширенных сценариях.|  
