...
## <a name="who-should-read-this-documentation"></a>Кому необходимо ознакомиться с этой документацией  
 Эта документация предназначена для разработчиков, знакомых с языком Visual Basic и некоторые основные аспекты [!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)].  
...
|[Дополнительно LINQ to XML, программирования (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/advanced-linq-to-xml-programming.md)|Предоставляет сведения о заметках, событиях, данных потоковой передачи и других расширенных сценариях.|  
