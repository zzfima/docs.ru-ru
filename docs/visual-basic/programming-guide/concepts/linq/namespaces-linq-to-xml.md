---
title: "Пространства имен в Visual Basic (LINQ to XML) | Документы Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="namespaces-in-visual-basic-linq-to-xml"></a>Пространства имен в Visual Basic (LINQ to XML)
