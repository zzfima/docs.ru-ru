...
|Метод|Синтаксис выражений запросов Visual Basic|  
|------------|------------------------------------------|  
...
|<xref:System.Linq.Enumerable.SelectMany%2A>|Несколько `From` предложения<br /><br /> (Дополнительные сведения см. в разделе [предложение From](../../../../visual-basic/language-reference/queries/from-clause.md).)|  
...
|<xref:System.Linq.Enumerable.TakeWhile%2A>|`Take While`<br /><br /> (Дополнительные сведения см. в разделе [занять While-предложение](../../../../visual-basic/language-reference/queries/take-while-clause.md).)|  
