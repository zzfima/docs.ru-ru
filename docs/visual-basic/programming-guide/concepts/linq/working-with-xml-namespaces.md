...
|[Практическое руководство. Управлять префиксами пространств имен (Visual Basic) (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)|Показывает, как управлять префиксами пространств имен с помощью деклараций глобальных пространств имен.|  
|[Области пространств имен по умолчанию в Visual Basic](../../../../visual-basic/programming-guide/concepts/linq/scope-of-default-namespaces.md)|Демонстрирует соответствующий способ составления запросов к XML в пространстве имен по умолчанию.|  
