...
## <a name="functional-programming-using-xslt"></a>Функциональное программирование с помощью XSLT  
 ...
 Тем не менее XSLT доказал свою полезность при чисто функциональном подходе для преобразования XML из одного вида в другой. Чисто функциональное программирование с помощью LINQ to XML во многом похоже на XSLT. Тем не менее программные конструкции, вводимые LINQ to XML и Visual Basic позволяют писать чисто функциональные преобразования, более удобочитаемые и легко обслуживаемые, чем XSLT.  
...
## <a name="transitioning-for-oop-developers"></a>Освоение нового подхода разработчиками объектно-ориентированных приложений  
 ...
 К счастью Visual Basic не требуют резкого перехода на функциональное программирование, так как он поддерживает как принудительной, так и функциональный подход. Разработчик может сам выбирать нужный подход в зависимости от конкретного сценария. В действительности в программах часто сочетаются оба стиля.  
