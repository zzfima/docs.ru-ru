...
---
# <a name="how-to-find-a-union-of-two-location-paths-xpath-linq-to-xml-visual-basic"></a>Как найти объединение двух путей расположения (XPath-LINQ to XML) (Visual Basic)
