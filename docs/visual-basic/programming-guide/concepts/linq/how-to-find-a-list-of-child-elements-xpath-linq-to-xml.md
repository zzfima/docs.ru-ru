...
---
# <a name="how-to-find-a-list-of-child-elements-xpath-linq-to-xml-visual-basic"></a>Как выполнить Поиск списка дочерних элементов (XPath-LINQ to XML) (Visual Basic)
