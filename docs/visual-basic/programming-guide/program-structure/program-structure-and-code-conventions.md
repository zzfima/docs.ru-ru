...
-   Соглашения об именовании объектов, переменных и процедур.  
 ...
 Следующие разделы предоставляют набор правил программирования для приложений Visual Basic, а также примеры применения.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Показано, как Сворачивание и скрытие частей кода в Visual Basic редактора кода.  
 ...
 Описывает использование квадратных скобок (`[]`) для обозначения имен переменных, которые также являются ключевыми словами Visual Basic.  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Предоставляет стандартные соглашения о написании кода для Visual Basic.  
