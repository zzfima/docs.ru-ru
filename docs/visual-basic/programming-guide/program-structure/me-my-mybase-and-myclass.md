...
`Me`, `My`, `MyBase`, и `MyClass` в [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] имеют схожие имена, но для других целей. В этом разделе описан каждый из этих сущностей, чтобы отличать их.  
...
## <a name="my"></a>My - функция  
 `My` Обеспечивает простой и понятный доступ на ряд [!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)] классов, включение [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] взаимодействия пользователя с компьютера, приложения, параметры, ресурсы и т. д.  
