---
title: "КОД языка &quot;&lt;имя&gt;&quot; не поддерживается в этой системе | Документы Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="locale-id-39ltnamegt39-is-not-supported-on-this-system"></a>КОД языка "&lt;имя&gt;" не поддерживается в этой системе
