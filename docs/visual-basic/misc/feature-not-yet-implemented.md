...
## <a name="to-correct-this-error"></a><span data-ttu-id="d9445-104">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="d9445-104">To correct this error</span></span>  
  
-   <span data-ttu-id="d9445-105">Удалите ссылку.</span><span class="sxs-lookup"><span data-stu-id="d9445-105">Remove the reference.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="d9445-106">См. также</span><span class="sxs-lookup"><span data-stu-id="d9445-106">See Also</span></span>  
 [<span data-ttu-id="d9445-107">Типы ошибок</span><span class="sxs-lookup"><span data-stu-id="d9445-107">Error Types</span></span>](../../visual-basic/programming-guide/language-features/error-types.md)  
