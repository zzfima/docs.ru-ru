...
---
# <a name="39optional39-cannot-be-applied-to-the-first-parameter-of-an-extension-method"></a>&#39;Необязательный&#39; не может применяться к первому параметру метода расширения
...
## <a name="see-also"></a>См. также  
 ...
 [Практическое: определение необязательных параметров для процедуры (Visual Basic)](https://msdn.microsoft.com/library/0b32b312-0da0-489b-96ad-7dcb1f1f8f88)  
