...
1.  Убедитесь, что файл, который вы пытаетесь загрузить в свойство `Picture` , является допустимым графическим файлом, поддерживаемым [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
  
## <a name="see-also"></a>См. также  
 [Изменения графики в Visual Basic .NET](http://msdn.microsoft.com/library/24cd2d55-ebf1-42d6-b755-00e9001f1cb8)
