...
1. Убедитесь, что вы пытаетесь загрузить в файл `Picture` свойство является допустимым графическим файлом, поддерживаемым Visual Basic.  
