...
---
# <a name="lttype1gt-ltpropertynamegt-conflicts-with-a-member-implicitly-declared-for-event-lteventnamegt-in-the-base-lttype2gt-ltclassnamegt"></a>&lt;тип1&gt; "&lt;propertyname&gt;«конфликтует с членом, неявно объявленным для события»&lt;eventname&gt;" в базовом &lt;тип2&gt; "&lt;classname &gt;'
