...
## <a name="to-correct-this-error"></a><span data-ttu-id="538cd-105">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="538cd-105">To correct this error</span></span>  
  
-   <span data-ttu-id="538cd-106">Проверьте указанный раздел реестра и определите, где и почему вставляются дополнительные обратные косые черты.</span><span class="sxs-lookup"><span data-stu-id="538cd-106">Examine the registry key being specified to determine where and why the extra backslashes are being inserted.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="538cd-107">См. также</span><span class="sxs-lookup"><span data-stu-id="538cd-107">See Also</span></span>  
 [<span data-ttu-id="538cd-108">Практическое руководство. Анализ путей к файлам</span><span class="sxs-lookup"><span data-stu-id="538cd-108">How to: Parse File Paths</span></span>](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-parse-file-paths.md)  
 [<span data-ttu-id="538cd-109">My.Computer.Registry</span><span class="sxs-lookup"><span data-stu-id="538cd-109">My.Computer.Registry</span></span>](xref:Microsoft.VisualBasic.MyServices.RegistryProxy)
