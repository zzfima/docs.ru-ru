...
---
# <a name="member-ltmembername1gt-implicitly-declares-ltimplicitmembernamegt-which-conflicts-with-a-member-in-the-base-class-ltbaseclassnamegt"></a>Член "&lt;имя_члена1&gt;«неявно объявляет»&lt;имя_неявного_члена&gt;«, который конфликтует с членом в базовом классе»&lt;имя_базового_класса&gt;"
