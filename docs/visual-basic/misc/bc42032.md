...
---
# <a name="operands-of-type-object-used-for-operator-39ltoperatorsymbolgt39-use-the-39isnot39-operator-to-test-object-identity"></a>Операнды типа Object используются для оператора "&lt;operatorsymbol&gt;"; проверки подлинности объекта используйте оператор «IsNot»
Выражение использует `<>` оператор с одного или обоих операндов [тип данных объекта](../../visual-basic/language-reference/data-types/object-data-type.md).  
