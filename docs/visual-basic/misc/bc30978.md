...
---
# <a name="range-variable-ltvariablegt-hides-a-variable-in-an-enclosing-block-or-a-range-variable-previously-defined-in-the-query-expression"></a>Переменная диапазона &lt;переменной&gt; скрывает переменную во внешнем блоке или переменную диапазона, ранее определенные в выражении запроса.
