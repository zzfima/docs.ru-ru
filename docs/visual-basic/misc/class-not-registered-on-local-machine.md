...
Эта ошибка обычно возникает из-за поврежденного файла. Может потребоваться переустановить [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)].  
  
## <a name="to-correct-this-error"></a>Исправление ошибки  
  
-   Переустановите [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)].  
