...
Параметр типа используется в качестве операнда для [оператор Is](../../visual-basic/language-reference/operators/is-operator.md) при определении параметра типа отсутствует либо [Class (Visual Basic)](https://msdn.microsoft.com/library/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) ключевое слово или имя определенного класса в его списке ограничений.  
