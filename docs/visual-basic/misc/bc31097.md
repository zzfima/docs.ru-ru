...
Член "\<membername настроек" не удается найти в классе\<classname настроек ". Это состояние, как правило, является результатом использования несоответствующей библиотеки "Microsoft.VisualBasic.dll".  
