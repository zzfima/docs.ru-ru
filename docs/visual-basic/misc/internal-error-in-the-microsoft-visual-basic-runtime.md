---
title: "Внутренняя ошибка во время выполнения Microsoft Visual Basic | Документы Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
Внутренняя ошибка в Microsoft [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] среды выполнения.  
