...
Файл ресурсов в проекте не соответствует стандартному формату для файла ресурса Windows, или существует несоответствие между файлом ресурсов и проектом [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] .  
