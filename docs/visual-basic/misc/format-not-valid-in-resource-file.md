---
title: "Недопустимый формат файла ресурсов | Документы Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
Файл ресурсов в проекте не совпадает со стандартным форматом для файла ресурса Windows, или существует несоответствие между файла ресурсов и [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] проекта.  
