...
### <a name="to-correct-the-error"></a><span data-ttu-id="cd1c2-104">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="cd1c2-104">To correct the error</span></span>  
  
-   <span data-ttu-id="cd1c2-105">Сократите число приемников событий.</span><span class="sxs-lookup"><span data-stu-id="cd1c2-105">Reduce the number of event receivers.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="cd1c2-106">См. также</span><span class="sxs-lookup"><span data-stu-id="cd1c2-106">See Also</span></span>  
 [<span data-ttu-id="cd1c2-107">Как: вызов событий, обрабатываемых приемником COM</span><span class="sxs-lookup"><span data-stu-id="cd1c2-107">How to: Raise Events Handled by a COM Sink</span></span>](http://msdn.microsoft.com/library/7c9944b2-e951-4c3e-a0a1-59b2ae37d7fd)  
 [<span data-ttu-id="cd1c2-108">Пошаговое руководство. Обработка событий</span><span class="sxs-lookup"><span data-stu-id="cd1c2-108">Walkthrough: Handling Events</span></span>](../../visual-basic/programming-guide/language-features/events/walkthrough-handling-events.md)
