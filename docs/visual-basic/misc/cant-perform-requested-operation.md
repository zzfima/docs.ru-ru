---
title: Можно&#39;t выполнить запрошенную операцию (Visual Basic)
ms.date: 07/20/2015
f1_keywords:
- vbrID17
...
## <a name="to-correct-this-error"></a><span data-ttu-id="f5148-105">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="f5148-105">To correct this error</span></span>  
  
-   <span data-ttu-id="f5148-106">Остановите выполнение кода, внесите необходимые изменения и затем повторите операцию.</span><span class="sxs-lookup"><span data-stu-id="f5148-106">Stop the code execution, make modifications if necessary, and then retry the operation.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="f5148-107">См. также</span><span class="sxs-lookup"><span data-stu-id="f5148-107">See Also</span></span>  
 [<span data-ttu-id="f5148-108">Типы ошибок</span><span class="sxs-lookup"><span data-stu-id="f5148-108">Error Types</span></span>](../../visual-basic/programming-guide/language-features/error-types.md)
