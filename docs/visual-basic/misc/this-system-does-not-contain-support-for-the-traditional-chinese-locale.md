...
## <a name="to-correct-this-error"></a><span data-ttu-id="708d2-104">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="708d2-104">To correct this error</span></span>  
  
1.  <span data-ttu-id="708d2-105">Обновите систему для поддержки традиционного китайского языка или запустите приложение на компьютере, который поддерживает этот языковой стандарт.</span><span class="sxs-lookup"><span data-stu-id="708d2-105">Upgrade the machine to support the Traditional Chinese locale, or run the application on a machine that supports the locale.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="708d2-106">См. также</span><span class="sxs-lookup"><span data-stu-id="708d2-106">See Also</span></span>  
 <xref:System.Globalization>  
   
 [<span data-ttu-id="708d2-107">Знакомство с международными приложениями на платформе .NET Framework</span><span class="sxs-lookup"><span data-stu-id="708d2-107">Introduction to International Applications Based on the .NET Framework</span></span>](/visualstudio/ide/introduction-to-international-applications-based-on-the-dotnet-framework)
