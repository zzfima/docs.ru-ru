...
---
# <a name="membername-is-not-declared-or-the-module-containing-it-is-not-loaded-in-the-debugging-session"></a>'\<имя_члена >' не объявлен или содержащий его модуль не загружен во время сеанса отладки
