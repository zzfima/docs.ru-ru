...
## <a name="to-correct-this-error"></a><span data-ttu-id="0bc42-105">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="0bc42-105">To correct this error</span></span>  
  
1.  <span data-ttu-id="0bc42-106">Проверьте свойство и определите, при каких условиях возможно его задание.</span><span class="sxs-lookup"><span data-stu-id="0bc42-106">Check the property and determine under what conditions it can be set.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="0bc42-107">См. также</span><span class="sxs-lookup"><span data-stu-id="0bc42-107">See Also</span></span>  
 [<span data-ttu-id="0bc42-108">Управление свойствами проектов и решений</span><span class="sxs-lookup"><span data-stu-id="0bc42-108">Managing Project and Solution Properties</span></span>](/visualstudio/ide/managing-project-and-solution-properties)
