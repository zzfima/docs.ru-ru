...
---
# <a name="event-lteventnamegt-event-specified-by-the-defaultevent-attribute-is-not-a-publicly-accessible-event-for-this-class"></a>Событие "&lt;eventname&gt;" событие, заданное атрибутом «DefaultEvent» не является общедоступным события для этого класса
