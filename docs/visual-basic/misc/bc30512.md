...
---
# <a name="option-strict-on-disallows-implicit-conversions-from-lttype1gt-to-lttype2gt"></a>Option Strict On запрещает неявное преобразование из "&lt;тип1&gt;«to»&lt;тип2&gt;"
