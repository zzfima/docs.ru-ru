...
---
# <a name="lambda-expression-cannot-be-converted-to-lttypenamegt-because-lttypenamegt-is-not-a-delegate-type"></a>Невозможно преобразовать лямбда-выражение в "&lt;typename&gt;«, так как»&lt;typename&gt;" не является типом делегата
