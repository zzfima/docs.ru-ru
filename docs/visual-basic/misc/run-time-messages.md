...
Этот раздел содержит сообщения об ошибках Visual Basic, возникающих во время выполнения.  
 ...
 [Для журнала событий было указано недопустимое имя](../../visual-basic/misc/an-invalid-name-was-specified-for-the-event-log.md)  
 ...
 [По указанным аргументам невозможно вычислить частоту](../../visual-basic/misc/cannot-calculate-rate-using-the-arguments-provided.md)  
 ...
 [Невозможно получить информацию о памяти из-за внутренней ошибки](../../visual-basic/misc/could-not-obtain-memory-information-due-to-internal-error.md)  
 ...
 [ReDim не может изменять число измерений](../../visual-basic/misc/redim-cannot-change-the-number-of-dimensions.md)  
 ...
 [Set не поддерживается во время выполнения](../../visual-basic/misc/set-not-supported-at-run-time.md)  
 ...
 [Указанный раздел реестра не существует](../../visual-basic/misc/specified-registry-key-does-not-exist.md)  
 ...
 [Указанный путь не существует:](../../visual-basic/misc/the-specified-path-does-not-exist.md)  
 ...
 [Превышено допустимое число приложений-клиентов DLL](../../visual-basic/misc/too-many-dll-application-clients.md)  
 ...
 [Невозможно произвести запись в файл журнала, на диске останется менее ReservedSpace](../../visual-basic/misc/unable-to-write-to-log-file-because-reduce-free-disk-space-below-reservedspace.md)  
