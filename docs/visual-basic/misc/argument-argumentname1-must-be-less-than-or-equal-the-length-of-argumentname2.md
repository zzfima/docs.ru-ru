...
## <a name="to-correct-this-error"></a><span data-ttu-id="ac87b-104">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="ac87b-104">To correct this error</span></span>  
  
-   <span data-ttu-id="ac87b-105">Сократите длину первого аргумента, чтобы она была не больше длины второго аргумента.</span><span class="sxs-lookup"><span data-stu-id="ac87b-105">Make the length of the first argument less than or equal to the length of the second argument.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="ac87b-106">См. также</span><span class="sxs-lookup"><span data-stu-id="ac87b-106">See Also</span></span>  
 [<span data-ttu-id="ac87b-107">Типы ошибок</span><span class="sxs-lookup"><span data-stu-id="ac87b-107">Error Types</span></span>](../../visual-basic/programming-guide/language-features/error-types.md)
