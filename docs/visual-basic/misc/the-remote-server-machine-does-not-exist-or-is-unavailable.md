...
## <a name="to-correct-this-error"></a><span data-ttu-id="78c96-105">Исправление ошибки</span><span class="sxs-lookup"><span data-stu-id="78c96-105">To correct this error</span></span>  
  
-   <span data-ttu-id="78c96-106">Еще раз подключитесь к сети и повторите попытку.</span><span class="sxs-lookup"><span data-stu-id="78c96-106">Reconnect to the network and try again.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="78c96-107">См. также</span><span class="sxs-lookup"><span data-stu-id="78c96-107">See Also</span></span>  
 [<span data-ttu-id="78c96-108">Типы ошибок</span><span class="sxs-lookup"><span data-stu-id="78c96-108">Error Types</span></span>](../../visual-basic/programming-guide/language-features/error-types.md)
