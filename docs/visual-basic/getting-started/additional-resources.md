...
|[Блог группы разработчиков Microsoft Visual Basic](https://blogs.msdn.microsoft.com/vbteam/)|Доступ к блогу команды разработчиков Visual Basic.|
...
|Термин|Определение|
|----------|----------------|
|[Форумы по Visual Basic](https://social.msdn.microsoft.com/Forums/vstudio/en-US/home?forum=vbgeneral)|Рассматриваются общие вопросы по Visual Basic.|
